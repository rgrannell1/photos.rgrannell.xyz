  ...
  return {
    view() {
      return (0, import_mithril3.default)(
        "a",
        { href: "/", onclick },
        (0, import_mithril3.default)("span.burger", "\u039E"),
      );
    },
  };
}
  ...
  return {
    view() {
      return (0, import_mithril3.default)(
        "a",
        { href: "/" },
        (0, import_mithril3.default)("span.brand", BRAND_TEXT),
      );
    },
  };
}
function RSSIcon() {
  ...
  return {
    view() {
      return (0, import_mithril3.default)("a.rss", {
        title: "rss",
        ...
        [
          (0, import_mithril3.default)("ul", [
            (0, import_mithril3.default)(
              "li.header-item",
              {},
              (0, import_mithril3.default)(BurgerMenu()),
            ),
            (0, import_mithril3.default)(
              "li.header-item",
              {},
              (0, import_mithril3.default)(HeaderBrandText()),
            ),
            (0, import_mithril3.default)("li.rss-tag header-item", {
              style: "float: right",
            }, (0, import_mithril3.default)(RSSIcon())),
            (0, import_mithril3.default)(
              "li.header-item",
              { style: "float: right" },
...
function AlbumStats() {
  ...
  return {
    view() {
      if (!isStats(stats)) {
        return (0, import_mithril7.default)("p");
      }
  ...
  return {
    view(vnode) {
      ...
      return (0, import_mithril10.default)("a", {
        ...
        (0, import_mithril10.default)(Image, {
          thumbnailUrl,
          loading,
          onclick,
        }),
...
function PhotoAlbum() {
  return {
    view(vnode) {
      ...
      return (0, import_mithril11.default)("div.photo-album", {
...
function CountryLink() {
  return {
    view(vnode) {
      ...
      if (mode === "flag") {
        return (0, import_mithril12.default)("a.country-link-short", {
          href: urnToUrl(id),
          onclick,
        }, flag);
      }
...
function PlaceLink() {
  return {
    view(vnode) {
      ...
      text = `${placeEmoji(location2)} ${
        one(location2.name) || "Unknown Place"
      }`;
...
function LocationLink() {
  return {
    view(vnode) {
      ...
      return (0, import_mithril12.default)(PlaceLink, {
        location: location2,
        mode,
      });
    },
  ...
  return {
    view(vnode) {
      ...
      const $videosList = videos.map((video) => {
        return (0, import_mithril16.default)(Video2, {
          video,
          preload: "auto",
        });
      });
...
function AlbumPage() {
  return {
    ...
    view(vnode) {
      ...
      const $albumMetadata = (0, import_mithril20.default)(
        "section.photos-metadata",
        [
          (0, import_mithril20.default)("h1", name),
          (0, import_mithril20.default)(
            "p.photo-album-date",
            (0, import_mithril20.default)("time", dateRange),
          ),
          (0, import_mithril20.default)(
            "p.photo-album-count",
            photoCountMessage,
          ...
          (0, import_mithril20.default)(
            ...
            import_mithril20.default.trust(description ?? ""),
          ),
          (0, import_mithril20.default)(AlbumShareButton, {
            url: location.href,
            name,
          }),
          " ",
      ...
      const $videosList = videos.map((video) => {
        return (0, import_mithril20.default)(Video2, {
          ...video,
          preload: "auto",
        });
      });
...
function PhotosPage() {
  return {
    view(vnode) {
      ...
      return (0, import_mithril21.default)("div", [
        $md,
        (0, import_mithril21.default)(PhotosList, { photos }),
      ]);
    },
  };
}
    ...
    view(vnode) {
      ...
      if (html) {
        return (0, import_mithril24.default)(
          "td",
          import_mithril24.default.trust(html),
        );
      }
    ...
    view(vnode) {
      ...
      infoItems.push(
        (0, import_mithril24.default)("tr", [
          ...
          (0, import_mithril24.default)(Country2, { photo, services }),
        ]),
        (0, import_mithril24.default)("tr", [
...
function PhotoPage() {
  return {
    view(vnode) {
      ...
      const $exif = (0, import_mithril25.default)(ExifData, {
        photo,
        services,
      });
      const $photoInfo = (0, import_mithril25.default)(PhotoInfo, {
        photo,
        services,
      });
      ...
      if (wikipedia) {
        $links.push(
          (0, import_mithril30.default)(
            "li",
            (0, import_mithril30.default)(ExternalLink, {
              href: wikipedia,
              text: "[wikipedia]",
            }),
          ),
  ...
  return {
    ...
    view(vnode) {
      ...
      if (places.size > 0) {
        ...
        metadata["Located In"] = (0, import_mithril30.default)(
          "ul",
          locations.map((location2) => {
            return (0, import_mithril30.default)(LocationLink, {
              location: location2,
              mode: "name",
            });
          }),
        ...
        metadata["Place Features"] = (0, import_mithril30.default)(
          ...
          features.map((feature) => {
            ...
            return (0, import_mithril30.default)(
              "li",
              { key: `feature-${urn2}` },
              (0, import_mithril30.default)(ThingLink, {
                urn: urn2,
                thing: feature,
              }),
            );
      ...
      if (thing.contains) {
        metadata["Contains"] = (0, import_mithril30.default)(
          "ul",
          arrayify(thing.contains).map((urn2) => {
            return (0, import_mithril30.default)(
              ...
              (0, import_mithril30.default)(ThingLink, {
                urn: urn2,
                thing: services.readLocation(urn2),
              }),
            );
          }),
        );
      ...
      if (thing.unescoId) {
        ...
        metadata["UNESCO"] = (0, import_mithril30.default)(
          "li",
          (0, import_mithril30.default)(UnescoLink, {
            urn: thing.unescoId,
            thing: unescoDetails,
          }),
        );
    ...
    view(vnode) {
      ...
      return (0, import_mithril30.default)("div", [
        (0, import_mithril30.default)("section.thing-page", [
          ...
          (0, import_mithril30.default)(ThingMetadata, {
            urn,
            things,
            services,
          }),
          (0, import_mithril30.default)("h3", "Photos"),
          (0, import_mithril30.default)(PhotoSection, {
            urn,
            things,
            services,
          }),
          (0, import_mithril30.default)("h3", "Albums"),
          (0, import_mithril30.default)(AlbumSection, {
            urn,
            things,
            services,
          }),
        ...
        (0, import_mithril31.default)(
          ...
          [
            ...
            (0, import_mithril31.default)("div.app-container", [
              (0, import_mithril31.default)(Sidebar, {
        ...
        (0, import_mithril31.default)(
          ...
          [
            ...
            (0, import_mithril31.default)("div.app-container", [
              ...
              (0, import_mithril31.default)(PhotoPage, {
                photo,
                services: state.services,
              }),
            ]),
...
//# sourceMappingURL=app.586785f3a1.js.map
