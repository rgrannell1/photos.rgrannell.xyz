...
function ThingTitle() {
  return {
    view(vnode) {
      ...
      return (0, import_mithril27.default)("h1", computeTitle(urn, things));
    },
  };
}
  ...
  return {
    view(vnode) {
      ...
      const $contains = locations.map((location2) => {
        const $link = (0, import_mithril30.default)(ThingLink, {
      ...
      return (0, import_mithril30.default)("ul", $contains);
    },
  };
}
      ...
      if (wikipedia) {
        $links.push(
          (0, import_mithril31.default)(
            "li",
            (0, import_mithril31.default)(ExternalLink, {
              href: wikipedia,
              text: "[wikipedia]",
            }),
          ),
...
function ThingMetadata() {
  return {
    ...
    view(vnode) {
      ...
      const parsed = asUrn(urn);
      metadata.Classification = (0, import_mithril31.default)("a", {
        ...
        metadata["Place Features"] = (0, import_mithril31.default)(
          ...
          features.map((feature) => {
            ...
            return (0, import_mithril31.default)(
              "li",
              { key: `feature-${urn2}` },
              (0, import_mithril31.default)(ThingLink, {
                urn: urn2,
                thing: feature,
              }),
            );
      ...
      if (thing.unescoId) {
        ...
        metadata["UNESCO"] = (0, import_mithril31.default)(
          "li",
          (0, import_mithril31.default)(UnescoLink, {
            urn: thing.unescoId,
            thing: unescoDetails ?? {},
          }),
        );
...
function PhotoSection() {
  return {
    view(vnode) {
      ...
      console.log(things);
      const urns = Object.values(things).flatMap((thing) =>
        Array.isArray(thing.id) ? thing.id : [thing.id]
      );
    ...
    view(vnode) {
      ...
      return (0, import_mithril31.default)("div", [
        (0, import_mithril31.default)("section.thing-page", [
          ...
          (0, import_mithril31.default)(ThingMetadata, {
            urn,
            things,
            services,
          }),
          (0, import_mithril31.default)("h3", "Photos"),
          (0, import_mithril31.default)(PhotoSection, {
            urn,
            things,
            services,
          }),
        ...
        (0, import_mithril32.default)(
          ...
          [
            ...
            (0, import_mithril32.default)("div.app-container", [
              (0, import_mithril32.default)(Sidebar, {
        ...
        (0, import_mithril32.default)(
          ...
          [
            ...
            (0, import_mithril32.default)("div.app-container", [
              ...
              (0, import_mithril32.default)(PhotoPage, {
                photo,
                services: state.services,
              }),
            ]),
...
//# sourceMappingURL=app.debec1bbe5.js.map
