...
`);n=a.pop()??"";for(let p of a){let m=t.parse(p);m!==void 0&&(yield m)}}if(n.length>0){let o=t.parse(n);o!==void 0&&(yield o)}}};var Be="photos";var je={photos:"photos",albums:"albums",album:"album",metadata:"metadata",about:"about",videos:"videos",thing:"thing",listing:"listing"},$=class{static UNESCO="unesco";static BIRD="bird";static MAMMAL="mammal";static REPTILE="reptile";static FISH="fish";static INSECT="insect";static AMPHIBIAN="amphibian";static GEONAME="geoname";static PHOTO="photo";static ALBUM="album";static VIDEO="video";static COUNTRY="country"},g=class{static SUBJECT="subject";static LOCATION="location";static LONGITUDE="longitude";static LATITUDE="latitude";static COUNTRY="country";static FLAG="flag";static RATING="rating";static NAME="name";static BIRDWATCH_URL="birdwatchUrl";static WIKIPEDIA="wikipedia";static CREATED_AT="createdAt";static SEASON="season";static F_STOP="f_stop";static FOCAL_LENGTH="focalLength";static MODEL="model";static EXPOSURE_TIME="exposureTime";static ISO="iso";static WIDTH="width";static HEIGHT="height";static THUMBNAIL_URL="thumbnailUrl";static PNG_URL="pngUrl";static MID_IMAGE_LOSSY_URL="midImageLossyUrl";static FULL_IMAGE="fullImage";static POSTER_URL="posterUrl";static VIDEO_URL_1080P="videoUrl1080p";static VIDEO_URL_480P="videoUrl480p";static VIDEO_URL_720P="videoUrl720p";static VIDEO_URL_UNSCALED="videoUrlUnscaled";static YEAR="year"},He=new Set([g.CREATED_AT,g.F_STOP,g.FOCAL_LENGTH,g.MODEL,g.EXPOSURE_TIME,g.ISO,g.WIDTH,g.HEIGHT]),Z=new Set([$.BIRD,$.MAMMAL,$.REPTILE,$.AMPHIBIAN,$.FISH,$.INSECT]),Ve=new Set([g.THUMBNAIL_URL,g.PNG_URL,g.MID_IMAGE_LOSSY_URL,g.FULL_IMAGE,g.POSTER_URL,g.VIDEO_URL_1080P,g.VIDEO_URL_480P,g.VIDEO_URL_720P,g.VIDEO_URL_UNSCALED]);function As(r,t){let{id:e,type:s}=x(t),i=r.search({source:{id:e,type:s},relation:g.NAME}).firstTarget();if(typeof i>"u")return i;if(typeof i!="string")throw new TypeError(`name is not a string: ${i}`);return i}function Ds(r,t){let{id:e,type:s}=x(t),i=r.search({source:{id:e,type:s},relation:[g.LONGITUDE,g.LATITUDE]}).firstObject();if(i)return{longitude:i.longitude,latitude:i.latitude}}function Rs(r){return{name:r.name,minDate:parseInt(r.minDate),maxDate:parseInt(r.maxDate),thumbnailUrl:r.thumbnailUrl,mosaicColours:r.mosaic,id:r.id,photosCount:r.photosCount,flags:r.flags}}function ks(r){return{...r}}function Os(r){return{...r}}function Ms(r,t){return r.search({source:{type:"photo"},relation:"albumId",target:{id:t}}).sources()}function Ls(r,t){return r.search({source:{type:t},relation:"name"}).objects().sort((s,i)=>s.name.localeCompare(i.name))}var _=class{static getName(t,e){return As(t,e)}static getAlbumPhotoSources(t,e){return Ms(t,e)}static getDistinctNames(t,e){return Ls(t,e)}static getGeocoordinates(t,e){return Ds(t,e)}static videoObjects(t){return t.search({source:{type:"video"}}).objects().map(ks)}static photoObjects(t,e={}){return t.search({...e,source:{type:"photo"}}).objects().map(Os).sort((s,i)=>i.createdAt-s.createdAt)}static albumObjects(t){return t.search({source:{type:"album"}}).objects().map(Rs).sort((e,s)=>s.minDate-e.minDate)}},Ht=class{static getURL(t,e){let s=_.getGeocoordinates(t,e);if(!s)return;let{longitude:i,latitude:n}=s;if(i&&n){let o=`https://www.google.com/maps?q=${n},${i}`;return l`
    ...
    `}};h([d({state:!0})],wt.prototype,"triples",2),h([d()],wt.prototype,"qs",2);var pe=wt;customElements.define("photos-page",pe);var ue=class extends f{render(){let t=document.getElementById("stats-data");if(!t)return console.error("No stats data found"),l``;let e=JSON.parse(t.innerText);return l`
    ...
    `}};h([d({})],St.prototype,"albums",2),h([d({state:!0})],St.prototype,"triples",2);customElements.define("albums-page",St);var Tt=class extends it{constructor(t){if(super(t),this.it=T,t.type!==nt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===T||t==null)return this._t=void 0,this.it=t;if(t===k)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;let e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};Tt.directiveName="unsafeHTML",Tt.resultType=1;var Xt=tt(Tt);var N=class extends f{render(){return l`
    <div>
    ...
    `}};h([d()],N.prototype,"id",2),h([d()],N.prototype,"url",2),h([d()],N.prototype,"preload",2),h([d()],N.prototype,"urlPoster",2),h([d()],N.prototype,"urlUnscaled",2),h([d()],N.prototype,"url1080p",2),h([d()],N.prototype,"url720p",2),h([d()],N.prototype,"url480p",2);customElements.define("app-video",N);var lt=class extends f{async shareAlbum(t){if(!navigator.share){console.error("navigator.share not available");return}this.sharing=!0;try{await navigator.share({title:`${this.title} - photos.rgrannell.xyz`,url:t})}catch(e){console.error("Error sharing:",e)}finally{this.sharing=!1}}render(){let t=this.shareAlbum.bind(this,this.url);return l`
      ...
      `}};h([d()],lt.prototype,"title",2),h([d()],lt.prototype,"url",2),h([d({state:!0})],lt.prototype,"sharing",2);customElements.define("album-share-button",lt);var Zt=class extends f{getId(){return w.parseUrn(this.urn)?.id??"unknown"}url(){return this.getId()?`https://whc.unesco.org/en/list/${this.getId()}`:null}render(){return this.getId()?l`
    ...
    `}render(){let t=this.image,e=t.albumId,s=this.triples,i=s.search({source:{id:E(t.id).id},relation:{predicate:n=>{let o=new Set(["albumId","fullImage","mosaicColours","thumbnailUrl","midImageLossyUrl"]);return!He.has(n)&&!o.has(n)}}}).triples();return l`
    <section>
    <h1>Metadata</h1>
    ...
    `}};h([d()],st.prototype,"id",2),h([d()],st.prototype,"image",2),h([d({state:!0})],st.prototype,"sharing",2),h([d({state:!0})],st.prototype,"triples",2);customElements.define("metadata-page",st);var fe=class extends f{connectedCallback(){super.connectedCallback(),C.setIndex(),document.title="About - photos"}render(){return l`
    <div>
    ...
    ${Object.entries(t).flatMap(([e,s])=>s?s.length===0?[]:e==="default"?[l`
      ...
      `]:[])}
    <div/>`}render(){let t=this.triples,e=w.parseUrn(this.urn),s=e.type,i=t.search({source:x(this.urn)}).firstObject()??{},n=Object.assign({Classification:this.renderClassification(s)});if(i.country&&(n.Country=l`<thing-link .triples=${this.triples} urn=${i.country}></thing-link>`),i.fcodeName){let A=i.fcodeName;n["Place Type"]=l`${D.capitalise(A)}`}Z.has(s)&&(n["First Photographed"]=l`<span>${this.firstPhotographed(t,{target:x(this.urn)})}</span>`);let o=i[g.WIKIPEDIA],c=i[g.BIRDWATCH_URL],a=Ht.getURL(t,this.urn),p=x(this.urn);p.id==="*"&&delete p.id;let m=this.getPhotoQueries(x(this.urn)),u={};for(let{query:A,label:pt}of m){let hs=this.urnImages(t,A);u[pt]=this.renderSubjectPhotos(hs)}let b={source:{type:"photo"},target:p},y=this.renderSubjectAlbums(t,b),I=this.renderPhotoSection(u);return l`
      <div>
    ...
    `}};h([d()],It.prototype,"urn",2),h([d({state:!0})],It.prototype,"triples",2);customElements.define("thing-page",It);var te=class{static loadingMode(t){return t===0?"auto":"none"}};var ee=class extends f{connectedCallback(){super.connectedCallback(),C.setIndex(),document.title="Videos- photos"}render(){let t=_.videoObjects(this.triples);async function*e(){for(let s=0;s<t.length;s++){let i=t[s];s%4===0&&await new Promise(n=>setTimeout(n,0)),yield l`<app-video
          id=${i.id}
    ...
    `:l`<div class="thing-metadata"><p>${s}</p></div>`}renderThingAlbum(t,e,s,i){let n=$e.chooseBestImage(this.triples,t,e);if(!n)return console.error("No image found for",t,e),l``;let o=(m,u)=>{let{type:b,id:y}=x(m),I=new CustomEvent("click-thing-album",{detail:{id:`${b}:${y}`,name:u},bubbles:!0,composed:!0});this.dispatchEvent(I)},c=this.triples.search({source:x(n)}).firstObject(),a=x(this.id),p=`${a.type}:${a.id}`;return l`
      <photo-album
    ...
    `}render(){let t=this.triples,e=_.getDistinctNames(t,this.id);return l`
    <section class="album-metadata">
...
lit-html/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=app.a02370e3da421dd8.js.map
