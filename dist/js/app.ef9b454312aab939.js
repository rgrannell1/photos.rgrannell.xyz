...
`);n=a.pop()??"";for(let p of a){let m=t.parse(p);m!==void 0&&(yield m)}}if(n.length>0){let o=t.parse(n);o!==void 0&&(yield o)}}};var je="photos";var He={photos:"photos",albums:"albums",album:"album",metadata:"metadata",about:"about",videos:"videos",thing:"thing",listing:"listing"},$=class{static UNESCO="unesco";static BIRD="bird";static MAMMAL="mammal";static REPTILE="reptile";static FISH="fish";static INSECT="insect";static AMPHIBIAN="amphibian";static GEONAME="geoname";static PHOTO="photo";static ALBUM="album";static VIDEO="video";static COUNTRY="country"},g=class{static SUBJECT="subject";static LOCATION="location";static LONGITUDE="longitude";static LATITUDE="latitude";static COUNTRY="country";static FLAG="flag";static RATING="rating";static NAME="name";static BIRDWATCH_URL="birdwatchUrl";static WIKIPEDIA="wikipedia";static CREATED_AT="createdAt";static SEASON="season";static F_STOP="f_stop";static FOCAL_LENGTH="focalLength";static MODEL="model";static EXPOSURE_TIME="exposureTime";static ISO="iso";static WIDTH="width";static HEIGHT="height";static THUMBNAIL_URL="thumbnailUrl";static PNG_URL="pngUrl";static MID_IMAGE_LOSSY_URL="midImageLossyUrl";static FULL_IMAGE="fullImage";static POSTER_URL="posterUrl";static VIDEO_URL_1080P="videoUrl1080p";static VIDEO_URL_480P="videoUrl480p";static VIDEO_URL_720P="videoUrl720p";static VIDEO_URL_UNSCALED="videoUrlUnscaled";static YEAR="year"},Ve=new Set([g.CREATED_AT,g.F_STOP,g.FOCAL_LENGTH,g.MODEL,g.EXPOSURE_TIME,g.ISO,g.WIDTH,g.HEIGHT]),tt=new Set([$.BIRD,$.MAMMAL,$.REPTILE,$.AMPHIBIAN,$.FISH,$.INSECT]),qe=new Set([g.THUMBNAIL_URL,g.PNG_URL,g.MID_IMAGE_LOSSY_URL,g.FULL_IMAGE,g.POSTER_URL,g.VIDEO_URL_1080P,g.VIDEO_URL_480P,g.VIDEO_URL_720P,g.VIDEO_URL_UNSCALED]);function Ds(r,t){let{id:e,type:s}=x(t),i=r.search({source:{id:e,type:s},relation:g.NAME}).firstTarget();if(typeof i>"u")return i;if(typeof i!="string")throw new TypeError(`name is not a string: ${i}`);return i}function Rs(r,t){let{id:e,type:s}=x(t),i=r.search({source:{id:e,type:s},relation:[g.LONGITUDE,g.LATITUDE]}).firstObject();if(i)return{longitude:i.longitude,latitude:i.latitude}}function ks(r){return{name:r.name,minDate:parseInt(r.minDate),maxDate:parseInt(r.maxDate),thumbnailUrl:r.thumbnailUrl,mosaicColours:r.mosaic,id:r.id,photosCount:r.photosCount,flags:r.flags}}function Os(r){return{...r}}function Ms(r){return{...r}}function Ls(r,t){return r.search({source:{type:"photo"},relation:"albumId",target:{id:t}}).sources()}function Ns(r,t){return r.search({source:{type:t},relation:"name"}).objects().sort((s,i)=>s.name.localeCompare(i.name))}var E=class{static getName(t,e){return Ds(t,e)}static getAlbumPhotoSources(t,e){return Ls(t,e)}static getDistinctNames(t,e){return Ns(t,e)}static getGeocoordinates(t,e){return Rs(t,e)}static videoObjects(t){return t.search({source:{type:"video"}}).objects().map(Os)}static photoObjects(t,e={}){return t.search({...e,source:{type:"photo"}}).objects().map(Ms).sort((s,i)=>i.createdAt-s.createdAt)}static albumObjects(t){return t.search({source:{type:"album"}}).objects().map(ks).sort((e,s)=>s.minDate-e.minDate)}},Ht=class{static getURL(t,e){let s=E.getGeocoordinates(t,e);if(!s)return;let{longitude:i,latitude:n}=s;if(i&&n){let o=`https://www.google.com/maps?q=${n},${i}`;return l`
    ...
    `}};h([d({type:Boolean,state:!0})],qt.prototype,"visible",2);customElements.define("photo-sidebar",qt);var Ft=class extends f{constructor(){super(...arguments);this.darkMode=!1}feedUrl(){return"/manifest/atom/atom-index.xml"}renderRss(){return l`
    ...
    `}};h([d()],Ft.prototype,"darkMode",2);customElements.define("photo-header",Ft);var ot={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},et=r=>(...t)=>({_$litDirective$:r,values:t}),nt=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this._$Ct=t,this._$AM=e,this._$Ci=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var{I:js}=Oe;var ze=r=>r.strings===void 0,Fe=()=>document.createComment(""),Ge=(r,t,e)=>{let s=r._$AA.parentNode,i=t===void 0?r._$AB:t._$AA;if(e===void 0){let n=s.insertBefore(Fe(),i),o=s.insertBefore(Fe(),i);e=new js(n,o,r,r.options)}else{let n=e._$AB.nextSibling,o=e._$AM,c=o!==r;if(c){let a;e._$AQ?.(r),e._$AM=r,e._$AP!==void 0&&(a=r._$AU)!==o._$AU&&e._$AP(a)}if(n!==i||c){let a=e._$AA;for(;a!==n;){let p=a.nextSibling;s.insertBefore(a,i),a=p}}}return e},We=(r,t,e=r)=>(r._$AI(t,e),r);var Ye=r=>{r._$AR()};var xt=(r,t)=>{let e=r._$AN;if(e===void 0)return!1;for(let s of e)s._$AO?.(t,!1),xt(s,t);return!0},zt=r=>{let t,e;do{if((t=r._$AM)===void 0)break;e=t._$AN,e.delete(r),r=t}while(e?.size===0)},Qe=r=>{for(let t;t=r._$AM;r=t){let e=t._$AN;if(e===void 0)t._$AN=e=new Set;else if(e.has(r))break;e.add(r),qs(t)}};function Hs(r){this._$AN!==void 0?(zt(this),this._$AM=r,Qe(this)):this._$AM=r}function Vs(r,t=!1,e=0){let s=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(s))for(let n=e;n<s.length;n++)xt(s[n],!1),zt(s[n]);else s!=null&&(xt(s,!1),zt(s));else xt(this,r)}var qs=r=>{r.type==ot.CHILD&&(r._$AP??=Vs,r._$AQ??=Hs)},Gt=class extends nt{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,s){super._$AT(t,e,s),Qe(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(xt(this,t),zt(this))}setValue(t){if(ze(this._$Ct))this._$Ct._$AI(t,this);else{let e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}};var Ke=async(r,t)=>{for await(let e of r)if(await t(e)===!1)return},Wt=class{constructor(t){this.G=t}disconnect(){this.G=void 0}reconnect(t){this.G=t}deref(){return this.G}},Yt=class{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??=new Promise((t=>this.Z=t))}resume(){this.Z?.(),this.Y=this.Z=void 0}};var wt=class extends Gt{constructor(){super(...arguments),this._$CK=new Wt(this),this._$CX=new Yt}render(t,e){return k}update(t,[e,s]){if(this.isConnected||this.disconnected(),e===this._$CJ)return k;this._$CJ=e;let i=0,{_$CK:n,_$CX:o}=this;return Ke(e,(async c=>{for(;o.get();)await o.get();let a=n.deref();if(a!==void 0){if(a._$CJ!==e)return!1;s!==void 0&&(c=s(c,i)),a.commitValue(c,i),i++}return!0})),k}commitValue(t,e){this.setValue(t)}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}},ji=et(wt);var at=et(class extends wt{constructor(r){if(super(r),r.type!==ot.CHILD)throw Error("asyncAppend can only be used in child expressions")}update(r,t){return this._$Ctt=r,super.update(r,t)}commitValue(r,t){t===0&&Ye(this._$Ctt);let e=Ge(this._$Ctt);We(e,r)}});var Qt=new Map,U=class{static loadingMode(t){let e=globalThis.innerWidth,s=globalThis.innerHeight,i=400,n=Math.floor(e/i),o=Math.floor(s/i);return t>n*o+1?"lazy":"eager"}static encodeBitmapDataURL(t){if(Qt.has(t))return Qt.get(t);let e=t.split("#").map(n=>`#${n}`),s=document.createElement("canvas");s.width=2,s.height=2;let i=s.getContext("2d");if(!i){console.error("context missing, cannot render colours");return}return i.fillStyle=e[1],i.fillRect(0,0,1,1),i.fillStyle=e[2],i.fillRect(1,0,1,1),i.fillStyle=e[3],i.fillRect(0,1,1,1),i.fillStyle=e[4],i.fillRect(1,1,1,1),Qt.set(t,s.toDataURL("image/png")),Qt.get(t)}};var V=class extends f{constructor(){super(...arguments);this.loading="eager"}renderIcon(){return l`
    ...
    `}};h([d({state:!0})],Tt.prototype,"triples",2),h([d()],Tt.prototype,"qs",2);var pe=Tt;customElements.define("photos-page",pe);var ue=class extends f{render(){let t=document.getElementById("stats-data");if(!t)return console.error("No stats data found"),l``;let e=JSON.parse(t.innerText);return l`
    ...
    <div class="photo-album">
      ...
      <slot></slot>
    </div>`}};h([d()],L.prototype,"id",2),h([d()],L.prototype,"title",2),h([d()],L.prototype,"triples",2),h([d()],L.prototype,"url",2),h([d()],L.prototype,"mosaicColours",2),h([d()],L.prototype,"loading",2),h([d()],L.prototype,"path",2),h([d()],L.prototype,"onClick",2);var q=class extends f{static{this.styles=os}dateRange(){if(!this.minDate&&!this.maxDate)return"unknown date";let t=globalThis.matchMedia("(max-width: 500px)");return lt.dateRange(this.minDate,this.maxDate,t.matches)}renderCountries(){return this.countries.split(",").map(t=>{let{flag:e,urn:s}=z.details(this.triples,t),i=I(s);return l`<a href="#/thing/country:${i.id}" title=${t}>${e}</a>`})}render(){let t=this.count===1?"photo":"photos",e=this.renderCountries();return l`
    ...
    `}};h([d({})],St.prototype,"albums",2),h([d({state:!0})],St.prototype,"triples",2);customElements.define("albums-page",St);var Et=class extends nt{constructor(t){if(super(t),this.it=S,t.type!==ot.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===S||t==null)return this._t=void 0,this.it=t;if(t===k)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;let e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};Et.directiveName="unsafeHTML",Et.resultType=1;var Xt=et(Et);var N=class extends f{render(){return l`
    <div>
    ...
    `}};h([d()],N.prototype,"id",2),h([d()],N.prototype,"url",2),h([d()],N.prototype,"preload",2),h([d()],N.prototype,"urlPoster",2),h([d()],N.prototype,"urlUnscaled",2),h([d()],N.prototype,"url1080p",2),h([d()],N.prototype,"url720p",2),h([d()],N.prototype,"url480p",2);customElements.define("app-video",N);var ct=class extends f{async shareAlbum(t){if(!navigator.share){console.error("navigator.share not available");return}this.sharing=!0;try{await navigator.share({title:`${this.title} - photos.rgrannell.xyz`,url:t})}catch(e){console.error("Error sharing:",e)}finally{this.sharing=!1}}render(){let t=this.shareAlbum.bind(this,this.url);return l`
      ...
      `}};h([d()],ct.prototype,"title",2),h([d()],ct.prototype,"url",2),h([d({state:!0})],ct.prototype,"sharing",2);customElements.define("album-share-button",ct);var Zt=class extends f{getId(){return w.parseUrn(this.urn)?.id??"unknown"}url(){return this.getId()?`https://whc.unesco.org/en/list/${this.getId()}`:null}render(){return this.getId()?l`
    ...
    `:l`<span>Invalid UNESCO URN</span>`}};h([d()],Zt.prototype,"urn",2);customElements.define("unesco-link",Zt);var dt=class extends f{render(){let t=z.urnDetails(this.triples,this.urn),e=w.toURL(this.urn);return l`<a class="country-link" href="${e}">${t.flag} ${t.name}</a>`}};h([d()],dt.prototype,"urn",2),h([d()],dt.prototype,"name",2),h([d()],dt.prototype,"triples",2);customElements.define("country-link",dt);var _t=class extends f{name(){let{type:t,id:e}=w.parseUrn(this.urn);if(tt.has(t))return l`<span>${st.toCommonName(this.triples,e)}</span>`;let s=this.triples.search({source:w.parseUrn(this.urn),relation:g.NAME}).firstTarget();return s?l`<span>${s}</span>`:decodeURIComponent(e)}linkClass(){let{type:t}=w.parseUrn(this.urn);return{[$.BIRD]:"bird-link",[$.MAMMAL]:"mammal-link",[$.REPTILE]:"reptile-link",[$.AMPHIBIAN]:"amphibian-link",[$.FISH]:"fish-link",[$.INSECT]:"insect-link"}[t]??""}render(){if(!w.isUrn(this.urn))return l`<span>Invalid URN</span>`;let t=w.toURL(this.urn);return w.is(this.urn,$.COUNTRY)?l`
    ...
    `}};h([d()],_t.prototype,"urn",2),h([d()],_t.prototype,"triples",2);customElements.define("thing-link",_t);var P=class extends f{connectedCallback(){super.connectedCallback(),C.setIndex(),document.title=`${this.title} - photos`}albumPhotos(t){let e=E.getAlbumPhotoSources(t,this.id);return Array.from(e).flatMap(s=>{let i=t.search({source:I(s)}).firstObject(!0);return i?[i]:[]})}albumVideos(t){let e=t.search({source:{type:"video"},relation:"albumId",target:{id:this.id}}).sources();return Array.from(e).flatMap(s=>{let i=t.search({source:I(s)}).firstObject();return i?[i]:[]})}renderPhotoCount(){return this.imageCount===1?`${this.imageCount} photo`:`${this.imageCount} photos`}thingsLinks(t){let e={},s=this.albumPhotos(t);for(let n of[$.UNESCO])e[n]=Array.from(new Set(s.flatMap(o=>o[g.LOCATION]?.filter(c=>w.is(c,n))).filter(o=>o)));for(let n of[$.BIRD,$.MAMMAL,$.REPTILE,$.FISH,$.AMPHIBIAN,$.INSECT])e[n]=Array.from(new Set(s.flatMap(o=>o[g.SUBJECT]?.filter(c=>w.is(c,n))).filter(o=>o)));let i=[];i=i.concat(e[$.UNESCO].map(n=>l`<unesco-link urn="${n}"></unesco-link>`));for(let n of[$.BIRD,$.MAMMAL,$.REPTILE,$.FISH,$.AMPHIBIAN,$.INSECT])i=i.concat(e[n].map(o=>l`<thing-link .urn="${o}" .triples="${this.triples}"></thing-link>`));return i}render(){let t=this.triples,e=globalThis.matchMedia("(max-width: 500px)"),s=lt.dateRange(this.minDate,this.maxDate,e.matches),n=this.albumPhotos(t).map((a,p)=>l`
      <app-photo
        ...
        ></app-video>`),c=this?.countries.split(",").map(a=>{let{flag:p,urn:m}=z.details(this.triples,a),u=I(m);return l`<span href="#/thing/country:${u.id}" title=${a}>${p}</span>`});return l`
    <div>
      <section class="photos-metadata">
        <h1>${this.title}</h1>
    ...
    `}};h([d()],ht.prototype,"url",2),h([d()],ht.prototype,"format",2),h([d({state:!0})],ht.prototype,"sharing",2);customElements.define("share-metadata-button",ht);function pt(r){return l`<th class="exif-heading">${r}</th>`}var rt=class extends f{connectedCallback(){super.connectedCallback(),C.setIndex(),document.title="Metadata - photos"}renderAperture(t){return t.fStop==="Unknown"?l`<td>Unknown</td>`:t.fStop==="0.0"?l`<td>Manual aperture control</td>`:t.fStop?l`<td>ƒ/${t.fStop}</td>`:l`<td>Unknown</td>`}renderFocalLength(t){return t.focalLength==="Unknown"?l`${t.focalLength}`:t.focalLength==="0"?l`<td>Manual lens</td>`:t.focalLength?l`<td>${t.focalLength}mm</td>`:l`<td>Unknown</td>`}renderSemanticKey(t){return t.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}renderSemanticValue(t,e){if(Array.isArray(e))return l`<ul class="thing-list">
        ${e.map(s=>l`<li>${this.renderSemanticValue.call(this,t,s)}</li>`)}
      </ul>`;if(t.includes("binomial"))return l`<em>${e}</em>`;if(t.toLowerCase()==="summary")return l`${Xt(e??"")}`;if(w.isRating(e)){let s=`urn:r\xF3:rating:${e}`;return l`<thing-link .triples=${this.triples} .urn="${s}"></thing-link>`}else{if(w.isUrn(e)&&w.is(e,$.UNESCO))return l`<unesco-link .urn="${e}"></unesco-link>`;if(w.isUrn(e))return l`<thing-link .triples=${this.triples} .urn="${e}"></thing-link>`}return e}isIgnoredKey(t){return new Set(["birdBinomial","mammalBinomial","wildlife","livingConditions","pngUrl","cover","fStop"]).has(t)}renderSemanticData(t){return l`
    ...
    `}render(){let t=this.image,e=t.albumId,s=this.triples,i=s.search({source:{id:I(t.id).id},relation:{predicate:n=>{let o=new Set(["albumId","fullImage","mosaicColours","thumbnailUrl","midImageLossyUrl"]);return!Ve.has(n)&&!o.has(n)}}}).triples();return l`
    <section>
    <h1>Metadata</h1>
    ...
    `}};h([d()],rt.prototype,"id",2),h([d()],rt.prototype,"image",2),h([d({state:!0})],rt.prototype,"sharing",2),h([d({state:!0})],rt.prototype,"triples",2);customElements.define("metadata-page",rt);var fe=class extends f{connectedCallback(){super.connectedCallback(),C.setIndex(),document.title="About - photos"}render(){return l`
    <div>
    ...
    `}};customElements.define("about-page",fe);var G=class G extends f{static{this.TYPE_VIEW={unesco:{title:"\u{1F3DB}\uFE0F Unesco World Heritage Sites",description:"Photos from some of the most outstanding places on earth."},country:{title:"\u{1F30D} Countries",description:"All photos are taken in some country..."}}}connectedCallback(){super.connectedCallback(),C.setIndex(),this.updatePageLocation()}updatePageLocation(){let t=E.getName(this.triples,this.urn);if(!t){document.title="Thing - photos";return}document.title=`${D.capitalise(t)} - photos`}isValidImage(t){return t&&t.thumbnailUrl}urnImages(t,e){let i=t.search(e).sources();return Array.from(i).flatMap(n=>{if(n.startsWith("urn:r\xF3")){let c=t.search({source:x(n)}).firstObject();return this.isValidImage(c)?[c]:[]}let o=t.search({source:{id:n,type:"photo"}}).firstObject();return this.isValidImage(o)?[o]:[]})}renderSubjectPhotos(t){return t.sort((e,s)=>s.createdAt-e.createdAt).map((e,s)=>l`
      ...
      `})}firstPhotographed(t,e){let i=this.urnImages(t,e).sort((n,o)=>n.createdAt-o.createdAt)[0];return i?new Date(parseInt(i.createdAt)).toLocaleDateString("en-IE",{day:"numeric",month:"short",year:"numeric"}):"Unknown"}renderTypeTitle(t){let e=t.toLowerCase();return G.TYPE_VIEW.hasOwnProperty(e)?G.TYPE_VIEW[e].title:D.capitalise(t)}renderTypeDescription(t){let e=t.toLowerCase();return G.TYPE_VIEW.hasOwnProperty(e)?G.TYPE_VIEW[e].description:""}renderTitle(){let t=E.getName(this.triples,this.urn);if(t)return t;try{let e=w.parseUrn(this.urn),s=decodeURIComponent(e.id);if(e.id==="*")return this.renderTypeTitle(e.type);if(e.type===$.COUNTRY){let i=this.triples.search({source:e}).firstObject();return i.flag?`${i.flag} ${t}`:t}return tt.has(e.type)?st.toCommonName(this.triples,s):s}catch{return this.urn}}renderClassification(t){return l`<a href="#/listing/${t}">${D.capitalise(t)}</a>`}getPhotoQueries(t){let e=t;e.id==="*"&&delete e.id;let s=[];if(tt.has(t.type))for(let i of["captivity","wild"]){let o={...t,qs:{context:i}};s.push({label:i,query:{target:o}})}else s.push({label:"default",query:{source:{type:"photo"},target:t}});return s}renderPhotoSection(t){return l`<div>
    ${Object.entries(t).flatMap(([e,s])=>s?s.length===0?[]:e==="default"?[l`
      ...
      `]:[])}
    <div/>`}render(){let t=this.triples,e=w.parseUrn(this.urn),s=e.type,i=t.search({source:x(this.urn)}).firstObject()??{},n=Object.assign({Classification:this.renderClassification(s)});if(i.country&&(n.Country=l`<thing-link .triples=${this.triples} urn=${i.country}></thing-link>`),i.fcodeName){let A=i.fcodeName;n["Place Type"]=l`${D.capitalise(A)}`}tt.has(s)&&(n["First Photographed"]=l`<span>${this.firstPhotographed(t,{target:x(this.urn)})}</span>`);let o=i[g.WIKIPEDIA],c=i[g.BIRDWATCH_URL],a=Ht.getURL(t,this.urn),p=x(this.urn);p.id==="*"&&delete p.id;let m=this.getPhotoQueries(x(this.urn)),u={};for(let{query:A,label:ut}of m){let ps=this.urnImages(t,A);u[ut]=this.renderSubjectPhotos(ps)}let b={source:{type:"photo"},target:p},y=this.renderSubjectAlbums(t,b),_=this.renderPhotoSection(u);return l`
      <div>
      <section class="thing-page">
        ...
        <p>
          ${tt.has(s)&&e.id!=="*"?l`<span class="thing-binomial ${s}-binomial">${st.pretty(e.id)}</span>`:l``}
        </p>
        <br>
    ...
    `}};h([d()],G.prototype,"urn",2),h([d({state:!0})],G.prototype,"triples",2);var $e=G;customElements.define("thing-page",$e);var te=class{static loadingMode(t){return t===0?"auto":"none"}};var ee=class extends f{connectedCallback(){super.connectedCallback(),C.setIndex(),document.title="Videos- photos"}render(){let t=E.videoObjects(this.triples);async function*e(){for(let s=0;s<t.length;s++){let i=t[s];s%4===0&&await new Promise(n=>setTimeout(n,0)),yield l`<app-video
          id=${i.id}
    ...
    `}};h([d()],It.prototype,"id",2),h([d({state:!0})],It.prototype,"triples",2);customElements.define("listing-page",It);function as(r,t,e){return typeof e=="string"&&parseInt(e)>=0?void 0:`invalid relation ${t} for value ${e}`}function W(r,t,e){return typeof e=="string"&&(e.startsWith("/")||e.startsWith("http"))?void 0:`invalid relation ${t} for value ${JSON.stringify(e)}`}function Ut(r,t,e){return`${t} deprecated`}function T(r,t,e){}function ls(r,t,e){return typeof e=="string"&&/\d+/.test(e)?void 0:`invalid relation ${t} for value ${JSON.stringify(e)}`}function cs(r,t,e){return typeof e=="string"&&/^\d+$/.test(e)&&Number(e)>0?void 0:`invalid relation ${t} for value ${JSON.stringify(e)}`}function Ws(r,t,e){return typeof e=="string"&&/^-?\d+(\.\d+)?$/.test(e)&&Number(e)>=-180&&Number(e)<=180?void 0:`invalid relation ${t} for value ${JSON.stringify(e)}`}function Ys(r,t,e){return typeof e=="string"&&/^-?\d+(\.\d+)?$/.test(e)&&Number(e)>=-90&&Number(e)<=90?void 0:`invalid relation ${t} for value ${JSON.stringify(e)}`}function Qs(r,t,e){return typeof e=="string"&&e.startsWith("urn:r\xF3:country")?void 0:`invalid country value ${e}`}function Ks(r,t,e){if(typeof e!="string")return`invalid rating value ${e}`;let s=decodeURIComponent(e);return s.match(/^⭐{0,5}$/)||s.match(/^urn:ró:rating:⭐{0,5}$/)?void 0:`invalid rating value ${e}`}var ds={living_conditions:Ut,mammal_binomial:Ut,plane_model:Ut,vehicle:Ut,videos_count:as,photos_count:as,height:ls,width:ls,max_date:cs,min_date:cs,png_url:W,poster_url:W,thumbnail_url:W,video_url_1080p:W,video_url_480p:W,video_url_720p:W,video_url_unscaled:W,latitude:Ys,longitude:Ws,full_image:W,country:Qs,rating:Ks,flag:T,album_id:T,bird_binomial:Ut,birdwatch_url:T,created_at:T,curie:T,description:T,exposure_time:T,fcode:T,fcode_name:T,flags:T,focal_length:T,f_stop:T,iso:T,location:T,model:T,mosaic:T,mosaic_colours:T,name:T,style:T,subject:T,summary:T,wikidata:T,wikipedia:T,wildlife:T};function hs(r){let t=[rs,ss,Xe,ts,Ze,es.bind(null,"https://photos-cdn.rgrannell.xyz"),ge.bind(null,me),is,ns],e=[r];for(let s of t)e=e.flatMap(s);return e}var Js=new jt,R=class R extends f{static{this.DEFAULT_PAGE="albums"}connectedCallback(){super.connectedCallback(),this.setStateFromUrl(),this.requestUpdate(),this._onPopState=this.handlePopState.bind(this),this.sidebarVisible=!1,globalThis.addEventListener("popstate",this._onPopState),(async()=>{let t=[];this.tribbleDB||(this.tribbleDB=new Be([],ds));for await(let e of Js.stream())t.push(...[e].flatMap(hs)),t.length>500&&(this.tribbleDB.add(t),this.tribbleDB=this.tribbleDB,t.length=0,this.requestUpdate());this.tribbleDB.add(t),this.tribbleDB=this.tribbleDB.clone(),this.requestUpdate()})()}disconnectedCallback(){super.disconnectedCallback(),globalThis.removeEventListener("popstate",this._onPopState)}handlePopState(){this.setStateFromUrl(),this.requestUpdate()}setStateFromUrl(){let t=M.getUrl();M.isPage(t?.type)?this.page=t.type:(console.error("did not match pagetype",t?.type),this.page=R.DEFAULT_PAGE),M.pageUsesId(this.page)&&typeof t.id=="string"&&(this.id=t.id),this.qs=t.qs}receiveClickAlbum(t){let{title:e,id:s}=t.detail;this.page="photos",this.id=s,this.title=e,M.showAlbumUrl(s)}receiveClickThingAlbum(t){let{title:e,id:s}=t.detail;this.page="thing",this.id=s,this.title=e,M.showThingUrl(s,this.tribbleDB)}receiveClickBurgerMenu(){this.sidebarVisible=!this.sidebarVisible}receiveClickPhotoMetadata(t){let{id:e,imageUrl:s,thumbnailUrl:i}=t.detail;this.page="metadata",this.id=e,this.imageUrl=s,this.thumbnailUrl=i,M.showMetadataUrl(e)}receiveSwitchTheme(t){this.darkMode=!this.darkMode,localStorage.setItem("darkMode",this.darkMode.toString()),this.requestUpdate()}receiveNavigatePage(t){this.page=t.detail.page,this.sidebarVisible=!1;let e=M.router(this.page);e||console.error(`no router found for page ${this.page}`),M.pageUsesId(this.page)?e(this.id):e()}pageClasses(t){let e=["page"];return t&&e.push("sidebar-visible"),e.join(" ")}renderPage(t){let e=this.pageClasses(t);if(!this.page||this.page==="albums")return l`
...
lit-html/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=app.ef9b454312aab939.js.map
