...
`);n=a.pop()??"";for(let p of a){let m=t.parse(p);m!==void 0&&(yield m)}}if(n.length>0){let o=t.parse(n);o!==void 0&&(yield o)}}};var Te="photos";var Re={photos:"photos",albums:"albums",album:"album",metadata:"metadata",about:"about",videos:"videos",thing:"thing",listing:"listing"},b=class{static UNESCO="unesco";static BIRD="bird";static MAMMAL="mammal";static REPTILE="reptile";static FISH="fish";static INSECT="insect";static AMPHIBIAN="amphibian";static GEONAME="geoname"},y=class{static SUBJECT="subject";static LOCATION="location";static LONGITUDE="longitude";static LATITUDE="latitude";static COUNTRY="country";static FLAG="flag";static RATING="rating";static NAME="name";static BIRDWATCH_URL="birdwatch_url";static WIKIPEDIA="wikipedia";static CREATED_AT="created_at";static F_STOP="f_stop";static FOCAL_LENGTH="focal_length";static MODEL="model";static EXPOSURE_TIME="exposure_time";static ISO="iso";static WIDTH="width";static HEIGHT="height"},De=new Set(["created_at","f_stop","focal_length","model","exposure_time","iso","width","height"]),K=new Set(["bird","mammal","reptile","amphibian","fish","insect"]);var M=class i{static{this.ROUTES={photos:this.showPhotosUrl,albums:this.showAlbumsUrl,album:this.showAlbumUrl,metadata:this.showMetadataUrl,about:this.showAboutUrl,videos:this.showVideosUrl,thing:this.showThingUrl,listing:this.showListingUrl}}static{this.URL_PREFIX_TO_PAGE={"#/albums":"albums","#/album":"album","#/metadata":"metadata","#/about":"about","#/videos":"videos","#/thing":"thing","#/photos":"photos","#/listing":"listing"}}static{this.ID_PAGES=new Set(["album","metadata","thing","listing"])}static isPage(t){return t in Re}static router(t){if(i.isPage(t))return i.ROUTES[t];throw new Error(`Unknown page: ${t}`)}static pageUsesId(t){return i.isPage(t)&&i.ID_PAGES.has(t)}static showAboutUrl(){window.location.hash="#/about",document.title="About - photos"}static showAlbumsUrl(){window.location.hash="#/albums",document.title="Albums - photos"}static showPhotosUrl(){window.location.hash="#/photos",document.title="Photos - photos"}static showAlbumUrl(t){window.location.hash=`#/album/${t}`,document.title="Album - photos"}static showPhotoUrl(t){window.location.hash=`#/photo/${t}`,document.title="Photo - photos"}static showMetadataUrl(t){window.location.hash=`#/metadata/${t}`,document.title="Metadata - photos"}static showVideosUrl(){window.location.hash="#/videos",document.title="Videos - photos"}static showThingUrl(t){window.location.hash=`#/thing/${t}`,document.title="Thing - photos"}static showListingUrl(t){window.location.hash=`#/listing/${t}`,document.title="Listing - photos"}static getUrl(){let t=window.location.hash;for(let[e,s]of Object.entries(i.URL_PREFIX_TO_PAGE))if(t.startsWith(e)){let r={type:s};return i.ID_PAGES.has(s)&&(r.id=t.split("/")[2]),r}return{type:"albums"}}};var gs={attribute:!0,type:String,converter:ht,reflect:!1,hasChanged:St},fs=(i=gs,t,e)=>{let{kind:s,metadata:r}=e,n=globalThis.litPropertyMetadata.get(r);if(n===void 0&&globalThis.litPropertyMetadata.set(r,n=new Map),s==="setter"&&((i=Object.create(i)).wrapped=!0),n.set(e.name,i),s==="accessor"){let{name:o}=e;return{set(h){let a=t.get.call(this);t.set.call(this,h),this.requestUpdate(o,a,i)},init(h){return h!==void 0&&this.C(o,void 0,i,h),h}}}if(s==="setter"){let{name:o}=e;return function(h){let a=this[o];t.call(this,h),this.requestUpdate(o,a,i)}}throw Error("Unsupported decorator location: "+s)};function c(i){return(t,e)=>typeof e=="object"?fs(i,t,e):((s,r,n)=>{let o=r.hasOwnProperty(n);return r.constructor.createProperty(n,s),o?Object.getOwnPropertyDescriptor(r,n):void 0})(i,t,e)}var kt=class extends g{render(){let t=["photo-sidebar"];return this.visible&&t.push("sidebar-visible"),l`
    ...
    `}};d([c({type:Boolean,state:!0})],kt.prototype,"visible",2);customElements.define("photo-sidebar",kt);var Mt=class extends g{constructor(){super(...arguments);this.darkMode=!1}feedUrl(){return"/manifest/atom/atom-index.xml"}renderRss(){return l`
    ...
    `}};d([c()],Mt.prototype,"darkMode",2);customElements.define("photo-header",Mt);var et={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Y=i=>(...t)=>({_$litDirective$:i,values:t}),tt=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this._$Ct=t,this._$AM=e,this._$Ci=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var{I:$s}=Se;var Me=i=>i.strings===void 0,ke=()=>document.createComment(""),Oe=(i,t,e)=>{let s=i._$AA.parentNode,r=t===void 0?i._$AB:t._$AA;if(e===void 0){let n=s.insertBefore(ke(),r),o=s.insertBefore(ke(),r);e=new $s(n,o,i,i.options)}else{let n=e._$AB.nextSibling,o=e._$AM,h=o!==i;if(h){let a;e._$AQ?.(i),e._$AM=i,e._$AP!==void 0&&(a=i._$AU)!==o._$AU&&e._$AP(a)}if(n!==r||h){let a=e._$AA;for(;a!==n;){let p=a.nextSibling;s.insertBefore(a,r),a=p}}}return e},Le=(i,t,e=i)=>(i._$AI(t,e),i);var Ne=i=>{i._$AR()};var gt=(i,t)=>{let e=i._$AN;if(e===void 0)return!1;for(let s of e)s._$AO?.(t,!1),gt(s,t);return!0},Ot=i=>{let t,e;do{if((t=i._$AM)===void 0)break;e=t._$AN,e.delete(i),i=t}while(e?.size===0)},Pe=i=>{for(let t;t=i._$AM;i=t){let e=t._$AN;if(e===void 0)t._$AN=e=new Set;else if(e.has(i))break;e.add(i),_s(t)}};function bs(i){this._$AN!==void 0?(Ot(this),this._$AM=i,Pe(this)):this._$AM=i}function ys(i,t=!1,e=0){let s=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(t)if(Array.isArray(s))for(let n=e;n<s.length;n++)gt(s[n],!1),Ot(s[n]);else s!=null&&(gt(s,!1),Ot(s));else gt(this,i)}var _s=i=>{i.type==et.CHILD&&(i._$AP??=ys,i._$AQ??=bs)},Lt=class extends tt{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,s){super._$AT(t,e,s),Pe(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(gt(this,t),Ot(this))}setValue(t){if(Me(this._$Ct))this._$Ct._$AI(t,this);else{let e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}};var je=async(i,t)=>{for await(let e of i)if(await t(e)===!1)return},Nt=class{constructor(t){this.G=t}disconnect(){this.G=void 0}reconnect(t){this.G=t}deref(){return this.G}},Pt=class{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??=new Promise((t=>this.Z=t))}resume(){this.Z?.(),this.Y=this.Z=void 0}};var ft=class extends Lt{constructor(){super(...arguments),this._$CK=new Nt(this),this._$CX=new Pt}render(t,e){return U}update(t,[e,s]){if(this.isConnected||this.disconnected(),e===this._$CJ)return U;this._$CJ=e;let r=0,{_$CK:n,_$CX:o}=this;return je(e,(async h=>{for(;o.get();)await o.get();let a=n.deref();if(a!==void 0){if(a._$CJ!==e)return!1;s!==void 0&&(h=s(h,r)),a.commitValue(h,r),r++}return!0})),U}commitValue(t,e){this.setValue(t)}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}},li=Y(ft);var st=Y(class extends ft{constructor(i){if(super(i),i.type!==et.CHILD)throw Error("asyncAppend can only be used in child expressions")}update(i,t){return this._$Ctt=i,super.update(i,t)}commitValue(i,t){t===0&&Ne(this._$Ctt);let e=Oe(this._$Ctt);Le(e,i)}});var jt=new Map,E=class{static loadingMode(t){let e=window.innerWidth,s=window.innerHeight,r=400,n=Math.floor(e/r),o=Math.floor(s/r);return t>n*o+1?"lazy":"eager"}static encodeBitmapDataURL(t){if(jt.has(t))return jt.get(t);let e=t.split("#").map(n=>`#${n}`),s=document.createElement("canvas");s.width=2,s.height=2;let r=s.getContext("2d");if(!r){console.error("context missing, cannot render colours");return}return r.fillStyle=e[1],r.fillRect(0,0,1,1),r.fillStyle=e[2],r.fillRect(1,0,1,1),r.fillStyle=e[3],r.fillRect(0,1,1,1),r.fillStyle=e[4],r.fillRect(1,1,1,1),jt.set(t,s.toDataURL("image/png")),jt.get(t)}};var j=class extends g{constructor(){super(...arguments);this.loading="eager"}renderIcon(){return l`
    ...
    `}};d([c({state:!0})],Bt.prototype,"triples",2);customElements.define("photos-page",Bt);var ne=class extends g{render(){let t=document.getElementById("stats-data");if(!t)return console.error("No stats data found"),l``;let e=JSON.parse(t.innerText);return l`
    ...
    `}};d([c()],D.prototype,"id",2),d([c()],D.prototype,"url",2),d([c()],D.prototype,"preload",2),d([c()],D.prototype,"url_poster",2),d([c()],D.prototype,"url_unscaled",2),d([c()],D.prototype,"url_1080p",2),d([c()],D.prototype,"url_720p",2),d([c()],D.prototype,"url_480p",2);customElements.define("app-video",D);var nt=class extends g{async shareAlbum(t){if(!navigator.share)console.error("navigator.share not available");else{this.sharing=!0;try{await navigator.share({title:`${this.title} - photos.rgrannell.xyz`,url:t})}catch(e){console.error("Error sharing:",e)}finally{this.sharing=!1}}}render(){return this.sharing?l`<button class="photo-share-button" disabled>[sharing...]</button>`:l`
      ...
      `}};d([c()],nt.prototype,"title",2),d([c()],nt.prototype,"url",2),d([c({state:!0})],nt.prototype,"sharing",2);customElements.define("album-share-button",nt);var Vt=class extends g{getId(){return w.parseUrn(this.urn)?.id??"unknown"}url(){return this.getId()?`https://whc.unesco.org/en/list/${this.getId()}`:null}render(){return this.getId()?l`
    ...
    `}render(){let t=this.image,e=t.album_id,s=this.triples,r=s.search({source:{id:v(t.id).id},relation:{predicate:n=>{let o=new Set(["album_id","full_image","mosaic_colours","thumbnail_url"]);return!De.has(n)&&!o.has(n)}}}).triples();return l`
    <section>
    <h1>Metadata</h1>
    ...
    `}};d([c()],X.prototype,"id",2),d([c()],X.prototype,"image",2),d([c({state:!0})],X.prototype,"sharing",2),d([c({state:!0})],X.prototype,"triples",2);customElements.define("metadata-page",X);var ae=class extends g{connectedCallback(){super.connectedCallback(),C.setIndex()}render(){return l`
    <div>
    ...
    <div/>`}render(){let t=this.triples,e=t.search({source:{type:"photo"}}).objects(),s=w.parseUrn(this.urn),r=s.type,n=t.search({source:I(this.urn)}).firstObject()??{},o=Object.assign({Classification:this.renderClassification(r)});if(n.country&&(o.Country=l`<thing-link .triples=${this.triples} urn=${n.country}></thing-link>`),n.fcode_name){let q=n.fcode_name;o["Place Type"]=l`${q.charAt(0).toUpperCase()}${q.slice(1)}`}K.has(r)&&(o["First Photographed"]=l`<span>${this.firstPhotographed(e,t,{target:I(this.urn)})}</span>`);let h=n[y.WIKIPEDIA],a=n[y.BIRDWATCH_URL],p=n[y.LONGITUDE],m=n[y.LATITUDE],u;if(p&&m){let q=`https://www.google.com/maps?q=${m},${p}`;u=l`
      ...
      `}let f=I(this.urn);f.id==="*"&&delete f.id;let $=this.getPhotoQueries(I(this.urn)),S={};for(let{query:q,label:Qt}of $){let Ye=this.urnImages(t,q);S[Qt]=this.renderSubjectPhotos(Ye)}let T={source:{type:"photo"},target:f},Gt=this.renderSubjectAlbums(t,T),Ke=this.renderPhotoSection(S);return l`
      <div>
    ...
    `}};d([c()],yt.prototype,"urn",2),d([c({state:!0})],yt.prototype,"triples",2);customElements.define("thing-page",yt);var Ft=class{static loadingMode(t){return t===0?"auto":"none"}};var zt=class extends g{connectedCallback(){super.connectedCallback(),C.setIndex()}getVideos(){return this.triples.search({source:{type:"video"}}).objects()}render(){let t=this.getVideos();async function*e(){for(let s=0;s<t.length;s++){let r=t[s];s%4===0&&await new Promise(n=>setTimeout(n,0)),yield l`<app-video
          id=${r.id}
    ...
    `}renderThingAlbum(t,e,s,r){let n=Wt.chooseBestImage(this.triples,t,e),o=this.triples.search({source:I(n)}).firstObject(),h=I(this.id),a=`${h.type}:${h.id}`;return l`
      <photo-album
        .triples=${this.triples}
...
lit-html/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=app.4ee1c5f94c1b4772.js.map
