...
var require_build2 = __commonJS({
  "node_modules/mithril/pathname/build.js"(exports, module) {
    ...
    module.exports = function(template, params) {
      ...
      var resolved = path.replace(/:([^\/\.-]+)(\.{3})?/g, function(m37, key, variadic) {
        delete query[key];
        if (params[key] == null) return m37;
  ...
  "node_modules/mithril/pathname/compileTemplate.js"(exports, module) {
    ...
    module.exports = function(template) {
      ...
      var regexp = new RegExp("^" + templateData.path.replace(
        ...
        /:([^\/.-]+)(\.{3}|\.(?!\.)|-)?|[\\^$*+.()|\[\]{}]/g,
        function(m37, key, extra) {
          if (key == null) return "\\" + m37;
...
var require_mithril = __commonJS({
  "node_modules/mithril/index.js"(exports, module) {
    ...
    var m37 = function m38() {
      return hyperscript.apply(this, arguments);
    };
    m37.m = hyperscript;
    m37.trust = hyperscript.trust;
    m37.fragment = hyperscript.fragment;
    m37.Fragment = "[";
    m37.mount = mountRedraw.mount;
    m37.route = require_route();
    m37.render = require_render2();
    m37.redraw = mountRedraw.redraw;
    m37.request = request.request;
    m37.parseQueryString = require_parse();
    m37.buildQueryString = require_build();
    m37.parsePathname = require_parse2();
    m37.buildPathname = require_build2();
    m37.vnode = require_vnode();
    m37.censor = require_censor();
    m37.domFor = domFor.domFor;
    module.exports = m37;
  }
});
...
function listen(label, callback) {
  window.document.addEventListener(label, callback);
}
...
function binomial(binomial2) {
  const pretty = binomial2.replace(/-/g, " ");
...
function AlbumPage() {
  return {
    ...
    view(vnode) {
      ...
      const $videosList = videos.map((video) => {
        return (0, import_mithril17.default)(Video, { video, preload: "auto" });
      });
      return (0, import_mithril17.default)(
        "div.page",
        $albumMetadata,
        (0, import_mithril17.default)("section.photo-container", $photosList),
        (0, import_mithril17.default)("section.video-container", $videosList)
      );
    }
  };
}
...
function PhotosPage() {
  return {
    view(vnode) {
      ...
      const $md = (0, import_mithril18.default)("section.photos-metadata", [
        (0, import_mithril18.default)("h1", "Photos"),
        (0, import_mithril18.default)("p.photo-album-count", countText)
      ]);
      return (0, import_mithril18.default)("div.page", [$md, (0, import_mithril18.default)(PhotosList, { photos })]);
    }
  };
}
...
function AlbumButton() {
  return {
    view(vnode) {
      ...
      return (0, import_mithril19.default)("a", {
        href: `#/album/${id}`,
...
function Heading() {
  return {
    view(vnode) {
      ...
      return (0, import_mithril20.default)("th.exif-heading", text);
    }
  };
}
function CameraModel() {
  return {
    view(vnode) {
      ...
      if ($model.length > 0) {
        return (0, import_mithril20.default)("td", $model);
      }
      return (0, import_mithril20.default)("td", "Unknown");
    }
  };
}
  ...
  return {
    view(vnode) {
      ...
      if (typeof photo.width === "string" && typeof photo.height === "string") {
        return (0, import_mithril20.default)("td", `${photo.width} x ${photo.height}`);
      }
      return (0, import_mithril20.default)("td", "Unknown");
    }
  };
  ...
  return {
    view(vnode) {
      ...
      if (photo.focalLength === "Unknown") {
        ...
        return (0, import_mithril20.default)("td", "Manual lens");
      } else if (!photo.focalLength) {
        return (0, import_mithril20.default)("td", "Unknown");
      } else {
        return (0, import_mithril20.default)("td", `${photo.focalLength}mm`);
      }
    }
  };
}
    ...
    view(vnode) {
      ...
      if (typeof exposureTime === "string") {
        ...
        if (isNaN(parsed)) {
          ...
          return (0, import_mithril20.default)("td", `${parsed} s`);
        } else {
          return (0, import_mithril20.default)("td", `1/${Math.round(1 / parsed)} s`);
        }
      }
      return (0, import_mithril20.default)("td", "Unknown");
    }
  ...
  return {
    view(vnode) {
      ...
      if (photo.fStop === "Unknown") {
        ...
        return (0, import_mithril20.default)("td", "Manual aperture control");
      } else if (!photo.fStop) {
        return (0, import_mithril20.default)("td", "Unknown");
      }
      return (0, import_mithril20.default)("td", `\u0192/${photo.fStop}`);
    }
  };
}
function ExifData() {
  return {
    view(vnode) {
      ...
      const $model = (0, import_mithril20.default)("tr", [
        ...
        (0, import_mithril20.default)(CameraModel, { photo, services })
      ]);
      const $dimensions = (0, import_mithril20.default)("tr", [
        (0, import_mithril20.default)(Heading, { text: "Dimensions" }),
        (0, import_mithril20.default)(ExifDimensions, { photo, services })
      ]);
      const $focalLength = (0, import_mithril20.default)("tr", [
        (0, import_mithril20.default)(Heading, { text: "Focal Length" }),
        (0, import_mithril20.default)(FocalLength, { photo, services })
      ]);
      const $shutterSpeed = (0, import_mithril20.default)("tr", [
        (0, import_mithril20.default)(Heading, { text: "Shutter Speed" }),
        (0, import_mithril20.default)(ShutterSpeed, { photo, services })
      ]);
      const $aperture = (0, import_mithril20.default)("tr", [
        (0, import_mithril20.default)(Heading, { text: "Aperture" }),
        (0, import_mithril20.default)(Aperture, { photo, services })
      ]);
      const $iso = (0, import_mithril20.default)("tr", [
        (0, import_mithril20.default)(Heading, { text: "ISO" }),
        (0, import_mithril20.default)("td", photo.iso ?? "Unknown")
      ]);
      return (0, import_mithril20.default)("table.metadata-table", [
        $dateTime,
        $model,
        $dimensions,
        $focalLength,
...
function Description() {
  return {
    view(vnode) {
      ...
      if (html) {
        return (0, import_mithril21.default)("td", import_mithril21.default.trust(html));
      }
      return (0, import_mithril21.default)("td", "\u2014");
    }
  };
}
function Location() {
...
function Rating() {
  return {
    view(vnode) {
      ...
      return (0, import_mithril21.default)("td", $rating.length > 0 ? $rating : "\u2014");
    }
  };
}
function Style() {
  ...
  return {
    view(vnode) {
      ...
      if (photo.description || photo.summary) {
        infoItems.push((0, import_mithril21.default)("tr", [
      ...
      infoItems.push(
        ...
        (0, import_mithril21.default)("tr", [
          ...
          (0, import_mithril21.default)(Location, { photo, services })
        ]),
        (0, import_mithril21.default)("tr", [
          (0, import_mithril21.default)(Heading2, { text: "Rating" }),
          (0, import_mithril21.default)(Rating, { photo, services })
        ]),
        (0, import_mithril21.default)("tr", [
...
function PhotoPage() {
  return {
    view(vnode) {
      const { photo, services } = vnode.attrs;
      const $links = (0, import_mithril22.default)("li.link-list", [
      ...
      const $exif = (0, import_mithril22.default)(ExifData, { photo, services });
      const $photoInfo = (0, import_mithril22.default)(PhotoInfo, { photo, services });
      return (0, import_mithril22.default)("section", [
        (0, import_mithril22.default)("h1", "Photo"),
        (0, import_mithril22.default)(Photo, {
          photo,
          loading: "eager",
          interactive: false
        }),
        ...
        (0, import_mithril22.default)(
          "div.page",
          (0, import_mithril22.default)("h3", "Photo Information"),
          $photoInfo,
          (0, import_mithril22.default)("h3", "Exif Data"),
          $exif
        )
      ]);
    }
...
function ThingUrls() {
  return {
    view(vnode) {
      ...
      if (things.length !== 1) {
        return (0, import_mithril24.default)("ul");
      }
      const [thing] = things;
      const $links = [];
      ...
      if (wikipedia) {
        $links.push(
          (0, import_mithril24.default)("li", (0, import_mithril24.default)(ExternalLink, { href: wikipedia, text: "[wikipedia]" }))
        );
      }
      const birdwatch = one(thing.birdwatchUrl);
      if (birdwatch) {
        $links.push(
          (0, import_mithril24.default)("li", (0, import_mithril24.default)(ExternalLink, { href: birdwatch, text: "[birdwatch]" }))
        );
      }
      return (0, import_mithril24.default)("ul.link-list", $links);
    }
  };
}
...
function ThingMetadata() {
  ...
  return {
    view(vnode) {
      ...
      const { type } = asUrn(one(thing.id));
      const $links = (0, import_mithril25.default)(ThingUrls, { things: [thing] });
      const title = type === KnownTypes.COUNTRY ? `${countryEmoji(thing)} ${one(thing.name)}` : one(thing.name);
      return (0, import_mithril25.default)("div.photo-album-metadata", [
        (0, import_mithril25.default)("p.photo-album-title", title),
        $links
      ]);
    }
  };
...
function drawThingAlbum(services, thing, idx) {
  ...
  const $md = (0, import_mithril26.default)(ThingMetadata, { thing });
  return [(0, import_mithril26.default)(PhotoAlbum, {
...
function ListingPage() {
  return {
    view(vnode) {
      ...
      return (0, import_mithril26.default)("div.page", [
        (0, import_mithril26.default)("section.album-metadata", $md),
        (0, import_mithril26.default)(AlbumsList2, { services, things })
      ]);
    }
  };
}
...
function PlacesList() {
  return {
    view(vnode) {
      ...
      return (0, import_mithril28.default)("ul", $places);
    }
  };
}
...
function FeatureLink() {
  return {
    view(vnode) {
      ...
      return (0, import_mithril30.default)("p", {
        class: ["thing-link", `${type}-link`].join(" ")
      }, text);
    }
  };
    ...
    view(vnode) {
      ...
      const $features = features.map((feature) => {
        ...
        return (0, import_mithril31.default)("li", {
          key: `feature-${id}`
        }, (0, import_mithril31.default)(FeatureLink, { urn: id, thing: feature }));
      });
...
function UnescoLink() {
  return {
    view(vnode) {
      ...
      const { type, id } = asUrn(urn);
      const name = one(thing.name) ?? id;
      return (0, import_mithril32.default)("a", {
  ...
  return {
    view(vnode) {
      ...
      const $unescos = unescos.map((unesco) => {
        ...
        return (0, import_mithril33.default)("li", (0, import_mithril33.default)(UnescoLink, { urn, thing: unesco }));
      });
      return (0, import_mithril33.default)("ul", $unescos);
    }
  };
}
...
function ThingMetadata2() {
  return {
    view(vnode) {
      ...
      metadata.Classification = (0, import_mithril34.default)(ListingLink, { urn });
      const locatedIn = setOf(KnownRelations.IN, things);
      if (locatedIn.size > 0) {
        metadata["Located In"] = (0, import_mithril34.default)(PlacesList, { services, urns: locatedIn });
      }
      if (things.length !== 1) {
        return;
      }
      const [thing] = things;
      if (thing.features) {
        metadata["Place Type"] = (0, import_mithril34.default)(FeaturesList, {
          urns: setify(thing.features),
          services
        });
      }
      if (thing.contains) {
        metadata["Contains"] = (0, import_mithril34.default)(PlacesList, {
          services,
          urns: setify(thing.contains)
        });
      }
      if (thing.unescoId) {
        metadata["UNESCO"] = (0, import_mithril34.default)(UnescoList, {
          urns: new Set(arrayify(thing.unescoId)),
          services
        });
      }
      const $rows = Object.entries(metadata).map(([key, value]) => {
        return (0, import_mithril34.default)("tr", [
          (0, import_mithril34.default)("th.exif-heading", key),
          (0, import_mithril34.default)("td", value)
        ]);
      });
      return (0, import_mithril34.default)("div", [
        (0, import_mithril34.default)("h3", "Details"),
        (0, import_mithril34.default)("table.metadata-table", $rows)
      ]);
    }
  };
}
    ...
    view(vnode) {
      ...
      const $albums = albums.map((album) => {
        const $countryLinks = [...countries].map((country) => {
          return (0, import_mithril34.default)(CountryLink, {
            country,
            key: `album-country-${album.id}-${country.id}`,
            mode: "flag"
          });
        });
        const $md = (0, import_mithril34.default)(PhotoAlbumMetadata, {
          title: album.name,
          minDate: album.minDate,
          maxDate: album.maxDate,
          count: album.photosCount,
        ...
        const $album = (0, import_mithril34.default)(PhotoAlbum, {
          imageUrl: album.thumbnailUrl,
          thumbnailUrl: album.thumbnailUrl,
          thumbnailDataUrl: encodeBitmapDataURL(album.mosaic),
          loading: "lazy",
          ...
          trip: void 0,
          child: (0, import_mithril34.default)("p")
        });
  ...
  return {
    view(vnode) {
      ...
      return (0, import_mithril34.default)(
        ...
        photos.map((photo, idx) => {
          const loading = loadingMode(idx);
          return (0, import_mithril34.default)(Photo, {
            key: `photo-${photo.id}`,
            photo,
            loading,
            interactive: true
...
function ThingPage() {
  return {
    view(vnode) {
      const { urn, things, services } = vnode.attrs;
      return (0, import_mithril34.default)("div.page", [
        (0, import_mithril34.default)("section.thing-page", [
          (0, import_mithril34.default)(ThingTitle, { urn, things }),
          (0, import_mithril34.default)(ThingSubtitle, { urn }),
          (0, import_mithril34.default)("br"),
          (0, import_mithril34.default)(ThingUrls, { urn, things, services }),
          (0, import_mithril34.default)(ThingMetadata2, { urn, things, services }),
          (0, import_mithril34.default)("h3", "Photos"),
          (0, import_mithril34.default)(PhotoSection, { urn, things, services }),
          (0, import_mithril34.default)("h3", "Albums"),
          (0, import_mithril34.default)(AlbumSection, { urn, things, services })
        ])
      ]);
    }
  };
...
listen("navigate", (event) => {
  ...
  import_mithril35.default.route.set(route);
});
listen("switch_theme", () => {
...
function AlbumsApp() {
  return {
    ...
    view() {
      return (0, import_mithril35.default)(
        "div.photos-app",
        { class: state.darkMode ? "dark-mode" : void 0 },
        [
          (0, import_mithril35.default)(Header, state),
          (0, import_mithril35.default)("div.app-container", {
            class: state.sidebarVisible ? "sidebar-visible" : void 0
          }, [
            (0, import_mithril35.default)(Sidebar, { visible: state.sidebarVisible }),
            (0, import_mithril35.default)(AlbumsPage, {
...
function AlbumApp() {
  return {
    oninit() {
      const id = import_mithril35.default.route.param("id");
      state.currentAlbum = `urn:r\xF3:album:${id}`;
    },
    view() {
      if (!state.currentAlbum) {
        return (0, import_mithril35.default)("p", "No album selected");
      }
      ...
      if (!album) {
        return (0, import_mithril35.default)("p", "Album not found");
      }
      ...
      return (0, import_mithril35.default)(
        ...
        [
          ...
          (0, import_mithril35.default)("div.app-container", {
            ...
            (0, import_mithril35.default)(Sidebar, { visible: state.sidebarVisible }),
            (0, import_mithril35.default)(AlbumPage, {
              album,
              subjects,
              locations,
              photos,
      ...
      return (0, import_mithril35.default)(
        ...
        [
          ...
          (0, import_mithril35.default)("div.app-container", {
            ...
            (0, import_mithril35.default)(Sidebar, { visible: state.sidebarVisible }),
            (0, import_mithril35.default)(AboutPage)
          ])
        ]
      );
    }
      ...
      return (0, import_mithril35.default)(
        ...
        [
          ...
          (0, import_mithril35.default)("div.app-container", {
            ...
            (0, import_mithril35.default)(Sidebar, { visible: state.sidebarVisible }),
            (0, import_mithril35.default)(VideosPage, {
      ...
      return (0, import_mithril35.default)(
        ...
        [
          ...
          (0, import_mithril35.default)("div.app-container", {
            ...
            (0, import_mithril35.default)(Sidebar, { visible: state.sidebarVisible }),
            (0, import_mithril35.default)(PhotosPage, {
...
function ThingApp() {
  ...
  return {
    view() {
      const pair = import_mithril35.default.route.param("pair");
      ...
      if (!state.currentUrn) {
        return (0, import_mithril35.default)("p", "No thing selected");
      }
      return (0, import_mithril35.default)(
        "div.photos-app",
        { class: state.darkMode ? "dark-mode" : void 0 },
        [
          ...
          (0, import_mithril35.default)("div.app-container", {
            ...
            (0, import_mithril35.default)(Sidebar, { visible: state.sidebarVisible }),
            (0, import_mithril35.default)(ThingPage, {
  ...
  return {
    ...
    view() {
      if (!state.currentPhoto) {
        return (0, import_mithril35.default)("p", "No photo selected");
      }
      const photo = readPhoto(state.data, state.currentPhoto);
      if (!photo) {
        return (0, import_mithril35.default)("p", "Photo not found");
      }
      return (0, import_mithril35.default)(
        "div.photos-app",
        { class: state.darkMode ? "dark-mode" : void 0 },
        [
          ...
          (0, import_mithril35.default)("div.app-container", {
            ...
            (0, import_mithril35.default)(Sidebar, { visible: state.sidebarVisible }),
            (0, import_mithril35.default)(PhotoPage, { photo, services: state.services })
          ])
        ]
      );
    }
...
function ListingApp() {
  return {
    oninit() {
      const type = import_mithril35.default.route.param("type");
      state.currentType = type;
    },
    view() {
      if (!state.currentType) {
        return (0, import_mithril35.default)("p", "No type selected");
      }
      ...
      return (0, import_mithril35.default)(
        ...
        [
          ...
          (0, import_mithril35.default)("div.app-container", {
            ...
            (0, import_mithril35.default)(Sidebar, { visible: state.sidebarVisible }),
            (0, import_mithril35.default)(ListingPage, {
...
// ts/index.ts
import_mithril36.default.route(document.body, "/albums", {
  "/albums": AlbumsApp,
  "/about": AboutApp,
  "/videos": VideosApp,
  "/photos": PhotosApp,
