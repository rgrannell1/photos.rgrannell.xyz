...
`);n=a.pop()??"";for(let p of a){let m=t.parse(p);m!==void 0&&(yield m)}}if(n.length>0){let o=t.parse(n);o!==void 0&&(yield o)}}};var He="photos";var Be={photos:"photos",albums:"albums",album:"album",metadata:"metadata",about:"about",videos:"videos",thing:"thing",listing:"listing"},$=class{static UNESCO="unesco";static BIRD="bird";static MAMMAL="mammal";static REPTILE="reptile";static FISH="fish";static INSECT="insect";static AMPHIBIAN="amphibian";static GEONAME="geoname";static PHOTO="photo";static ALBUM="album";static VIDEO="video";static COUNTRY="country"},g=class{static SUBJECT="subject";static LOCATION="location";static LONGITUDE="longitude";static LATITUDE="latitude";static COUNTRY="country";static FLAG="flag";static RATING="rating";static NAME="name";static BIRDWATCH_URL="birdwatchUrl";static WIKIPEDIA="wikipedia";static CREATED_AT="createdAt";static SEASON="season";static F_STOP="f_stop";static FOCAL_LENGTH="focalLength";static MODEL="model";static EXPOSURE_TIME="exposureTime";static ISO="iso";static WIDTH="width";static HEIGHT="height";static THUMBNAIL_URL="thumbnailUrl";static PNG_URL="pngUrl";static MID_IMAGE_LOSSY_URL="midImageLossyUrl";static FULL_IMAGE="fullImage";static POSTER_URL="posterUrl";static VIDEO_URL_1080P="videoUrl1080p";static VIDEO_URL_480P="videoUrl480p";static VIDEO_URL_720P="videoUrl720p";static VIDEO_URL_UNSCALED="videoUrlUnscaled";static YEAR="year"},Ve=new Set([g.CREATED_AT,g.F_STOP,g.FOCAL_LENGTH,g.MODEL,g.EXPOSURE_TIME,g.ISO,g.WIDTH,g.HEIGHT]),tt=new Set([$.BIRD,$.MAMMAL,$.REPTILE,$.AMPHIBIAN,$.FISH,$.INSECT]),qe=new Set([g.THUMBNAIL_URL,g.PNG_URL,g.MID_IMAGE_LOSSY_URL,g.FULL_IMAGE,g.POSTER_URL,g.VIDEO_URL_1080P,g.VIDEO_URL_480P,g.VIDEO_URL_720P,g.VIDEO_URL_UNSCALED]);function Rs(r,t){let{id:e,type:s}=w(t),i=r.search({source:{id:e,type:s},relation:g.NAME}).firstTarget();if(typeof i>"u")return i;if(typeof i!="string")throw new TypeError(`name is not a string: ${i}`);return i}function Ds(r,t){let{id:e,type:s}=w(t),i=r.search({source:{id:e,type:s},relation:{relation:[g.LONGITUDE,g.LATITUDE]}}).firstObject();if(i)return{longitude:i.longitude,latitude:i.latitude}}function Os(r){return{name:r.name,minDate:parseInt(r.minDate),maxDate:parseInt(r.maxDate),thumbnailUrl:r.thumbnailUrl,mosaicColours:r.mosaic,id:r.id,photosCount:r.photosCount,flags:r.flags}}function ks(r){return{...r}}function Ms(r){return{...r}}function Ls(r,t){return r.search({source:{type:"photo"},relation:"albumId",target:{id:t}}).sources()}function Ns(r,t){return r.search({source:{type:t},relation:"name"}).objects().sort((s,i)=>s.name.localeCompare(i.name))}var I=class{static getName(t,e){return Rs(t,e)}static getAlbumPhotoSources(t,e){return Ls(t,e)}static getDistinctNames(t,e){return Ns(t,e)}static getGeocoordinates(t,e){return Ds(t,e)}static videoObjects(t){return t.search({source:{type:"video"}}).objects().map(ks)}static photoObjects(t,e={}){return t.search({...e,source:{type:"photo"}}).objects().map(Ms).sort((s,i)=>i.createdAt-s.createdAt)}static albumObjects(t){return t.search({source:{type:"album"}}).objects().map(Os).sort((e,s)=>s.minDate-e.minDate)}},Ht=class{static getURL(t,e){let s=I.getGeocoordinates(t,e);if(!s)return;let{longitude:i,latitude:n}=s;if(i&&n){let o=`https://www.google.com/maps?q=${n},${i}`;return l`
    ...
    `}};h([d()],qt.prototype,"darkMode",2);customElements.define("photo-header",qt);var ot={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},et=r=>(...t)=>({_$litDirective$:r,values:t}),nt=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this._$Ct=t,this._$AM=e,this._$Ci=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var{I:Hs}=ke;var ze=r=>r.strings===void 0,Fe=()=>document.createComment(""),Ge=(r,t,e)=>{let s=r._$AA.parentNode,i=t===void 0?r._$AB:t._$AA;if(e===void 0){let n=s.insertBefore(Fe(),i),o=s.insertBefore(Fe(),i);e=new Hs(n,o,r,r.options)}else{let n=e._$AB.nextSibling,o=e._$AM,c=o!==r;if(c){let a;e._$AQ?.(r),e._$AM=r,e._$AP!==void 0&&(a=r._$AU)!==o._$AU&&e._$AP(a)}if(n!==i||c){let a=e._$AA;for(;a!==n;){let p=a.nextSibling;s.insertBefore(a,i),a=p}}}return e},We=(r,t,e=r)=>(r._$AI(t,e),r);var Ye=r=>{r._$AR()};var vt=(r,t)=>{let e=r._$AN;if(e===void 0)return!1;for(let s of e)s._$AO?.(t,!1),vt(s,t);return!0},Ft=r=>{let t,e;do{if((t=r._$AM)===void 0)break;e=t._$AN,e.delete(r),r=t}while(e?.size===0)},Qe=r=>{for(let t;t=r._$AM;r=t){let e=t._$AN;if(e===void 0)t._$AN=e=new Set;else if(e.has(r))break;e.add(r),qs(t)}};function Bs(r){this._$AN!==void 0?(Ft(this),this._$AM=r,Qe(this)):this._$AM=r}function Vs(r,t=!1,e=0){let s=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(s))for(let n=e;n<s.length;n++)vt(s[n],!1),Ft(s[n]);else s!=null&&(vt(s,!1),Ft(s));else vt(this,r)}var qs=r=>{r.type==ot.CHILD&&(r._$AP??=Vs,r._$AQ??=Bs)},zt=class extends nt{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,s){super._$AT(t,e,s),Qe(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(vt(this,t),Ft(this))}setValue(t){if(ze(this._$Ct))this._$Ct._$AI(t,this);else{let e=[...this._$Ct._$AH];e[this._$Ci]=t,this._$Ct._$AI(e,this,0)}}disconnected(){}reconnected(){}};var Ke=async(r,t)=>{for await(let e of r)if(await t(e)===!1)return},Gt=class{constructor(t){this.G=t}disconnect(){this.G=void 0}reconnect(t){this.G=t}deref(){return this.G}},Wt=class{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??=new Promise((t=>this.Z=t))}resume(){this.Z?.(),this.Y=this.Z=void 0}};var wt=class extends zt{constructor(){super(...arguments),this._$CK=new Gt(this),this._$CX=new Wt}render(t,e){return D}update(t,[e,s]){if(this.isConnected||this.disconnected(),e===this._$CJ)return D;this._$CJ=e;let i=0,{_$CK:n,_$CX:o}=this;return Ke(e,(async c=>{for(;o.get();)await o.get();let a=n.deref();if(a!==void 0){if(a._$CJ!==e)return!1;s!==void 0&&(c=s(c,i)),a.commitValue(c,i),i++}return!0})),D}commitValue(t,e){this.setValue(t)}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}},Hi=et(wt);var at=et(class extends wt{constructor(r){if(super(r),r.type!==ot.CHILD)throw Error("asyncAppend can only be used in child expressions")}update(r,t){return this._$Ctt=r,super.update(r,t)}commitValue(r,t){t===0&&Ye(this._$Ctt);let e=Ge(this._$Ctt);We(e,r)}});var Yt=new Map,C=class{static loadingMode(t){let e=window.innerWidth,s=window.innerHeight,i=400,n=Math.floor(e/i),o=Math.floor(s/i);return t>n*o+1?"lazy":"eager"}static encodeBitmapDataURL(t){if(Yt.has(t))return Yt.get(t);let e=t.split("#").map(n=>`#${n}`),s=document.createElement("canvas");s.width=2,s.height=2;let i=s.getContext("2d");if(!i){console.error("context missing, cannot render colours");return}return i.fillStyle=e[1],i.fillRect(0,0,1,1),i.fillStyle=e[2],i.fillRect(1,0,1,1),i.fillStyle=e[3],i.fillRect(0,1,1,1),i.fillStyle=e[4],i.fillRect(1,1,1,1),Yt.set(t,s.toDataURL("image/png")),Yt.get(t)}};var V=class extends f{constructor(){super(...arguments);this.loading="eager"}renderIcon(){return l`
    ...
    `}hidePlaceholder(e){this.broadcast("photo-loaded",{url:this.thumbnailUrl})();let s=e.target?.parentNode?.querySelector(".thumbnail-placeholder");s.style.zIndex=-1}render(){if(!this.id)return l`<p>Missing photo ID</p>`;let e=this.id.startsWith("urn:")?U(this.id).id:this.id,s={id:e,imageUrl:this.imageUrl,thumbnailUrl:this.thumbnailUrl,thumbnailDataUrl:C.encodeBitmapDataURL(this.mosaicColours)},i=document.createElement("div");i.innerHTML=this.summary??"";let n=i.textContent??i.innerText??"";return l`
    <div class="photo">
    ...
    `}};h([d()],It.prototype,"urn",2),h([d()],It.prototype,"triples",2);customElements.define("thing-link",It);var P=class extends f{connectedCallback(){super.connectedCallback(),T.setIndex()}albumPhotos(t){let e=I.getAlbumPhotoSources(t,this.id);return Array.from(e).flatMap(s=>{let i=t.search({source:U(s)}).firstObject(!0);return i?[i]:[]})}albumVideos(t){let e=t.search({source:{type:"video"},relation:"albumId",target:{id:this.id}}).sources();return Array.from(e).flatMap(s=>{let i=t.search({source:U(s)}).firstObject();return i?[i]:[]})}renderPhotoCount(){return this.imageCount===1?`${this.imageCount} photo`:`${this.imageCount} photos`}thingsLinks(t){let e={},s=this.albumPhotos(t);for(let n of[$.UNESCO])e[n]=Array.from(new Set(s.flatMap(o=>o[g.LOCATION]?.filter(c=>x.is(c,n))).filter(o=>o)));for(let n of[$.BIRD,$.MAMMAL,$.REPTILE,$.FISH,$.AMPHIBIAN,$.INSECT])e[n]=Array.from(new Set(s.flatMap(o=>o[g.SUBJECT]?.filter(c=>x.is(c,n))).filter(o=>o)));let i=[];i=i.concat(e[$.UNESCO].map(n=>l`<unesco-link urn="${n}"></unesco-link>`));for(let n of[$.BIRD,$.MAMMAL,$.REPTILE,$.FISH,$.AMPHIBIAN,$.INSECT])i=i.concat(e[n].map(o=>l`<thing-link .urn="${o}" .triples="${this.triples}"></thing-link>`));return i}render(){let t=this.triples,e=window.matchMedia("(max-width: 500px)"),s=lt.dateRange(this.minDate,this.maxDate,e.matches),n=this.albumPhotos(t).map((a,p)=>l`
      <app-photo
        ...
        ></app-video>`),c=this?.countries.split(",").map(a=>{let{flag:p,urn:m}=z.details(this.triples,a),u=U(m);return l`<span href="#/thing/country:${u.id}" title=${a}>${p}</span>`});return l`
    <div>
      <section class="photos-metadata">
        <h1>${this.title}</h1>
    ...
    `}render(){let t=this.image,e=t.albumId,s=this.triples,i=s.search({source:{id:U(t.id).id},relation:{predicate:n=>{let o=new Set(["albumId","fullImage","mosaicColours","thumbnailUrl","midImageLossyUrl"]);return!Ve.has(n)&&!o.has(n)}}}).triples();return l`
    <section>
    <h1>Metadata</h1>
    ...
    `}};h([d()],rt.prototype,"id",2),h([d()],rt.prototype,"image",2),h([d({state:!0})],rt.prototype,"sharing",2),h([d({state:!0})],rt.prototype,"triples",2);customElements.define("metadata-page",rt);var fe=class extends f{connectedCallback(){super.connectedCallback(),T.setIndex()}render(){return l`
    <div>
    ...
    `}};customElements.define("about-page",fe);var Et=class extends f{connectedCallback(){super.connectedCallback(),T.setIndex(),this.updatePageLocation()}updatePageLocation(){let t=I.getName(this.triples,this.urn);if(!t){document.title="Thing - photos";return}document.title=`${A.capitalise(t)} - photos`}isValidImage(t){return t&&t.thumbnailUrl}urnImages(t,e){let i=t.search(e).sources();return Array.from(i).flatMap(n=>{if(n.startsWith("urn:r\xF3")){let c=t.search({source:w(n)}).firstObject();return this.isValidImage(c)?[c]:[]}let o=t.search({source:{id:n,type:"photo"}}).firstObject();return this.isValidImage(o)?[o]:[]})}renderSubjectPhotos(t){return t.sort((e,s)=>s.createdAt-e.createdAt).map((e,s)=>l`
      ...
      `})}firstPhotographed(t,e){let i=this.urnImages(t,e).sort((n,o)=>n.createdAt-o.createdAt)[0];return i?new Date(parseInt(i.createdAt)).toLocaleDateString("en-IE",{day:"numeric",month:"short",year:"numeric"}):"Unknown"}renderTitle(){let t=I.getName(this.triples,this.urn);if(t)return t;try{let e=x.parseUrn(this.urn),s=decodeURIComponent(e.id);if(e.id==="*")return A.capitalise(e.type);if(e.type===$.COUNTRY){let i=this.triples.search({source:e}).firstObject();return i.flag?`${i.flag} ${t}`:t}return tt.has(e.type)?st.toCommonName(this.triples,s):s}catch{return this.urn}}renderClassification(t){return l`<a href="#/listing/${t}">${A.capitalise(t)}</a>`}getPhotoQueries(t){let e=t;e.id==="*"&&delete e.id;let s=[];if(tt.has(t.type))for(let i of["captivity","wild"]){let o={...t,qs:{context:i}};s.push({label:i,query:{target:o}})}else s.push({label:"default",query:{source:{type:"photo"},target:t}});return s}renderPhotoSection(t){return l`<div>
    ${Object.entries(t).flatMap(([e,s])=>s?s.length===0?[]:e==="default"?[l`
      ...
      `]:[])}
    <div/>`}render(){let t=this.triples,e=I.photoObjects(t),s=x.parseUrn(this.urn),i=s.type,n=t.search({source:w(this.urn)}).firstObject()??{},o=Object.assign({Classification:this.renderClassification(i)});if(n.country&&(o.Country=l`<thing-link .triples=${this.triples} urn=${n.country}></thing-link>`),n.fcodeName){let W=n.fcodeName;o["Place Type"]=l`${A.capitalise(W)}`}tt.has(i)&&(o["First Photographed"]=l`<span>${this.firstPhotographed(t,{target:w(this.urn)})}</span>`);let c=n[g.WIKIPEDIA],a=n[g.BIRDWATCH_URL],p=Ht.getURL(t,this.urn),m=w(this.urn);m.id==="*"&&delete m.id;let u=this.getPhotoQueries(w(this.urn)),b={};for(let{query:W,label:ee}of u){let ps=this.urnImages(t,W);b[ee]=this.renderSubjectPhotos(ps)}let y={source:{type:"photo"},target:m},E=this.renderSubjectAlbums(t,y),O=this.renderPhotoSection(b);return l`
      <div>
    ...
    `}};h([d()],Et.prototype,"urn",2),h([d({state:!0})],Et.prototype,"triples",2);customElements.define("thing-page",Et);var Zt=class{static loadingMode(t){return t===0?"auto":"none"}};var te=class extends f{connectedCallback(){super.connectedCallback(),T.setIndex()}render(){let t=I.videoObjects(this.triples);async function*e(){for(let s=0;s<t.length;s++){let i=t[s];s%4===0&&await new Promise(n=>setTimeout(n,0)),yield l`<app-video
          id=${i.id}
    ...
    `}renderThingAlbum(t,e,s,i){let n=$e.chooseBestImage(this.triples,t,e),o=(m,u)=>{let{type:b,id:y}=w(m),E=new CustomEvent("click-thing-album",{detail:{id:`${b}:${y}`,name:u},bubbles:!0,composed:!0});this.dispatchEvent(E)},c=this.triples.search({source:w(n)}).firstObject(),a=w(this.id),p=`${a.type}:${a.id}`;return l`
      <photo-album
    ...
    <section class="album-metadata">
      <h1 class="albums-header">${A.capitalise(this.id)}s</h1>
      <a href="/#/thing/${this.id}:*">See all ${A.pluralise(this.id)} photos</a>
    </section>
...
lit-html/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=app.c9534bfd0308620c.js.map
