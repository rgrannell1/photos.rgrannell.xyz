...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ie=/'/g,Ce=/"/g,Ve=/^(?:script|style|textarea|title)$/i,Ye=s=>(t,...e)=>({_$litType$:s,strings:t,values:e}),l=Ye(1),ms=Ye(2),_=Symbol.for("lit-noChange"),A=Symbol.for("lit-nothing"),Me=new WeakMap,z=F.createTreeWalker(F,129);function ze(s,t){if(!Array.isArray(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ee!==void 0?Ee.createHTML(t):t}var Fe=(s,t)=>{let e=s.length-1,i=[],r,n=t===2?"<svg>":"",o=st;for(let c=0;c<e;c++){let a=s[c],h,u,d=-1,m=0;for(;m<a.length&&(o.lastIndex=m,u=o.exec(a),u!==null);)m=o.lastIndex,o===st?u[1]==="!--"?o=Te:u[1]!==void 0?o=Ue:u[2]!==void 0?(Ve.test(u[2])&&(r=RegExp("</"+u[2],"g")),o=Y):u[3]!==void 0&&(o=Y):o===Y?u[0]===">"?(o=r??st,d=-1):u[1]===void 0?d=-2:(d=o.lastIndex-u[2].length,h=u[1],o=u[3]===void 0?Y:u[3]==='"'?Ce:Ie):o===Ce||o===Ie?o=Y:o===Te||o===Ue?o=st:(o=Y,r=void 0);let $=o===Y&&s[c+1].startsWith("/>")?" ":"";n+=o===st?a+us:d>=0?(i.push(h),a.slice(0,d)+Kt+a.slice(d)+B+$):a+B+(d===-2?c:$)}return[ze(s,n+(s[e]||"<?>")+(t===2?"</svg>":"")),i]},at=class s{constructor({strings:t,_$litType$:e},i){let r;this.parts=[];let n=0,o=0,c=t.length-1,a=this.parts,[h,u]=Fe(t,e);if(this.el=s.createElement(h,i),z.currentNode=this.el.content,e===2){let d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(r=z.nextNode())!==null&&a.length<c;){if(r.nodeType===1){if(r.hasAttributes())for(let d of r.getAttributeNames())if(d.endsWith(Kt)){let m=u[o++],$=r.getAttribute(d).split(B),b=/([.?@])?(.*)/.exec(m);a.push({type:1,index:n,name:b[2],strings:$,ctor:b[1]==="."?gt:b[1]==="?"?$t:b[1]==="@"?bt:q}),r.removeAttribute(d)}else d.startsWith(B)&&(a.push({type:6,index:n}),r.removeAttribute(d));if(Ve.test(r.tagName)){let d=r.textContent.split(B),m=d.length-1;if(m>0){r.textContent=mt?mt.emptyScript:"";for(let $=0;$<m;$++)r.append(d[$],nt()),z.nextNode(),a.push({type:2,index:++n});r.append(d[m],nt())}}}else if(r.nodeType===8)if(r.data===Jt)a.push({type:2,index:n});else{let d=-1;for(;(d=r.data.indexOf(B,d+1))!==-1;)a.push({type:7,index:n}),d+=B.length-1}n++}}static createElement(t,e){let i=F.createElement("template");return i.innerHTML=t,i}};function W(s,t,e=s,i){if(t===_)return t;let r=i!==void 0?e.U?.[i]:e.N,n=ot(t)?void 0:t._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),n===void 0?r=void 0:(r=new n(s),r._$AT(s,e,i)),i!==void 0?(e.U??=[])[i]=r:e.N=r),r!==void 0&&(t=W(s,r._$AS(s,t.values),r,i)),t}var ft=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}O(t){let{el:{content:e},parts:i}=this._$AD,r=(t?.creationScope??F).importNode(e,!0);z.currentNode=r;let n=z.nextNode(),o=0,c=0,a=i[0];for(;a!==void 0;){if(o===a.index){let h;a.type===2?h=new xt(n,n.nextSibling,this,t):a.type===1?h=new a.ctor(n,a.name,a.strings,this,t):a.type===6&&(h=new yt(n,this,t)),this._$AV.push(h),a=i[++c]}o!==a?.index&&(n=z.nextNode(),o++)}return z.currentNode=F,r}R(t){let e=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}},xt=class We{get _$AU(){return this._$AM?._$AU??this.V}constructor(t,e,i,r){this.type=2,this._$AH=A,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=r,this.V=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=W(this,t,e),ot(t)?t===A||t==null||t===""?(this._$AH!==A&&this._$AR(),this._$AH=A):t!==this._$AH&&t!==_&&this.L(t):t._$litType$!==void 0?this.I(t):t.nodeType!==void 0?this.j(t):Ge(t)?this.D(t):this.L(t)}H(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}j(t){this._$AH!==t&&(this._$AR(),this._$AH=this.H(t))}L(t){this._$AH!==A&&ot(this._$AH)?this._$AA.nextSibling.data=t:this.j(F.createTextNode(t)),this._$AH=t}I(t){let{values:e,_$litType$:i}=t,r=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=at.createElement(ze(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===r)this._$AH.R(e);else{let n=new ft(r,this),o=n.O(this.options);n.R(e),this.j(o),this._$AH=n}}_$AC(t){let e=Me.get(t.strings);return e===void 0&&Me.set(t.strings,e=new at(t)),e}D(t){je(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,i,r=0;for(let n of t)r===e.length?e.push(i=new We(this.H(nt()),this.H(nt()),this,this.options)):i=e[r],i._$AI(n),r++;r<e.length&&(this._$AR(i&&i._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){let i=t.nextSibling;t.remove(),t=i}}setConnected(t){this._$AM===void 0&&(this.V=t,this._$AP?.(t))}},q=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,r,n){this.type=1,this._$AH=A,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=A}_$AI(t,e=this,i,r){let n=this.strings,o=!1;if(n===void 0)t=W(this,t,e,0),o=!ot(t)||t!==this._$AH&&t!==_,o&&(this._$AH=t);else{let c=t,a,h;for(t=n[0],a=0;a<n.length-1;a++)h=W(this,c[i+a],e,a),h===_&&(h=this._$AH[a]),o||=!ot(h)||h!==this._$AH[a],h===A?t=A:t!==A&&(t+=(h??"")+n[a+1]),this._$AH[a]=h}o&&!r&&this.B(t)}B(t){t===A?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},gt=class extends q{constructor(){super(...arguments),this.type=3}B(t){this.element[this.name]=t===A?void 0:t}},$t=class extends q{constructor(){super(...arguments),this.type=4}B(t){this.element.toggleAttribute(this.name,!!t&&t!==A)}},bt=class extends q{constructor(t,e,i,r,n){super(t,e,i,r,n),this.type=5}_$AI(t,e=this){if((t=W(this,t,e,0)??A)===_)return;let i=this._$AH,r=t===A&&i!==A||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,n=t!==A&&(i===A||r);r&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},yt=class{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){W(this,t)}},fs={W:Kt,q:B,J:Jt,Z:1,F:Fe,G:ft,K:Ge,X:W,Y:xt,tt:q,st:$t,it:bt,et:gt,ot:yt},gs=Qt.litHtmlPolyfillSupport;gs?.(at,xt),(Qt.litHtmlVersions??=[]).push("3.1.3");var qe=(s,t,e)=>{let i=e?.renderBefore??t,r=i._$litPart$;if(r===void 0){let n=e?.renderBefore??null;i._$litPart$=r=new xt(t.insertBefore(nt(),n),n,void 0,e??{})}return r._$AI(s),r};var V=class extends j{constructor(){super(...arguments),this.renderOptions={host:this},this.ht=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this.ht=qe(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this.ht?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this.ht?.setConnected(!1)}render(){return _}};V._$litElement$=!0,V.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:V});var $s=globalThis.litElementPolyfillSupport;$s?.({LitElement:V});(globalThis.litElementVersions??=[]).push("4.0.5");var{Y:bs}=fs,ys=s=>s===null||typeof s!="object"&&typeof s!="function";var Re=(s,t)=>t===void 0?s?._$litType$!==void 0:s?._$litType$===t,As=s=>s?._$litType$?.h!=null;var Ze=s=>s.strings===void 0,Le=()=>document.createComment(""),G=(s,t,e)=>{let i=s._$AA.parentNode,r=t===void 0?s._$AB:t._$AA;if(e===void 0){let n=i.insertBefore(Le(),r),o=i.insertBefore(Le(),r);e=new bs(n,o,s,s.options)}else{let n=e._$AB.nextSibling,o=e._$AM,c=o!==s;if(c){let a;e._$AQ?.(s),e._$AM=s,e._$AP!==void 0&&(a=s._$AU)!==o._$AU&&e._$AP(a)}if(n!==r||c){let a=e._$AA;for(;a!==n;){let h=a.nextSibling;i.insertBefore(a,r),a=h}}}return e},H=(s,t,e=s)=>(s._$AI(t,e),s),vs={},lt=(s,t=vs)=>s._$AH=t,Wt=s=>s._$AH,Vt=s=>{s._$AP?.(!1,!0);let t=s._$AA,e=s._$AB.nextSibling;for(;t!==e;){let i=t.nextSibling;t.remove(),t=i}},Qe=s=>{s._$AR()};var E=s=>(...t)=>({_$litDirective$:s,values:t}),L=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this.nt=t,this._$AM=e,this.rt=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var rt=(s,t)=>{let e=s._$AN;if(e===void 0)return!1;for(let i of e)i._$AO?.(t,!1),rt(i,t);return!0},At=s=>{let t,e;do{if((t=s._$AM)===void 0)break;e=t._$AN,e.delete(s),s=t}while(e?.size===0)},Ke=s=>{for(let t;t=s._$AM;s=t){let e=t._$AN;if(e===void 0)t._$AN=e=new Set;else if(e.has(s))break;e.add(s),ws(t)}};function _s(s){this._$AN!==void 0?(At(this),this._$AM=s,Ke(this)):this._$AM=s}function Ss(s,t=!1,e=0){let i=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(t)if(Array.isArray(i))for(let n=e;n<i.length;n++)rt(i[n],!1),At(i[n]);else i!=null&&(rt(i,!1),At(i));else rt(this,s)}var ws=s=>{s.type==2&&(s._$AP??=Ss,s._$AQ??=_s)},ct=class extends L{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,i){super._$AT(t,e,i),Ke(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(rt(this,t),At(this))}setValue(t){if(Ze(this.nt))this.nt._$AI(t,this);else{let e=[...this.nt._$AH];e[this.rt]=t,this.nt._$AI(e,this,0)}}disconnected(){}reconnected(){}};var vt=class{constructor(t){this.ct=t}disconnect(){this.ct=void 0}reconnect(t){this.ct=t}deref(){return this.ct}},_t=class{constructor(){this.lt=void 0,this.ut=void 0}get(){return this.lt}pause(){this.lt??=new Promise(t=>this.ut=t)}resume(){this.ut?.(),this.lt=this.ut=void 0}};var St=class extends ct{constructor(){super(...arguments),this.dt=new vt(this),this.ft=new _t}render(t,e){return _}update(t,[e,i]){if(this.isConnected||this.disconnected(),e===this.vt)return _;this.vt=e;let r=0,{dt:n,ft:o}=this;return(async(c,a)=>{for await(let h of c)if(await a(h)===!1)return})(e,async c=>{for(;o.get();)await o.get();let a=n.deref();if(a!==void 0){if(a.vt!==e)return!1;i!==void 0&&(c=i(c,r)),a.commitValue(c,r),r++}return!0}),_}commitValue(t,e){this.setValue(t)}disconnected(){this.dt.disconnect(),this.ft.pause()}reconnected(){this.dt.reconnect(this),this.ft.resume()}},Ns=E(St),Et=E(class extends St{constructor(s){if(super(s),s.type!==2)throw Error("asyncAppend can only be used in child expressions")}update(s,t){return this.ht=s,super.update(s,t)}commitValue(s,t){t===0&&Qe(this.ht);let e=G(this.ht);H(e,s)}}),Oe=s=>As(s)?s._$litType$.h:s.strings,Ds=E(class extends L{constructor(s){super(s),this.yt=new WeakMap}render(s){return[s]}update(s,[t]){let e=Re(this.bt)?Oe(this.bt):null,i=Re(t)?Oe(t):null;if(e!==null&&(i===null||e!==i)){let r=Wt(s).pop(),n=this.yt.get(e);if(n===void 0){let o=document.createDocumentFragment();n=qe(A,o),n.setConnected(!1),this.yt.set(e,n)}lt(n,[r]),G(n,void 0,r)}if(i!==null){if(e===null||e!==i){let r=this.yt.get(i);if(r!==void 0){let n=Wt(r).pop();Qe(s),G(s,void 0,n),lt(s,[n])}}this.bt=t}else this.bt=void 0;return this.render(t)}});var Bs=E(class extends L{constructor(s){if(super(s),s.type!==1||s.name!=="class"||s.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(s){return" "+Object.keys(s).filter(t=>s[t]).join(" ")+" "}update(s,[t]){if(this.gt===void 0){this.gt=new Set,s.strings!==void 0&&(this.wt=new Set(s.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(let i in t)t[i]&&!this.wt?.has(i)&&this.gt.add(i);return this.render(t)}let e=s.element.classList;for(let i of this.gt)i in t||(e.remove(i),this.gt.delete(i));for(let i in t){let r=!!t[i];r===this.gt.has(i)||this.wt?.has(i)||(r?(e.add(i),this.gt.add(i)):(e.remove(i),this.gt.delete(i)))}return _}}),xs={},Hs=E(class extends L{constructor(){super(...arguments),this._t=xs}render(s,t){return t()}update(s,[t,e]){if(Array.isArray(t)){if(Array.isArray(this._t)&&this._t.length===t.length&&t.every((i,r)=>i===this._t[r]))return _}else if(this._t===t)return _;return this._t=Array.isArray(t)?Array.from(t):t,this.render(t,e)}});var js=E(class extends L{constructor(){super(...arguments),this.key=A}render(s,t){return this.key=s,t}update(s,[t,e]){return t!==this.key&&(lt(s),this.key=t),e}}),Gs=E(class extends L{constructor(s){if(super(s),s.type!==3&&s.type!==1&&s.type!==4)throw Error("The `live` directive is not allowed on child or event bindings");if(!Ze(s))throw Error("`live` bindings can only contain a single expression")}render(s){return s}update(s,[t]){if(t===_||t===A)return t;let e=s.element,i=s.name;if(s.type===3){if(t===e[i])return _;if(s.type===4){if(!!t===e.hasAttribute(i))return _;if(s.type===1&&e.getAttribute(i)===t+"")return _}}return lt(s),t}});var Yt=new WeakMap,Vs=E(class extends ct{render(s){return A}update(s,[t]){let e=t!==this.ct;return e&&this.ct!==void 0&&this.St(void 0),(e||this.$t!==this.Tt)&&(this.ct=t,this.xt=s.options?.host,this.St(this.Tt=s.element)),A}St(s){if(typeof this.ct=="function"){let t=this.xt??globalThis,e=Yt.get(t);e===void 0&&(e=new WeakMap,Yt.set(t,e)),e.get(this.ct)!==void 0&&this.ct.call(this.xt,void 0),e.set(this.ct,s),s!==void 0&&this.ct.call(this.xt,s)}else this.ct.value=s}get $t(){return typeof this.ct=="function"?Yt.get(this.xt??globalThis)?.get(this.ct):this.ct?.value}disconnected(){this.$t===this.Tt&&this.St(void 0)}reconnected(){this.St(this.Tt)}}),ke=(s,t,e)=>{let i=new Map;for(let r=t;r<=e;r++)i.set(s[r],r);return i},Ys=E(class extends L{constructor(s){if(super(s),s.type!==2)throw Error("repeat() can only be used in text expressions")}Et(s,t,e){let i;e===void 0?e=t:t!==void 0&&(i=t);let r=[],n=[],o=0;for(let c of s)r[o]=i?i(c,o):o,n[o]=e(c,o),o++;return{values:n,keys:r}}render(s,t,e){return this.Et(s,t,e).values}update(s,[t,e,i]){let r=Wt(s),{values:n,keys:o}=this.Et(t,e,i);if(!Array.isArray(r))return this.Ct=o,n;let c=this.Ct??=[],a=[],h,u,d=0,m=r.length-1,$=0,b=n.length-1;for(;d<=m&&$<=b;)if(r[d]===null)d++;else if(r[m]===null)m--;else if(c[d]===o[$])a[$]=H(r[d],n[$]),d++,$++;else if(c[m]===o[b])a[b]=H(r[m],n[b]),m--,b--;else if(c[d]===o[b])a[b]=H(r[d],n[b]),G(s,a[b+1],r[d]),d++,b--;else if(c[m]===o[$])a[$]=H(r[m],n[$]),G(s,r[d],r[m]),m--,$++;else if(h===void 0&&(h=ke(o,$,b),u=ke(c,d,m)),h.has(c[d]))if(h.has(c[m])){let I=u.get(o[$]),et=I!==void 0?r[I]:null;if(et===null){let ve=G(s,r[d]);H(ve,n[$]),a[$]=ve}else a[$]=H(et,n[$]),G(s,r[d],et),r[I]=null;$++}else Vt(r[m]),m--;else Vt(r[d]),d++;for(;$<=b;){let I=G(s,a[b+1]);H(I,n[$]),a[$++]=I}for(;d<=m;){let I=r[d++];I!==null&&Vt(I)}return this.Ct=o,lt(s,a),_}}),Je="important",Es=" !"+Je,zs=E(class extends L{constructor(s){if(super(s),s.type!==1||s.name!=="style"||s.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(s){return Object.keys(s).reduce((t,e)=>{let i=s[e];return i==null?t:t+`${e=e.includes("-")?e:e.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`},"")}update(s,[t]){let{style:e}=s.element;if(this.Pt===void 0)return this.Pt=new Set(Object.keys(t)),this.render(t);for(let i of this.Pt)t[i]==null&&(this.Pt.delete(i),i.includes("-")?e.removeProperty(i):e[i]=null);for(let i in t){let r=t[i];if(r!=null){this.Pt.add(i);let n=typeof r=="string"&&r.endsWith(Es);i.includes("-")||n?e.setProperty(i,n?r.slice(0,-11):r,n?Je:""):e[i]=r}}return _}}),Fs=E(class extends L{constructor(s){if(super(s),s.type!==2)throw Error("templateContent can only be used in child bindings")}render(s){return this.At===s?_:(this.At=s,document.importNode(s.content,!0))}}),Q=class extends L{constructor(t){if(super(t),this.bt=A,t.type!==2)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===A||t==null)return this.kt=void 0,this.bt=t;if(t===_)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.bt)return this.kt;this.bt=t;let e=[t];return e.raw=e,this.kt={_$litType$:this.constructor.resultType,strings:e,values:[]}}};Q.directiveName="unsafeHTML",Q.resultType=1;var Tt=E(Q);var ht=class extends Q{};ht.directiveName="unsafeSVG",ht.resultType=2;var Ws=E(ht),Pe=s=>!ys(s)&&typeof s.then=="function",Ne=1073741823;var qt=class extends ct{constructor(){super(...arguments),this.Mt=Ne,this.Ut=[],this.dt=new vt(this),this.ft=new _t}render(...t){return t.find(e=>!Pe(e))??_}update(t,e){let i=this.Ut,r=i.length;this.Ut=e;let n=this.dt,o=this.ft;this.isConnected||this.disconnected();for(let c=0;c<e.length&&!(c>this.Mt);c++){let a=e[c];if(!Pe(a))return this.Mt=c,a;c<r&&a===i[c]||(this.Mt=Ne,r=0,Promise.resolve(a).then(async h=>{for(;o.get();)await o.get();let u=n.deref();if(u!==void 0){let d=u.Ut.indexOf(a);d>-1&&d<u.Mt&&(u.Mt=d,u.setValue(h))}}))}return _}disconnected(){this.dt.disconnect(),this.ft.pause()}reconnected(){this.dt.reconnect(this),this.ft.resume()}},qs=E(qt);var Ts=Symbol.for(""),Us=s=>{if(s?.r===Ts)return s?._$litStatic$};var De=new Map,Xe=s=>(t,...e)=>{let i=e.length,r,n,o=[],c=[],a,h=0,u=!1;for(;h<i;){for(a=t[h];h<i&&(n=e[h],(r=Us(n))!==void 0);)a+=r+t[++h],u=!0;h!==i&&c.push(n),o.push(a),h++}if(h===i&&o.push(t[i]),u){let d=o.join("$$lit$$");(t=De.get(d))===void 0&&(o.raw=o,De.set(d,t=o)),e=c}return s(t,...e)},Zs=Xe(l),Qs=Xe(ms);var f=class extends V{createRenderRoot(){return this}broadcast(t,e){return()=>{let i=new CustomEvent(t,{detail:e,bubbles:!0,composed:!0});this.dispatchEvent(i)}}};var Ut=Symbol("the albums manifest"),It=Symbol("the images manifest"),hi=Symbol("the site manifest"),Ct=Symbol("the videos manifest"),Mt=Symbol("the exif data"),di=Symbol("the semantic data"),pi=Symbol("the album stats"),Rt=Symbol("the triples data");var ts="photos",p=class{static EAGER="eager";static LAZY="lazy"},g=class{static PHOTOS="photos";static ALBUMS="albums";static ALBUM="album";static METADATA="metadata";static ABOUT="about";static VIDEOS="videos";static THING="thing"},y=class{static UNESCO="unesco";static BIRD="bird";static MAMMAL="mammal";static REPTILE="reptile";static FISH="fish";static INSECT="insect";static AMPHIBIAN="amphibian";static GEONAME="geoname"},S=class{static SUBJECT="subject";static LOCATION="location";static LONGITUDE="longitude";static LATITUDE="latitude";static RATING="rating";static NAME="name";static BIRDWATCH_URL="birdwatch_url";static WIKIPEDIA="wikipedia"},K=new Set(["bird","mammal","reptile","amphibian","fish","insect"]);var J=window.envConfig,Lt=class{_data;constructor(t=`/manifest/images.${J.publication_id}.json`){this.url=t}processImages(t){let e=t[0],i=[];for(let r of t.slice(1)){let n={};for(let o=0;o<e.length;o++)n[e[o]]=r[o];i.push(n)}return i}async init(){if(window[It]&&(this._data=window[It]),this._data||this.loading)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.processImages(t);window[It]=e,this._data=e}images(){return this._data.map(t=>({...t,full_image:`https://photos-cdn.rgrannell.xyz${t.full_image}`,thumbnail_url:`https://photos-cdn.rgrannell.xyz${t.thumbnail_url}`}))}},Ot=class{_data;constructor(t=`/manifest/videos.${J.publication_id}.json`){this.url=t}processVideos(t){let e=t[0],i=[];for(let r of t.slice(1)){let n={};for(let o=0;o<e.length;o++)n[e[o]]=r[o];i.push(n)}return i}async init(){if(window[Ct]&&(this._data=window[Ct]),this._data||this.loading)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.processVideos(t);window[Ct]=e,this._data=e}videos(){return this._data.map(t=>({...t,poster_url:`https://photos-cdn.rgrannell.xyz${t.poster_url}`,video_url_1080p:`https://photos-cdn.rgrannell.xyz${t.video_url_1080p}`,video_url_480p:`https://photos-cdn.rgrannell.xyz${t.video_url_480p}`,video_url_720p:`https://photos-cdn.rgrannell.xyz${t.video_url_720p}`,video_url_unscaled:`https://photos-cdn.rgrannell.xyz${t.video_url_unscaled}`,tags:(t.tags??"").split(",").filter(e=>e!="Published").map(e=>e.trim())}))}},kt=class{_data;constructor(t=`/manifest/albums.${J.publication_id}.json`){this.url=t}process(t){let e=t[0],i=[];for(let r of t.slice(1)){let n={};if(r.length!==e.length)throw new Error(`album row length mismatch: expected ${e.length}, got ${r.length}`);for(let o=0;o<e.length;o++)n[e[o]]=r[o];i.push(n)}return i}async init(){if(window[Ut]&&(this._data=window[Ut]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.process(t);window[Ut]=e,this._data=e}albums(){return this._data.map(t=>({...t,thumbnail_url:`https://photos-cdn.rgrannell.xyz${t.thumbnail_url}`,thumbnail_mosaic_url:`${t.thumbnail_mosaic_url}`}))}},Pt=class{_data;constructor(t=`/manifest/exif.${J.publication_id}.json`){this.url=t}process(t){let e=t[0],i=[];for(let r of t.slice(1)){let n={};for(let o=0;o<e.length;o++)n[e[o]]=r[o];i.push(n)}return i}async init(){if(window[Mt]&&(this._data=window[Mt]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.process(t);window[Mt]=e,this._data=e}exif(){return this._data}};var Nt=class{_data;constructor(t=`/manifest/stats.${J.publication_id}.json`){this.url=t}async init(){let t=document.getElementById("stats-data");this._data=JSON.parse(t.textContent),this._data||console.error("stats symbol not injected")}stats(){return this._data}},Dt=class{_data;constructor(t=`/manifest/triples.${J.publication_id}.json`){this.url=t}async init(){if(window[Rt]&&(this._data=window[Rt]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json();window[Rt]=t,this._data=t}};var P=class s{static ROUTES={[g.PHOTOS]:this.showPhotosUrl,[g.ALBUMS]:this.showAlbumsUrl,[g.ALBUM]:this.showAlbumUrl,[g.METADATA]:this.showMetadataUrl,[g.ABOUT]:this.showAboutUrl,[g.VIDEOS]:this.showVideosUrl,[g.THING]:this.showThingUrl};static router(t){if(s.ROUTES.hasOwnProperty(t))return s.ROUTES[t];throw new Error(`Unknown page: ${t}`)}static pageUsesId(t){return t===g.ALBUM||t===g.PHOTO||t===g.METADATA||t===g.THING}static showAboutUrl(){window.location.hash="#/about",document.title="About - photos"}static showAlbumsUrl(){window.location.hash="#/albums",document.title="Albums - photos"}static showPhotosUrl(){window.location.hash="#/photos",document.title="Photos - photos"}static showAlbumUrl(t){window.location.hash=`#/album/${t}`,document.title="Album - photos"}static showPhotoUrl(t){window.location.hash=`#/photo/${t}`,document.title="Photo - photos"}static showMetadataUrl(t){window.location.hash=`#/metadata/${t}`,document.title="Metadata - photos"}static showVideosUrl(){window.location.hash="#/videos",document.title="Videos - photos"}static showThingUrl(t){window.location.hash=`#/thing/${t}`,document.title="Thing - photos"}static getUrl(){return window.location.hash.startsWith("#/albums")?{type:"albums"}:window.location.hash.startsWith("#/album")?{type:"album",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/metadata")?{type:"metadata",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/thing")?{type:"thing",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/photos")?{type:"photos"}:window.location.hash.startsWith("#/about")?{type:"about"}:window.location.hash.startsWith("#/videos")?{type:"videos"}:{type:"albums"}}};var Xt=class extends f{static get properties(){return{visible:{type:Boolean}}}render(){let t=["photo-sidebar"];return this.visible&&t.push("sidebar-visible"),l`
    ...
    `}};customElements.define("photo-sidebar",Xt);var te=class extends f{static get properties(){return{darkMode:{type:Boolean},tag:{type:String}}}feedUrl(){return this.tag?`/feeds/tags/${this.tag}.json`:"/manifest/atom/atom-index.xml"}render(){let t=this.darkMode?"\u2600\uFE0F":"\u{1F319}",e=ts;return l`
    ...
    `}};customElements.define("photo-header",te);var Bt=new Map,T=class{static loadingMode(t){let e=window.innerWidth,i=window.innerHeight,r=400,n=Math.floor(e/r),o=Math.floor(i/r);return t>n*o+1?"lazy":"eager"}static encodeBitmapDataURL(t){if(Bt.has(t))return Bt.get(t);let e=t.split("#").map(n=>`#${n}`),i=document.createElement("canvas");i.width=2,i.height=2;let r=i.getContext("2d");return r.fillStyle=e[1],r.fillRect(0,0,1,1),r.fillStyle=e[2],r.fillRect(1,0,1,1),r.fillStyle=e[3],r.fillRect(0,1,1,1),r.fillStyle=e[4],r.fillRect(1,1,1,1),Bt.set(t,i.toDataURL("image/png")),Bt.get(t)}};var ee=class extends f{static get properties(){return{id:{type:String},imageUrl:{type:String},thumbnailUrl:{type:String},mosaicColours:{type:String},summary:{type:String},loading:{type:String}}}renderIcon(){return l`
    ...
    `}};customElements.define("search-bar",se);var w=class{static getElement(){return document.getElementById("rss")}static setTag(t){let e=this.getElement();if(!e||!t)return;let i=`/feeds/tags/${t}.json`;e.href=i}static setIndex(){let t=this.getElement();if(!t)return;let e="/manifest/atom/atom-index.xml";t.href=e}};var ie=class extends f{static get properties(){return{images:{type:Object}}}connectedCallback(){super.connectedCallback(),w.setIndex()}allImages(){return this.images.images().sort((t,e)=>e.created_at-t.created_at)}render(){let t=this.allImages();async function*e(){for(let i=0;i<t.length;i++){let r=t[i];yield l`
          <app-photo
            id=${r.id}
    ...
    `}};customElements.define("photos-page",ie);var re=class extends f{static get properties(){return{albums:{type:Array},stats:{type:Array}}}render(){return l`
    ...
    `}};customElements.define("photo-album-page",oe);var ae=class extends f{static get properties(){return{id:{type:String},url:{type:String},preload:{type:String},url_poster:{type:String},url_unscaled:{type:String},url_1080p:{type:String},url_720p:{type:String},url_480p:{type:String}}}render(){return l`
    <div>
    ...
    `}};customElements.define("album-page",pe);var ue=class extends f{static get properties(){return{url:{type:String},format:{type:String},sharing:{state:!0,type:Boolean}}}async shareImage(t){if(!navigator.share)console.error("navigator.share not available");else{this.sharing=!0;try{let e=await fetch(t),i=new URL(t).pathname;await navigator.share({title:i,files:[new File([await e.blob()],i,{type:this.format})]})}finally{this.sharing=!1}}}render(){return this.sharing?l`<button class="photo-share-button" disabled>[sharing...]</button>`:l`
      ...
      `}};customElements.define("share-metadata-button",ue);var me=class extends f{static get properties(){return{tagName:{type:String},count:{type:Number}}}render(){let{tagName:t,count:e}=this,i=encodeURIComponent(t);return typeof e>"u"?l`<a
        href="#/tag/${i}"
        @click=${this.broadcast("click-tag",{tagName:t})}>${t}</a>`:l`<a
      href="#/tag/${i}"
      rel="tag"
      @click=${this.broadcast("click-tag",{tagName:t})}>${t}</a> (${e})`}};customElements.define("tag-link",me);var fe=class extends f{static get properties(){return{id:{type:String},image:{type:Object},exif:{type:Object},semantic:{type:Object},sharing:{state:!0,type:Boolean},triples:{type:Array}}}connectedCallback(){super.connectedCallback(),w.setIndex()}renderAperture(t){return t.f_stop==="Unknown"?l`<td>Unknown aperture</td>`:t.f_stop==="0.0"?l`<td>Manual aperture control</td>`:l`<td>ƒ/${t.f_stop}</td>`}renderFocalLength(t){return t.focal_length==="Unknown"?l`${t.focal_length}`:t.focal_length==="0"?l`<td>Manual lens</td>`:l`<td>${t.focal_length}mm equiv.</td>`}renderSemanticKey(t){return t.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}renderSemanticValue(t,e){if(Array.isArray(e))return l`<ul class="thing-list">
        ${e.map(i=>l`<li>${this.renderSemanticValue.call(this,t,i)}</li>`)}
      </ul>`;if(t.includes("binomial"))return l`<em>${e}</em>`;if(t.toLowerCase()==="summary")return l`${Tt(e??"")}`;if(v.isRating(e)){let i=`urn:r\xF3:rating:${e}`;return l`<thing-link .triples=${this.triples} .urn="${i}"></thing-link>`}else{if(v.isUrn(e)&&v.is(e,y.UNESCO))return l`<unesco-link .urn="${e}"></unesco-link>`;if(v.isUrn(e))return l`<thing-link .triples=${this.triples} .urn="${e}"></thing-link>`}return e}isIgnoredKey(t){return new Set(["bird_binomial","wildlife","living_conditions"]).has(t)}renderSemanticData(t){return l`
    ...
    `}};customElements.define("metadata-page",fe);var ge=class extends f{static get properties(){return{}}connectedCallback(){super.connectedCallback(),w.setIndex()}render(){return l`
    <div>
    ...
    `}};customElements.define("about-page",ge);var jt=class{static loadingMode(t){return t===0?"auto":"none"}};var $e=class extends f{static get properties(){return{videos:{type:Object}}}connectedCallback(){super.connectedCallback(),w.setIndex()}videos(){return this.videos.videos()}render(){let t=this.videos().map((e,i)=>l`<app-video
      id=${e.id}
    ...
    `}};customElements.define("videos-page",$e);var be=class extends f{static get properties(){return{urn:{type:String},images:{type:Object},albums:{type:Object},triples:{type:Object}}}connectedCallback(){super.connectedCallback(),w.setIndex()}filterUrnImages(t,e){let i=[S.SUBJECT,S.LOCATION,S.RATING],r=dt(this.urn);r.id==="*"&&delete r.id;let o=e.search({target:r}).sources();return Array.from(o).flatMap(c=>t.filter(a=>a.id===c).slice(0,1))}renderSubjectPhotos(t,e){return this.filterUrnImages(t,e).sort((i,r)=>r.created_at-i.created_at).map((i,r)=>l`
      ...
      <section class="thing-page">
        ...
        <p>
          ${K.has(o)&&n.id!=="*"?l`<span class="thing-binomial">(${Z.pretty(n.id)})</span>`:l``}
        </p>
        <br>
