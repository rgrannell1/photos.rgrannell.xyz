var st = globalThis,
  Nt = st.ShadowRoot && (st.ShadyCSS === void 0 || st.ShadyCSS.nativeShadow) &&
  ...
  We = (i) => new Ot(typeof i == "string" ? i : i + "", void 0, Ue);
var qe = (i, t) => {
    if (Nt) {
      i.adoptedStyleSheets = t.map((e) =>
        ...
        let s = document.createElement("style"), r = st.litNonce;
  ...
  ut = globalThis,
  ue = ut.trustedTypes,
  ss = ue ? ue.emptyScript : "",
  is = ut.reactiveElementPolyfillSupport,
  F = (i, t) => i,
  Dt = {
    toAttribute(i, t) {
      switch (t) {
...
Symbol.metadata ??= Symbol("metadata"),
  ut.litPropertyMetadata ??= new WeakMap();
var P = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, s) {
    let { get: r, set: a } = Xe(this.prototype, t) ?? {
      get() {
        return this[e];
      },
      set(o) {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this.o(), this.hasOwnProperty(F("properties"))) {
      let e = this.properties, s = [...Qe(e), ...ts(e)];
  ...
  C(t, e) {
    let s = this.constructor.elementProperties.get(t),
      r = this.constructor.p(t, s);
    if (r !== void 0 && s.reflect === !0) {
      let a = (s.converter?.toAttribute !== void 0 ? s.converter : Dt)
  ...
  _$AK(t, e) {
    let s = this.constructor, r = s.u.get(t);
    if (r !== void 0 && this.m !== r) {
      let a = s.getPropertyOptions(r),
        o = typeof a.converter == "function"
          ? { fromAttribute: a.converter }
          : a.converter?.fromAttribute !== void 0
          ? a.converter
          : Dt;
      this.m = r, this[r] = o.fromAttribute(e, a.type), this.m = null;
    }
  }
  requestUpdate(t, e, s) {
    if (t !== void 0) {
  ...
  T(t, e, s) {
    this._$AL.has(t) || this._$AL.set(t, e),
      s.reflect === !0 && this.m !== t && (this.M ??= new Set()).add(t);
  }
  async A() {
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      if (this.renderRoot ??= this.createRenderRoot(), this.v) {
        for (let [r, a] of this.v) this[r] = a;
        this.v = void 0;
      }
      let s = this.constructor.elementProperties;
      if (s.size > 0) {
        for (let [r, a] of s) {
          a.wrapped !== !0 || this._$AL.has(r) || this[r] === void 0 ||
            this.T(r, this[r], a);
        }
      }
    }
...
P.elementStyles = [],
  ...
  P[F("elementProperties")] = new Map(),
  P[F("finalized")] = new Map(),
  is?.({ ReactiveElement: P }),
  (ut.reactiveElementVersions ??= []).push("2.0.4");
var It = globalThis,
  it = It.trustedTypes,
  ge = it ? it.createPolicy("lit-html", { createHTML: (i) => i }) : void 0,
  Bt = "$lit$",
  ...
  Me = Array.isArray,
  Ce = (i) => Me(i) || typeof i?.[Symbol.iterator] == "function",
  Mt = `[ 	
\f\r]`,
  Z = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
  fe = /-->/g,
...
\f\r"'\`<>=]|("|')|))|$)`,
  ...
  Oe = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }),
  c = Oe(1),
  as = Oe(2),
  y = Symbol.for("lit-noChange"),
  b = Symbol.for("lit-nothing"),
  ye = new WeakMap(),
  G = j.createTreeWalker(j, 129);
function De(i, t) {
...
var Pe = (i, t) => {
    let e = i.length - 1, s = [], r, a = t === 2 ? "<svg>" : "", o = Z;
    for (let h = 0; h < e; h++) {
      let n = i[h], m, f, p = -1, $ = 0;
      for (; $ < n.length && (o.lastIndex = $, f = o.exec(n), f !== null);) {
        $ = o.lastIndex,
          o === Z
            ? f[1] === "!--"
              ? o = fe
              ...
              ? o = $e
              : f[2] !== void 0
              ? (ke.test(f[2]) && (r = RegExp("</" + f[2], "g")), o = B)
              : f[3] !== void 0 && (o = B)
            : o === B
            ? f[0] === ">"
              ? (o = r ?? Z, p = -1)
              : f[1] === void 0
              ? p = -2
              : (p = o.lastIndex - f[2].length,
                m = f[1],
                o = f[3] === void 0 ? B : f[3] === '"' ? Ae : be)
            : o === Ae || o === be
            ? o = B
            : o === fe || o === $e
            ? o = Z
      ...
      let g = o === B && i[h + 1].startsWith("/>") ? " " : "";
      a += o === Z
        ? n + rs
        : p >= 0
        ? (s.push(m), n.slice(0, p) + Bt + n.slice(p) + k + g)
        : n + k + (p === -2 ? h : g);
    }
    return [De(i, a + (i[e] || "<?>") + (t === 2 ? "</svg>" : "")), s];
  },
  K = class i {
    constructor({ strings: t, _$litType$: e }, s) {
      let r;
      this.parts = [];
      let a = 0, o = 0, h = t.length - 1, n = this.parts, [m, f] = Pe(t, e);
      if (
        this.el = i.createElement(m, s),
      ...
      for (; (r = G.nextNode()) !== null && n.length < h;) {
        if (r.nodeType === 1) {
          if (r.hasAttributes()) {
            for (let p of r.getAttributeNames()) {
              if (p.endsWith(Bt)) {
                let $ = f[o++],
                  g = r.getAttribute(p).split(k),
                  _ = /([.?@])?(.*)/.exec($);
                n.push({
                  type: 1,
                  index: a,
                  ...
                  (n.push({ type: 6, index: a }), r.removeAttribute(p));}
            }
          }
          if (ke.test(r.tagName)) {
            let p = r.textContent.split(k), $ = p.length - 1;
            if ($ > 0) {
          ...
          if (r.data === Gt) n.push({ type: 2, index: a });
          else {
            let p = -1;
            for (; (p = r.data.indexOf(k, p + 1)) !== -1;) {
              n.push({ type: 7, index: a }), p += k.length - 1;
            }
          }
        }
        a++;
    ...
    static createElement(t, e) {
      let s = j.createElement("template");
      return s.innerHTML = t, s;
    }
  };
function H(i, t, e = i, s) {
  if (t === y) return t;
  let r = s !== void 0 ? e.U?.[s] : e.N, a = J(t) ? void 0 : t._$litDirective$;
  return r?.constructor !== a &&
    (r?._$AO?.(!1),
      a === void 0 ? r = void 0 : (r = new a(i), r._$AT(i, e, s)),
      s !== void 0 ? (e.U ??= [])[s] = r : e.N = r),
    r !== void 0 && (t = H(i, r._$AS(i, t.values), r, s)),
    t;
}
var rt = class {
    constructor(t, e) {
    ...
    O(t) {
      let { el: { content: e }, parts: s } = this._$AD,
        r = (t?.creationScope ?? j).importNode(e, !0);
      G.currentNode = r;
      let a = G.nextNode(), o = 0, h = 0, n = s[0];
      for (; n !== void 0;) {
        if (o === n.index) {
          let m;
          n.type === 2
            ? m = new mt(a, a.nextSibling, this, t)
            : n.type === 1
            ? m = new n.ctor(a, n.name, n.strings, this, t)
            : n.type === 6 && (m = new lt(a, this, t)),
            this._$AV.push(m),
            n = s[++h];
        }
        o !== n?.index && (a = G.nextNode(), o++);
      }
      return G.currentNode = j, r;
    }
    R(t) {
      let e = 0;
  ...
  mt = class Re {
    ...
    L(t) {
      this._$AH !== b && J(this._$AH)
        ? this._$AA.nextSibling.data = t
        : this.j(j.createTextNode(t)), this._$AH = t;
    }
    I(t) {
      let { values: e, _$litType$: s } = t,
        r = typeof s == "number" ? this._$AC(t) : (s.el === void 0 &&
          (s.el = K.createElement(De(s.h, s.h[0]), this.options)),
          s);
      if (this._$AH?._$AD === r) this._$AH.R(e);
      else {
        let a = new rt(r, this), o = a.O(this.options);
        a.R(e), this.j(o), this._$AH = a;
      }
    }
    _$AC(t) {
      let e = ye.get(t.strings);
      return e === void 0 && ye.set(t.strings, e = new K(t)), e;
    }
    D(t) {
      ...
      for (let a of t) {
        r === e.length
          ? e.push(s = new Re(this.H(q()), this.H(q()), this, this.options))
          : s = e[r],
          s._$AI(a),
          r++;
      }
  ...
  Y = class {
    ...
    _$AI(t, e = this, s, r) {
      let a = this.strings, o = !1;
      if (a === void 0) {
        t = H(this, t, e, 0),
          o = !J(t) || t !== this._$AH && t !== y,
          o && (this._$AH = t);
      } else {
        let h = t, n, m;
  ...
  nt = class extends Y {
    ...
    _$AI(t, e = this) {
      if ((t = H(this, t, e, 0) ?? b) === y) return;
      let s = this._$AH,
        r = t === b && s !== b || t.capture !== s.capture ||
  ...
  ns = It.litHtmlPolyfillSupport;
ns?.(K, mt), (It.litHtmlVersions ??= []).push("3.1.3");
var Ne = (i, t, e) => {
  let s = e?.renderBefore ?? t, r = s._$litPart$;
  if (r === void 0) {
    let a = e?.renderBefore ?? null;
    s._$litPart$ = r = new mt(t.insertBefore(q(), a), a, void 0, e ?? {});
  }
  return r._$AI(i), r;
};
var N = class extends P {
  ...
  update(t) {
    ...
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      super.update(t),
      this.ht = Ne(e, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
var ls = globalThis.litElementPolyfillSupport;
ls?.({ LitElement: N });
(globalThis.litElementVersions ??= []).push("4.0.5");
var { Y: cs } = os,
  hs = (i) => i === null || typeof i != "object" && typeof i != "function";
var _e = (i, t) =>
    t === void 0 ? i?._$litType$ !== void 0 : i?._$litType$ === t,
  ds = (i) => i?._$litType$?.h != null;
var Ie = (i) => i.strings === void 0,
  ve = () => document.createComment(""),
  R = (i, t, e) => {
    let s = i._$AA.parentNode, r = t === void 0 ? i._$AB : t._$AA;
    if (e === void 0) {
      let a = s.insertBefore(ve(), r), o = s.insertBefore(ve(), r);
      e = new cs(a, o, i, i.options);
    } else {
      let a = e._$AB.nextSibling, o = e._$AM, h = o !== i;
      if (h) {
        let n;
        e._$AQ?.(i),
          e._$AM = i,
          e._$AP !== void 0 && (n = i._$AU) !== o._$AU && e._$AP(n);
      }
      if (a !== r || h) {
        let n = e._$AA;
        for (; n !== a;) {
          let m = n.nextSibling;
          s.insertBefore(n, r), n = m;
        }
      }
    }
    return e;
  },
  D = (i, t, e = i) => (i._$AI(t, e), i),
  ps = {},
  X = (i, t = ps) => i._$AH = t,
  Pt = (i) => i._$AH,
  Ct = (i) => {
    i._$AP?.(!1, !0);
    let t = i._$AA, e = i._$AB.nextSibling;
    for (; t !== e;) {
      let s = t.nextSibling;
      t.remove(), t = s;
    }
...
var x = (i) => (...t) => ({ _$litDirective$: i, values: t }),
  M = class {
    constructor(t) {}
    get _$AU() {
      return this._$AM._$AU;
    ...
    _$AT(t, e, s) {
      this.nt = t, this._$AM = e, this.rt = s;
    }
    _$AS(t, e) {
...
var W = (i, t) => {
    ...
    for (let s of e) s._$AO?.(t, !1), W(s, t);
    return !0;
  },
  ct = (i) => {
    let t, e;
...
function us(i) {
  this._$AN !== void 0 ? (ct(this), this._$AM = i, Ge(this)) : this._$AM = i;
}
function ms(i, t = !1, e = 0) {
  let s = this._$AH, r = this._$AN;
  if (r !== void 0 && r.size !== 0) {
    if (t) {
      if (Array.isArray(s)) {
        for (let a = e; a < s.length; a++) W(s[a], !1), ct(s[a]);
      } else s != null && (W(s, !1), ct(s));
    } else W(this, i);
  }
}
var gs = (i) => {
    i.type == 2 && (i._$AP ??= ms, i._$AQ ??= us);
  },
  Q = class extends M {
    constructor() {
    ...
    _$AT(t, e, s) {
      super._$AT(t, e, s), Ge(this), this.isConnected = t._$AU;
    }
    _$AO(t, e = !0) {
      t !== this.isConnected &&
    ...
    setValue(t) {
      if (Ie(this.nt)) this.nt._$AI(t, this);
      else {
        let e = [...this.nt._$AH];
...
var pt = class extends Q {
    constructor() {
      super(...arguments), this.dt = new ht(this), this.ft = new dt();
    }
    render(t, e) {
      return y;
    }
    update(t, [e, s]) {
      if (this.isConnected || this.disconnected(), e === this.vt) return y;
      this.vt = e;
      let r = 0, { dt: a, ft: o } = this;
      return (async (h, n) => {
        for await (let m of h) if (await n(m) === !1) return;
      })(e, async (h) => {
        for (; o.get();) await o.get();
        let n = a.deref();
        if (n !== void 0) {
          if (n.vt !== e) return !1;
          s !== void 0 && (h = s(h, r)), n.commitValue(h, r), r++;
        }
        return !0;
      }),
        y;
  ...
  Ss = x(
    class extends pt {
      ...
      update(i, t) {
        return this.ht = i, super.update(i, t);
      }
      commitValue(i, t) {
        t === 0 && Be(this.ht);
        let e = R(this.ht);
  ...
  we = (i) => ds(i) ? i._$litType$.h : i.strings,
  Es = x(
    class extends M {
      constructor(i) {
        super(i), this.yt = new WeakMap();
      }
      render(i) {
        return [i];
      }
      update(i, [t]) {
        let e = _e(this.bt) ? we(this.bt) : null, s = _e(t) ? we(t) : null;
        if (e !== null && (s === null || e !== s)) {
          let r = Pt(i).pop(), a = this.yt.get(e);
          if (a === void 0) {
            let o = document.createDocumentFragment();
            a = Ne(b, o), a.setConnected(!1), this.yt.set(e, a);
          }
          X(a, [r]), R(a, void 0, r);
        }
        if (s !== null) {
...
var xs = x(
    class extends M {
      constructor(i) {
        if (
          super(i), i.type !== 1 || i.name !== "class" || i.strings?.length > 2
        ) {
          throw Error(
      ...
      update(i, [t]) {
        if (this.gt === void 0) {
          this.gt = new Set(),
            i.strings !== void 0 &&
            (this.wt = new Set(
              i.strings.join(" ").split(/\s/).filter((s) => s !== ""),
            ));
          for (let s in t) t[s] && !this.wt?.has(s) && this.gt.add(s);
          return this.render(t);
        }
        let e = i.element.classList;
        for (let s of this.gt) s in t || (e.remove(s), this.gt.delete(s));
        for (let s in t) {
          let r = !!t[s];
          r === this.gt.has(s) || this.wt?.has(s) ||
            (r ? (e.add(s), this.gt.add(s)) : (e.remove(s), this.gt.delete(s)));
        }
        return y;
      }
    },
      ...
      update(i, [t, e]) {
        if (Array.isArray(t)) {
          if (
            ...
            t.every((s, r) => s === this._t[r])
          ) return y;
        } else if (this._t === t) return y;
...
var Us = x(
    class extends M {
      ...
      update(i, [t, e]) {
        return t !== this.key && (X(i), this.key = t), e;
      }
    },
  ),
  Ls = x(
    class extends M {
      constructor(i) {
        if (super(i), i.type !== 3 && i.type !== 1 && i.type !== 4) {
          throw Error(
      ...
      update(i, [t]) {
        if (t === y || t === b) return t;
        let e = i.element, s = i.name;
        if (i.type === 3) {
          if (t === e[s]) return y;
          if (i.type === 4) {
            if (!!t === e.hasAttribute(s)) return y;
            if (i.type === 1 && e.getAttribute(s) === t + "") return y;
          }
        }
        return X(i), t;
      }
...
var kt = new WeakMap(),
    ...
    class extends Q {
      ...
      update(i, [t]) {
        ...
        return e && this.ct !== void 0 && this.St(void 0),
          (e || this.$t !== this.Tt) &&
          (this.ct = t,
            this.xt = i.options?.host,
            this.St(this.Tt = i.element)),
          b;
      }
      St(i) {
        if (typeof this.ct == "function") {
          let t = this.xt ?? globalThis, e = kt.get(t);
          e === void 0 && (e = new WeakMap(), kt.set(t, e)),
            e.get(this.ct) !== void 0 && this.ct.call(this.xt, void 0),
            e.set(this.ct, i),
            i !== void 0 && this.ct.call(this.xt, i);
        } else this.ct.value = i;
      }
      get $t() {
        return typeof this.ct == "function"
          ? kt.get(this.xt ?? globalThis)?.get(this.ct)
          : this.ct?.value;
      }
      disconnected() {
  ...
  Cs = x(
    class extends M {
      ...
      Et(i, t, e) {
        ...
        let r = [], a = [], o = 0;
        for (let h of i) r[o] = s ? s(h, o) : o, a[o] = e(h, o), o++;
        return { values: a, keys: r };
      }
      render(i, t, e) {
        return this.Et(i, t, e).values;
      }
      update(i, [t, e, s]) {
        let r = Pt(i), { values: a, keys: o } = this.Et(t, e, s);
        if (!Array.isArray(r)) return this.Ct = o, a;
        let h = this.Ct ??= [],
          n = [],
          m,
          f,
        ...
        for (; p <= $ && g <= _;) {
          ...
          else if (h[p] === o[g]) n[g] = D(r[p], a[g]), p++, g++;
          else if (h[$] === o[_]) n[_] = D(r[$], a[_]), $--, _--;
          else if (h[p] === o[_]) {
            n[_] = D(r[p], a[_]), R(i, n[_ + 1], r[p]), p++, _--;
          } else if (h[$] === o[g]) {
            n[g] = D(r[$], a[g]), R(i, r[p], r[$]), $--, g++;
          } else if (
            m === void 0 && (m = Se(o, g, _), f = Se(h, p, $)), m.has(h[p])
          ) {
            if (m.has(h[$])) {
              let C = f.get(o[g]), z = C !== void 0 ? r[C] : null;
              if (z === null) {
                let he = R(i, r[p]);
                D(he, a[g]), n[g] = he;
              } else n[g] = D(z, a[g]), R(i, r[p], z), r[C] = null;
              g++;
            } else Ct(r[$]), $--;
          } else Ct(r[p]), p++;
        }
  ...
  ks = x(
    class extends M {
      constructor(i) {
        if (
          super(i), i.type !== 1 || i.name !== "style" || i.strings?.length > 2
        ) {
          throw Error(
      ...
      update(i, [t]) {
        let { style: e } = i.element;
        if (this.Pt === void 0) {
          return this.Pt = new Set(Object.keys(t)), this.render(t);
        }
        for (let s of this.Pt) {
          t[s] == null &&
            (this.Pt.delete(s),
              s.includes("-") ? e.removeProperty(s) : e[s] = null);
        }
        for (let s in t) {
          let r = t[s];
          if (r != null) {
            this.Pt.add(s);
            let a = typeof r == "string" && r.endsWith($s);
            s.includes("-") || a
              ? e.setProperty(s, a ? r.slice(0, -11) : r, a ? je : "")
              : e[s] = r;
          }
        }
        return y;
  ...
  Os = x(
    class extends M {
      ...
      render(i) {
        return this.At === i
          ? y
          : (this.At = i, document.importNode(i.content, !0));
      }
    },
  ),
  V = class extends M {
    constructor(t) {
      if (super(t), this.bt = b, t.type !== 2) {
        throw Error(
    ...
    render(t) {
      if (t === b || t == null) return this.kt = void 0, this.bt = t;
      if (t === y) return t;
      if (typeof t != "string") {
        throw Error(
...
tt.directiveName = "unsafeSVG", tt.resultType = 2;
var Ds = x(tt),
  Ee = (i) => !hs(i) && typeof i.then == "function",
  xe = 1073741823;
var Rt = class extends Q {
    ...
    render(...t) {
      return t.find((e) => !Ee(e)) ?? y;
    }
    update(t, e) {
      let s = this.Ut, r = s.length;
      this.Ut = e;
      let a = this.dt, o = this.ft;
      this.isConnected || this.disconnected();
      for (let h = 0; h < e.length && !(h > this.Mt); h++) {
        let n = e[h];
        if (!Ee(n)) return this.Mt = h, n;
        h < r && n === s[h] ||
          (this.Mt = xe,
            r = 0,
            Promise.resolve(n).then(async (m) => {
              for (; o.get();) await o.get();
              let f = a.deref();
              if (f !== void 0) {
                let p = f.Ut.indexOf(n);
                p > -1 && p < f.Mt && (f.Mt = p, f.setValue(m));
              }
            }));
      }
      return y;
...
var bs = Symbol.for(""),
  As = (i) => {
    if (i?.r === bs) return i?._$litStatic$;
  };
var Te = new Map(),
  He = (i) => (t, ...e) => {
    let s = e.length, r, a, o = [], h = [], n, m = 0, f = !1;
    for (; m < s;) {
      for (n = t[m]; m < s && (a = e[m], (r = As(a)) !== void 0);) {
        n += r + t[++m], f = !0;
      }
      m !== s && h.push(a), o.push(n), m++;
    }
    if (m === s && o.push(t[s]), f) {
      let p = o.join("$$lit$$");
      (t = Te.get(p)) === void 0 && (o.raw = o, Te.set(p, t = o)), e = h;
    }
    return i(t, ...e);
  },
  Rs = He(c),
...
var ft = Symbol("the albums manifest"),
  $t = Symbol("the images manifest"),
  Ks = Symbol("the site manifest"),
  bt = Symbol("metadata about the site manifest"),
  At = Symbol("the videos manifest"),
  yt = Symbol("the exif data"),
  _t = Symbol("the semantic data"),
  Ye = 53.33306,
  Ve = -6.24889,
  ze = 6,
  Ze = "photos",
...
async function ys(i = "/manifest/env.json") {
  return await (await fetch(i)).json();
}
var et = await ys(),
  vt = class {
    _data;
    constructor(t = `/manifest/images.${et.publication_id}.json`) {
      this.url = t;
    }
    processImages(t) {
      let e = t[0], s = [];
      for (let r of t.slice(1)) {
        let a = {};
        for (let o = 0; o < e.length; o++) a[e[o]] = r[o];
        s.push(a);
      }
      return s;
    }
    async init() {
      if (window[$t] && (this._data = window[$t]), this._data || this.loading) {
        return;
      }
      console.log(`\u{1F50E} fetching ${this.url}`);
      let t = await (await fetch(this.url)).json(), e = this.processImages(t);
      window[$t] = e, this._data = e;
    }
    images() {
      return this._data.map((t) => ({
        ...
        thumbnail_mosaic_url: `data:image/bmp;base64,${t.thumbnail_mosaic_url}`,
      }));
    }
  },
  wt = class {
    _data;
    constructor(t = `/manifest/videos.${et.publication_id}.json`) {
      this.url = t;
    }
    processVideos(t) {
      let e = t[0], s = [];
    ...
    async init() {
      if (window[At] && (this._data = window[At]), this._data || this.loading) {
        return;
      }
      console.log(`\u{1F50E} fetching ${this.url}`);
      let t = await (await fetch(this.url)).json(), e = this.processVideos(t);
      window[At] = e, this._data = e;
    }
    videos() {
      return this._data.map((t) => ({
        ...t,
  ...
  St = class {
    _data;
    constructor(t = `/manifest/albums.${et.publication_id}.json`) {
      this.url = t;
    }
    process(t) {
      let e = t[0], s = [];
    ...
    async init() {
      if (window[ft] && (this._data = window[ft]), this._data) return;
      console.log(`\u{1F50E} fetching ${this.url}`);
      let t = await (await fetch(this.url)).json(), e = this.process(t);
      window[ft] = e, this._data = e;
    }
    albums() {
      return this._data.map((t) => ({
        ...t,
  ...
  Et = class {
    _data;
    constructor(t = `/manifest/exif.${et.publication_id}.json`) {
      this.url = t;
    }
    process(t) {
      let e = t[0], s = [];
    ...
    async init() {
      if (window[yt] && (this._data = window[yt]), this._data) return;
      console.log(`\u{1F50E} fetching ${this.url}`);
      let t = await (await fetch(this.url)).json(), e = this.process(t);
      window[yt] = e, this._data = e;
    }
    exif() {
      return this._data;
    }
...
var xt = class {
    _data;
    constructor(t = `/manifest/semantic.${et.publication_id}.json`) {
      this.url = t;
    }
    async init() {
      if (window[_t] && (this._data = window[_t]), this._data) return;
      console.log(`\u{1F50E} fetching ${this.url}`);
      let t = await (await fetch(this.url)).json();
      window[_t] = t, this._data = t;
    }
    semantic() {
      return this._data;
    }
  ...
  Tt = class {
    _data;
    constructor(t = "/manifest/metadata.json") {
      this.url = t;
    }
    async init() {
      if (window[bt] && (this._data = window[bt]), this._data) return;
      console.log(`\u{1F50E} fetching ${this.url}`);
      let t = await (await fetch(this.url)).json();
      window[bt] = t, this._data = t;
    }
    metadata() {
      return this._data;
    }
    ...
    childrenOf(t, e) {
      let s = new Set([]);
      for (let r of e) this.isChild(t, r) && s.add(r);
      return s;
    }
  };
var v = class {
  ...
  static showDateUrl(t) {
    window.location.hash = `#/date/${t}`, document.title = "Date - photos";
  }
  static showLocationsUrl() {
    window.location.hash = "#/locations", document.title = "Locations - photos";
  }
  static showTagsUrl() {
    window.location.hash = "#/tags", document.title = "Tags - photos";
  }
  static showStatsUrl() {
    window.location.hash = "#/stats", document.title = "Stats - photos";
  }
  static showMetadataUrl(t) {
    window.location.hash = `#/metadata/${t}`,
      document.title = "Metadata - photos";
  }
  static showTagAlbumUrl(t) {
  ...
  static getUrl() {
    return window.location.hash.startsWith("#/albums")
      ...
      : window.location.hash.startsWith("#/locations")
      ? { type: "locations" }
      : window.location.hash.startsWith("#/tags")
      ? { type: "tags" }
      : window.location.hash.startsWith("#/tag")
      ? {
        type: "tag-album",
      ...
      : window.location.hash.startsWith("#/date")
      ? { type: "date", date: window.location.hash.split("/")[2] }
...
customElements.define("photo-sidebar", jt);
var Ht = class extends u {
  static get properties() {
    return { darkMode: { type: Boolean }, tag: { type: String } };
  }
  feedUrl() {
    return this.tag ? `/feeds/tags/${this.tag}.json` : "/manifest/feed.json";
  }
  render() {
    let t = this.darkMode ? "\u2600\uFE0F" : "\u{1F319}", e = Ze;
    return c`
...
customElements.define("photo-header", Ht);
...
customElements.define("app-photo", Yt);
...
customElements.define("search-bar", Vt);
var I = class {
...
var A = class {
  ...
  static setTag(t) {
    ...
    if (!e || !t) return;
    let s = `/feeds/tags/${t}.json`;
    e.href = s;
  }
  static setIndex() {
    let t = this.getElement();
    if (!t) return;
    let e = "/manifest/feed.json";
    t.href = e;
  }
};
var zt = class extends u {
  ...
  connectedCallback() {
    super.connectedCallback(), A.setIndex();
  }
  allImages() {
    return this.images.images();
  }
  render() {
    let t = this.allImages().map((e, s) =>
      c`
      <app-photo
        id=${e.id}
        tags="${e.tags}"
...
customElements.define("photos-page", zt);
var O = class i {
  static parse(t) {
    let [e, s] = t.split(" ");
  ...
  static dateRange(t, e, s) {
    ...
    let r = t instanceof Date ? t : new Date(parseFloat(t)),
      a = e instanceof Date ? e : new Date(parseFloat(e));
    if (s) {
      let o = { day: "numeric", month: "short" },
        h = r.toLocaleDateString("en-IE", o),
        n = a.toLocaleDateString("en-IE", o),
        m = r.toLocaleDateString("en-IE", { day: "numeric" }),
        f = a.toLocaleDateString("en-IE", { day: "numeric" }),
        p = r.toLocaleDateString("en-IE", { month: "short" }),
        $ = a.toLocaleDateString("en-IE", { month: "short" }),
        g = r.getFullYear(),
        _ = a.getFullYear(),
        C = p === $,
        z = g === _;
...
var Zt = class extends u {
  ...
  dateRange() {
    ...
    return O.dateRange(this.minDate, this.maxDate, t.matches);
  }
  hidePlaceholder(t) {
...
customElements.define("photo-album", Zt);
var Ft = class extends u {
  static get properties() {
    return { albums: { type: Object } };
  }
  connectedCallback() {
    super.connectedCallback(), A.setIndex();
  }
  getAlbums() {
    return Object.values(this.albums.albums()).map((t) => {
      ...
      return {
        ...
        maxDate: t.max_date,
        url: t.thumbnail_url,
        thumbnailDataUrl: `data:image/bmp;base64,${t.thumbnail_mosaic_url}`,
        id: t.id,
        count: e,
        flags: (t.flags ?? "").split(","),
      };
  ...
  imageCount() {
    let t = 0;
    for (let e of this.getAlbums()) t += e.count;
    return t;
  }
  loadingMode(t) {
    let e = window.innerWidth,
      ...
      a = Math.floor(e / r),
      o = Math.floor(s / r);
    return t > a * o ? "lazy" : "eager";
  }
  render() {
    return performance.mark("start-albums-render"),
      c`
    ...
    <section class="album-container">
      ${
        this.getAlbums().sort((t, e) => e.maxDate - t.maxDate).map((t, e) => {
          let s = this.loadingMode(e);
          return c`
            <photo-album
              title="${t.title}"
              url="${t.url}"
...
customElements.define("photo-album-page", Ft);
var Wt = class extends u {
  ...
  firstUpdated() {
    super.firstUpdated();
    let t = this.querySelector("#map"), e = createMap(t).setView([Ye, Ve], ze);
    e.addLayer(
      tileLayer("http://{s}.tile.osm.org/{z}/{x}/{y}.png", { minZoom: 4 }),
    );
    let r = this.albums.albums();
...
customElements.define("locations-page", Wt);
...
customElements.define("app-video", qt);
var Jt = class extends u {
  static get properties() {
    return {
      title: { type: String },
  ...
  render() {
    return this.sharing
      ? c`<button class="photo-share-button" disabled>[sharing...]</button>`
      : c`
...
customElements.define("album-share-button", Jt);
var Ut = class i {
  static setXTheEverythingAppFormallyKnownAsTwitter(t) {
    let e = document.querySelector('meta[property="twitter:url"]');
    e.setAttribute("content", t.url),
  ...
  static set(t) {
    i.setXTheEverythingAppFormallyKnownAsTwitter(t), i.setOpenGraph(t);
  }
};
var Kt = class extends u {
  ...
  connectedCallback() {
    ...
    let t = this.albumPhotos()[0];
    t || console.error(`empty album! ${this.id}`),
      Ut.set({
  ...
  albumPhotos() {
    return this.images.images().filter((t) => t.album_id === this.id);
  }
  albumVideos() {
    return this.videos.videos().filter((t) => t.album_id === this.id);
  }
  renderPhotoCount() {
  ...
  render() {
    let t = window.matchMedia("(max-width: 500px)"),
      e = O.dateRange(this.minDate, this.maxDate, t.matches),
      s = this.albumPhotos().map((a, o) =>
        c`
      <app-photo
        id=${a.id}
        tags="${a.tags}"
...
customElements.define("album-page", Kt);
...
customElements.define("stats-page", Xt);
var Qt = class extends u {
  static get properties() {
    return { tag: { type: String }, images: { type: Object } };
  }
  connectedCallback() {
    super.connectedCallback(), A.setTag(this.tag);
  }
  photos() {
    return this.images.images().filter((t) => t.tags.includes(this.tag));
  }
  imageCount() {
  ...
  render() {
    let t = window.matchMedia("(max-width: 500px)"),
      [e, s] = O.findRange(this.photos()),
      r = O.dateRange(e, s, t.matches);
    return c`
    <div>
      <section class="photos-metadata">
        <h1>${this.tag}</h1>
...
customElements.define("tag-page", Qt);
var te = class extends u {
  static get properties() {
    return { tagName: { type: String }, count: { type: Number } };
  }
  render() {
    let { tagName: t, count: e } = this, s = encodeURIComponent(t);
    return typeof e > "u"
      ? c`<a
        href="#/tag/${s}"
...
customElements.define("tag-link", te);
var ee = class extends u {
  ...
  render() {
    let { tagName: t } = this;
    return c`<div class="photo-album">
      <img class="thumbnail-image thumbnail-placeholder" width="400" height="400" src="${this.thumbnailDataUrl}"/>
      ...
      this?.links?.wikipedia
        ? c`<a href="${this.links.wikipedia}">[wiki]</a>`
        : ""
    }
      ${
      this?.links?.birdwatch
        ? c`<a href="${this.links.birdwatch}">[birdwatch]</a>`
        : ""
    }
    </div>`;
  }
};
customElements.define("tag-album", ee);
var se = class extends u {
  static get properties() {
    return { images: { type: Object }, metadata: { type: Object } };
  }
  connectedCallback() {
    super.connectedCallback(), A.setIndex();
  }
  tags() {
    let t = {};
    for (let e of this.images.images()) {
      for (let s of e.tags) t[s] || (t[s] = 0), t[s]++;
    }
    return Object.entries(t).toSorted((e, s) => e[0].localeCompare(s[0]));
  }
  renderTagLink(t) {
    return c`<li>
  ...
  tagCover(t) {
    return this.images.images().filter((s) => s.tags.includes(t))[0];
  }
  tagLinks(t) {
    return this.metadata[t]?.links;
  }
  renderTagCover(t) {
    let e = this.tagCover(t), s = this.tagLinks(t);
    if (!e) {
      console.error(`No cover image for tag: ${t}`);
      return;
    }
    return c`<tag-album url="${e.thumbnail_url}" thumbnailDataUrl="${e.thumbnail_mosaic_url}" tagName=${t} .links=${s}>`;
  }
  tagsFamily(t, e) {
    let s = new Set(t._data[e].children);
...
customElements.define("tags-page", se);
...
customElements.define("share-metadata-button", ie);
var re = class extends u {
  ...
  renderAperture() {
    return this.exif.f_stop === "Unknown"
      ? c`<td>Unknown aperture</td>`
      : this.exif.f_stop === "0.0"
      ? c`<td>Manual aperture control</td>`
      : c`<td>ƒ/${this.exif.f_stop}</td>`;
  }
  renderFocalLength() {
    return this.exif.focal_length === "Unknown"
      ? c`${this.exif.focal_length}`
      : this.exif.focal_length === "0"
      ? c`<td>Manual lens</td>`
      : c`<td>${this.exif.focal_length}mm equiv.</td>`;
  }
  renderSemanticKey(t) {
    return t.replace(/_/g, " ").replace(/\b\w/g, (e) => e.toUpperCase());
  }
  renderSemanticValue(t, e) {
    return t.includes("binomial") ? c`<em>${e}</em>` : e;
  }
  ...
  render() {
    let t = this.image, e = this.exif, s = this.semantic;
    return c`
    <section>
    <h1>Metadata</h1>
    ...
    <table class="metadata-table">
      ...
      <tr>
        ...
        <td>1/${
      e.exposure_time ? Math.round(1 / e.exposure_time) : "Unknown"
    }</td>
      </tr>
      <tr>
...
customElements.define("metadata-page", re);
var ae = class extends u {
  static get properties() {
    return { date: { type: String }, images: { type: Object } };
  }
  connectedCallback() {
    super.connectedCallback(), A.setIndex();
  }
  datePhotos() {
    return this.images.images().filter((t) => {
      if (!t.created_at) return !1;
      let [e] = t.created_at.split(" ");
      return e.replace(/\:/g, "-") === this.date;
    });
  }
  render() {
    let t = this.datePhotos().map((e, s) =>
      c`
      <app-photo
        id=${e.id}
        tags="${e.tags}"
...
customElements.define("date-page", ae);
...
customElements.define("about-page", oe);
var Lt = class {
  static loadingMode(t) {
    let e = window.innerWidth,
      s = window.innerHeight,
...
var S = new St(),
  ...
  U = new Et(),
  L = new xt(),
  _s = [[S, l.EAGER], [w, l.EAGER], [E, l.EAGER], [T, l.EAGER], [U, l.EAGER], [
    L,
    l.EAGER,
  ]],
  vs = {
    ...
    [d.ALBUMS]: [[S, l.EAGER], [w, l.LAZY], [E, l.LAZY], [T, l.LAZY], [
      U,
      l.LAZY,
    ], [L, l.LAZY]],
    [d.PHOTOS]: [[S, l.EAGER], [w, l.EAGER], [E, l.EAGER], [T, l.LAZY], [
      U,
      l.LAZY,
    ], [L, l.LAZY]],
    [d.VIDEOS]: [[S, l.LAZY], [w, l.LAZY], [E, l.EAGER], [T, l.LAZY], [
      U,
      l.LAZY,
    ], [L, l.LAZY]],
    [d.ALBUM]: [[S, l.EAGER], [w, l.EAGER], [E, l.EAGER], [T, l.LAZY], [
      U,
      l.LAZY,
    ], [L, l.LAZY]],
    [d.PHOTO]: [[S, l.EAGER], [w, l.EAGER], [E, l.EAGER], [T, l.LAZY], [
      U,
      l.EAGER,
    ], [L, l.EAGER]],
    [d.DATE]: [[S, l.EAGER], [w, l.EAGER], [E, l.EAGER], [T, l.LAZY], [
      U,
      l.LAZY,
    ], [L, l.LAZY]],
    [d.TAG_ALBUM]: [[S, l.LAZY], [w, l.EAGER], [E, l.EAGER], [T, l.LAZY], [
      U,
      l.EAGER,
    ], [L, l.EAGER]],
    [d.TAG]: [[S, l.LAZY], [w, l.EAGER], [E, l.EAGER], [T, l.LAZY], [
      U,
      l.EAGER,
    ], [L, l.EAGER]],
    [d.LOCATIONS]: [[S, l.EAGER], [w, l.LAZY], [E, l.LAZY], [T, l.LAZY], [
      U,
      l.EAGER,
    ], [L, l.EAGER]],
    [d.METADATA]: [[S, l.LAZY], [w, l.EAGER], [E, l.EAGER], [T, l.EAGER], [
      U,
      l.EAGER,
    ], [L, l.EAGER]],
    [d.STATS]: [[S, l.LAZY], [w, l.LAZY], [E, l.LAZY], [T, l.LAZY], [
      U,
      l.EAGER,
    ], [L, l.EAGER]],
  },
  le = class {
    static async init() {
      ...
      let e = vs[t?.type] ?? _s, s = [];
      for (let [r, a] of e) {
        a === l.EAGER ? s.push(r.init()) : a === l.LAZY && r.init();
      }
      await Promise.all(s);
    }
  };
await le.init();
var ce = class i extends u {
  static DEFAULT_PAGE = d.ALBUMS;
  static LOCATION_TYPE_TO_PAGE = {
    album: d.ALBUM,
    albums: d.ALBUMS,
    photos: d.PHOTOS,
    date: d.DATE,
    "tag-album": d.TAG_ALBUM,
    tags: d.TAGS,
  ...
  setStateFromUrl() {
    let t = v.getUrl();
    i.LOCATION_TYPE_TO_PAGE[t?.type]
      ? this.page = i.LOCATION_TYPE_TO_PAGE[t.type]
      : (console.error("did not match pagetype", t?.type),
        this.page = i.DEFAULT_PAGE),
      this.page === d.METADATA || this.page === d.ALBUM ||
        this.page === d.METADATA
        ? this.id = t.id
        : this.page === d.TAG_ALBUM
        ? this.tag = t.tag
        : this.page === d.DATE && (this.date = t.date);
  }
  receiveClickAlbum(t) {
    let { title: e, id: s } = t.detail;
    this.page = d.PHOTOS, this.id = s, this.title = e, v.showAlbumUrl(s);
  }
  async receiveClickTag(t) {
    let { tagName: e } = t.detail;
    this.page = d.TAG_ALBUM, this.tag = e, v.showTagAlbumUrl(e);
  }
  async receiveClickBurgerMenu() {
    this.sidebarVisible = !this.sidebarVisible;
  }
  async receiveClickPhotoMetadata(t) {
    let { id: e, imageUrl: s, thumbnailUrl: r, tags: a } = t.detail;
    this.page = d.METADATA,
      this.id = e,
      this.imageUrl = s,
      this.thumbnailUrl = r,
  ...
  receiveNavigatePage(t) {
    this.page = t.detail.page,
      this.page === d.ABOUT
        ...
        : this.page === d.TAGS
        ? v.showTagsUrl()
        : this.page === d.LOCATIONS
        ? v.showLocationsUrl()
        : this.page === d.STATS
        ? v.showStatsUrl()
        : this.page === d.PHOTOS
        ? v.showAlbumUrl(this.id)
        : this.page === d.METADATA
        ? v.showMetadataUrl(this.id)
        : this.page === d.DATE
        ? v.showDateUrl(this.date)
        : this.page === d.VIDEOS
        ? v.showVideosUrl()
        : v.showAlbumsUrl(),
      this.sidebarVisible = !1;
  ...
  renderPage(t) {
    let e = ["page"];
    if (t && e.push("sidebar-visible"), !this.page || this.page === "albums") {
      return c`
      <photo-album-page .albums="${S}" class="${
        e.join(" ")
      }"></photo-album-page>
      `;
    }
    if (this.page === d.ABOUT) {
      return c`<about-page class="${e.join(" ")}"></about-page>`;
    }
    if (this.page === d.PHOTOS) {
      return c`<photos-page class="${e.join(" ")}" .images=${w}></photos-page>`;
    }
    if (this.page === d.ALBUM) {
      this.id || console.error("no album id provided");
      let s = S.albums().find((r) => r.id === this.id);
    ...
    if (this.page === d.LOCATIONS) {
      return c`
      <locations-page .albums="${S}" class="${e.join(" ")}"></locations-page>
      `;
    }
    if (this.page === d.STATS) {
      return c`
      <stats-page class="${e.join(" ")}"></stats-page>
      `;
    }
    if (this.page === d.METADATA) {
      let s = w.images().find((h) => h.id === this.id),
        r = U.exif().find((h) => h.id === this.id),
        a = L.semantic().filter((h) => h[0] === this.id),
        o = {};
      for (let [h, n, m] of a) {
        o[n] ? typeof o[n] == "string" && (o[n] = [o[n], m]) : o[n] = m;
      }
      return s || console.error(`failed to find photo with id ${this.id}`),
        c`
      <metadata-page .image=${s} .semantic=${o} .exif=${r} id=${this.id} class="${
          e.join(" ")
        }"></metadata-page>
      `;
    }
    if (this.page === d.VIDEOS) {
      return c`
...
customElements.define("photo-app", ce);
export { _s as DEFAULT_DEPENDENCIES, ce as PhotoApp, vs as PAGE_DEPENDECIES };
/**
 * @license
