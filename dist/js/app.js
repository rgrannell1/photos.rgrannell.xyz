var lt=globalThis,kt=lt.ShadowRoot&&(lt.ShadyCSS===void 0||lt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ae=Symbol(),oe=new WeakMap,Et=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==Ae)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.i,e=this.t;if(kt&&t===void 0){let s=e!==void 0&&e.length===1;s&&(t=oe.get(e)),t===void 0&&((this.i=t=new CSSStyleSheet).replaceSync(this.cssText),s&&oe.set(e,t))}return t}toString(){return this.cssText}},Ye=i=>new Et(typeof i=="string"?i:i+"",void 0,Ae);var Qe=(i,t)=>{if(kt)i.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(let e of t){let s=document.createElement("style"),r=lt.litNonce;r!==void 0&&s.setAttribute("nonce",r),s.textContent=e.cssText,i.appendChild(s)}},ae=kt?i=>i:i=>i instanceof CSSStyleSheet?(t=>{let e="";for(let s of t.cssRules)e+=s.cssText;return Ye(e)})(i):i,{is:Ke,defineProperty:Je,getOwnPropertyDescriptor:Xe,getOwnPropertyNames:Ze,getOwnPropertySymbols:ts,getPrototypeOf:es}=Object,yt=globalThis,le=yt.trustedTypes,ss=le?le.emptyScript:"",is=yt.reactiveElementPolyfillSupport,Z=(i,t)=>i,Ct={toAttribute(i,t){switch(t){case Boolean:i=i?ss:null;break;case Object:case Array:i=i==null?i:JSON.stringify(i)}return i},fromAttribute(i,t){let e=i;switch(t){case Boolean:e=i!==null;break;case Number:e=i===null?null:Number(i);break;case Object:case Array:try{e=JSON.parse(i)}catch{e=null}}return e}},xe=(i,t)=>!Ke(i,t),ce={attribute:!0,type:String,converter:Ct,reflect:!1,useDefault:!1,hasChanged:xe};Symbol.metadata??=Symbol("metadata"),yt.litPropertyMetadata??=new WeakMap;var P=class extends HTMLElement{static addInitializer(t){this.o(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this.u&&[...this.u.keys()]}static createProperty(t,e=ce){if(e.state&&(e.attribute=!1),this.o(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){let s=Symbol(),r=this.getPropertyDescriptor(t,s,e);r!==void 0&&Je(this.prototype,t,r)}}static getPropertyDescriptor(t,e,s){let{get:r,set:n}=Xe(this.prototype,t)??{get(){return this[e]},set(o){this[e]=o}};return{get:r,set(o){let h=r?.call(this);n?.call(this,o),this.requestUpdate(t,h,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??ce}static o(){if(this.hasOwnProperty(Z("elementProperties")))return;let t=es(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(Z("finalized")))return;if(this.finalized=!0,this.o(),this.hasOwnProperty(Z("properties"))){let e=this.properties,s=[...Ze(e),...ts(e)];for(let r of s)this.createProperty(r,e[r])}let t=this[Symbol.metadata];if(t!==null){let e=litPropertyMetadata.get(t);if(e!==void 0)for(let[s,r]of e)this.elementProperties.set(s,r)}this.u=new Map;for(let[e,s]of this.elementProperties){let r=this.p(e,s);r!==void 0&&this.u.set(r,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let e=[];if(Array.isArray(t)){let s=new Set(t.flat(1/0).reverse());for(let r of s)e.unshift(ae(r))}else t!==void 0&&e.push(ae(t));return e}static p(t,e){let s=e.attribute;return s===!1?void 0:typeof s=="string"?s:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this.v=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this.m=null,this._()}_(){this.S=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this.$(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this.P??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this.P?.delete(t)}$(){let t=new Map,e=this.constructor.elementProperties;for(let s of e.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this.v=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Qe(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this.P?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this.P?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,s){this._$AK(t,s)}C(t,e){let s=this.constructor.elementProperties.get(t),r=this.constructor.p(t,s);if(r!==void 0&&s.reflect===!0){let n=(s.converter?.toAttribute!==void 0?s.converter:Ct).toAttribute(e,s.type);this.m=t,n==null?this.removeAttribute(r):this.setAttribute(r,n),this.m=null}}_$AK(t,e){let s=this.constructor,r=s.u.get(t);if(r!==void 0&&this.m!==r){let n=s.getPropertyOptions(r),o=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:Ct;this.m=r;let h=o.fromAttribute(e,n.type);this[r]=h??this.T?.get(r)??h,this.m=null}}requestUpdate(t,e,s){if(t!==void 0){let r=this.constructor,n=this[t];if(s??=r.getPropertyOptions(t),!((s.hasChanged??xe)(n,e)||s.useDefault&&s.reflect&&n===this.T?.get(t)&&!this.hasAttribute(r.p(t,s))))return;this.M(t,e,s)}this.isUpdatePending===!1&&(this.S=this.k())}M(t,e,{useDefault:s,reflect:r,wrapped:n},o){s&&!(this.T??=new Map).has(t)&&(this.T.set(t,o??e??this[t]),n!==!0||o!==void 0)||(this._$AL.has(t)||(this.hasUpdated||s||(e=void 0),this._$AL.set(t,e)),r===!0&&this.m!==t&&(this.A??=new Set).add(t))}async k(){this.isUpdatePending=!0;try{await this.S}catch(e){Promise.reject(e)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this.v){for(let[r,n]of this.v)this[r]=n;this.v=void 0}let s=this.constructor.elementProperties;if(s.size>0)for(let[r,n]of s){let{wrapped:o}=n,h=this[r];o!==!0||this._$AL.has(r)||h===void 0||this.M(r,void 0,n,h)}}let t=!1,e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this.P?.forEach(s=>s.hostUpdate?.()),this.update(e)):this.U()}catch(s){throw t=!1,this.U(),s}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this.P?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}U(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this.S}shouldUpdate(t){return!0}update(t){this.A&&=this.A.forEach(e=>this.C(e,this[e])),this.U()}updated(t){}firstUpdated(t){}};P.elementStyles=[],P.shadowRootOptions={mode:"open"},P[Z("elementProperties")]=new Map,P[Z("finalized")]=new Map,is?.({ReactiveElement:P}),(yt.reactiveElementVersions??=[]).push("2.1.1");var Dt=globalThis,ct=Dt.trustedTypes,he=ct?ct.createPolicy("lit-html",{createHTML:i=>i}):void 0,Rt="$lit$",M=`lit$${Math.random().toFixed(9).slice(2)}$`,Pt="?"+M,rs=`<${Pt}>`,V=document,et=()=>V.createComment(""),st=i=>i===null||typeof i!="object"&&typeof i!="function",Lt=Array.isArray,_e=i=>Lt(i)||typeof i?.[Symbol.iterator]=="function",Tt=`[ 	
\f\r]`,X=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,de=/-->/g,pe=/>/g,j=RegExp(`>|${Tt}(?:([^\\s"'>=/]+)(${Tt}*=${Tt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ue=/'/g,me=/"/g,Te=/^(?:script|style|textarea|title)$/i,Nt=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),l=Nt(1),ns=Nt(2),Es=Nt(3),x=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),fe=new WeakMap,H=V.createTreeWalker(V,129);function Ie(i,t){if(!Lt(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return he!==void 0?he.createHTML(t):t}var Ue=(i,t)=>{let e=i.length-1,s=[],r,n=t===2?"<svg>":t===3?"<math>":"",o=X;for(let h=0;h<e;h++){let a=i[h],c,p,d=-1,m=0;for(;m<a.length&&(o.lastIndex=m,p=o.exec(a),p!==null);)m=o.lastIndex,o===X?p[1]==="!--"?o=de:p[1]!==void 0?o=pe:p[2]!==void 0?(Te.test(p[2])&&(r=RegExp("</"+p[2],"g")),o=j):p[3]!==void 0&&(o=j):o===j?p[0]===">"?(o=r??X,d=-1):p[1]===void 0?d=-2:(d=o.lastIndex-p[2].length,c=p[1],o=p[3]===void 0?j:p[3]==='"'?me:ue):o===me||o===ue?o=j:o===de||o===pe?o=X:(o=j,r=void 0);let u=o===j&&i[h+1].startsWith("/>")?" ":"";n+=o===X?a+rs:d>=0?(s.push(c),a.slice(0,d)+Rt+a.slice(d)+M+u):a+M+(d===-2?h:u)}return[Ie(i,n+(i[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]},it=class i{constructor({strings:t,_$litType$:e},s){let r;this.parts=[];let n=0,o=0,h=t.length-1,a=this.parts,[c,p]=Ue(t,e);if(this.el=i.createElement(c,s),H.currentNode=this.el.content,e===2||e===3){let d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(r=H.nextNode())!==null&&a.length<h;){if(r.nodeType===1){if(r.hasAttributes())for(let d of r.getAttributeNames())if(d.endsWith(Rt)){let m=p[o++],u=r.getAttribute(d).split(M),b=/([.?@])?(.*)/.exec(m);a.push({type:1,index:n,name:b[2],strings:u,ctor:b[1]==="."?dt:b[1]==="?"?pt:b[1]==="@"?ut:z}),r.removeAttribute(d)}else d.startsWith(M)&&(a.push({type:6,index:n}),r.removeAttribute(d));if(Te.test(r.tagName)){let d=r.textContent.split(M),m=d.length-1;if(m>0){r.textContent=ct?ct.emptyScript:"";for(let u=0;u<m;u++)r.append(d[u],et()),H.nextNode(),a.push({type:2,index:++n});r.append(d[m],et())}}}else if(r.nodeType===8)if(r.data===Pt)a.push({type:2,index:n});else{let d=-1;for(;(d=r.data.indexOf(M,d+1))!==-1;)a.push({type:7,index:n}),d+=M.length-1}n++}}static createElement(t,e){let s=V.createElement("template");return s.innerHTML=t,s}};function q(i,t,e=i,s){if(t===x)return t;let r=s!==void 0?e.N?.[s]:e.O,n=st(t)?void 0:t._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),n===void 0?r=void 0:(r=new n(i),r._$AT(i,e,s)),s!==void 0?(e.N??=[])[s]=r:e.O=r),r!==void 0&&(t=q(i,r._$AS(i,t.values),r,s)),t}var ht=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}R(t){let{el:{content:e},parts:s}=this._$AD,r=(t?.creationScope??V).importNode(e,!0);H.currentNode=r;let n=H.nextNode(),o=0,h=0,a=s[0];for(;a!==void 0;){if(o===a.index){let c;a.type===2?c=new vt(n,n.nextSibling,this,t):a.type===1?c=new a.ctor(n,a.name,a.strings,this,t):a.type===6&&(c=new mt(n,this,t)),this._$AV.push(c),a=s[++h]}o!==a?.index&&(n=H.nextNode(),o++)}return H.currentNode=V,r}V(t){let e=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},vt=class Ee{get _$AU(){return this._$AM?._$AU??this.D}constructor(t,e,s,r){this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=r,this.D=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=q(this,t,e),st(t)?t===y||t==null||t===""?(this._$AH!==y&&this._$AR(),this._$AH=y):t!==this._$AH&&t!==x&&this.L(t):t._$litType$!==void 0?this.j(t):t.nodeType!==void 0?this.I(t):_e(t)?this.H(t):this.L(t)}B(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}I(t){this._$AH!==t&&(this._$AR(),this._$AH=this.B(t))}L(t){this._$AH!==y&&st(this._$AH)?this._$AA.nextSibling.data=t:this.I(V.createTextNode(t)),this._$AH=t}j(t){let{values:e,_$litType$:s}=t,r=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=it.createElement(Ie(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===r)this._$AH.V(e);else{let n=new ht(r,this),o=n.R(this.options);n.V(e),this.I(o),this._$AH=n}}_$AC(t){let e=fe.get(t.strings);return e===void 0&&fe.set(t.strings,e=new it(t)),e}H(t){Lt(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,s,r=0;for(let n of t)r===e.length?e.push(s=new Ee(this.B(et()),this.B(et()),this,this.options)):s=e[r],s._$AI(n),r++;r<e.length&&(this._$AR(s&&s._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let s=t.nextSibling;t.remove(),t=s}}setConnected(t){this._$AM===void 0&&(this.D=t,this._$AP?.(t))}},z=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,r,n){this.type=1,this._$AH=y,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=n,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=y}_$AI(t,e=this,s,r){let n=this.strings,o=!1;if(n===void 0)t=q(this,t,e,0),o=!st(t)||t!==this._$AH&&t!==x,o&&(this._$AH=t);else{let h=t,a,c;for(t=n[0],a=0;a<n.length-1;a++)c=q(this,h[s+a],e,a),c===x&&(c=this._$AH[a]),o||=!st(c)||c!==this._$AH[a],c===y?t=y:t!==y&&(t+=(c??"")+n[a+1]),this._$AH[a]=c}o&&!r&&this.W(t)}W(t){t===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},dt=class extends z{constructor(){super(...arguments),this.type=3}W(t){this.element[this.name]=t===y?void 0:t}},pt=class extends z{constructor(){super(...arguments),this.type=4}W(t){this.element.toggleAttribute(this.name,!!t&&t!==y)}},ut=class extends z{constructor(t,e,s,r,n){super(t,e,s,r,n),this.type=5}_$AI(t,e=this){if((t=q(this,t,e,0)??y)===x)return;let s=this._$AH,r=t===y&&s!==y||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,n=t!==y&&(s===y||r);r&&this.element.removeEventListener(this.name,this,s),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},mt=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){q(this,t)}},os={q:Rt,J:M,Z:Pt,F:1,G:Ue,K:ht,X:_e,Y:q,tt:vt,st:z,it:pt,et:ut,ht:dt,ot:mt},as=Dt.litHtmlPolyfillSupport;as?.(it,vt),(Dt.litHtmlVersions??=[]).push("3.3.1");var Ce=(i,t,e)=>{let s=e?.renderBefore??t,r=s._$litPart$;if(r===void 0){let n=e?.renderBefore??null;s._$litPart$=r=new vt(t.insertBefore(et(),n),n,void 0,e??{})}return r._$AI(i),r},Bt=globalThis;var N=class extends P{constructor(){super(...arguments),this.renderOptions={host:this},this.rt=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this.rt=Ce(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this.rt?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this.rt?.setConnected(!1)}render(){return x}};N._$litElement$=!0,N.finalized=!0,Bt.litElementHydrateSupport?.({LitElement:N});var ls=Bt.litElementPolyfillSupport;ls?.({LitElement:N});(Bt.litElementVersions??=[]).push("4.2.1");var{tt:cs}=os,hs=i=>i===null||typeof i!="object"&&typeof i!="function";var ge=(i,t)=>t===void 0?i?._$litType$!==void 0:i?._$litType$===t,ds=i=>i?._$litType$?.h!=null;var Me=i=>i.strings===void 0,be=()=>document.createComment(""),L=(i,t,e)=>{let s=i._$AA.parentNode,r=t===void 0?i._$AB:t._$AA;if(e===void 0){let n=s.insertBefore(be(),r),o=s.insertBefore(be(),r);e=new cs(n,o,i,i.options)}else{let n=e._$AB.nextSibling,o=e._$AM,h=o!==i;if(h){let a;e._$AQ?.(i),e._$AM=i,e._$AP!==void 0&&(a=i._$AU)!==o._$AU&&e._$AP(a)}if(n!==r||h){let a=e._$AA;for(;a!==n;){let c=a.nextSibling;s.insertBefore(a,r),a=c}}}return e},R=(i,t,e=i)=>(i._$AI(t,e),i),ps={},rt=(i,t=ps)=>i._$AH=t,Mt=i=>i._$AH,It=i=>{i._$AR(),i._$AA.remove()},Oe=i=>{i._$AR()};var I=i=>(...t)=>({_$litDirective$:i,values:t}),E=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this.nt=t,this._$AM=e,this.ct=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var tt=(i,t)=>{let e=i._$AN;if(e===void 0)return!1;for(let s of e)s._$AO?.(t,!1),tt(s,t);return!0},ft=i=>{let t,e;do{if((t=i._$AM)===void 0)break;e=t._$AN,e.delete(i),i=t}while(e?.size===0)},ke=i=>{for(let t;t=i._$AM;i=t){let e=t._$AN;if(e===void 0)t._$AN=e=new Set;else if(e.has(i))break;e.add(i),fs(t)}};function us(i){this._$AN!==void 0?(ft(this),this._$AM=i,ke(this)):this._$AM=i}function ms(i,t=!1,e=0){let s=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(t)if(Array.isArray(s))for(let n=e;n<s.length;n++)tt(s[n],!1),ft(s[n]);else s!=null&&(tt(s,!1),ft(s));else tt(this,i)}var fs=i=>{i.type==2&&(i._$AP??=ms,i._$AQ??=us)},nt=class extends E{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,s){super._$AT(t,e,s),ke(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(tt(this,t),ft(this))}setValue(t){if(Me(this.nt))this.nt._$AI(t,this);else{let e=[...this.nt._$AH];e[this.ct]=t,this.nt._$AI(e,this,0)}}disconnected(){}reconnected(){}};var gt=class{constructor(t){this.lt=t}disconnect(){this.lt=void 0}reconnect(t){this.lt=t}deref(){return this.lt}},bt=class{constructor(){this.ut=void 0,this.dt=void 0}get(){return this.ut}pause(){this.ut??=new Promise(t=>this.dt=t)}resume(){this.dt?.(),this.ut=this.dt=void 0}};var $t=class extends nt{constructor(){super(...arguments),this.ft=new gt(this),this.vt=new bt}render(t,e){return x}update(t,[e,s]){if(this.isConnected||this.disconnected(),e===this.yt)return x;this.yt=e;let r=0,{ft:n,vt:o}=this;return(async(h,a)=>{for await(let c of h)if(await a(c)===!1)return})(e,async h=>{for(;o.get();)await o.get();let a=n.deref();if(a!==void 0){if(a.yt!==e)return!1;s!==void 0&&(h=s(h,r)),a.commitValue(h,r),r++}return!0}),x}commitValue(t,e){this.setValue(t)}disconnected(){this.ft.disconnect(),this.vt.pause()}reconnected(){this.ft.reconnect(this),this.vt.resume()}},Cs=I($t),Q=I(class extends $t{constructor(i){if(super(i),i.type!==2)throw Error("asyncAppend can only be used in child expressions")}update(i,t){return this.rt=i,super.update(i,t)}commitValue(i,t){t===0&&Oe(this.rt);let e=L(this.rt);R(e,i)}}),$e=i=>ds(i)?i._$litType$.h:i.strings,Ms=I(class extends E{constructor(i){super(i),this.bt=new WeakMap}render(i){return[i]}update(i,[t]){let e=ge(this.gt)?$e(this.gt):null,s=ge(t)?$e(t):null;if(e!==null&&(s===null||e!==s)){let r=Mt(i).pop(),n=this.bt.get(e);if(n===void 0){let o=document.createDocumentFragment();n=Ce(y,o),n.setConnected(!1),this.bt.set(e,n)}rt(n,[r]),L(n,void 0,r)}if(s!==null){if(e===null||e!==s){let r=this.bt.get(s);if(r!==void 0){let n=Mt(r).pop();Oe(i),L(i,void 0,n),rt(i,[n])}}this.gt=t}else this.gt=void 0;return this.render(t)}});var Os=I(class extends E{constructor(i){if(super(i),i.type!==1||i.name!=="class"||i.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter(t=>i[t]).join(" ")+" "}update(i,[t]){if(this.wt===void 0){this.wt=new Set,i.strings!==void 0&&(this._t=new Set(i.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(let s in t)t[s]&&!this._t?.has(s)&&this.wt.add(s);return this.render(t)}let e=i.element.classList;for(let s of this.wt)s in t||(e.remove(s),this.wt.delete(s));for(let s in t){let r=!!t[s];r===this.wt.has(s)||this._t?.has(s)||(r?(e.add(s),this.wt.add(s)):(e.remove(s),this.wt.delete(s)))}return x}}),gs={},ks=I(class extends E{constructor(){super(...arguments),this.St=gs}render(i,t){return t()}update(i,[t,e]){if(Array.isArray(t)){if(Array.isArray(this.St)&&this.St.length===t.length&&t.every((s,r)=>s===this.St[r]))return x}else if(this.St===t)return x;return this.St=Array.isArray(t)?Array.from(t):t,this.render(t,e)}});var Ds=I(class extends E{constructor(){super(...arguments),this.key=y}render(i,t){return this.key=i,t}update(i,[t,e]){return t!==this.key&&(rt(i),this.key=t),e}}),Rs=I(class extends E{constructor(i){if(super(i),i.type!==3&&i.type!==1&&i.type!==4)throw Error("The `live` directive is not allowed on child or event bindings");if(!Me(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[t]){if(t===x||t===y)return t;let e=i.element,s=i.name;if(i.type===3){if(t===e[s])return x}else if(i.type===4){if(!!t===e.hasAttribute(s))return x}else if(i.type===1&&e.getAttribute(s)===t+"")return x;return rt(i),t}});var Ut=new WeakMap,Ps=I(class extends nt{render(i){return y}update(i,[t]){let e=t!==this.lt;return e&&this.lt!==void 0&&this.$t(void 0),(e||this.Tt!==this.xt)&&(this.lt=t,this.Et=i.options?.host,this.$t(this.xt=i.element)),y}$t(i){if(this.isConnected||(i=void 0),typeof this.lt=="function"){let t=this.Et??globalThis,e=Ut.get(t);e===void 0&&(e=new WeakMap,Ut.set(t,e)),e.get(this.lt)!==void 0&&this.lt.call(this.Et,void 0),e.set(this.lt,i),i!==void 0&&this.lt.call(this.Et,i)}else this.lt.value=i}get Tt(){return typeof this.lt=="function"?Ut.get(this.Et??globalThis)?.get(this.lt):this.lt?.value}disconnected(){this.Tt===this.xt&&this.$t(void 0)}reconnected(){this.$t(this.xt)}}),ye=(i,t,e)=>{let s=new Map;for(let r=t;r<=e;r++)s.set(i[r],r);return s},Ls=I(class extends E{constructor(i){if(super(i),i.type!==2)throw Error("repeat() can only be used in text expressions")}Ct(i,t,e){let s;e===void 0?e=t:t!==void 0&&(s=t);let r=[],n=[],o=0;for(let h of i)r[o]=s?s(h,o):o,n[o]=e(h,o),o++;return{values:n,keys:r}}render(i,t,e){return this.Ct(i,t,e).values}update(i,[t,e,s]){let r=Mt(i),{values:n,keys:o}=this.Ct(t,e,s);if(!Array.isArray(r))return this.Pt=o,n;let h=this.Pt??=[],a=[],c,p,d=0,m=r.length-1,u=0,b=n.length-1;for(;d<=m&&u<=b;)if(r[d]===null)d++;else if(r[m]===null)m--;else if(h[d]===o[u])a[u]=R(r[d],n[u]),d++,u++;else if(h[m]===o[b])a[b]=R(r[m],n[b]),m--,b--;else if(h[d]===o[b])a[b]=R(r[d],n[b]),L(i,a[b+1],r[d]),d++,b--;else if(h[m]===o[u])a[u]=R(r[m],n[u]),L(i,r[d],r[m]),m--,u++;else if(c===void 0&&(c=ye(o,u,b),p=ye(h,d,m)),c.has(h[d]))if(c.has(h[m])){let A=p.get(o[u]),B=A!==void 0?r[A]:null;if(B===null){let at=L(i,r[d]);R(at,n[u]),a[u]=at}else a[u]=R(B,n[u]),L(i,r[d],B),r[A]=null;u++}else It(r[m]),m--;else It(r[d]),d++;for(;u<=b;){let A=L(i,a[b+1]);R(A,n[u]),a[u++]=A}for(;d<=m;){let A=r[d++];A!==null&&It(A)}return this.Pt=o,rt(i,a),x}}),De="important",bs=" !"+De,Ns=I(class extends E{constructor(i){if(super(i),i.type!==1||i.name!=="style"||i.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(i){return Object.keys(i).reduce((t,e)=>{let s=i[e];return s==null?t:t+`${e=e.includes("-")?e:e.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(i,[t]){let{style:e}=i.element;if(this.Mt===void 0)return this.Mt=new Set(Object.keys(t)),this.render(t);for(let s of this.Mt)t[s]==null&&(this.Mt.delete(s),s.includes("-")?e.removeProperty(s):e[s]=null);for(let s in t){let r=t[s];if(r!=null){this.Mt.add(s);let n=typeof r=="string"&&r.endsWith(bs);s.includes("-")||n?e.setProperty(s,n?r.slice(0,-11):r,n?De:""):e[s]=r}}return x}}),Bs=I(class extends E{constructor(i){if(super(i),i.type!==2)throw Error("templateContent can only be used in child bindings")}render(i){return this.At===i?x:(this.At=i,document.importNode(i.content,!0))}}),Y=class extends E{constructor(t){if(super(t),this.gt=y,t.type!==2)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===y||t==null)return this.kt=void 0,this.gt=t;if(t===x)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.gt)return this.kt;this.gt=t;let e=[t];return e.raw=e,this.kt={_$litType$:this.constructor.resultType,strings:e,values:[]}}};Y.directiveName="unsafeHTML",Y.resultType=1;var wt=I(Y);var ot=class extends Y{};ot.directiveName="unsafeSVG",ot.resultType=2;var js=I(ot),ve=i=>!hs(i)&&typeof i.then=="function",we=1073741823;var Ot=class extends nt{constructor(){super(...arguments),this.Ot=we,this.Ut=[],this.ft=new gt(this),this.vt=new bt}render(...t){return t.find(e=>!ve(e))??x}update(t,e){let s=this.Ut,r=s.length;this.Ut=e;let n=this.ft,o=this.vt;this.isConnected||this.disconnected();for(let h=0;h<e.length&&!(h>this.Ot);h++){let a=e[h];if(!ve(a))return this.Ot=h,a;h<r&&a===s[h]||(this.Ot=we,r=0,Promise.resolve(a).then(async c=>{for(;o.get();)await o.get();let p=n.deref();if(p!==void 0){let d=p.Ut.indexOf(a);d>-1&&d<p.Ot&&(p.Ot=d,p.setValue(c))}}))}return x}disconnected(){this.ft.disconnect(),this.vt.pause()}reconnected(){this.ft.reconnect(this),this.vt.resume()}},Hs=I(Ot);var $s=Symbol.for(""),ys=i=>{if(i?.r===$s)return i?._$litStatic$};var Se=new Map,Re=i=>(t,...e)=>{let s=e.length,r,n,o=[],h=[],a,c=0,p=!1;for(;c<s;){for(a=t[c];c<s&&(n=e[c],(r=ys(n))!==void 0);)a+=r+t[++c],p=!0;c!==s&&h.push(n),o.push(a),c++}if(c===s&&o.push(t[s]),p){let d=o.join("$$lit$$");(t=Se.get(d))===void 0&&(o.raw=o,Se.set(d,t=o)),e=h}return i(t,...e)},Vs=Re(l),qs=Re(ns);window.litDisableBundleWarning||console.warn("Lit has been loaded from a bundle that combines all core features into a single file. To reduce transfer size and parsing cost, consider using the `lit` npm package directly in your project.");var f=class extends N{createRenderRoot(){return this}broadcast(t,e){return()=>{let s=new CustomEvent(t,{detail:e,bubbles:!0,composed:!0});this.dispatchEvent(s)}}};var Pe=class{#t;#e;#s;constructor(){this.#t=0,this.#e=new Map,this.#s=new Map}map(){return this.#e}reverseMap(){return this.#s}add(i){return this.#e.has(i)?this.#e.get(i):(this.#e.set(i,this.#t),this.#s.set(this.#t,i),this.#t++,this.#t-1)}setIndex(i,t){this.#e.set(i,t),this.#s.set(t,i)}getIndex(i){return this.#e.get(i)}getValue(i){return this.#s.get(i)}has(i){return this.#e.has(i)}},Le=class{static intersection(i,t){if(t.length===0)return new Set;t.sort((s,r)=>s.size-r.size);let e=new Set(t[0]);for(let s=1;s<t.length;s++){let r=t[s];for(let n of e)i.setCheck(),r.has(n)||e.delete(n);if(e.size===0)break}return e}},Ne=class{stringIndex;constructor(){this.stringIndex=new Pe}parseTriple(i){let t=i.match(/^(\d+) (\d+) (\d+)$/);if(!t)throw new SyntaxError(`Invalid format for triple line: ${i}`);let e=this.stringIndex.getValue(parseInt(t[1],10)),s=this.stringIndex.getValue(parseInt(t[2],10)),r=this.stringIndex.getValue(parseInt(t[3],10));if(e===void 0||s===void 0||r===void 0)throw new SyntaxError(`Invalid triple reference: ${i}`);return[e,s,r]}parseDeclaration(i){let t=i.match(/^(\d+) "(.*)"$/);if(!t)throw new SyntaxError(`Invalid format for declaration line: ${i}`);let e=t[1],s=t[2];this.stringIndex.setIndex(s,parseInt(e,10))}parse(i){if(/^(\d+)\s(\d+)\s(\d+)$/.test(i))return this.parseTriple(i);this.parseDeclaration(i)}};function _(i,t="r\xF3"){if(!i.startsWith(`urn:${t}:`))throw new Error(`Invalid URN for namespace ${t}: ${i}`);let e=i.split(":")[2],[s,r]=i.split("?"),n=s.split(":")[3],o=r?Object.fromEntries(new URLSearchParams(r)):{};return{type:e,id:n,qs:o}}function C(i,t="r\xF3"){try{return _(i,t)}catch{return{type:"unknown",id:i,qs:{}}}}var vs=class{mapReadCount;constructor(){this.mapReadCount=0}mapRead(){this.mapReadCount++}},ws=class{setCheckCount;constructor(){this.setCheckCount=0}setCheck(){this.setCheckCount++}},Ss=class{indexedTriples;stringIndex;sourceType;sourceId;sourceQs;relations;targetType;targetId;targetQs;metrics;stringUrn;constructor(i){this.indexedTriples=[],this.stringIndex=new Pe,this.sourceType=new Map,this.sourceId=new Map,this.sourceQs=new Map,this.relations=new Map,this.targetType=new Map,this.targetId=new Map,this.targetQs=new Map,this.stringUrn=new Map,this.add(i),this.metrics=new vs}add(i){let t=this.indexedTriples.length;for(let e=0;e<i.length;e++){let s=t+e,r=i[e],n=this.stringUrn.has(r[0])?this.stringUrn.get(r[0]):this.stringUrn.set(r[0],C(r[0])).get(r[0]),o=r[1],h=this.stringUrn.has(r[2])?this.stringUrn.get(r[2]):this.stringUrn.set(r[2],C(r[2])).get(r[2]),a=this.stringIndex.add(n.type),c=this.stringIndex.add(n.id),p=this.stringIndex.add(o),d=this.stringIndex.add(h.type),m=this.stringIndex.add(h.id);this.indexedTriples.push([this.stringIndex.add(r[0]),p,this.stringIndex.add(r[2])]),this.sourceType.has(a)||this.sourceType.set(a,new Set),this.sourceType.get(a).add(s),this.sourceId.has(c)||this.sourceId.set(c,new Set),this.sourceId.get(c).add(s);for(let[u,b]of Object.entries(n.qs)){let A=this.stringIndex.add(`${u}=${b}`);this.sourceQs.has(A)||this.sourceQs.set(A,new Set),this.sourceQs.get(A).add(s)}this.relations.has(p)||this.relations.set(p,new Set),this.relations.get(p).add(s),this.targetType.has(d)||this.targetType.set(d,new Set),this.targetType.get(d).add(s),this.targetId.has(m)||this.targetId.set(m,new Set),this.targetId.get(m).add(s);for(let[u,b]of Object.entries(h.qs)){let A=this.stringIndex.add(`${u}=${b}`);this.targetQs.has(A)||this.targetQs.set(A,new Set),this.targetQs.get(A).add(s)}}}get length(){return this.indexedTriples.length}triples(){return this.indexedTriples.map(([i,t,e])=>[this.stringIndex.getValue(i),this.stringIndex.getValue(t),this.stringIndex.getValue(e)])}getTriple(i){if(i<0||i>=this.indexedTriples.length)return;let[t,e,s]=this.indexedTriples[i];return[this.stringIndex.getValue(t),this.stringIndex.getValue(e),this.stringIndex.getValue(s)]}getTripleIndices(i){if(!(i<0||i>=this.indexedTriples.length))return this.indexedTriples[i]}getSourceTypeSet(i){let t=this.stringIndex.getIndex(i);if(t!==void 0)return this.metrics.mapRead(),this.sourceType.get(t)}getSourceIdSet(i){let t=this.stringIndex.getIndex(i);if(t!==void 0)return this.metrics.mapRead(),this.sourceId.get(t)}getSourceQsSet(i,t){let e=this.stringIndex.getIndex(`${i}=${t}`);if(e!==void 0)return this.metrics.mapRead(),this.sourceQs.get(e)}getRelationSet(i){let t=this.stringIndex.getIndex(i);if(t!==void 0)return this.metrics.mapRead(),this.relations.get(t)}getTargetTypeSet(i){let t=this.stringIndex.getIndex(i);if(t!==void 0)return this.metrics.mapRead(),this.targetType.get(t)}getTargetIdSet(i){let t=this.stringIndex.getIndex(i);if(t!==void 0)return this.metrics.mapRead(),this.targetId.get(t)}getTargetQsSet(i,t){let e=this.stringIndex.getIndex(`${i}=${t}`);if(e!==void 0)return this.metrics.mapRead(),this.targetQs.get(e)}},O=class{static source(i){return i[0]}static relation(i){return i[1]}static target(i){return i[2]}};function As(i,t,e){let s=t.names.concat(e.names);if(t.rows.length===0||e.rows.length===0)return{names:s,rows:[]};let r=new Map,n=new Map;for(let a=0;a<t.rows.length;a++){let c=t.rows[a][2];r.has(c)||r.set(c,[]),r.get(c).push(a)}for(let a=0;a<e.rows.length;a++){let c=e.rows[a][0];n.has(c)||n.set(c,[]),n.get(c).push(a)}let o=Le.intersection(i,[new Set(r.keys()),new Set(n.keys())]),h=[];for(let a of o){let c=n.get(a),p=r.get(a);for(let d of c)for(let m of p){let u=t.rows[d].concat(e.rows[m]);h.push(u)}}return{names:s,rows:h}}var Be=class F{index;triplesCount;cursorIndices;metrics;constructor(t){this.index=new Ss(t),this.triplesCount=this.index.length,this.cursorIndices=new Set,this.metrics=new ws;for(let e=0;e<this.triplesCount;e++)this.cursorIndices.add(e)}clone(){let t=new F([]);return t.index=this.index,t.triplesCount=this.triplesCount,t.cursorIndices=this.cursorIndices,t.metrics=this.metrics,t}static of(t){return new F(t)}static from(t){let e=[];for(let s of t){let{id:r,...n}=s;if(typeof r!="string")throw new Error("Each TripleObject must have a string id.");for(let[o,h]of Object.entries(n))if(Array.isArray(h))for(let a of h)e.push([r,o,a]);else e.push([r,o,h])}return new F(e)}add(t){let e=this.index.length;this.index.add(t),this.triplesCount=this.index.length;for(let s=e;s<this.triplesCount;s++)this.cursorIndices.add(s)}map(t){return new F(this.index.triples().map(t))}flatMap(t){let e=this.index.triples().flatMap(t);return new F(e)}firstTriple(){return this.index.length>0?this.index.getTriple(0):void 0}firstSource(){let t=this.firstTriple();return t?O.source(t):void 0}firstRelation(){let t=this.firstTriple();return t?O.relation(t):void 0}firstTarget(){let t=this.firstTriple();return t?O.target(t):void 0}firstObject(t=!1){return this.objects(t)[0]}triples(){return this.index.triples()}sources(){return new Set(this.index.triples().map(O.source))}relations(){return new Set(this.index.triples().map(O.relation))}targets(){return new Set(this.index.triples().map(O.target))}objects(t=!1){let e=[];for(let[s,r]of Object.entries(this.object(t)))r.id=s,e.push(r);return e}object(t=!1){let e={};for(let[s,r,n]of this.index.triples())e[s]||(e[s]={id:s}),e[s][r]?Array.isArray(e[s][r])?e[s][r].push(n):e[s][r]=[e[s][r],n]:e[s][r]=t?[n]:n;return e}#t(t){let e=[this.cursorIndices],{source:s,relation:r,target:n}=t;if(typeof s>"u"&&typeof n>"u"&&typeof r>"u")throw new Error("At least one search parameter must be defined");let o=["source","relation","target"];for(let c of Object.keys(t))if(Object.prototype.hasOwnProperty.call(t,c)&&!o.includes(c))throw new Error(`Unexpected search parameter: ${c}`);if(s){if(s.type){let c=this.index.getSourceTypeSet(s.type);if(c)e.push(c);else return new Set}if(s.id){let c=this.index.getSourceIdSet(s.id);if(c)e.push(c);else return new Set}if(s.qs)for(let[c,p]of Object.entries(s.qs)){let d=this.index.getSourceQsSet(c,p);if(d)e.push(d);else return new Set}}if(n){if(n.type){let c=this.index.getTargetTypeSet(n.type);if(c)e.push(c);else return new Set}if(n.id){let c=this.index.getTargetIdSet(n.id);if(c)e.push(c);else return new Set}if(n.qs)for(let[c,p]of Object.entries(n.qs)){let d=this.index.getTargetQsSet(c,p);if(d)e.push(d);else return new Set}}if(r){let c=typeof r=="string"?{relation:[r]}:r;if(c.relation){let p=new Set;for(let d of c.relation){let m=this.index.getRelationSet(d);if(m)for(let u of m)p.add(u)}if(p.size>0)e.push(p);else return new Set}}let h=Le.intersection(this.metrics,e),a=new Set;for(let c of h){let p=this.index.getTriple(c);if(!s?.predicate&&!n?.predicate&&!(typeof r=="object"&&r.predicate)){a.add(c);continue}let d=!0;s?.predicate&&(d=d&&s.predicate(O.source(p))),n?.predicate&&(d=d&&n.predicate(O.target(p))),typeof r=="object"&&r.predicate&&(d=d&&r.predicate(O.relation(p))),d&&a.add(c)}return a}search(t){let e=[];for(let s of this.#t(t)){let r=this.index.getTriple(s);r&&e.push(r)}return new F(e)}search2(t){let e=Object.entries(t),s=[];for(let h=0;h<e.length-2;h+=2){let a=e.slice(h,h+3),c={source:a[0][1],relation:a[1][1],target:a[2][1]},p=a.map(u=>u[0]),d=this.#t(c),m=Array.from(d).flatMap(u=>{let b=this.index.getTripleIndices(u);return typeof b>"u"?[]:[b]});s.push({names:p,rows:m})}let r=s.reduce(As.bind(this,this.metrics)),n=r.names,o=[];for(let h of r.rows){let a={};for(let c=0;c<n.length;c++){let p=n[c];a[p]=this.index.stringIndex.getValue(h[c])}o.push(a)}return o}getMetrics(){return{index:this.index.metrics,db:this.metrics}}};var xs=window.envConfig,St=class{constructor(t=`/manifest/tribbles.${xs.publication_id}.txt`){this.url=t}async*stream(){let t=new Ne,e=await fetch(this.url);if(!e.body)throw new Error("No response body");let s=new TextDecoderStream,r=e.body.pipeThrough(s).getReader(),n="";for(;;){let{value:o,done:h}=await r.read();if(h)break;n+=o;let a=n.split(`
`);n=a.pop()??"";for(let c of a){let p=t.parse(c);p!==void 0&&(yield p)}}if(n.length>0){let o=t.parse(n);o!==void 0&&(yield o)}}};var ui=Symbol("the albums manifest"),mi=Symbol("the images manifest"),fi=Symbol("the site manifest"),gi=Symbol("the videos manifest"),bi=Symbol("the semantic data"),$i=Symbol("the album stats"),yi=Symbol("the triples data");var je="photos";var g=class{static PHOTOS="photos";static ALBUMS="albums";static ALBUM="album";static METADATA="metadata";static ABOUT="about";static VIDEOS="videos";static THING="thing"},$=class{static UNESCO="unesco";static BIRD="bird";static MAMMAL="mammal";static REPTILE="reptile";static FISH="fish";static INSECT="insect";static AMPHIBIAN="amphibian";static GEONAME="geoname"},v=class{static SUBJECT="subject";static LOCATION="location";static LONGITUDE="longitude";static LATITUDE="latitude";static COUNTRY="country";static FLAG="flag";static RATING="rating";static NAME="name";static BIRDWATCH_URL="birdwatch_url";static WIKIPEDIA="wikipedia";static CREATED_AT="created_at";static F_STOP="f_stop";static FOCAL_LENGTH="focal_length";static MODEL="model";static EXPOSURE_TIME="exposure_time";static ISO="iso";static WIDTH="width";static HEIGHT="height"},He=new Set(["created_at","f_stop","focal_length","model","exposure_time","iso","width","height"]),W=new Set(["bird","mammal","reptile","amphibian","fish","insect"]);var k=class i{static{this.ROUTES={[g.PHOTOS]:this.showPhotosUrl,[g.ALBUMS]:this.showAlbumsUrl,[g.ALBUM]:this.showAlbumUrl,[g.METADATA]:this.showMetadataUrl,[g.ABOUT]:this.showAboutUrl,[g.VIDEOS]:this.showVideosUrl,[g.THING]:this.showThingUrl}}static router(t){if(i.ROUTES.hasOwnProperty(t))return i.ROUTES[t];throw new Error(`Unknown page: ${t}`)}static pageUsesId(t){return t===g.ALBUM||t===g.PHOTO||t===g.METADATA||t===g.THING}static showAboutUrl(){window.location.hash="#/about",document.title="About - photos"}static showAlbumsUrl(){window.location.hash="#/albums",document.title="Albums - photos"}static showPhotosUrl(){window.location.hash="#/photos",document.title="Photos - photos"}static showAlbumUrl(t){window.location.hash=`#/album/${t}`,document.title="Album - photos"}static showPhotoUrl(t){window.location.hash=`#/photo/${t}`,document.title="Photo - photos"}static showMetadataUrl(t){window.location.hash=`#/metadata/${t}`,document.title="Metadata - photos"}static showVideosUrl(){window.location.hash="#/videos",document.title="Videos - photos"}static showThingUrl(t){window.location.hash=`#/thing/${t}`,document.title="Thing - photos"}static getUrl(){return window.location.hash.startsWith("#/albums")?{type:"albums"}:window.location.hash.startsWith("#/album")?{type:"album",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/metadata")?{type:"metadata",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/thing")?{type:"thing",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/photos")?{type:"photos"}:window.location.hash.startsWith("#/about")?{type:"about"}:window.location.hash.startsWith("#/videos")?{type:"videos"}:{type:"albums"}}};var jt=class extends f{static get properties(){return{visible:{type:Boolean}}}render(){let t=["photo-sidebar"];return this.visible&&t.push("sidebar-visible"),l`
    <aside class="${t.join(" ")}">
      <nav>
        <ul>
          <li
    ...
    `}};customElements.define("photo-sidebar",jt);var Ht=class extends f{static get properties(){return{darkMode:{type:Boolean},tag:{type:String}}}feedUrl(){return this.tag?`/feeds/tags/${this.tag}.json`:"/manifest/atom/atom-index.xml"}render(){let t=this.darkMode?"\u2600\uFE0F":"\u{1F319}",e=je;return l`
    ...
    `}};customElements.define("photo-header",Ht);var At=new Map,U=class{static loadingMode(t){let e=window.innerWidth,s=window.innerHeight,r=400,n=Math.floor(e/r),o=Math.floor(s/r);return t>n*o+1?"lazy":"eager"}static encodeBitmapDataURL(t){if(At.has(t))return At.get(t);let e=t.split("#").map(n=>`#${n}`),s=document.createElement("canvas");s.width=2,s.height=2;let r=s.getContext("2d");if(!r){console.error("context missing, cannot render colours");return}return r.fillStyle=e[1],r.fillRect(0,0,1,1),r.fillStyle=e[2],r.fillRect(1,0,1,1),r.fillStyle=e[3],r.fillRect(0,1,1,1),r.fillStyle=e[4],r.fillRect(1,1,1,1),At.set(t,s.toDataURL("image/png")),At.get(t)}};var Vt=class extends f{static get properties(){return{id:{type:String},imageUrl:{type:String},thumbnailUrl:{type:String},mosaicColours:{type:String},summary:{type:String},loading:{type:String}}}renderIcon(){return l`
    ...
    `}};customElements.define("photos-page",qt);var zt=class extends f{static get properties(){return{albums:{type:Array}}}render(){let t=document.getElementById("stats-data"),e=JSON.parse(t.innerText);return l`
    ...
    `}};customElements.define("albums-page",Gt);var Yt=class extends f{static get properties(){return{id:{type:String},url:{type:String},preload:{type:String},url_poster:{type:String},url_unscaled:{type:String},url_1080p:{type:String},url_720p:{type:String},url_480p:{type:String}}}render(){return l`
    <div>
    ...
    `}};customElements.define("app-video",Yt);var Qt=class extends f{static get properties(){return{title:{type:String},url:{type:String},sharing:{state:!0,type:Boolean}}}async shareAlbum(t){if(!navigator.share)console.error("navigator.share not available");else{this.sharing=!0;try{await navigator.share({title:`${this.title} - photos.rgrannell.xyz`,url:t})}finally{this.sharing=!1}}}render(){return this.sharing?l`<button class="photo-share-button" disabled>[sharing...]</button>`:l`
      <button class="photo-share-button" ?disabled=${!navigator.share} @click=${this.shareAlbum.bind(this,this.url)}>[share]</button>
      `}};customElements.define("album-share-button",Qt);var Kt=class extends f{static{this.properties={urn:{type:String}}}id(){return S.parseUrn(this.urn)?.id??"unknown"}url(){return this.id()?`https://whc.unesco.org/en/list/${this.id()}`:null}render(){return this.id()?l`
    ...
    `}};customElements.define("album-page",Xt);var Zt=class extends f{static get properties(){return{url:{type:String},format:{type:String},sharing:{state:!0,type:Boolean}}}async shareImage(t){if(!navigator.share)console.error("navigator.share not available");else{this.sharing=!0;try{let e=await fetch(t),s=new URL(t).pathname;await navigator.share({title:s,files:[new File([await e.blob()],s,{type:this.format})]})}finally{this.sharing=!1}}}render(){return this.sharing?l`<button class="photo-share-button" disabled>[sharing...]</button>`:l`
      <button class="photo-share-button" ?disabled=${!navigator.share} @click=${this.shareImage.bind(this,this.url)}>[share]</button>
      `}};customElements.define("share-metadata-button",Zt);var te=class extends f{static get properties(){return{tagName:{type:String},count:{type:Number}}}render(){let{tagName:t,count:e}=this,s=encodeURIComponent(t);return typeof e>"u"?l`<a
        href="#/tag/${s}"
        @click=${this.broadcast("click-tag",{tagName:t})}>${t}</a>`:l`<a
      href="#/tag/${s}"
      rel="tag"
      @click=${this.broadcast("click-tag",{tagName:t})}>${t}</a> (${e})`}};customElements.define("tag-link",te);var ee=class extends f{static get properties(){return{id:{type:String},image:{type:Object},semantic:{type:Object},sharing:{state:!0,type:Boolean},triples:{type:Object,state:!0}}}connectedCallback(){super.connectedCallback(),T.setIndex()}renderAperture(t){return t.f_stop==="Unknown"?l`<td>Unknown aperture</td>`:t.f_stop==="0.0"?l`<td>Manual aperture control</td>`:l`<td>ƒ/${t.f_stop}</td>`}renderFocalLength(t){return t.focal_length==="Unknown"?l`${t.focal_length}`:t.focal_length==="0"?l`<td>Manual lens</td>`:l`<td>${t.focal_length}mm equiv.</td>`}renderSemanticKey(t){return t.replace(/_/g," ").replace(/\b\w/g,e=>e.toUpperCase())}renderSemanticValue(t,e){if(Array.isArray(e))return l`<ul class="thing-list">
    ...
    `:l`<p>No EXIF data available</p>`}render(){let t=this.image,e=t.album_id,s=this.triples,r=s.search({source:{id:_(t.id).id},relation:{predicate:n=>{let o=new Set(["album_id","full_image","mosaic_colours","thumbnail_url"]);return!He.has(n)&&!o.has(n)}}}).triples();return l`
    <section>
    <h1>Metadata</h1>
    ...
    `}};customElements.define("metadata-page",ee);var se=class extends f{static get properties(){return{}}connectedCallback(){super.connectedCallback(),T.setIndex()}render(){return l`
    <div>
    ...
    `}};customElements.define("about-page",se);var ie=class extends f{static get properties(){return{urn:{type:String},triples:{type:Object,state:!0}}}connectedCallback(){super.connectedCallback(),T.setIndex()}urnImages(t,e){console.log(t.triples());let r=t.search(e).sources();return Array.from(r).flatMap(n=>{if(n.startsWith("urn:r\xF3")){let h=t.search({source:C(n)}).firstObject();return h?[h]:[]}let o=t.search({source:{id:n,type:"photo"}}).firstObject();return o?[o]:[]})}renderSubjectPhotos(t){return t.sort((e,s)=>s.created_at-e.created_at).map((e,s)=>l`
      <app-photo
    ...
    <div/>`}render(){let t=this.triples,e=t.search({source:{type:"photo"}}).objects(),s=S.parseUrn(this.urn),r=s.type,n=t.search({source:C(this.urn)}).firstObject()??{},o=Object.assign({Classification:this.renderClassification(r)});if(n.country&&(o.Country=l`<thing-link .triples=${this.triples} urn=${n.country}></thing-link>`),n.fcode_name){let D=n.fcode_name;o["Place Type"]=l`${D.charAt(0).toUpperCase()}${D.slice(1)}`}W.has(r)&&(o["First Photographed"]=l`<span>${this.firstPhotographed(e,t,{target:C(this.urn)})}</span>`);let h=n[v.WIKIPEDIA],a=n[v.BIRDWATCH_URL],c=n[v.LONGITUDE],p=n[v.LATITUDE],d;if(c&&p){let D=`https://www.google.com/maps?q=${p},${c}`;d=l`
      ...
      `}let m=C(this.urn);m.id==="*"&&delete m.id;let u={target:m},b=this.getPhotoQueries(C(this.urn)),A={};for(let{query:D,label:_t}of b){let Ge=this.urnImages(t,D);A[_t]=this.renderSubjectPhotos(Ge)}let B=this.renderSubjectAlbums(t,u),at=this.renderPhotoSection(A);return l`
      <div>
