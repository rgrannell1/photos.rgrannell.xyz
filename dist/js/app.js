var at = globalThis,
  Ot = at.ShadowRoot && (at.ShadyCSS === void 0 || at.ShadyCSS.nativeShadow) &&
  ...
  Ge = (i) => new Et(typeof i == "string" ? i : i + "", void 0, Se);
var Ye = (i, t) => {
    if (Ot) {
      i.adoptedStyleSheets = t.map((e) =>
        ...
        let s = document.createElement("style"), r = at.litNonce;
  ...
  $t = globalThis,
  oe = $t.trustedTypes,
  es = oe ? oe.emptyScript : "",
  ss = $t.reactiveElementPolyfillSupport,
  Z = (i, t) => i,
  Ct = {
    toAttribute(i, t) {
      switch (t) {
...
var P = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, e, s) {
    let { get: r, set: n } = Je(this.prototype, t) ?? {
      get() {
        return this[e];
      },
      set(o) {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this.o(), this.hasOwnProperty(Z("properties"))) {
      let e = this.properties, s = [...Ze(e), ...Xe(e)];
  ...
  C(t, e) {
    ...
    if (r !== void 0 && s.reflect === !0) {
      let n = (s.converter?.toAttribute !== void 0 ? s.converter : Ct)
...
P.elementStyles = [],
  ...
  P[Z("elementProperties")] = new Map(),
  P[Z("finalized")] = new Map(),
  ss?.({ ReactiveElement: P }),
  ($t.reactiveElementVersions ??= []).push("2.0.4");
var Rt = globalThis,
  lt = Rt.trustedTypes,
  le = lt ? lt.createPolicy("lit-html", { createHTML: (i) => i }) : void 0,
  Dt = "$lit$",
  ...
  V = document,
  tt = () => V.createComment(""),
  et = (i) => i === null || typeof i != "object" && typeof i != "function",
  Ae = Array.isArray,
  xe = (i) => Ae(i) || typeof i?.[Symbol.iterator] == "function",
  Tt = `[ 	
\f\r]`,
  J = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
  ce = /-->/g,
...
\f\r"'\`<>=]|("|')|))|$)`,
  ...
  de = /'/g,
  pe = /"/g,
  _e = /^(?:script|style|textarea|title)$/i,
  Te = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }),
  l = Te(1),
  rs = Te(2),
  w = Symbol.for("lit-noChange"),
  y = Symbol.for("lit-nothing"),
  ue = new WeakMap(),
  H = V.createTreeWalker(V, 129);
function Ie(i, t) {
...
var Ue = (i, t) => {
    let e = i.length - 1, s = [], r, n = t === 2 ? "<svg>" : "", o = J;
    for (let h = 0; h < e; h++) {
      let a = i[h], c, p, d = -1, u = 0;
        ...
        u = o.lastIndex,
          o === J
            ? p[1] === "!--"
              ...
              ? o = he
              : p[2] !== void 0
              ? (_e.test(p[2]) && (r = RegExp("</" + p[2], "g")), o = j)
              : p[3] !== void 0 && (o = j)
            : o === j
            ? p[0] === ">"
              ? (o = r ?? J, d = -1)
      ...
      let m = o === j && i[h + 1].startsWith("/>") ? " " : "";
      n += o === J
        ? a + is
        : d >= 0
        ? (s.push(c), a.slice(0, d) + Dt + a.slice(d) + M + m)
        : a + M + (d === -2 ? h : m);
    }
    return [Ie(i, n + (i[e] || "<?>") + (t === 2 ? "</svg>" : "")), s];
  },
  st = class i {
    constructor({ strings: t, _$litType$: e }, s) {
      let r;
      this.parts = [];
      let n = 0, o = 0, h = t.length - 1, a = this.parts, [c, p] = Ue(t, e);
      if (
        this.el = i.createElement(c, s),
      ...
      for (; (r = H.nextNode()) !== null && a.length < h;) {
        if (r.nodeType === 1) {
          if (r.hasAttributes()) {
            for (let d of r.getAttributeNames()) {
              if (d.endsWith(Dt)) {
                let u = p[o++],
                  m = r.getAttribute(d).split(M),
                  b = /([.?@])?(.*)/.exec(u);
                a.push({
                  type: 1,
                  index: n,
          ...
          if (_e.test(r.tagName)) {
            let d = r.textContent.split(M), u = d.length - 1;
            if (u > 0) {
          ...
          if (r.data === Pt) a.push({ type: 2, index: n });
          else {
            let d = -1;
    ...
    static createElement(t, e) {
      let s = V.createElement("template");
      return s.innerHTML = t, s;
    }
  };
function q(i, t, e = i, s) {
  if (t === w) return t;
  let r = s !== void 0 ? e.U?.[s] : e.N, n = et(t) ? void 0 : t._$litDirective$;
...
var ct = class {
    ...
    O(t) {
      let { el: { content: e }, parts: s } = this._$AD,
        r = (t?.creationScope ?? V).importNode(e, !0);
      H.currentNode = r;
      let n = H.nextNode(), o = 0, h = 0, a = s[0];
      for (; a !== void 0;) {
        if (o === a.index) {
          let c;
          a.type === 2
            ? c = new yt(n, n.nextSibling, this, t)
            : a.type === 1
            ? c = new a.ctor(n, a.name, a.strings, this, t)
            : a.type === 6 && (c = new ut(n, this, t)),
            this._$AV.push(c),
            a = s[++h];
        }
        o !== a?.index && (n = H.nextNode(), o++);
      }
      return H.currentNode = V, r;
    }
    R(t) {
      let e = 0;
  ...
  yt = class Ee {
    ...
    L(t) {
      this._$AH !== y && et(this._$AH)
        ? this._$AA.nextSibling.data = t
        : this.j(V.createTextNode(t)), this._$AH = t;
    }
    I(t) {
      let { values: e, _$litType$: s } = t,
        r = typeof s == "number" ? this._$AC(t) : (s.el === void 0 &&
          (s.el = st.createElement(Ie(s.h, s.h[0]), this.options)),
          s);
      if (this._$AH?._$AD === r) this._$AH.R(e);
      else {
        let n = new ct(r, this), o = n.O(this.options);
        n.R(e), this.j(o), this._$AH = n;
      }
    }
    _$AC(t) {
      let e = ue.get(t.strings);
      return e === void 0 && ue.set(t.strings, e = new st(t)), e;
    }
    D(t) {
      ...
      for (let n of t) {
        r === e.length
          ? e.push(s = new Ee(this.H(tt()), this.H(tt()), this, this.options))
          : s = e[r],
          s._$AI(n),
          r++;
      }
    ...
    _$AI(t, e = this, s, r) {
      ...
      if (n === void 0) {
        ...
        for (t = n[0], a = 0; a < n.length - 1; a++) {
          c = q(this, h[s + a], e, a),
            c === w && (c = this._$AH[a]),
            o ||= !et(c) || c !== this._$AH[a],
            c === y ? t = y : t !== y && (t += (c ?? "") + n[a + 1]),
            this._$AH[a] = c;
        }
      }
      o && !r && this.B(t);
...
os?.(st, yt), (Rt.litHtmlVersions ??= []).push("3.1.3");
var Ce = (i, t, e) => {
  let s = e?.renderBefore ?? t, r = s._$litPart$;
  if (r === void 0) {
    let n = e?.renderBefore ?? null;
    s._$litPart$ = r = new yt(t.insertBefore(tt(), n), n, void 0, e ?? {});
  }
  return r._$AI(i), r;
};
var N = class extends P {
  ...
  update(t) {
    ...
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      super.update(t),
      this.ht = Ce(e, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
var as = globalThis.litElementPolyfillSupport;
as?.({ LitElement: N });
(globalThis.litElementVersions ??= []).push("4.0.5");
var { Y: ls } = ns,
  cs = (i) => i === null || typeof i != "object" && typeof i != "function";
var me = (i, t) =>
    t === void 0 ? i?._$litType$ !== void 0 : i?._$litType$ === t,
  hs = (i) => i?._$litType$?.h != null;
var Me = (i) => i.strings === void 0,
  fe = () => document.createComment(""),
  L = (i, t, e) => {
    let s = i._$AA.parentNode, r = t === void 0 ? i._$AB : t._$AA;
    if (e === void 0) {
      let n = s.insertBefore(fe(), r), o = s.insertBefore(fe(), r);
      e = new ls(n, o, i, i.options);
    } else {
      let n = e._$AB.nextSibling, o = e._$AM, h = o !== i;
      if (h) {
        let a;
        e._$AQ?.(i),
          e._$AM = i,
...
var X = (i, t) => {
    ...
    for (let s of e) s._$AO?.(t, !1), X(s, t);
    return !0;
  },
  mt = (i) => {
    let t, e;
...
function ps(i) {
  this._$AN !== void 0 ? (mt(this), this._$AM = i, Oe(this)) : this._$AM = i;
}
function us(i, t = !1, e = 0) {
  let s = this._$AH, r = this._$AN;
  if (r !== void 0 && r.size !== 0) {
    if (t) {
      if (Array.isArray(s)) {
        for (let n = e; n < s.length; n++) X(s[n], !1), mt(s[n]);
      } else s != null && (X(s, !1), mt(s));
    } else X(this, i);
  }
}
var ms = (i) => {
    i.type == 2 && (i._$AP ??= us, i._$AQ ??= ps);
  },
  rt = class extends C {
    constructor() {
    ...
    _$AT(t, e, s) {
      super._$AT(t, e, s), Oe(this), this.isConnected = t._$AU;
    }
    _$AO(t, e = !0) {
      t !== this.isConnected &&
    ...
    setValue(t) {
      if (Me(this.nt)) this.nt._$AI(t, this);
      else {
        let e = [...this.nt._$AH];
...
var bt = class extends rt {
    constructor() {
      super(...arguments), this.dt = new ft(this), this.ft = new gt();
    }
    render(t, e) {
      return w;
    }
    update(t, [e, s]) {
      if (this.isConnected || this.disconnected(), e === this.vt) return w;
      this.vt = e;
      let r = 0, { dt: n, ft: o } = this;
      return (async (h, a) => {
        for await (let c of h) if (await a(c) === !1) return;
      })(e, async (h) => {
        for (; o.get();) await o.get();
        let a = n.deref();
        if (a !== void 0) {
          if (a.vt !== e) return !1;
          s !== void 0 && (h = s(h, r)), a.commitValue(h, r), r++;
        }
        return !0;
      }),
        w;
  ...
  ge = (i) => hs(i) ? i._$litType$.h : i.strings,
  Is = I(
    class extends C {
      constructor(i) {
      ...
      update(i, [t]) {
        let e = me(this.bt) ? ge(this.bt) : null, s = me(t) ? ge(t) : null;
        if (e !== null && (s === null || e !== s)) {
          let r = Mt(i).pop(), n = this.yt.get(e);
          if (n === void 0) {
            let o = document.createDocumentFragment();
            n = Ce(y, o), n.setConnected(!1), this.yt.set(e, n);
          }
          it(n, [r]), L(n, void 0, r);
        }
        if (s !== null) {
...
var Cs = I(
    class extends C {
      constructor() {
        super(...arguments), this.key = y;
      }
      render(i, t) {
        return this.key = i, t;
      }
      update(i, [t, e]) {
        return t !== this.key && (it(i), this.key = t), e;
      }
    },
  ),
  Ms = I(
    class extends C {
      ...
      update(i, [t]) {
        ...
        if (i.type === 3) {
          if (t === e[s]) return w;
          if (i.type === 4) {
            if (!!t === e.hasAttribute(s)) return w;
            if (i.type === 1 && e.getAttribute(s) === t + "") return w;
          }
        }
        return it(i), t;
      }
...
var Ut = new WeakMap(),
    ...
    class extends rt {
      ...
      St(i) {
        if (typeof this.ct == "function") {
          let t = this.xt ?? globalThis, e = Ut.get(t);
          e === void 0 && (e = new WeakMap(), Ut.set(t, e)),
      ...
      get $t() {
        return typeof this.ct == "function"
          ? Ut.get(this.xt ?? globalThis)?.get(this.ct)
          : this.ct?.value;
      }
      disconnected() {
  ...
  Os = I(
    class extends C {
      ...
      Et(i, t, e) {
        ...
        let r = [], n = [], o = 0;
        for (let h of i) r[o] = s ? s(h, o) : o, n[o] = e(h, o), o++;
      ...
      update(i, [t, e, s]) {
        let r = Mt(i), { values: n, keys: o } = this.Et(t, e, s);
        ...
        for (; d <= u && m <= b;) {
          ...
          else if (h[d] === o[m]) a[m] = D(r[d], n[m]), d++, m++;
          else if (h[u] === o[b]) a[b] = D(r[u], n[b]), u--, b--;
          else if (h[d] === o[b]) {
            a[b] = D(r[d], n[b]), L(i, a[b + 1], r[d]), d++, b--;
          } else if (h[u] === o[m]) {
            a[m] = D(r[u], n[m]), L(i, r[d], r[u]), u--, m++;
          } else if (
            c === void 0 && (c = be(o, m, b), p = be(h, d, u)), c.has(h[d])
          ) {
            if (c.has(h[u])) {
              let T = p.get(o[m]), B = T !== void 0 ? r[T] : null;
              if (B === null) {
                let ot = L(i, r[d]);
                D(ot, n[m]), a[m] = ot;
              } else a[m] = D(B, n[m]), L(i, r[d], B), r[T] = null;
              m++;
            } else It(r[u]), u--;
          } else It(r[d]), d++;
        }
    ...
    class extends C {
      ...
      update(i, [t]) {
        ...
        for (let s in t) {
          ...
          if (r != null) {
            this.Pt.add(s);
            let n = typeof r == "string" && r.endsWith(gs);
            s.includes("-") || n
              ? e.setProperty(s, n ? r.slice(0, -11) : r, n ? Re : "")
              : e[s] = r;
          }
        }
        return w;
  ...
  G = class extends C {
    ...
    render(t) {
      if (t === y || t == null) return this.kt = void 0, this.bt = t;
      if (t === w) return t;
      if (typeof t != "string") {
        throw Error(
...
var Ps = I(nt),
  $e = (i) => !cs(i) && typeof i.then == "function",
  ye = 1073741823;
var kt = class extends rt {
    ...
    update(t, e) {
      ...
      for (let h = 0; h < e.length && !(h > this.Mt); h++) {
        let a = e[h];
        if (!$e(a)) return this.Mt = h, a;
        h < r && a === s[h] ||
          (this.Mt = ye,
            r = 0,
            Promise.resolve(a).then(async (c) => {
              for (; o.get();) await o.get();
              let p = n.deref();
              if (p !== void 0) {
                let d = p.Ut.indexOf(a);
                d > -1 && d < p.Mt && (p.Mt = d, p.setValue(c));
              }
            }));
      }
      return w;
...
var ve = new Map(),
  De = (i) => (t, ...e) => {
    let s = e.length, r, n, o = [], h = [], a, c = 0, p = !1;
    for (; c < s;) {
      for (a = t[c]; c < s && (n = e[c], (r = $s(n)) !== void 0);) {
        a += r + t[++c], p = !0;
      }
      c !== s && h.push(n), o.push(a), c++;
    }
    if (c === s && o.push(t[s]), p) {
      let d = o.join("$$lit$$");
      (t = ve.get(d)) === void 0 && (o.raw = o, ve.set(d, t = o)), e = h;
    }
    return i(t, ...e);
  },
  Ns = De(l),
...
var U = class {
  ...
  Ss = class {
    ...
    indexTriples(i) {
      for (let t = 0; t < i.length; t++) this.indexTriple(i[t], t);
    }
    indexTriple(i, t) {
      let e = k(U.source(i)),
        s = U.relation(i),
        ...
        h = this.stringIndex.add(s),
        a = this.stringIndex.add(r.type),
        c = this.stringIndex.add(r.id);
      this.indexedTriples.push([
        this.stringIndex.add(U.source(i)),
        h,
        this.stringIndex.add(U.target(i)),
      ]),
      ...
      for (let [p, d] of Object.entries(e.qs)) {
        let u = this.stringIndex.add(`${p}=${d}`);
        this.sourceQs.has(u) || this.sourceQs.set(u, new Set()),
          this.sourceQs.get(u).add(t);
      }
      this.relations.has(h) || this.relations.set(h, new Set()),
        this.relations.get(h).add(t),
        this.targetType.has(a) || this.targetType.set(a, new Set()),
        this.targetType.get(a).add(t),
        this.targetId.has(c) || this.targetId.set(c, new Set()),
        this.targetId.get(c).add(t);
      for (let [p, d] of Object.entries(r.qs)) {
        let u = this.stringIndex.add(`${p}=${d}`);
        this.targetQs.has(u) || this.targetQs.set(u, new Set()),
          this.targetQs.get(u).add(t);
      }
    }
    add(i) {
      let t = this.indexedTriples.length;
      for (let e = 0; e < i.length; e++) this.indexTriple(i[e], t + e);
    }
    get length() {
...
function ws(i, t, e) {
  ...
  for (let a = 0; a < t.rows.length; a++) {
    let c = t.rows[a][2];
    r.has(c) || r.set(c, []), r.get(c).push(a);
  }
  for (let a = 0; a < e.rows.length; a++) {
    let c = e.rows[a][0];
    n.has(c) || n.set(c, []), n.get(c).push(a);
  }
  let o = Le.intersection(i, [new Set(r.keys()), new Set(n.keys())]), h = [];
  for (let a of o) {
    let c = n.get(a), p = r.get(a);
    for (let d of c) {
      for (let u of p) {
        let m = t.rows[d].concat(e.rows[u]);
        h.push(m);
      }
    }
  }
  return { names: s, rows: h };
}
var Be = class Y {
  index;
  triplesCount;
  ...
  static from(t) {
    ...
    for (let s of t) {
      ...
      for (let [o, h] of Object.entries(n)) {
        if (Array.isArray(h)) {
          for (let a of h) e.push([r, o, a]);
        } else e.push([r, o, h]);
      }
    }
    return new Y(e);
  ...
  map(t) {
    return new Y(this.index.triples().map(t));
  }
  flatMap(t) {
  ...
  firstSource() {
    ...
    return t ? U.source(t) : void 0;
  }
  firstRelation() {
    let t = this.firstTriple();
    return t ? U.relation(t) : void 0;
  }
  firstTarget() {
    let t = this.firstTriple();
    return t ? U.target(t) : void 0;
  }
  firstObject(t = !1) {
  ...
  sources() {
    return new Set(this.index.triples().map(U.source));
  }
  relations() {
    return new Set(this.index.triples().map(U.relation));
  }
  targets() {
    return new Set(this.index.triples().map(U.target));
  }
  objects(t = !1) {
    let e = [];
  ...
  #t(t) {
    ...
    for (let c of Object.keys(t)) {
      if (Object.prototype.hasOwnProperty.call(t, c) && !o.includes(c)) {
        throw new Error(`Unexpected search parameter: ${c}`);
      }
    }
    if (s) {
      if (s.type) {
        let c = this.index.getSourceTypeSet(s.type);
        if (c) e.push(c);
        else return new Set();
      }
      if (s.id) {
        let c = this.index.getSourceIdSet(s.id);
        if (c) e.push(c);
        else return new Set();
      }
      if (s.qs) {
        for (let [c, p] of Object.entries(s.qs)) {
          let d = this.index.getSourceQsSet(c, p);
          if (d) e.push(d);
          else return new Set();
        }
      }
    ...
    if (n) {
      if (n.type) {
        let c = this.index.getTargetTypeSet(n.type);
        if (c) e.push(c);
        else return new Set();
      }
      if (n.id) {
        let c = this.index.getTargetIdSet(n.id);
        if (c) e.push(c);
        else return new Set();
      }
      if (n.qs) {
        for (let [c, p] of Object.entries(n.qs)) {
          let d = this.index.getTargetQsSet(c, p);
          if (d) e.push(d);
          else return new Set();
        }
      }
    ...
    if (r) {
      let c = typeof r == "string" ? { relation: [r] } : r;
      if (c.relation) {
        let p = new Set();
        for (let d of c.relation) {
          let u = this.index.getRelationSet(d);
          if (u) { for (let m of u) p.add(m); }
        }
        if (p.size > 0) e.push(p);
        else return new Set();
      }
    }
    let h = Le.intersection(this.metrics, e), a = new Set();
    for (let c of h) {
      let p = this.index.getTriple(c);
      if (
      ...
      let d = !0;
      s?.predicate && (d = d && s.predicate(U.source(p))),
        n?.predicate && (d = d && n.predicate(U.target(p))),
        typeof r == "object" && r.predicate &&
        (d = d && r.predicate(U.relation(p))),
        d && a.add(c);
    }
    return a;
  }
  ...
  search2(t) {
    ...
    for (let h = 0; h < e.length - 2; h += 2) {
      let a = e.slice(h, h + 3),
        c = { source: a[0][1], relation: a[1][1], target: a[2][1] },
        p = a.map((m) => m[0]),
        d = this.#t(c),
        u = Array.from(d).flatMap((m) => {
          let b = this.index.getTripleIndices(m);
          return typeof b > "u" ? [] : [b];
        });
      s.push({ names: p, rows: u });
    }
    let r = s.reduce(ws.bind(this, this.metrics)), n = r.names, o = [];
    for (let h of r.rows) {
      let a = {};
      for (let c = 0; c < n.length; c++) {
        let p = n[c];
        a[p] = this.index.stringIndex.getValue(h[c]);
      }
      o.push(a);
    }
    return o;
...
var As = window.envConfig,
  wt = class {
    constructor(t = `/manifest/tribbles.${As.publication_id}.txt`) {
      this.url = t;
    }
    async *stream() {
      let t = new Ne(), e = await fetch(this.url);
      if (!e.body) throw new Error("No response body");
      let s = new TextDecoderStream(),
        r = e.body.pipeThrough(s).getReader(),
        n = "";
      for (;;) {
        let { value: o, done: h } = await r.read();
        if (h) break;
        n += o;
        let a = n.split(`
`);
...
var ci = Symbol("the albums manifest"),
  hi = Symbol("the images manifest"),
  di = Symbol("the site manifest"),
  pi = Symbol("the videos manifest"),
  ui = Symbol("the semantic data"),
  mi = Symbol("the album stats"),
  fi = Symbol("the triples data");
var je = "photos";
var g = class {
  ...
  F = new Set(["bird", "mammal", "reptile", "amphibian", "fish", "insect"]);
var O = class i {
  static {
    this.ROUTES = {
  ...
  static router(t) {
    if (i.ROUTES.hasOwnProperty(t)) return i.ROUTES[t];
...
customElements.define("photo-sidebar", Lt);
var Nt = class extends f {
  ...
  render() {
    let t = this.darkMode ? "\u2600\uFE0F" : "\u{1F319}", e = je;
    return l`
...
customElements.define("photo-header", Nt);
var At = new Map(),
  E = class {
    ...
    static encodeBitmapDataURL(t) {
      ...
      return r.fillStyle = e[1],
        ...
        r.fillStyle = e[4],
        r.fillRect(1, 1, 1, 1),
        At.set(t, s.toDataURL("image/png")),
        At.get(t);
    }
  };
var Bt = class extends f {
  ...
  render() {
    ...
    let t = this.id.startsWith("urn:") ? x(this.id).id : this.id,
      e = {
        id: t,
        imageUrl: this.imageUrl,
        thumbnailUrl: this.thumbnailUrl,
        thumbnailDataUrl: E.encodeBitmapDataURL(this.mosaicColours),
      },
      s = document.createElement("div");
    s.innerHTML = this.summary ?? "";
    let r = s.textContent ?? s.innerText ?? "";
    return l`
    <div class="photo">
...
customElements.define("app-photo", Bt);
...
customElements.define("search-bar", jt);
var _ = class {
  static getElement() {
...
var Ht = class extends f {
  static get properties() {
    return { triples: { type: Object, state: !0 } };
  }
  connectedCallback() {
...
customElements.define("photos-page", Ht);
var Vt = class extends f {
  static get properties() {
    return { albums: { type: Array } };
  }
  render() {
    let t = document.getElementById("stats-data"), e = JSON.parse(t.innerText);
    return l`
...
customElements.define("photos-stats", Vt);
var Q = class i {
  static parse(t) {
    let [e, s] = t.split(" ");
  ...
  static dateRange(t, e, s) {
    ...
    if (s) {
      let o = { day: "numeric", month: "short" },
        ...
        c = r.toLocaleDateString("en-IE", { day: "numeric" }),
...
var xs = window.envConfig,
  ...
  W = class {
    ...
    static toCommonName(t, e) {
      return t.search({ source: { id: e }, relation: v.NAME }).firstTarget() ??
        e;
    }
    static birdwatchUrl(t, e) {
      let { id: s } = x(e);
      return t.search({ source: { id: s }, relation: v.BIRDWATCH_URL })
        .firstTarget();
    }
  },
  K = class {
    static details(t, e) {
      let s = t.search({
          source: { type: "country" },
          relation: { relation: [v.NAME, v.FLAG] },
        }),
        r = s.search({ relation: v.NAME, target: { id: e } }).firstSource(),
        n = x(r),
        o = s.search({ source: n, relation: v.FLAG }).firstTarget();
...
function Ve(i) {
  return A.getRelation(i) !== v.RATING ? [i] : [[
    A.getSource(i),
    A.getRelation(i),
    `urn:r\xF3:rating:${encodeURIComponent(A.getTarget(i))}`,
  ]];
}
function qe(i) {
  if (A.getRelation(i) !== v.COUNTRY) return [i];
  let e = `urn:r\xF3:country:${A.getTarget(i).toLowerCase().replace(" ", "-")}`;
  return [[
    A.getSource(i),
    A.getRelation(i),
    e,
...
function ze(i) {
  for (
    ...
    if (A.getRelation(i) === t) {
      return [[A.getSource(i), t, `${xs.photos_url}${A.getTarget(i)}`]];
    }
  }
  return [i];
}
...
var qt = class extends f {
  ...
  dateRange() {
    ...
    return Q.dateRange(this.minDate, this.maxDate, t.matches);
  }
  hidePlaceholder(t) {
  ...
  renderCountries() {
    return this.countries.split(",").map((t) => {
      let { flag: e, urn: s } = K.details(this.triples, t), r = x(s);
      return l`<span href="#/thing/country:${r.id}" title=${t}>${e}</span>`;
    });
  }
  render() {
    performance.mark(`start-album-render-${this.url}`);
    let t = E.encodeBitmapDataURL(this.mosaicColours),
      e = this.renderCountries(),
      s = x(this.id);
    return l`
    <div class="photo-album">
      ...
      this.hidePlaceholder.bind(this)
        ...
        @click=${
      this.broadcast("click-album", { id: s.id, title: this.title })
    }>
    </a>
...
customElements.define("photo-album", qt);
var zt = class extends f {
  ...
  _onScroll() {
    ...
    let n = Math.min(...r.map((a) => a.minDate)),
      h = new Date(n).toLocaleString("default", {
        month: "short",
        year: "numeric",
      });
    t && h !== "Invalid Date" && (t.textContent = h);
  }
  _clearCacheOnResize() {
    this.datesCache = [];
  }
...
customElements.define("albums-page", Ft);
...
customElements.define("app-video", Wt);
...
customElements.define("album-share-button", Gt);
var Yt = class extends f {
  static {
    this.properties = { urn: { type: String } };
  }
  id() {
...
customElements.define("unesco-link", Yt);
var Qt = class extends f {
  static {
    this.properties = { urn: { type: String }, triples: { type: Array } };
  }
  name() {
    let { type: t, id: e } = S.parseUrn(this.urn);
    if (F.has(t)) return l`<span>${W.toCommonName(this.triples, e)}</span>`;
    let s = this.triples.search({
      source: S.parseUrn(this.urn),
      relation: v.NAME,
    }).firstTarget();
    return console.log(this.urn),
      s ? l`<span>${s}</span>` : decodeURIComponent(e);
  }
  linkClass() {
...
customElements.define("thing-link", Qt);
var Kt = class extends f {
  ...
  albumPhotos(t) {
    ...
    return Array.from(e).flatMap((s) => {
      let r = t.search({ source: x(s) }).firstObject();
      return r ? [r] : [];
    });
  }
  albumVideos(t) {
  ...
  thingsLinks(t) {
    ...
    for (let n of [$.UNESCO]) {
      e[n] = Array.from(
        new Set(
          s.flatMap((o) => o[v.LOCATION]?.filter((h) => S.is(h, n))).filter(
            (o) => o,
          ),
        ),
      );
    ...
    for (
      ...
      e[n] = Array.from(
        new Set(
          s.flatMap((o) => o[v.SUBJECT]?.filter((h) => S.is(h, n))).filter(
            (o) => o,
          ),
        ),
      );
    ...
    let r = [];
    r = r.concat(
      e[$.UNESCO].map((n) => l`<unesco-link urn="${n}"></unesco-link>`),
    );
    for (
      let n of [$.BIRD, $.MAMMAL, $.REPTILE, $.FISH, $.AMPHIBIAN, $.INSECT]
    ) {
  ...
  render() {
    let t = this.triples,
      ...
      s = Q.dateRange(this.minDate, this.maxDate, e.matches),
      n = this.albumPhotos(t).map((a, c) =>
        l`
      <app-photo
        id=${a.id}
        summary=${a.summary}
      ...
      h = this?.countries.split(",").map((a) => {
        let { flag: c, urn: p } = K.details(this.triples, a), d = x(p);
        return l`<span href="#/thing/country:${d.id}" title=${a}>${c}</span>`;
      });
    return l`
    <div>
      <section class="photos-metadata">
...
customElements.define("share-metadata-button", Jt);
var Zt = class extends f {
  static get properties() {
...
customElements.define("tag-link", Zt);
  ...
  renderSemanticData(t) {
    return l`
      ...
      <table class="metadata-table">
        ${
      t.sort((e, s) => A.getRelation(e).localeCompare(A.getRelation(s))).filter(
        (e) => !this.isIgnoredKey(A.getRelation(e)),
      ).map((e) =>
        l`
          <tr>
            <th class="exif-heading">${
          this.renderSemanticKey(A.getRelation(e))
        }</th>
              <td>${
          this.renderSemanticValue(A.getRelation(e), A.getTarget(e))
        }</td>
          `
      )
    }
...
customElements.define("metadata-page", Xt);
...
var ee = class extends f {
  static get properties() {
    return { urn: { type: String }, triples: { type: Object, state: !0 } };
  }
  connectedCallback() {
    super.connectedCallback(), _.setIndex();
  }
  ...
  renderSubjectAlbums(t, e) {
    ...
    return Array.from(r).flatMap((n) =>
      this.getAlbums().filter((o) => x(o.id).id === n)
  ...
  firstPhotographed(t, e, s) {
    let n = this.urnImages(e, s).sort((o, h) => o.created_at - h.created_at)[0];
    return n
  ...
  renderTitle() {
    let { id: t, type: e } = S.parseUrn(this.urn),
      s = this.triples.search({ source: { id: t, type: e }, relation: v.NAME })
        .firstTarget();
    if (s) return s;
    try {
      let r = S.parseUrn(this.urn), n = decodeURIComponent(r.id);
      return r.id === "*"
        ? `${r.type.charAt(0).toUpperCase()}${r.type.slice(1)}`
        : F.has(r.type)
        ? W.toCommonName(this.triples, n)
        : n;
    } catch {
      return this.urn;
    }
  ...
  getPhotoQueries(t) {
    ...
    } else s.push({ label: "default", query: { target: t } });
    return s;
  }
  ...
  render() {
    let t = this.triples,
      ...
      s = S.parseUrn(this.urn),
      r = s.type,
      n = t.search({ source: k(this.urn) }).firstObject() ?? {},
    ...
    if (
      ...
      let R = n.fcode_name;
      o["Place Type"] = l`${R.charAt(0).toUpperCase()}${R.slice(1)}`;
    }
    F.has(r) &&
      (o["First Photographed"] = l`<span>${
        this.firstPhotographed(e, t, { target: k(this.urn) })
      }</span>`);
    let h = n[v.WIKIPEDIA],
      a = n[v.BIRDWATCH_URL],
      c = n[v.LONGITUDE],
      ...
      d;
    if (c && p) {
      let R = `https://www.google.com/maps?q=${p},${c}`;
      d = l`
    ...
    let u = k(this.urn);
    u.id === "*" && delete u.id;
    let m = { target: u }, b = this.getPhotoQueries(k(this.urn)), T = {};
    for (let { query: R, label: _t } of b) {
      let We = this.urnImages(t, R);
      T[_t] = this.renderSubjectPhotos(We);
    }
    let B = this.renderSubjectAlbums(t, m), ot = this.renderPhotoSection(T);
    return l`
      <div>
      <section class="thing-page">
        ...
        <p>
          ${
      F.has(r) && s.id !== "*"
        ? l`<span class="thing-binomial">(${W.pretty(s.id)})</span>`
        : l``
    }
        </p>
        <br>
...
customElements.define("thing-page", ee);
var xt = class {
  static loadingMode(t) {
...
var _s = new wt(),
  ie = class i extends f {
    static {
      this.DEFAULT_PAGE = g.ALBUMS;
    }
    static {
      this.LOCATION_TYPE_TO_PAGE = {
        album: g.ALBUM,
        albums: g.ALBUMS,
        photos: g.PHOTOS,
        metadata: g.METADATA,
    ...
    connectedCallback() {
      super.connectedCallback(),
        ...
        (async () => {
          let t = [];
          this.tribbleDB || (this.tribbleDB = new Be([]));
          ...
          t.length && this.tribbleDB.add(t);
          let e = [Fe, Ve, qe, ze];
          this.tribbleDB = this.tribbleDB.flatMap((s) => {
            let r = [s];
            for (let n of e) r = r.flatMap(n);
            return r;
          }), this.requestUpdate();
        })();
    }
    ...
    receiveClickAlbum(t) {
      ...
      this.page = g.PHOTOS, this.id = s, this.title = e, O.showAlbumUrl(s);
    }
    ...
    receiveNavigatePage(t) {
      ...
      let e = O.router(this.page);
      e || console.error(`no router found for page ${this.page}`),
        O.pageUsesId(this.page) ? e(this.id) : e();
    }
    pageClasses(t) {
      let e = ["page"];
