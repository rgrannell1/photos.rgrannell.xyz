...
\f\r"'\`<>=]|("|')|))|$)`,"g"),re=/'/g,oe=/"/g,Ae=/^(?:script|style|textarea|title)$/i,ye=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),l=ye(1),We=ye(2),A=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),ne=new WeakMap,I=R.createTreeWalker(R,129);function ve(i,t){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return se!==void 0?se.createHTML(t):t}var we=(i,t)=>{let e=i.length-1,s=[],a,r=t===2?"<svg>":"",o=Y;for(let h=0;h<e;h++){let n=i[h],p,f,c=-1,b=0;for(;b<n.length&&(o.lastIndex=b,f=o.exec(n),f!==null);)b=o.lastIndex,o===Y?f[1]==="!--"?o=ie:f[1]!==void 0?o=ae:f[2]!==void 0?(Ae.test(f[2])&&(a=RegExp("</"+f[2],"g")),o=N):f[3]!==void 0&&(o=N):o===N?f[0]===">"?(o=a??Y,c=-1):f[1]===void 0?c=-2:(c=o.lastIndex-f[2].length,p=f[1],o=f[3]===void 0?N:f[3]==='"'?oe:re):o===oe||o===re?o=N:o===ie||o===ae?o=Y:(o=N,a=void 0);let g=o===N&&i[h+1].startsWith("/>")?" ":"";r+=o===Y?n+Ve:c>=0?(s.push(p),n.slice(0,c)+Ut+n.slice(c)+C+g):n+C+(c===-2?h:g)}return[ve(i,r+(i[e]||"<?>")+(t===2?"</svg>":"")),s]},Z=class i{constructor({strings:t,_$litType$:e},s){let a;this.parts=[];let r=0,o=0,h=t.length-1,n=this.parts,[p,f]=we(t,e);if(this.el=i.createElement(p,s),I.currentNode=this.el.content,e===2){let c=this.el.content.firstChild;c.replaceWith(...c.childNodes)}for(;(a=I.nextNode())!==null&&n.length<h;){if(a.nodeType===1){if(a.hasAttributes())for(let c of a.getAttributeNames())if(c.endsWith(Ut)){let b=f[o++],g=a.getAttribute(c).split(C),v=/([.?@])?(.*)/.exec(b);n.push({type:1,index:r,name:v[2],strings:g,ctor:v[1]==="."?et:v[1]==="?"?st:v[1]==="@"?it:H}),a.removeAttribute(c)}else c.startsWith(C)&&(n.push({type:6,index:r}),a.removeAttribute(c));if(Ae.test(a.tagName)){let c=a.textContent.split(C),b=c.length-1;if(b>0){a.textContent=X?X.emptyScript:"";for(let g=0;g<b;g++)a.append(c[g],V()),I.nextNode(),n.push({type:2,index:++r});a.append(c[b],V())}}}else if(a.nodeType===8)if(a.data===kt)n.push({type:2,index:r});else{let c=-1;for(;(c=a.data.indexOf(C,c+1))!==-1;)n.push({type:7,index:r}),c+=C.length-1}r++}}static createElement(t,e){let s=R.createElement("template");return s.innerHTML=t,s}};function B(i,t,e=i,s){if(t===A)return t;let a=s!==void 0?e.U?.[s]:e.N,r=W(t)?void 0:t._$litDirective$;return a?.constructor!==r&&(a?._$AO?.(!1),r===void 0?a=void 0:(a=new r(i),a._$AT(i,e,s)),s!==void 0?(e.U??=[])[s]=a:e.N=a),a!==void 0&&(t=B(i,a._$AS(i,t.values),a,s)),t}var tt=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}O(t){let{el:{content:e},parts:s}=this._$AD,a=(t?.creationScope??R).importNode(e,!0);I.currentNode=a;let r=I.nextNode(),o=0,h=0,n=s[0];for(;n!==void 0;){if(o===n.index){let p;n.type===2?p=new ct(r,r.nextSibling,this,t):n.type===1?p=new n.ctor(r,n.name,n.strings,this,t):n.type===6&&(p=new at(r,this,t)),this._$AV.push(p),n=s[++h]}o!==n?.index&&(r=I.nextNode(),o++)}return I.currentNode=R,a}R(t){let e=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},ct=class _e{get _$AU(){return this._$AM?._$AU??this.V}constructor(t,e,s,a){this.type=2,this._$AH=$,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=a,this.V=a?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=B(this,t,e),W(t)?t===$||t==null||t===""?(this._$AH!==$&&this._$AR(),this._$AH=$):t!==this._$AH&&t!==A&&this.L(t):t._$litType$!==void 0?this.I(t):t.nodeType!==void 0?this.j(t):$e(t)?this.D(t):this.L(t)}H(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}j(t){this._$AH!==t&&(this._$AR(),this._$AH=this.H(t))}L(t){this._$AH!==$&&W(this._$AH)?this._$AA.nextSibling.data=t:this.j(R.createTextNode(t)),this._$AH=t}I(t){let{values:e,_$litType$:s}=t,a=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=Z.createElement(ve(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===a)this._$AH.R(e);else{let r=new tt(a,this),o=r.O(this.options);r.R(e),this.j(o),this._$AH=r}}_$AC(t){let e=ne.get(t.strings);return e===void 0&&ne.set(t.strings,e=new Z(t)),e}D(t){be(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,s,a=0;for(let r of t)a===e.length?e.push(s=new _e(this.H(V()),this.H(V()),this,this.options)):s=e[a],s._$AI(r),a++;a<e.length&&(this._$AR(s&&s._$AB.nextSibling,a),e.length=a)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){let s=t.nextSibling;t.remove(),t=s}}setConnected(t){this._$AM===void 0&&(this.V=t,this._$AP?.(t))}},H=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,a,r){this.type=1,this._$AH=$,this._$AN=void 0,this.element=t,this.name=e,this._$AM=a,this.options=r,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=$}_$AI(t,e=this,s,a){let r=this.strings,o=!1;if(r===void 0)t=B(this,t,e,0),o=!W(t)||t!==this._$AH&&t!==A,o&&(this._$AH=t);else{let h=t,n,p;for(t=r[0],n=0;n<r.length-1;n++)p=B(this,h[s+n],e,n),p===A&&(p=this._$AH[n]),o||=!W(p)||p!==this._$AH[n],p===$?t=$:t!==$&&(t+=(p??"")+r[n+1]),this._$AH[n]=p}o&&!a&&this.B(t)}B(t){t===$?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},et=class extends H{constructor(){super(...arguments),this.type=3}B(t){this.element[this.name]=t===$?void 0:t}},st=class extends H{constructor(){super(...arguments),this.type=4}B(t){this.element.toggleAttribute(this.name,!!t&&t!==$)}},it=class extends H{constructor(t,e,s,a,r){super(t,e,s,a,r),this.type=5}_$AI(t,e=this){if((t=B(this,t,e,0)??$)===A)return;let s=this._$AH,a=t===$&&s!==$||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,r=t!==$&&(s===$||a);a&&this.element.removeEventListener(this.name,this,s),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},at=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){B(this,t)}},Ze={W:Ut,q:C,J:kt,Z:1,F:we,G:tt,K:$e,X:B,Y:ct,tt:H,st,it,et,ot:at},qe=Tt.litHtmlPolyfillSupport;qe?.(Z,ct),(Tt.litHtmlVersions??=[]).push("3.1.3");var Se=(i,t,e)=>{let s=e?.renderBefore??t,a=s._$litPart$;if(a===void 0){let r=e?.renderBefore??null;s._$litPart$=a=new ct(t.insertBefore(V(),r),r,void 0,e??{})}return a._$AI(i),a};var P=class extends L{constructor(){super(...arguments),this.renderOptions={host:this},this.ht=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this.ht=Se(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this.ht?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this.ht?.setConnected(!1)}render(){return A}};P._$litElement$=!0,P.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:P});var Je=globalThis.litElementPolyfillSupport;Je?.({LitElement:P});(globalThis.litElementVersions??=[]).push("4.0.5");var{Y:Ke}=Ze,Qe=i=>i===null||typeof i!="object"&&typeof i!="function";var le=(i,t)=>t===void 0?i?._$litType$!==void 0:i?._$litType$===t,Xe=i=>i?._$litType$?.h!=null;var xe=i=>i.strings===void 0,he=()=>document.createComment(""),O=(i,t,e)=>{let s=i._$AA.parentNode,a=t===void 0?i._$AB:t._$AA;if(e===void 0){let r=s.insertBefore(he(),a),o=s.insertBefore(he(),a);e=new Ke(r,o,i,i.options)}else{let r=e._$AB.nextSibling,o=e._$AM,h=o!==i;if(h){let n;e._$AQ?.(i),e._$AM=i,e._$AP!==void 0&&(n=i._$AU)!==o._$AU&&e._$AP(n)}if(r!==a||h){let n=e._$AA;for(;n!==r;){let p=n.nextSibling;s.insertBefore(n,a),n=p}}}return e},M=(i,t,e=i)=>(i._$AI(t,e),i),ts={},q=(i,t=ts)=>i._$AH=t,St=i=>i._$AH,yt=i=>{i._$AP?.(!1,!0);let t=i._$AA,e=i._$AB.nextSibling;for(;t!==e;){let s=t.nextSibling;t.remove(),t=s}},Ee=i=>{i._$AR()};var x=i=>(...t)=>({_$litDirective$:i,values:t}),T=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this.nt=t,this._$AM=e,this.rt=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var F=(i,t)=>{let e=i._$AN;if(e===void 0)return!1;for(let s of e)s._$AO?.(t,!1),F(s,t);return!0},rt=i=>{let t,e;do{if((t=i._$AM)===void 0)break;e=t._$AN,e.delete(i),i=t}while(e?.size===0)},Te=i=>{for(let t;t=i._$AM;i=t){let e=t._$AN;if(e===void 0)t._$AN=e=new Set;else if(e.has(i))break;e.add(i),is(t)}};function es(i){this._$AN!==void 0?(rt(this),this._$AM=i,Te(this)):this._$AM=i}function ss(i,t=!1,e=0){let s=this._$AH,a=this._$AN;if(a!==void 0&&a.size!==0)if(t)if(Array.isArray(s))for(let r=e;r<s.length;r++)F(s[r],!1),rt(s[r]);else s!=null&&(F(s,!1),rt(s));else F(this,i)}var is=i=>{i.type==2&&(i._$AP??=ss,i._$AQ??=es)},J=class extends T{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,s){super._$AT(t,e,s),Te(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(F(this,t),rt(this))}setValue(t){if(xe(this.nt))this.nt._$AI(t,this);else{let e=[...this.nt._$AH];e[this.rt]=t,this.nt._$AI(e,this,0)}}disconnected(){}reconnected(){}};var ot=class{constructor(t){this.ct=t}disconnect(){this.ct=void 0}reconnect(t){this.ct=t}deref(){return this.ct}},nt=class{constructor(){this.lt=void 0,this.ut=void 0}get(){return this.lt}pause(){this.lt??=new Promise(t=>this.ut=t)}resume(){this.ut?.(),this.lt=this.ut=void 0}};var lt=class extends J{constructor(){super(...arguments),this.dt=new ot(this),this.ft=new nt}render(t,e){return A}update(t,[e,s]){if(this.isConnected||this.disconnected(),e===this.vt)return A;this.vt=e;let a=0,{dt:r,ft:o}=this;return(async(h,n)=>{for await(let p of h)if(await n(p)===!1)return})(e,async h=>{for(;o.get();)await o.get();let n=r.deref();if(n!==void 0){if(n.vt!==e)return!1;s!==void 0&&(h=s(h,a)),n.commitValue(h,a),a++}return!0}),A}commitValue(t,e){this.setValue(t)}disconnected(){this.dt.disconnect(),this.ft.pause()}reconnected(){this.dt.reconnect(this),this.ft.resume()}},ds=x(lt),ps=x(class extends lt{constructor(i){if(super(i),i.type!==2)throw Error("asyncAppend can only be used in child expressions")}update(i,t){return this.ht=i,super.update(i,t)}commitValue(i,t){t===0&&Ee(this.ht);let e=O(this.ht);M(e,i)}}),ce=i=>Xe(i)?i._$litType$.h:i.strings,us=x(class extends T{constructor(i){super(i),this.yt=new WeakMap}render(i){return[i]}update(i,[t]){let e=le(this.bt)?ce(this.bt):null,s=le(t)?ce(t):null;if(e!==null&&(s===null||e!==s)){let a=St(i).pop(),r=this.yt.get(e);if(r===void 0){let o=document.createDocumentFragment();r=Se($,o),r.setConnected(!1),this.yt.set(e,r)}q(r,[a]),O(r,void 0,a)}if(s!==null){if(e===null||e!==s){let a=this.yt.get(s);if(a!==void 0){let r=St(a).pop();Ee(i),O(i,void 0,r),q(i,[r])}}this.bt=t}else this.bt=void 0;return this.render(t)}});var ms=x(class extends T{constructor(i){if(super(i),i.type!==1||i.name!=="class"||i.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter(t=>i[t]).join(" ")+" "}update(i,[t]){if(this.gt===void 0){this.gt=new Set,i.strings!==void 0&&(this.wt=new Set(i.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(let s in t)t[s]&&!this.wt?.has(s)&&this.gt.add(s);return this.render(t)}let e=i.element.classList;for(let s of this.gt)s in t||(e.remove(s),this.gt.delete(s));for(let s in t){let a=!!t[s];a===this.gt.has(s)||this.wt?.has(s)||(a?(e.add(s),this.gt.add(s)):(e.remove(s),this.gt.delete(s)))}return A}}),as={},gs=x(class extends T{constructor(){super(...arguments),this._t=as}render(i,t){return t()}update(i,[t,e]){if(Array.isArray(t)){if(Array.isArray(this._t)&&this._t.length===t.length&&t.every((s,a)=>s===this._t[a]))return A}else if(this._t===t)return A;return this._t=Array.isArray(t)?Array.from(t):t,this.render(t,e)}});var fs=x(class extends T{constructor(){super(...arguments),this.key=$}render(i,t){return this.key=i,t}update(i,[t,e]){return t!==this.key&&(q(i),this.key=t),e}}),bs=x(class extends T{constructor(i){if(super(i),i.type!==3&&i.type!==1&&i.type!==4)throw Error("The `live` directive is not allowed on child or event bindings");if(!xe(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[t]){if(t===A||t===$)return t;let e=i.element,s=i.name;if(i.type===3){if(t===e[s])return A;if(i.type===4){if(!!t===e.hasAttribute(s))return A;if(i.type===1&&e.getAttribute(s)===t+"")return A}}return q(i),t}});var vt=new WeakMap,$s=x(class extends J{render(i){return $}update(i,[t]){let e=t!==this.ct;return e&&this.ct!==void 0&&this.St(void 0),(e||this.$t!==this.Tt)&&(this.ct=t,this.xt=i.options?.host,this.St(this.Tt=i.element)),$}St(i){if(typeof this.ct=="function"){let t=this.xt??globalThis,e=vt.get(t);e===void 0&&(e=new WeakMap,vt.set(t,e)),e.get(this.ct)!==void 0&&this.ct.call(this.xt,void 0),e.set(this.ct,i),i!==void 0&&this.ct.call(this.xt,i)}else this.ct.value=i}get $t(){return typeof this.ct=="function"?vt.get(this.xt??globalThis)?.get(this.ct):this.ct?.value}disconnected(){this.$t===this.Tt&&this.St(void 0)}reconnected(){this.St(this.Tt)}}),de=(i,t,e)=>{let s=new Map;for(let a=t;a<=e;a++)s.set(i[a],a);return s},As=x(class extends T{constructor(i){if(super(i),i.type!==2)throw Error("repeat() can only be used in text expressions")}Et(i,t,e){let s;e===void 0?e=t:t!==void 0&&(s=t);let a=[],r=[],o=0;for(let h of i)a[o]=s?s(h,o):o,r[o]=e(h,o),o++;return{values:r,keys:a}}render(i,t,e){return this.Et(i,t,e).values}update(i,[t,e,s]){let a=St(i),{values:r,keys:o}=this.Et(t,e,s);if(!Array.isArray(a))return this.Ct=o,r;let h=this.Ct??=[],n=[],p,f,c=0,b=a.length-1,g=0,v=r.length-1;for(;c<=b&&g<=v;)if(a[c]===null)c++;else if(a[b]===null)b--;else if(h[c]===o[g])n[g]=M(a[c],r[g]),c++,g++;else if(h[b]===o[v])n[v]=M(a[b],r[v]),b--,v--;else if(h[c]===o[v])n[v]=M(a[c],r[v]),O(i,n[v+1],a[c]),c++,v--;else if(h[b]===o[g])n[g]=M(a[b],r[g]),O(i,a[c],a[b]),b--,g++;else if(p===void 0&&(p=de(o,g,v),f=de(h,c,b)),p.has(h[c]))if(p.has(h[b])){let U=f.get(o[g]),G=U!==void 0?a[U]:null;if(G===null){let Kt=O(i,a[c]);M(Kt,r[g]),n[g]=Kt}else n[g]=M(G,r[g]),O(i,a[c],G),a[U]=null;g++}else yt(a[b]),b--;else yt(a[c]),c++;for(;g<=v;){let U=O(i,n[v+1]);M(U,r[g]),n[g++]=U}for(;c<=b;){let U=a[c++];U!==null&&yt(U)}return this.Ct=o,q(i,n),A}}),Ue="important",rs=" !"+Ue,ys=x(class extends T{constructor(i){if(super(i),i.type!==1||i.name!=="style"||i.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(i){return Object.keys(i).reduce((t,e)=>{let s=i[e];return s==null?t:t+`${e=e.includes("-")?e:e.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(i,[t]){let{style:e}=i.element;if(this.Pt===void 0)return this.Pt=new Set(Object.keys(t)),this.render(t);for(let s of this.Pt)t[s]==null&&(this.Pt.delete(s),s.includes("-")?e.removeProperty(s):e[s]=null);for(let s in t){let a=t[s];if(a!=null){this.Pt.add(s);let r=typeof a=="string"&&a.endsWith(rs);s.includes("-")||r?e.setProperty(s,r?a.slice(0,-11):a,r?Ue:""):e[s]=a}}return A}}),vs=x(class extends T{constructor(i){if(super(i),i.type!==2)throw Error("templateContent can only be used in child bindings")}render(i){return this.At===i?A:(this.At=i,document.importNode(i.content,!0))}}),j=class extends T{constructor(t){if(super(t),this.bt=$,t.type!==2)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===$||t==null)return this.kt=void 0,this.bt=t;if(t===A)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.bt)return this.kt;this.bt=t;let e=[t];return e.raw=e,this.kt={_$litType$:this.constructor.resultType,strings:e,values:[]}}};j.directiveName="unsafeHTML",j.resultType=1;var dt=x(j);var K=class extends j{};K.directiveName="unsafeSVG",K.resultType=2;var ws=x(K),pe=i=>!Qe(i)&&typeof i.then=="function",ue=1073741823;var xt=class extends J{constructor(){super(...arguments),this.Mt=ue,this.Ut=[],this.dt=new ot(this),this.ft=new nt}render(...t){return t.find(e=>!pe(e))??A}update(t,e){let s=this.Ut,a=s.length;this.Ut=e;let r=this.dt,o=this.ft;this.isConnected||this.disconnected();for(let h=0;h<e.length&&!(h>this.Mt);h++){let n=e[h];if(!pe(n))return this.Mt=h,n;h<a&&n===s[h]||(this.Mt=ue,a=0,Promise.resolve(n).then(async p=>{for(;o.get();)await o.get();let f=r.deref();if(f!==void 0){let c=f.Ut.indexOf(n);c>-1&&c<f.Mt&&(f.Mt=c,f.setValue(p))}}))}return A}disconnected(){this.dt.disconnect(),this.ft.pause()}reconnected(){this.dt.reconnect(this),this.ft.resume()}},_s=x(xt);var os=Symbol.for(""),ns=i=>{if(i?.r===os)return i?._$litStatic$};var me=new Map,ke=i=>(t,...e)=>{let s=e.length,a,r,o=[],h=[],n,p=0,f=!1;for(;p<s;){for(n=t[p];p<s&&(r=e[p],(a=ns(r))!==void 0);)n+=a+t[++p],f=!0;p!==s&&h.push(r),o.push(n),p++}if(p===s&&o.push(t[s]),f){let c=o.join("$$lit$$");(t=me.get(c))===void 0&&(o.raw=o,me.set(c,t=o)),e=h}return i(t,...e)},Ss=ke(l),xs=ke(We);var u=class extends P{createRenderRoot(){return this}broadcast(t,e){return()=>{let s=new CustomEvent(t,{detail:e,bubbles:!0,composed:!0});this.dispatchEvent(s)}}};var pt=Symbol("the albums manifest"),ut=Symbol("the images manifest"),Bs=Symbol("the site manifest"),mt=Symbol("metadata about the site manfiest"),Ce=53.33306,Me=-6.24889,Le=6,Oe="photos",m=class{static EAGER="eager";static LAZY="lazy"},d=class{static PHOTOS="photos";static ALBUMS="albums";static DATE="date";static LOCATIONS="locations";static ALBUM="album";static STATS="stats";static TAG="tag";static TAG_ALBUM="tag-album";static TAGS="tags";static METADATA="metadata";static ABOUT="about"};async function ls(){return await(await fetch("/manifest/env.json")).json()}var Pe=await ls(),gt=class{_data;constructor(t=`/manifest/images.${Pe.publication_id}.json`){this.url=t}processImages(t){let e=t[0],s=[];for(let a of t.slice(1)){let r={};for(let o=0;o<e.length;o++)r[e[o]]=a[o];s.push(r)}return s}async init(){if(window[ut]&&(this._data=window[ut]),this._data||this.loading)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.processImages(t);window[ut]=e,this._data=e}images(){return this._data.map(t=>({...t,tags:(t.tags??"").split(",").filter(e=>e!="Published").map(e=>e.trim())}))}},ft=class{_data;constructor(t=`/manifest/albums.${Pe.publication_id}.json`){this.url=t}processAlbums(t){let e=t[0],s=[];for(let a of t.slice(1)){let r={};for(let o=0;o<e.length;o++)r[e[o]]=a[o];s.push(r)}return s}async init(){if(window[pt]&&(this._data=window[pt]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.processAlbums(t);window[pt]=e,this._data=e}albums(){return this._data}};function De(i,t,e){if(!i.hasOwnProperty(t))return!1;let s=i[t];if(s.includes(e))return!0;for(let a of s)if(De(i,a,e))return!0;return!1}var bt=class{_data;constructor(t="/manifest/metadata.json"){this.url=t}async init(){if(window[mt]&&(this._data=window[mt]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json();window[mt]=t,this._data=t}metadata(){return this._data}isChild(t,e){return De(this._data,t,e)}childrenOf(t,e){let s=new Set([]);for(let a of e)this.isChild(t,a)&&s.add(a);return s}};var w=class{static showAboutUrl(){window.location.hash="#/about",document.title="About - photos"}static showAlbumsUrl(){window.location.hash="#/albums",document.title="Albums - photos"}static showPhotosUrl(){window.location.hash="#/photos",document.title="Photos - photos"}static showAlbumUrl(t){window.location.hash=`#/album/${t}`,document.title="Album - photos"}static showPhotoUrl(t){window.location.hash=`#/photo/${t}`,document.title="Photo - photos"}static showDateUrl(t){window.location.hash=`#/date/${t}`,document.title="Date - photos"}static showLocationsUrl(){window.location.hash="#/locations",document.title="Locations - photos"}static showTagsUrl(){window.location.hash="#/tags",document.title="Tags - photos"}static showStatsUrl(){window.location.hash="#/stats",document.title="Stats - photos"}static showMetadataUrl(t){window.location.hash=`#/metadata/${t}`,document.title="Metadata - photos"}static showTagAlbumUrl(t){window.location.hash=`#/tag/${encodeURIComponent(t)}`,document.title="Tag - photos"}static getUrl(){return window.location.hash.startsWith("#/albums")?{type:"albums"}:window.location.hash.startsWith("#/album")?{type:"album",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/locations")?{type:"locations"}:window.location.hash.startsWith("#/tags")?{type:"tags"}:window.location.hash.startsWith("#/tag")?{type:"tag-album",tag:decodeURIComponent(window.location.hash.split("/")[2])}:window.location.hash.startsWith("#/stats")?{type:"stats"}:window.location.hash.startsWith("#/metadata")?{type:"metadata",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/date")?{type:"date",date:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/photos")?{type:"photos"}:window.location.hash.startsWith("#/about")?{type:"about"}:{type:"albums"}}};var Ct=class extends u{static get properties(){return{visible:{type:Boolean}}}render(){let t=["photo-sidebar"];return this.visible&&t.push("sidebar-visible"),l`
    ...
    `}};customElements.define("photo-sidebar",Ct);var Mt=class extends u{static get properties(){return{darkMode:{type:Boolean},tag:{type:String}}}feedUrl(){return this.tag?`/feeds/tags/${this.tag}.json`:"/feeds/index.json"}render(){let t=this.darkMode?"\u2600\uFE0F":"\u{1F319}",e=Oe;return l`
    ...
    `}};customElements.define("photo-header",Mt);var Lt=class extends u{static get properties(){return{id:{type:String},imageUrl:{type:String},thumbnailDataUrl:{type:String},thumbnailUrl:{type:String},tags:{type:Array},loading:{type:String}}}renderIcon(){return l`
    ...
    `}};customElements.define("photo-album-page",Nt);var It=class extends u{static get properties(){return{albums:{type:Object}}}connectedCallback(){super.connectedCallback(),y.setIndex()}firstUpdated(){super.firstUpdated();let t=this.querySelector("#map"),e=createMap(t).setView([Ce,Me],Le);e.addLayer(tileLayer("http://{s}.tile.osm.org/{z}/{x}/{y}.png",{minZoom:4}));let a=this.albums.albums();for(let r of Object.values(a)){let o=r.geolocation;o&&geoJSON(o,{style:function(){return{color:"red"}},onEachFeature:(h,n)=>{let p=`
            <section>
              <h3>${r.name}</h3>
            ...
            `;n.bindPopup(p)}}).addTo(e)}}render(){return l`
    <section>
      <h1>Locations</h1>

      <div id="map"></div>
    </section>
    `}};customElements.define("locations-page",It);var Rt=class extends u{static get properties(){return{title:{type:String},url:{type:String},sharing:{state:!0,type:Boolean}}}async shareAlbum(t){if(!navigator.share)console.error("navigator.share not available");else{this.sharing=!0;try{await navigator.share({title:`${this.title} - photos.rgrannell.xyz`,url:t})}finally{this.sharing=!1}}}render(){return this.sharing?l`<button class="photo-share-button" disabled>[sharing...]</button>`:l`
      <button class="photo-share-button" ?disabled=${!navigator.share} @click=${this.shareAlbum.bind(this,this.url)}>[share]</button>
      `}};customElements.define("album-share-button",Rt);var $t=class i{static setXTheEverythingAppFormallyKnownAsTwitter(t){let e=document.querySelector('meta[property="twitter:url"]');e.setAttribute("content",t.url),document.querySelector('meta[name="twitter:title"]').setAttribute("content",t.title),document.querySelector('meta[name="twitter:description"]').setAttribute("content",t.description),document.querySelector('meta[name="twitter:image"]').setAttribute("content",t.image),console.log(e)}static setOpenGraph(t){document.querySelector('meta[property="og:url"]').setAttribute("content",t.url),document.querySelector('meta[property="og:title"]').setAttribute("content",t.title),document.querySelector('meta[property="og:description"]').setAttribute("content",t.description),document.querySelector('meta[property="og:image"]').setAttribute("content",t.image)}static set(t){i.setXTheEverythingAppFormallyKnownAsTwitter(t),i.setOpenGraph(t)}};var Bt=class extends u{static get properties(){return{title:{type:String},id:{type:String},minDate:{type:String},maxDate:{type:String},imageCount:{type:Number},description:{type:String},images:{type:Object}}}connectedCallback(){super.connectedCallback();let t=this.albumPhotos()[0];t||console.error(`empty album! ${this.id}`),$t.set({url:window.location.href,title:this.title,description:this.description,image:t.thumbnail_url}),y.setIndex()}albumPhotos(){return this.images.images().filter(t=>t.album_id===this.id)}renderPhotoCount(){return this.imageCount===1?`${this.imageCount} photo`:`${this.imageCount} photos`}render(){let t=window.matchMedia("(max-width: 500px)"),e=k.dateRange(this.minDate,this.maxDate,t.matches),s=this.albumPhotos().map((a,r)=>l`
      <app-photo
        id=${a.id}
        tags="${a.tags}"
    ...
    `}};customElements.define("album-page",Bt);var Ht=class extends u{connectedCallback(){super.connectedCallback(),y.setIndex()}render(){return l`
    <section>
      <h1>Statistics</h1>
    </section>
    `}};customElements.define("stats-page",Ht);var jt=class extends u{static get properties(){return{tag:{type:String},images:{type:Object}}}connectedCallback(){super.connectedCallback(),y.setTag(this.tag)}photos(){return this.images.images().filter(t=>t.tags.includes(this.tag))}imageCount(){return this.photos().length}render(){let t=window.matchMedia("(max-width: 500px)"),[e,s]=k.findRange(this.photos()),a=k.dateRange(e,s,t.matches);return l`
    <div>
      <section class="photos-metadata">
        <h1>${this.tag}</h1>
    ...
    `}};customElements.define("tag-page",jt);var Gt=class extends u{static get properties(){return{tagName:{type:String},count:{type:Number}}}render(){let{tagName:t,count:e}=this,s=encodeURIComponent(t);return typeof e>"u"?l`<a
        href="#/tag/${s}"
        @click=${this.broadcast("click-tag",{tagName:t})}>${t}</a>`:l`<a
      href="#/tag/${s}"
      rel="tag"
      @click=${this.broadcast("click-tag",{tagName:t})}>${t}</a> (${e})`}};customElements.define("tag-link",Gt);var Yt=class extends u{static get properties(){return{tagName:{type:String},url:{type:String},thumbnailDataUrl:{type:String},links:{type:Object},loading:{type:String}}}hidePlaceholder(t){this.broadcast("photo-loaded",{url:this.thumbnailUrl})();let e=t.target.parentNode.querySelector(".thumbnail-placeholder");e.style.zIndex=-1}render(){let{tagName:t}=this;return l`<div class="photo-album">
      <img class="thumbnail-image thumbnail-placeholder" width="400" height="400" src="${this.thumbnailDataUrl}"/>
    ...
    `}};customElements.define("date-page",Wt);var Zt=class extends u{static get properties(){return{}}connectedCallback(){super.connectedCallback(),y.setIndex()}render(){return l`
    <div>
