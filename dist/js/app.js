...
\f\r"'\`<>=]|("|')|))|$)`,"g"),be=/'/g,Ae=/"/g,Ce=/^(?:script|style|textarea|title)$/i,Oe=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),c=Oe(1),os=Oe(2),y=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),ye=new WeakMap,G=j.createTreeWalker(j,129);function De(i,t){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return ge!==void 0?ge.createHTML(t):t}var Pe=(i,t)=>{let e=i.length-1,s=[],r,o=t===2?"<svg>":"",a=Z;for(let h=0;h<e;h++){let n=i[h],m,f,p=-1,$=0;for(;$<n.length&&(a.lastIndex=$,f=a.exec(n),f!==null);)$=a.lastIndex,a===Z?f[1]==="!--"?a=fe:f[1]!==void 0?a=$e:f[2]!==void 0?(Ce.test(f[2])&&(r=RegExp("</"+f[2],"g")),a=B):f[3]!==void 0&&(a=B):a===B?f[0]===">"?(a=r??Z,p=-1):f[1]===void 0?p=-2:(p=a.lastIndex-f[2].length,m=f[1],a=f[3]===void 0?B:f[3]==='"'?Ae:be):a===Ae||a===be?a=B:a===fe||a===$e?a=Z:(a=B,r=void 0);let g=a===B&&i[h+1].startsWith("/>")?" ":"";o+=a===Z?n+rs:p>=0?(s.push(m),n.slice(0,p)+Bt+n.slice(p)+C+g):n+C+(p===-2?h:g)}return[De(i,o+(i[e]||"<?>")+(t===2?"</svg>":"")),s]},K=class i{constructor({strings:t,_$litType$:e},s){let r;this.parts=[];let o=0,a=0,h=t.length-1,n=this.parts,[m,f]=Pe(t,e);if(this.el=i.createElement(m,s),G.currentNode=this.el.content,e===2){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(r=G.nextNode())!==null&&n.length<h;){if(r.nodeType===1){if(r.hasAttributes())for(let p of r.getAttributeNames())if(p.endsWith(Bt)){let $=f[a++],g=r.getAttribute(p).split(C),_=/([.?@])?(.*)/.exec($);n.push({type:1,index:o,name:_[2],strings:g,ctor:_[1]==="."?ot:_[1]==="?"?at:_[1]==="@"?nt:Y}),r.removeAttribute(p)}else p.startsWith(C)&&(n.push({type:6,index:o}),r.removeAttribute(p));if(Ce.test(r.tagName)){let p=r.textContent.split(C),$=p.length-1;if($>0){r.textContent=it?it.emptyScript:"";for(let g=0;g<$;g++)r.append(p[g],q()),G.nextNode(),n.push({type:2,index:++o});r.append(p[$],q())}}}else if(r.nodeType===8)if(r.data===Gt)n.push({type:2,index:o});else{let p=-1;for(;(p=r.data.indexOf(C,p+1))!==-1;)n.push({type:7,index:o}),p+=C.length-1}o++}}static createElement(t,e){let s=j.createElement("template");return s.innerHTML=t,s}};function H(i,t,e=i,s){if(t===y)return t;let r=s!==void 0?e.U?.[s]:e.N,o=J(t)?void 0:t._$litDirective$;return r?.constructor!==o&&(r?._$AO?.(!1),o===void 0?r=void 0:(r=new o(i),r._$AT(i,e,s)),s!==void 0?(e.U??=[])[s]=r:e.N=r),r!==void 0&&(t=H(i,r._$AS(i,t.values),r,s)),t}var rt=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}O(t){let{el:{content:e},parts:s}=this._$AD,r=(t?.creationScope??j).importNode(e,!0);G.currentNode=r;let o=G.nextNode(),a=0,h=0,n=s[0];for(;n!==void 0;){if(a===n.index){let m;n.type===2?m=new mt(o,o.nextSibling,this,t):n.type===1?m=new n.ctor(o,n.name,n.strings,this,t):n.type===6&&(m=new lt(o,this,t)),this._$AV.push(m),n=s[++h]}a!==n?.index&&(o=G.nextNode(),a++)}return G.currentNode=j,r}R(t){let e=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},mt=class Re{get _$AU(){return this._$AM?._$AU??this.V}constructor(t,e,s,r){this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=r,this.V=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=H(this,t,e),J(t)?t===b||t==null||t===""?(this._$AH!==b&&this._$AR(),this._$AH=b):t!==this._$AH&&t!==y&&this.L(t):t._$litType$!==void 0?this.I(t):t.nodeType!==void 0?this.j(t):ke(t)?this.D(t):this.L(t)}H(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}j(t){this._$AH!==t&&(this._$AR(),this._$AH=this.H(t))}L(t){this._$AH!==b&&J(this._$AH)?this._$AA.nextSibling.data=t:this.j(j.createTextNode(t)),this._$AH=t}I(t){let{values:e,_$litType$:s}=t,r=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=K.createElement(De(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===r)this._$AH.R(e);else{let o=new rt(r,this),a=o.O(this.options);o.R(e),this.j(a),this._$AH=o}}_$AC(t){let e=ye.get(t.strings);return e===void 0&&ye.set(t.strings,e=new K(t)),e}D(t){Me(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,s,r=0;for(let o of t)r===e.length?e.push(s=new Re(this.H(q()),this.H(q()),this,this.options)):s=e[r],s._$AI(o),r++;r<e.length&&(this._$AR(s&&s._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){let s=t.nextSibling;t.remove(),t=s}}setConnected(t){this._$AM===void 0&&(this.V=t,this._$AP?.(t))}},Y=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,r,o){this.type=1,this._$AH=b,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=b}_$AI(t,e=this,s,r){let o=this.strings,a=!1;if(o===void 0)t=H(this,t,e,0),a=!J(t)||t!==this._$AH&&t!==y,a&&(this._$AH=t);else{let h=t,n,m;for(t=o[0],n=0;n<o.length-1;n++)m=H(this,h[s+n],e,n),m===y&&(m=this._$AH[n]),a||=!J(m)||m!==this._$AH[n],m===b?t=b:t!==b&&(t+=(m??"")+o[n+1]),this._$AH[n]=m}a&&!r&&this.B(t)}B(t){t===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},ot=class extends Y{constructor(){super(...arguments),this.type=3}B(t){this.element[this.name]=t===b?void 0:t}},at=class extends Y{constructor(){super(...arguments),this.type=4}B(t){this.element.toggleAttribute(this.name,!!t&&t!==b)}},nt=class extends Y{constructor(t,e,s,r,o){super(t,e,s,r,o),this.type=5}_$AI(t,e=this){if((t=H(this,t,e,0)??b)===y)return;let s=this._$AH,r=t===b&&s!==b||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==b&&(s===b||r);r&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},lt=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){H(this,t)}},as={W:Bt,q:C,J:Gt,Z:1,F:Pe,G:rt,K:ke,X:H,Y:mt,tt:Y,st:at,it:nt,et:ot,ot:lt},ns=It.litHtmlPolyfillSupport;ns?.(K,mt),(It.litHtmlVersions??=[]).push("3.1.3");var Ne=(i,t,e)=>{let s=e?.renderBefore??t,r=s._$litPart$;if(r===void 0){let o=e?.renderBefore??null;s._$litPart$=r=new mt(t.insertBefore(q(),o),o,void 0,e??{})}return r._$AI(i),r};var N=class extends P{constructor(){super(...arguments),this.renderOptions={host:this},this.ht=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this.ht=Ne(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this.ht?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this.ht?.setConnected(!1)}render(){return y}};N._$litElement$=!0,N.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:N});var ls=globalThis.litElementPolyfillSupport;ls?.({LitElement:N});(globalThis.litElementVersions??=[]).push("4.0.5");var{Y:cs}=as,hs=i=>i===null||typeof i!="object"&&typeof i!="function";var _e=(i,t)=>t===void 0?i?._$litType$!==void 0:i?._$litType$===t,ds=i=>i?._$litType$?.h!=null;var Ie=i=>i.strings===void 0,ve=()=>document.createComment(""),R=(i,t,e)=>{let s=i._$AA.parentNode,r=t===void 0?i._$AB:t._$AA;if(e===void 0){let o=s.insertBefore(ve(),r),a=s.insertBefore(ve(),r);e=new cs(o,a,i,i.options)}else{let o=e._$AB.nextSibling,a=e._$AM,h=a!==i;if(h){let n;e._$AQ?.(i),e._$AM=i,e._$AP!==void 0&&(n=i._$AU)!==a._$AU&&e._$AP(n)}if(o!==r||h){let n=e._$AA;for(;n!==o;){let m=n.nextSibling;s.insertBefore(n,r),n=m}}}return e},D=(i,t,e=i)=>(i._$AI(t,e),i),ps={},X=(i,t=ps)=>i._$AH=t,Pt=i=>i._$AH,kt=i=>{i._$AP?.(!1,!0);let t=i._$AA,e=i._$AB.nextSibling;for(;t!==e;){let s=t.nextSibling;t.remove(),t=s}},Be=i=>{i._$AR()};var x=i=>(...t)=>({_$litDirective$:i,values:t}),M=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this.nt=t,this._$AM=e,this.rt=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var W=(i,t)=>{let e=i._$AN;if(e===void 0)return!1;for(let s of e)s._$AO?.(t,!1),W(s,t);return!0},ct=i=>{let t,e;do{if((t=i._$AM)===void 0)break;e=t._$AN,e.delete(i),i=t}while(e?.size===0)},Ge=i=>{for(let t;t=i._$AM;i=t){let e=t._$AN;if(e===void 0)t._$AN=e=new Set;else if(e.has(i))break;e.add(i),gs(t)}};function us(i){this._$AN!==void 0?(ct(this),this._$AM=i,Ge(this)):this._$AM=i}function ms(i,t=!1,e=0){let s=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(t)if(Array.isArray(s))for(let o=e;o<s.length;o++)W(s[o],!1),ct(s[o]);else s!=null&&(W(s,!1),ct(s));else W(this,i)}var gs=i=>{i.type==2&&(i._$AP??=ms,i._$AQ??=us)},Q=class extends M{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,s){super._$AT(t,e,s),Ge(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(W(this,t),ct(this))}setValue(t){if(Ie(this.nt))this.nt._$AI(t,this);else{let e=[...this.nt._$AH];e[this.rt]=t,this.nt._$AI(e,this,0)}}disconnected(){}reconnected(){}};var ht=class{constructor(t){this.ct=t}disconnect(){this.ct=void 0}reconnect(t){this.ct=t}deref(){return this.ct}},dt=class{constructor(){this.lt=void 0,this.ut=void 0}get(){return this.lt}pause(){this.lt??=new Promise(t=>this.ut=t)}resume(){this.ut?.(),this.lt=this.ut=void 0}};var pt=class extends Q{constructor(){super(...arguments),this.dt=new ht(this),this.ft=new dt}render(t,e){return y}update(t,[e,s]){if(this.isConnected||this.disconnected(),e===this.vt)return y;this.vt=e;let r=0,{dt:o,ft:a}=this;return(async(h,n)=>{for await(let m of h)if(await n(m)===!1)return})(e,async h=>{for(;a.get();)await a.get();let n=o.deref();if(n!==void 0){if(n.vt!==e)return!1;s!==void 0&&(h=s(h,r)),n.commitValue(h,r),r++}return!0}),y}commitValue(t,e){this.setValue(t)}disconnected(){this.dt.disconnect(),this.ft.pause()}reconnected(){this.dt.reconnect(this),this.ft.resume()}},ws=x(pt),Ss=x(class extends pt{constructor(i){if(super(i),i.type!==2)throw Error("asyncAppend can only be used in child expressions")}update(i,t){return this.ht=i,super.update(i,t)}commitValue(i,t){t===0&&Be(this.ht);let e=R(this.ht);D(e,i)}}),we=i=>ds(i)?i._$litType$.h:i.strings,Es=x(class extends M{constructor(i){super(i),this.yt=new WeakMap}render(i){return[i]}update(i,[t]){let e=_e(this.bt)?we(this.bt):null,s=_e(t)?we(t):null;if(e!==null&&(s===null||e!==s)){let r=Pt(i).pop(),o=this.yt.get(e);if(o===void 0){let a=document.createDocumentFragment();o=Ne(b,a),o.setConnected(!1),this.yt.set(e,o)}X(o,[r]),R(o,void 0,r)}if(s!==null){if(e===null||e!==s){let r=this.yt.get(s);if(r!==void 0){let o=Pt(r).pop();Be(i),R(i,void 0,o),X(i,[o])}}this.bt=t}else this.bt=void 0;return this.render(t)}});var xs=x(class extends M{constructor(i){if(super(i),i.type!==1||i.name!=="class"||i.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter(t=>i[t]).join(" ")+" "}update(i,[t]){if(this.gt===void 0){this.gt=new Set,i.strings!==void 0&&(this.wt=new Set(i.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(let s in t)t[s]&&!this.wt?.has(s)&&this.gt.add(s);return this.render(t)}let e=i.element.classList;for(let s of this.gt)s in t||(e.remove(s),this.gt.delete(s));for(let s in t){let r=!!t[s];r===this.gt.has(s)||this.wt?.has(s)||(r?(e.add(s),this.gt.add(s)):(e.remove(s),this.gt.delete(s)))}return y}}),fs={},Ts=x(class extends M{constructor(){super(...arguments),this._t=fs}render(i,t){return t()}update(i,[t,e]){if(Array.isArray(t)){if(Array.isArray(this._t)&&this._t.length===t.length&&t.every((s,r)=>s===this._t[r]))return y}else if(this._t===t)return y;return this._t=Array.isArray(t)?Array.from(t):t,this.render(t,e)}});var Us=x(class extends M{constructor(){super(...arguments),this.key=b}render(i,t){return this.key=i,t}update(i,[t,e]){return t!==this.key&&(X(i),this.key=t),e}}),Ls=x(class extends M{constructor(i){if(super(i),i.type!==3&&i.type!==1&&i.type!==4)throw Error("The `live` directive is not allowed on child or event bindings");if(!Ie(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[t]){if(t===y||t===b)return t;let e=i.element,s=i.name;if(i.type===3){if(t===e[s])return y;if(i.type===4){if(!!t===e.hasAttribute(s))return y;if(i.type===1&&e.getAttribute(s)===t+"")return y}}return X(i),t}});var Ct=new WeakMap,Ms=x(class extends Q{render(i){return b}update(i,[t]){let e=t!==this.ct;return e&&this.ct!==void 0&&this.St(void 0),(e||this.$t!==this.Tt)&&(this.ct=t,this.xt=i.options?.host,this.St(this.Tt=i.element)),b}St(i){if(typeof this.ct=="function"){let t=this.xt??globalThis,e=Ct.get(t);e===void 0&&(e=new WeakMap,Ct.set(t,e)),e.get(this.ct)!==void 0&&this.ct.call(this.xt,void 0),e.set(this.ct,i),i!==void 0&&this.ct.call(this.xt,i)}else this.ct.value=i}get $t(){return typeof this.ct=="function"?Ct.get(this.xt??globalThis)?.get(this.ct):this.ct?.value}disconnected(){this.$t===this.Tt&&this.St(void 0)}reconnected(){this.St(this.Tt)}}),Se=(i,t,e)=>{let s=new Map;for(let r=t;r<=e;r++)s.set(i[r],r);return s},ks=x(class extends M{constructor(i){if(super(i),i.type!==2)throw Error("repeat() can only be used in text expressions")}Et(i,t,e){let s;e===void 0?e=t:t!==void 0&&(s=t);let r=[],o=[],a=0;for(let h of i)r[a]=s?s(h,a):a,o[a]=e(h,a),a++;return{values:o,keys:r}}render(i,t,e){return this.Et(i,t,e).values}update(i,[t,e,s]){let r=Pt(i),{values:o,keys:a}=this.Et(t,e,s);if(!Array.isArray(r))return this.Ct=a,o;let h=this.Ct??=[],n=[],m,f,p=0,$=r.length-1,g=0,_=o.length-1;for(;p<=$&&g<=_;)if(r[p]===null)p++;else if(r[$]===null)$--;else if(h[p]===a[g])n[g]=D(r[p],o[g]),p++,g++;else if(h[$]===a[_])n[_]=D(r[$],o[_]),$--,_--;else if(h[p]===a[_])n[_]=D(r[p],o[_]),R(i,n[_+1],r[p]),p++,_--;else if(h[$]===a[g])n[g]=D(r[$],o[g]),R(i,r[p],r[$]),$--,g++;else if(m===void 0&&(m=Se(a,g,_),f=Se(h,p,$)),m.has(h[p]))if(m.has(h[$])){let k=f.get(a[g]),V=k!==void 0?r[k]:null;if(V===null){let he=R(i,r[p]);D(he,o[g]),n[g]=he}else n[g]=D(V,o[g]),R(i,r[p],V),r[k]=null;g++}else kt(r[$]),$--;else kt(r[p]),p++;for(;g<=_;){let k=R(i,n[_+1]);D(k,o[g]),n[g++]=k}for(;p<=$;){let k=r[p++];k!==null&&kt(k)}return this.Ct=a,X(i,n),y}}),je="important",$s=" !"+je,Cs=x(class extends M{constructor(i){if(super(i),i.type!==1||i.name!=="style"||i.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(i){return Object.keys(i).reduce((t,e)=>{let s=i[e];return s==null?t:t+`${e=e.includes("-")?e:e.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(i,[t]){let{style:e}=i.element;if(this.Pt===void 0)return this.Pt=new Set(Object.keys(t)),this.render(t);for(let s of this.Pt)t[s]==null&&(this.Pt.delete(s),s.includes("-")?e.removeProperty(s):e[s]=null);for(let s in t){let r=t[s];if(r!=null){this.Pt.add(s);let o=typeof r=="string"&&r.endsWith($s);s.includes("-")||o?e.setProperty(s,o?r.slice(0,-11):r,o?je:""):e[s]=r}}return y}}),Os=x(class extends M{constructor(i){if(super(i),i.type!==2)throw Error("templateContent can only be used in child bindings")}render(i){return this.At===i?y:(this.At=i,document.importNode(i.content,!0))}}),z=class extends M{constructor(t){if(super(t),this.bt=b,t.type!==2)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===b||t==null)return this.kt=void 0,this.bt=t;if(t===y)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.bt)return this.kt;this.bt=t;let e=[t];return e.raw=e,this.kt={_$litType$:this.constructor.resultType,strings:e,values:[]}}};z.directiveName="unsafeHTML",z.resultType=1;var gt=x(z);var tt=class extends z{};tt.directiveName="unsafeSVG",tt.resultType=2;var Ds=x(tt),Ee=i=>!hs(i)&&typeof i.then=="function",xe=1073741823;var Rt=class extends Q{constructor(){super(...arguments),this.Mt=xe,this.Ut=[],this.dt=new ht(this),this.ft=new dt}render(...t){return t.find(e=>!Ee(e))??y}update(t,e){let s=this.Ut,r=s.length;this.Ut=e;let o=this.dt,a=this.ft;this.isConnected||this.disconnected();for(let h=0;h<e.length&&!(h>this.Mt);h++){let n=e[h];if(!Ee(n))return this.Mt=h,n;h<r&&n===s[h]||(this.Mt=xe,r=0,Promise.resolve(n).then(async m=>{for(;a.get();)await a.get();let f=o.deref();if(f!==void 0){let p=f.Ut.indexOf(n);p>-1&&p<f.Mt&&(f.Mt=p,f.setValue(m))}}))}return y}disconnected(){this.dt.disconnect(),this.ft.pause()}reconnected(){this.dt.reconnect(this),this.ft.resume()}},Ps=x(Rt);var bs=Symbol.for(""),As=i=>{if(i?.r===bs)return i?._$litStatic$};var Te=new Map,He=i=>(t,...e)=>{let s=e.length,r,o,a=[],h=[],n,m=0,f=!1;for(;m<s;){for(n=t[m];m<s&&(o=e[m],(r=As(o))!==void 0);)n+=r+t[++m],f=!0;m!==s&&h.push(o),a.push(n),m++}if(m===s&&a.push(t[s]),f){let p=a.join("$$lit$$");(t=Te.get(p))===void 0&&(a.raw=a,Te.set(p,t=a)),e=h}return i(t,...e)},Rs=He(c),Ns=He(os);var u=class extends N{createRenderRoot(){return this}broadcast(t,e){return()=>{let s=new CustomEvent(t,{detail:e,bubbles:!0,composed:!0});this.dispatchEvent(s)}}};var ft=Symbol("the albums manifest"),$t=Symbol("the images manifest"),Ks=Symbol("the site manifest"),bt=Symbol("metadata about the site manifest"),At=Symbol("the videos manifest"),yt=Symbol("the exif data"),_t=Symbol("the semantic data"),Ye=53.33306,ze=-6.24889,Ve=6,Ze="photos",l=class{static EAGER="eager";static LAZY="lazy"},d=class{static PHOTOS="photos";static ALBUMS="albums";static DATE="date";static LOCATIONS="locations";static ALBUM="album";static STATS="stats";static TAG="tag";static TAG_ALBUM="tag-album";static TAGS="tags";static METADATA="metadata";static ABOUT="about";static VIDEOS="videos"};async function ys(i="/manifest/env.json"){return await(await fetch(i)).json()}var et=await ys(),vt=class{_data;constructor(t=`/manifest/images.${et.publication_id}.json`){this.url=t}processImages(t){let e=t[0],s=[];for(let r of t.slice(1)){let o={};for(let a=0;a<e.length;a++)o[e[a]]=r[a];s.push(o)}return s}async init(){if(window[$t]&&(this._data=window[$t]),this._data||this.loading)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.processImages(t);window[$t]=e,this._data=e}images(){return this._data.map(t=>({...t,full_image:`https://photos-cdn.rgrannell.xyz${t.full_image}`,thumbnail_url:`https://photos-cdn.rgrannell.xyz${t.thumbnail_url}`,thumbnail_mosaic_url:`data:image/bmp;base64,${t.thumbnail_mosaic_url}`}))}},wt=class{_data;constructor(t=`/manifest/videos.${et.publication_id}.json`){this.url=t}processVideos(t){let e=t[0],s=[];for(let r of t.slice(1)){let o={};for(let a=0;a<e.length;a++)o[e[a]]=r[a];s.push(o)}return s}async init(){if(window[At]&&(this._data=window[At]),this._data||this.loading)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.processVideos(t);window[At]=e,this._data=e}videos(){return this._data.map(t=>({...t,poster_url:`https://photos-cdn.rgrannell.xyz${t.poster_url}`,video_url_1080p:`https://photos-cdn.rgrannell.xyz${t.video_url_1080p}`,video_url_480p:`https://photos-cdn.rgrannell.xyz${t.video_url_480p}`,video_url_720p:`https://photos-cdn.rgrannell.xyz${t.video_url_720p}`,video_url_unscaled:`https://photos-cdn.rgrannell.xyz${t.video_url_unscaled}`,tags:(t.tags??"").split(",").filter(e=>e!="Published").map(e=>e.trim())}))}},St=class{_data;constructor(t=`/manifest/albums.${et.publication_id}.json`){this.url=t}process(t){let e=t[0],s=[];for(let r of t.slice(1)){let o={};for(let a=0;a<e.length;a++)o[e[a]]=r[a];s.push(o)}return s}async init(){if(window[ft]&&(this._data=window[ft]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.process(t);window[ft]=e,this._data=e}albums(){return this._data.map(t=>({...t,thumbnail_url:`https://photos-cdn.rgrannell.xyz${t.thumbnail_url}`,thumbnail_mosaic_url:`${t.thumbnail_mosaic_url}`}))}},Et=class{_data;constructor(t=`/manifest/exif.${et.publication_id}.json`){this.url=t}process(t){let e=t[0],s=[];for(let r of t.slice(1)){let o={};for(let a=0;a<e.length;a++)o[e[a]]=r[a];s.push(o)}return s}async init(){if(window[yt]&&(this._data=window[yt]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.process(t);window[yt]=e,this._data=e}exif(){return this._data}};function Fe(i,t,e){if(!i.hasOwnProperty(t))return!1;let s=i[t];if(s.includes(e))return!0;for(let r of s)if(Fe(i,r,e))return!0;return!1}var xt=class{_data;constructor(t=`/manifest/semantic.${et.publication_id}.json`){this.url=t}async init(){if(window[_t]&&(this._data=window[_t]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json();window[_t]=t,this._data=t}semantic(){return this._data}},Tt=class{_data;constructor(t="/manifest/metadata.json"){this.url=t}async init(){if(window[bt]&&(this._data=window[bt]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json();window[bt]=t,this._data=t}metadata(){return this._data}isChild(t,e){return Fe(this._data,t,e)}childrenOf(t,e){let s=new Set([]);for(let r of e)this.isChild(t,r)&&s.add(r);return s}};var v=class{static showAboutUrl(){window.location.hash="#/about",document.title="About - photos"}static showAlbumsUrl(){window.location.hash="#/albums",document.title="Albums - photos"}static showPhotosUrl(){window.location.hash="#/photos",document.title="Photos - photos"}static showAlbumUrl(t){window.location.hash=`#/album/${t}`,document.title="Album - photos"}static showPhotoUrl(t){window.location.hash=`#/photo/${t}`,document.title="Photo - photos"}static showDateUrl(t){window.location.hash=`#/date/${t}`,document.title="Date - photos"}static showLocationsUrl(){window.location.hash="#/locations",document.title="Locations - photos"}static showTagsUrl(){window.location.hash="#/tags",document.title="Tags - photos"}static showStatsUrl(){window.location.hash="#/stats",document.title="Stats - photos"}static showMetadataUrl(t){window.location.hash=`#/metadata/${t}`,document.title="Metadata - photos"}static showTagAlbumUrl(t){window.location.hash=`#/tag/${encodeURIComponent(t)}`,document.title="Tag - photos"}static showVideosUrl(){window.location.hash="#/videos",document.title="Videos - photos"}static getUrl(){return window.location.hash.startsWith("#/albums")?{type:"albums"}:window.location.hash.startsWith("#/album")?{type:"album",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/locations")?{type:"locations"}:window.location.hash.startsWith("#/tags")?{type:"tags"}:window.location.hash.startsWith("#/tag")?{type:"tag-album",tag:decodeURIComponent(window.location.hash.split("/")[2])}:window.location.hash.startsWith("#/stats")?{type:"stats"}:window.location.hash.startsWith("#/metadata")?{type:"metadata",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/date")?{type:"date",date:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/photos")?{type:"photos"}:window.location.hash.startsWith("#/about")?{type:"about"}:window.location.hash.startsWith("#/videos")?{type:"videos"}:{type:"albums"}}};var jt=class extends u{static get properties(){return{visible:{type:Boolean}}}render(){let t=["photo-sidebar"];return this.visible&&t.push("sidebar-visible"),c`
    ...
    `}};customElements.define("app-photo",Yt);var zt=class extends u{render(){return c`
    <div class="search-box">
      <input type="text" placeholder="Search...">
    </div>
    `}};customElements.define("search-bar",zt);var I=class{static loadingMode(t){let e=window.innerWidth,s=window.innerHeight,r=400,o=Math.floor(e/r),a=Math.floor(s/r);return t>o*a+1?"lazy":"eager"}};var A=class{static getElement(){return document.getElementById("rss")}static setTag(t){let e=this.getElement();if(!e||!t)return;let s=`/feeds/tags/${t}.json`;e.href=s}static setIndex(){let t=this.getElement();if(!t)return;let e="/manifest/feed.json";t.href=e}};var Vt=class extends u{static get properties(){return{images:{type:Object}}}connectedCallback(){super.connectedCallback(),A.setIndex()}allImages(){return this.images.images()}render(){let t=this.allImages().map((e,s)=>c`
      <app-photo
        id=${e.id}
        tags="${e.tags}"
    ...
    `}};customElements.define("photos-page",Vt);var O=class i{static parse(t){let[e,s]=t.split(" ");return e=e.replace(/:/g,"-"),new Date(`${e} ${s}`)}static formatExifDate(t){if(!t)return t;let e=new Date(t).toISOString(),[s,r]=e.split("T")[0].replace(/\:/g,"-");return`${s.replace(/\:/g,"/")} ${r}`}static findRange(t){let e=1/0,s=-1/0;for(let r of t){if(!r.created_at)continue;let o=i.parse(r.created_at);o<e&&(e=o),o>s&&(s=o)}return[e,s]}static dateRange(t,e,s){if(!t&&!e)return"unknown date";let r=t instanceof Date?t:new Date(parseFloat(t)),o=e instanceof Date?e:new Date(parseFloat(e));if(s){let a={day:"numeric",month:"short"},h=r.toLocaleDateString("en-IE",a),n=o.toLocaleDateString("en-IE",a),m=r.toLocaleDateString("en-IE",{day:"numeric"}),f=o.toLocaleDateString("en-IE",{day:"numeric"}),p=r.toLocaleDateString("en-IE",{month:"short"}),$=o.toLocaleDateString("en-IE",{month:"short"}),g=r.getFullYear(),_=o.getFullYear(),k=p===$,V=g===_;return h===n?`${h} ${g}`:k&&V?`${m} - ${f} ${$} ${g}`:`${h} ${g} - ${n} ${_}`}else{let a={year:"numeric",month:"short",day:"numeric"},h=r.toLocaleDateString("en-IE",a),n=o.toLocaleDateString("en-IE",a);return h===n?h:`${h} \u2014 ${n}`}}};var Zt=class extends u{static get properties(){return{title:{type:String},url:{type:String},thumbnailDataUrl:{type:String},minDate:{type:String},maxDate:{type:String},id:{type:String},count:{type:Number},countries:{type:Array},loading:{type:String}}}dateRange(){if(!this.minDate&&!this.maxDate)return"unknown date";let t=window.matchMedia("(max-width: 500px)");return O.dateRange(this.minDate,this.maxDate,t.matches)}hidePlaceholder(t){this.broadcast("photo-loaded",{url:this.url})();let e=t.target.parentNode.querySelector(".thumbnail-placeholder");e.style.zIndex=-1}render(){return performance.mark(`start-album-render-${this.url}`),c`
    ...
    `}};customElements.define("photo-album-page",Ft);var Wt=class extends u{static get properties(){return{albums:{type:Object}}}connectedCallback(){super.connectedCallback(),A.setIndex()}firstUpdated(){super.firstUpdated();let t=this.querySelector("#map"),e=createMap(t).setView([Ye,ze],Ve);e.addLayer(tileLayer("http://{s}.tile.osm.org/{z}/{x}/{y}.png",{minZoom:4}));let r=this.albums.albums();for(let o of Object.values(r)){let a=o.geolocation;a&&geoJSON(a,{style:function(){return{color:"red"}},onEachFeature:(h,n)=>{let m=`
            <section>
              <h3>${o.name}</h3>
    ...
    <img class="thumbnail-image" src="${t.thumbnail_url}"/>
      ...
      <h3>Rating</h3>
      <p>${s.rating??"unrated"}</p>

      <h3>Photo Subject</h3>
      <p>${s.style??""}</p>

      <h3>Tags</h3>
      <ul class="photo-tag-list">${r}</ul>
    ...
    `}};customElements.define("date-page",oe);var ae=class extends u{static get properties(){return{}}connectedCallback(){super.connectedCallback(),A.setIndex()}render(){return c`
    <div>
    ...
    `}};customElements.define("videos-page",ne);var S=new St,w=new vt,E=new wt,T=new Tt,U=new Et,L=new xt,_s=[[S,l.EAGER],[w,l.EAGER],[E,l.EAGER],[T,l.EAGER],[U,l.EAGER],[L,l.EAGER]],vs={[d.ABOUT]:[[S,l.LAZY],[w,l.LAZY],[E,l.LAZY],[T,l.LAZY],[U,l.LAZY],[L,l.LAZY]],[d.ALBUMS]:[[S,l.EAGER],[w,l.LAZY],[E,l.LAZY],[T,l.LAZY],[U,l.LAZY],[L,l.LAZY]],[d.PHOTOS]:[[S,l.EAGER],[w,l.EAGER],[E,l.EAGER],[T,l.LAZY],[U,l.LAZY],[L,l.LAZY]],[d.VIDEOS]:[[S,l.LAZY],[w,l.LAZY],[E,l.EAGER],[T,l.LAZY],[U,l.LAZY],[L,l.LAZY]],[d.ALBUM]:[[S,l.EAGER],[w,l.EAGER],[E,l.EAGER],[T,l.LAZY],[U,l.LAZY],[L,l.LAZY]],[d.PHOTO]:[[S,l.EAGER],[w,l.EAGER],[E,l.EAGER],[T,l.LAZY],[U,l.EAGER],[L,l.EAGER]],[d.DATE]:[[S,l.EAGER],[w,l.EAGER],[E,l.EAGER],[T,l.LAZY],[U,l.LAZY],[L,l.LAZY]],[d.TAG_ALBUM]:[[S,l.LAZY],[w,l.EAGER],[E,l.EAGER],[T,l.LAZY],[U,l.EAGER],[L,l.EAGER]],[d.TAG]:[[S,l.LAZY],[w,l.EAGER],[E,l.EAGER],[T,l.LAZY],[U,l.EAGER],[L,l.EAGER]],[d.LOCATIONS]:[[S,l.EAGER],[w,l.LAZY],[E,l.LAZY],[T,l.LAZY],[U,l.EAGER],[L,l.EAGER]],[d.METADATA]:[[S,l.LAZY],[w,l.EAGER],[E,l.EAGER],[T,l.EAGER],[U,l.EAGER],[L,l.EAGER]],[d.STATS]:[[S,l.LAZY],[w,l.LAZY],[E,l.LAZY],[T,l.LAZY],[U,l.EAGER],[L,l.EAGER]]},le=class{static async init(){let t=v.getUrl();console.log(`loading ${t?.type}`);let e=vs[t?.type]??_s,s=[];for(let[r,o]of e)o===l.EAGER?s.push(r.init()):o===l.LAZY&&r.init();await Promise.all(s)}};await le.init();var ce=class i extends u{static DEFAULT_PAGE=d.ALBUMS;static LOCATION_TYPE_TO_PAGE={album:d.ALBUM,albums:d.ALBUMS,photos:d.PHOTOS,date:d.DATE,"tag-album":d.TAG_ALBUM,tags:d.TAGS,locations:d.LOCATIONS,stats:d.STATS,metadata:d.METADATA,about:d.ABOUT,videos:d.VIDEOS};static get properties(){return{title:{type:String},page:{type:String},sidebarVisible:{type:Boolean,state:!0},id:{type:String},tags:{type:Array},imageUrl:{type:String},thumbnailUrl:{type:String},route:{type:String},params:{type:Object},query:{type:Object},darkMode:{type:Boolean}}}connectedCallback(){super.connectedCallback(),this.setStateFromUrl(),this.requestUpdate(),window.addEventListener("popstate",this.handlePopState.bind(this)),this.sidebarVisible=!1}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this.handlePopState.bind(this))}handlePopState(){this.setStateFromUrl(),this.requestUpdate()}setStateFromUrl(){let t=v.getUrl();i.LOCATION_TYPE_TO_PAGE[t?.type]?this.page=i.LOCATION_TYPE_TO_PAGE[t.type]:(console.error("did not match pagetype",t?.type),this.page=i.DEFAULT_PAGE),this.page===d.METADATA||this.page===d.ALBUM||this.page===d.METADATA?this.id=t.id:this.page===d.TAG_ALBUM?this.tag=t.tag:this.page===d.DATE&&(this.date=t.date)}receiveClickAlbum(t){let{title:e,id:s}=t.detail;this.page=d.PHOTOS,this.id=s,this.title=e,v.showAlbumUrl(s)}async receiveClickTag(t){let{tagName:e}=t.detail;this.page=d.TAG_ALBUM,this.tag=e,v.showTagAlbumUrl(e)}async receiveClickBurgerMenu(){this.sidebarVisible=!this.sidebarVisible}async receiveClickPhotoMetadata(t){let{id:e,imageUrl:s,thumbnailUrl:r,tags:o}=t.detail;this.page=d.METADATA,this.id=e,this.imageUrl=s,this.thumbnailUrl=r,this.tags=o??[],v.showMetadataUrl(e)}receiveSwitchTheme(t){this.darkMode=!this.darkMode,localStorage.setItem("darkMode",this.darkMode),this.requestUpdate()}receiveNavigatePage(t){this.page=t.detail.page,this.page===d.ABOUT?v.showAboutUrl():this.page===d.PHOTOS?v.showPhotosUrl():this.page===d.ALBUMS?v.showAlbumsUrl():this.page===d.TAGS?v.showTagsUrl():this.page===d.LOCATIONS?v.showLocationsUrl():this.page===d.STATS?v.showStatsUrl():this.page===d.PHOTOS?v.showAlbumUrl(this.id):this.page===d.METADATA?v.showMetadataUrl(this.id):this.page===d.DATE?v.showDateUrl(this.date):this.page===d.VIDEOS?v.showVideosUrl():v.showAlbumsUrl(),this.sidebarVisible=!1}renderPage(t){let e=["page"];if(t&&e.push("sidebar-visible"),!this.page||this.page==="albums")return c`
      ...
      `;if(this.page===d.METADATA){let s=w.images().find(h=>h.id===this.id),r=U.exif().find(h=>h.id===this.id),o=L.semantic().filter(h=>h[0]===this.id),a={};for(let[h,n,m]of o)a[n]?typeof a[n]=="string"&&(a[n]=[a[n],m]):a[n]=m;return s||console.error(`failed to find photo with id ${this.id}`),c`
