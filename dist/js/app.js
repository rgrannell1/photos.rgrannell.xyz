...
\f\r"'\`<>=]|("|')|))|$)`,"g"),$e=/'/g,be=/"/g,Oe=/^(?:script|style|textarea|title)$/i,Ce=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),l=Ce(1),es=Ce(2),y=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),ye=new WeakMap,H=j.createTreeWalker(j,129);function ke(i,t){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return me!==void 0?me.createHTML(t):t}var Re=(i,t)=>{let e=i.length-1,s=[],r,n=t===2?"<svg>":"",o=q;for(let c=0;c<e;c++){let a=i[c],u,g,d=-1,$=0;for(;$<a.length&&(o.lastIndex=$,g=o.exec(a),g!==null);)$=o.lastIndex,o===q?g[1]==="!--"?o=fe:g[1]!==void 0?o=ge:g[2]!==void 0?(Oe.test(g[2])&&(r=RegExp("</"+g[2],"g")),o=B):g[3]!==void 0&&(o=B):o===B?g[0]===">"?(o=r??q,d=-1):g[1]===void 0?d=-2:(d=o.lastIndex-g[2].length,u=g[1],o=g[3]===void 0?B:g[3]==='"'?be:$e):o===be||o===$e?o=B:o===fe||o===ge?o=q:(o=B,r=void 0);let f=o===B&&i[c+1].startsWith("/>")?" ":"";n+=o===q?a+ts:d>=0?(s.push(u),a.slice(0,d)+jt+a.slice(d)+k+f):a+k+(d===-2?c:f)}return[ke(i,n+(i[e]||"<?>")+(t===2?"</svg>":"")),s]},tt=class i{constructor({strings:t,_$litType$:e},s){let r;this.parts=[];let n=0,o=0,c=t.length-1,a=this.parts,[u,g]=Re(t,e);if(this.el=i.createElement(u,s),H.currentNode=this.el.content,e===2){let d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(r=H.nextNode())!==null&&a.length<c;){if(r.nodeType===1){if(r.hasAttributes())for(let d of r.getAttributeNames())if(d.endsWith(jt)){let $=g[o++],f=r.getAttribute(d).split(k),A=/([.?@])?(.*)/.exec($);a.push({type:1,index:n,name:A[2],strings:f,ctor:A[1]==="."?lt:A[1]==="?"?ct:A[1]==="@"?ht:G}),r.removeAttribute(d)}else d.startsWith(k)&&(a.push({type:6,index:n}),r.removeAttribute(d));if(Oe.test(r.tagName)){let d=r.textContent.split(k),$=d.length-1;if($>0){r.textContent=ot?ot.emptyScript:"";for(let f=0;f<$;f++)r.append(d[f],K()),H.nextNode(),a.push({type:2,index:++n});r.append(d[$],K())}}}else if(r.nodeType===8)if(r.data===Yt)a.push({type:2,index:n});else{let d=-1;for(;(d=r.data.indexOf(k,d+1))!==-1;)a.push({type:7,index:n}),d+=k.length-1}n++}}static createElement(t,e){let s=j.createElement("template");return s.innerHTML=t,s}};function Y(i,t,e=i,s){if(t===y)return t;let r=s!==void 0?e.U?.[s]:e.N,n=X(t)?void 0:t._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),n===void 0?r=void 0:(r=new n(i),r._$AT(i,e,s)),s!==void 0?(e.U??=[])[s]=r:e.N=r),r!==void 0&&(t=Y(i,r._$AS(i,t.values),r,s)),t}var at=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}O(t){let{el:{content:e},parts:s}=this._$AD,r=(t?.creationScope??j).importNode(e,!0);H.currentNode=r;let n=H.nextNode(),o=0,c=0,a=s[0];for(;a!==void 0;){if(o===a.index){let u;a.type===2?u=new $t(n,n.nextSibling,this,t):a.type===1?u=new a.ctor(n,a.name,a.strings,this,t):a.type===6&&(u=new dt(n,this,t)),this._$AV.push(u),a=s[++c]}o!==a?.index&&(n=H.nextNode(),o++)}return H.currentNode=j,r}R(t){let e=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},$t=class Pe{get _$AU(){return this._$AM?._$AU??this.V}constructor(t,e,s,r){this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=r,this.V=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Y(this,t,e),X(t)?t===b||t==null||t===""?(this._$AH!==b&&this._$AR(),this._$AH=b):t!==this._$AH&&t!==y&&this.L(t):t._$litType$!==void 0?this.I(t):t.nodeType!==void 0?this.j(t):Le(t)?this.D(t):this.L(t)}H(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}j(t){this._$AH!==t&&(this._$AR(),this._$AH=this.H(t))}L(t){this._$AH!==b&&X(this._$AH)?this._$AA.nextSibling.data=t:this.j(j.createTextNode(t)),this._$AH=t}I(t){let{values:e,_$litType$:s}=t,r=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=tt.createElement(ke(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===r)this._$AH.R(e);else{let n=new at(r,this),o=n.O(this.options);n.R(e),this.j(o),this._$AH=n}}_$AC(t){let e=ye.get(t.strings);return e===void 0&&ye.set(t.strings,e=new tt(t)),e}D(t){Me(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,s,r=0;for(let n of t)r===e.length?e.push(s=new Pe(this.H(K()),this.H(K()),this,this.options)):s=e[r],s._$AI(n),r++;r<e.length&&(this._$AR(s&&s._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){let s=t.nextSibling;t.remove(),t=s}}setConnected(t){this._$AM===void 0&&(this.V=t,this._$AP?.(t))}},G=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,r,n){this.type=1,this._$AH=b,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=n,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=b}_$AI(t,e=this,s,r){let n=this.strings,o=!1;if(n===void 0)t=Y(this,t,e,0),o=!X(t)||t!==this._$AH&&t!==y,o&&(this._$AH=t);else{let c=t,a,u;for(t=n[0],a=0;a<n.length-1;a++)u=Y(this,c[s+a],e,a),u===y&&(u=this._$AH[a]),o||=!X(u)||u!==this._$AH[a],u===b?t=b:t!==b&&(t+=(u??"")+n[a+1]),this._$AH[a]=u}o&&!r&&this.B(t)}B(t){t===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},lt=class extends G{constructor(){super(...arguments),this.type=3}B(t){this.element[this.name]=t===b?void 0:t}},ct=class extends G{constructor(){super(...arguments),this.type=4}B(t){this.element.toggleAttribute(this.name,!!t&&t!==b)}},ht=class extends G{constructor(t,e,s,r,n){super(t,e,s,r,n),this.type=5}_$AI(t,e=this){if((t=Y(this,t,e,0)??b)===y)return;let s=this._$AH,r=t===b&&s!==b||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,n=t!==b&&(s===b||r);r&&this.element.removeEventListener(this.name,this,s),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},dt=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){Y(this,t)}},ss={W:jt,q:k,J:Yt,Z:1,F:Re,G:at,K:Le,X:Y,Y:$t,tt:G,st:ct,it:ht,et:lt,ot:dt},is=Ht.litHtmlPolyfillSupport;is?.(tt,$t),(Ht.litHtmlVersions??=[]).push("3.1.3");var Ne=(i,t,e)=>{let s=e?.renderBefore??t,r=s._$litPart$;if(r===void 0){let n=e?.renderBefore??null;s._$litPart$=r=new $t(t.insertBefore(K(),n),n,void 0,e??{})}return r._$AI(i),r};var I=class extends N{constructor(){super(...arguments),this.renderOptions={host:this},this.ht=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this.ht=Ne(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this.ht?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this.ht?.setConnected(!1)}render(){return y}};I._$litElement$=!0,I.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:I});var rs=globalThis.litElementPolyfillSupport;rs?.({LitElement:I});(globalThis.litElementVersions??=[]).push("4.0.5");var{Y:ns}=ss,os=i=>i===null||typeof i!="object"&&typeof i!="function";var Ae=(i,t)=>t===void 0?i?._$litType$!==void 0:i?._$litType$===t,as=i=>i?._$litType$?.h!=null;var De=i=>i.strings===void 0,_e=()=>document.createComment(""),D=(i,t,e)=>{let s=i._$AA.parentNode,r=t===void 0?i._$AB:t._$AA;if(e===void 0){let n=s.insertBefore(_e(),r),o=s.insertBefore(_e(),r);e=new ns(n,o,i,i.options)}else{let n=e._$AB.nextSibling,o=e._$AM,c=o!==i;if(c){let a;e._$AQ?.(i),e._$AM=i,e._$AP!==void 0&&(a=i._$AU)!==o._$AU&&e._$AP(a)}if(n!==r||c){let a=e._$AA;for(;a!==n;){let u=a.nextSibling;s.insertBefore(a,r),a=u}}}return e},P=(i,t,e=i)=>(i._$AI(t,e),i),ls={},et=(i,t=ls)=>i._$AH=t,Dt=i=>i._$AH,kt=i=>{i._$AP?.(!1,!0);let t=i._$AA,e=i._$AB.nextSibling;for(;t!==e;){let s=t.nextSibling;t.remove(),t=s}},Ie=i=>{i._$AR()};var w=i=>(...t)=>({_$litDirective$:i,values:t}),E=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this.nt=t,this._$AM=e,this.rt=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var J=(i,t)=>{let e=i._$AN;if(e===void 0)return!1;for(let s of e)s._$AO?.(t,!1),J(s,t);return!0},ut=i=>{let t,e;do{if((t=i._$AM)===void 0)break;e=t._$AN,e.delete(i),i=t}while(e?.size===0)},Be=i=>{for(let t;t=i._$AM;i=t){let e=t._$AN;if(e===void 0)t._$AN=e=new Set;else if(e.has(i))break;e.add(i),ds(t)}};function cs(i){this._$AN!==void 0?(ut(this),this._$AM=i,Be(this)):this._$AM=i}function hs(i,t=!1,e=0){let s=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(t)if(Array.isArray(s))for(let n=e;n<s.length;n++)J(s[n],!1),ut(s[n]);else s!=null&&(J(s,!1),ut(s));else J(this,i)}var ds=i=>{i.type==2&&(i._$AP??=hs,i._$AQ??=cs)},st=class extends E{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,s){super._$AT(t,e,s),Be(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(J(this,t),ut(this))}setValue(t){if(De(this.nt))this.nt._$AI(t,this);else{let e=[...this.nt._$AH];e[this.rt]=t,this.nt._$AI(e,this,0)}}disconnected(){}reconnected(){}};var pt=class{constructor(t){this.ct=t}disconnect(){this.ct=void 0}reconnect(t){this.ct=t}deref(){return this.ct}},mt=class{constructor(){this.lt=void 0,this.ut=void 0}get(){return this.lt}pause(){this.lt??=new Promise(t=>this.ut=t)}resume(){this.ut?.(),this.lt=this.ut=void 0}};var ft=class extends st{constructor(){super(...arguments),this.dt=new pt(this),this.ft=new mt}render(t,e){return y}update(t,[e,s]){if(this.isConnected||this.disconnected(),e===this.vt)return y;this.vt=e;let r=0,{dt:n,ft:o}=this;return(async(c,a)=>{for await(let u of c)if(await a(u)===!1)return})(e,async c=>{for(;o.get();)await o.get();let a=n.deref();if(a!==void 0){if(a.vt!==e)return!1;s!==void 0&&(c=s(c,r)),a.commitValue(c,r),r++}return!0}),y}commitValue(t,e){this.setValue(t)}disconnected(){this.dt.disconnect(),this.ft.pause()}reconnected(){this.dt.reconnect(this),this.ft.resume()}},ys=w(ft),As=w(class extends ft{constructor(i){if(super(i),i.type!==2)throw Error("asyncAppend can only be used in child expressions")}update(i,t){return this.ht=i,super.update(i,t)}commitValue(i,t){t===0&&Ie(this.ht);let e=D(this.ht);P(e,i)}}),ve=i=>as(i)?i._$litType$.h:i.strings,_s=w(class extends E{constructor(i){super(i),this.yt=new WeakMap}render(i){return[i]}update(i,[t]){let e=Ae(this.bt)?ve(this.bt):null,s=Ae(t)?ve(t):null;if(e!==null&&(s===null||e!==s)){let r=Dt(i).pop(),n=this.yt.get(e);if(n===void 0){let o=document.createDocumentFragment();n=Ne(b,o),n.setConnected(!1),this.yt.set(e,n)}et(n,[r]),D(n,void 0,r)}if(s!==null){if(e===null||e!==s){let r=this.yt.get(s);if(r!==void 0){let n=Dt(r).pop();Ie(i),D(i,void 0,n),et(i,[n])}}this.bt=t}else this.bt=void 0;return this.render(t)}});var vs=w(class extends E{constructor(i){if(super(i),i.type!==1||i.name!=="class"||i.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter(t=>i[t]).join(" ")+" "}update(i,[t]){if(this.gt===void 0){this.gt=new Set,i.strings!==void 0&&(this.wt=new Set(i.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(let s in t)t[s]&&!this.wt?.has(s)&&this.gt.add(s);return this.render(t)}let e=i.element.classList;for(let s of this.gt)s in t||(e.remove(s),this.gt.delete(s));for(let s in t){let r=!!t[s];r===this.gt.has(s)||this.wt?.has(s)||(r?(e.add(s),this.gt.add(s)):(e.remove(s),this.gt.delete(s)))}return y}}),us={},ws=w(class extends E{constructor(){super(...arguments),this._t=us}render(i,t){return t()}update(i,[t,e]){if(Array.isArray(t)){if(Array.isArray(this._t)&&this._t.length===t.length&&t.every((s,r)=>s===this._t[r]))return y}else if(this._t===t)return y;return this._t=Array.isArray(t)?Array.from(t):t,this.render(t,e)}});var Ss=w(class extends E{constructor(){super(...arguments),this.key=b}render(i,t){return this.key=i,t}update(i,[t,e]){return t!==this.key&&(et(i),this.key=t),e}}),Es=w(class extends E{constructor(i){if(super(i),i.type!==3&&i.type!==1&&i.type!==4)throw Error("The `live` directive is not allowed on child or event bindings");if(!De(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[t]){if(t===y||t===b)return t;let e=i.element,s=i.name;if(i.type===3){if(t===e[s])return y;if(i.type===4){if(!!t===e.hasAttribute(s))return y;if(i.type===1&&e.getAttribute(s)===t+"")return y}}return et(i),t}});var Rt=new WeakMap,xs=w(class extends st{render(i){return b}update(i,[t]){let e=t!==this.ct;return e&&this.ct!==void 0&&this.St(void 0),(e||this.$t!==this.Tt)&&(this.ct=t,this.xt=i.options?.host,this.St(this.Tt=i.element)),b}St(i){if(typeof this.ct=="function"){let t=this.xt??globalThis,e=Rt.get(t);e===void 0&&(e=new WeakMap,Rt.set(t,e)),e.get(this.ct)!==void 0&&this.ct.call(this.xt,void 0),e.set(this.ct,i),i!==void 0&&this.ct.call(this.xt,i)}else this.ct.value=i}get $t(){return typeof this.ct=="function"?Rt.get(this.xt??globalThis)?.get(this.ct):this.ct?.value}disconnected(){this.$t===this.Tt&&this.St(void 0)}reconnected(){this.St(this.Tt)}}),we=(i,t,e)=>{let s=new Map;for(let r=t;r<=e;r++)s.set(i[r],r);return s},Us=w(class extends E{constructor(i){if(super(i),i.type!==2)throw Error("repeat() can only be used in text expressions")}Et(i,t,e){let s;e===void 0?e=t:t!==void 0&&(s=t);let r=[],n=[],o=0;for(let c of i)r[o]=s?s(c,o):o,n[o]=e(c,o),o++;return{values:n,keys:r}}render(i,t,e){return this.Et(i,t,e).values}update(i,[t,e,s]){let r=Dt(i),{values:n,keys:o}=this.Et(t,e,s);if(!Array.isArray(r))return this.Ct=o,n;let c=this.Ct??=[],a=[],u,g,d=0,$=r.length-1,f=0,A=n.length-1;for(;d<=$&&f<=A;)if(r[d]===null)d++;else if(r[$]===null)$--;else if(c[d]===o[f])a[f]=P(r[d],n[f]),d++,f++;else if(c[$]===o[A])a[A]=P(r[$],n[A]),$--,A--;else if(c[d]===o[A])a[A]=P(r[d],n[A]),D(i,a[A+1],r[d]),d++,A--;else if(c[$]===o[f])a[f]=P(r[$],n[f]),D(i,r[d],r[$]),$--,f++;else if(u===void 0&&(u=we(o,f,A),g=we(c,d,$)),u.has(c[d]))if(u.has(c[$])){let U=g.get(o[f]),W=U!==void 0?r[U]:null;if(W===null){let ce=D(i,r[d]);P(ce,n[f]),a[f]=ce}else a[f]=P(W,n[f]),D(i,r[d],W),r[U]=null;f++}else kt(r[$]),$--;else kt(r[d]),d++;for(;f<=A;){let U=D(i,a[A+1]);P(U,n[f]),a[f++]=U}for(;d<=$;){let U=r[d++];U!==null&&kt(U)}return this.Ct=o,et(i,a),y}}),He="important",ps=" !"+He,Ts=w(class extends E{constructor(i){if(super(i),i.type!==1||i.name!=="style"||i.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(i){return Object.keys(i).reduce((t,e)=>{let s=i[e];return s==null?t:t+`${e=e.includes("-")?e:e.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(i,[t]){let{style:e}=i.element;if(this.Pt===void 0)return this.Pt=new Set(Object.keys(t)),this.render(t);for(let s of this.Pt)t[s]==null&&(this.Pt.delete(s),s.includes("-")?e.removeProperty(s):e[s]=null);for(let s in t){let r=t[s];if(r!=null){this.Pt.add(s);let n=typeof r=="string"&&r.endsWith(ps);s.includes("-")||n?e.setProperty(s,n?r.slice(0,-11):r,n?He:""):e[s]=r}}return y}}),Ms=w(class extends E{constructor(i){if(super(i),i.type!==2)throw Error("templateContent can only be used in child bindings")}render(i){return this.At===i?y:(this.At=i,document.importNode(i.content,!0))}}),z=class extends E{constructor(t){if(super(t),this.bt=b,t.type!==2)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===b||t==null)return this.kt=void 0,this.bt=t;if(t===y)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.bt)return this.kt;this.bt=t;let e=[t];return e.raw=e,this.kt={_$litType$:this.constructor.resultType,strings:e,values:[]}}};z.directiveName="unsafeHTML",z.resultType=1;var bt=w(z);var it=class extends z{};it.directiveName="unsafeSVG",it.resultType=2;var Ls=w(it),Se=i=>!os(i)&&typeof i.then=="function",Ee=1073741823;var It=class extends st{constructor(){super(...arguments),this.Mt=Ee,this.Ut=[],this.dt=new pt(this),this.ft=new mt}render(...t){return t.find(e=>!Se(e))??y}update(t,e){let s=this.Ut,r=s.length;this.Ut=e;let n=this.dt,o=this.ft;this.isConnected||this.disconnected();for(let c=0;c<e.length&&!(c>this.Mt);c++){let a=e[c];if(!Se(a))return this.Mt=c,a;c<r&&a===s[c]||(this.Mt=Ee,r=0,Promise.resolve(a).then(async u=>{for(;o.get();)await o.get();let g=n.deref();if(g!==void 0){let d=g.Ut.indexOf(a);d>-1&&d<g.Mt&&(g.Mt=d,g.setValue(u))}}))}return y}disconnected(){this.dt.disconnect(),this.ft.pause()}reconnected(){this.dt.reconnect(this),this.ft.resume()}},Os=w(It);var ms=Symbol.for(""),fs=i=>{if(i?.r===ms)return i?._$litStatic$};var xe=new Map,je=i=>(t,...e)=>{let s=e.length,r,n,o=[],c=[],a,u=0,g=!1;for(;u<s;){for(a=t[u];u<s&&(n=e[u],(r=fs(n))!==void 0);)a+=r+t[++u],g=!0;u!==s&&c.push(n),o.push(a),u++}if(u===s&&o.push(t[s]),g){let d=o.join("$$lit$$");(t=xe.get(d))===void 0&&(o.raw=o,xe.set(d,t=o)),e=c}return i(t,...e)},Cs=je(l),ks=je(es);var p=class extends I{createRenderRoot(){return this}broadcast(t,e){return()=>{let s=new CustomEvent(t,{detail:e,bubbles:!0,composed:!0});this.dispatchEvent(s)}}};var yt=Symbol("the albums manifest"),At=Symbol("the images manifest"),Ws=Symbol("the site manifest"),_t=Symbol("metadata about the site manifest"),vt=Symbol("the videos manifest"),wt=Symbol("the exif data"),St=Symbol("the semantic data");var Ye="photos",h=class{static EAGER="eager";static LAZY="lazy"},m=class{static PHOTOS="photos";static ALBUMS="albums";static ALBUM="album";static METADATA="metadata";static ABOUT="about";static VIDEOS="videos";static THING="thing"},V=class{static UNESCO="unesco"},Z=class{static SUBJECT="subject";static LOCATION="location";static RATING="rating"};async function gs(i="/manifest/env.json"){return await(await fetch(i)).json()}var rt=await gs(),Et=class{_data;constructor(t=`/manifest/images.${rt.publication_id}.json`){this.url=t}processImages(t){let e=t[0],s=[];for(let r of t.slice(1)){let n={};for(let o=0;o<e.length;o++)n[e[o]]=r[o];s.push(n)}return s}async init(){if(window[At]&&(this._data=window[At]),this._data||this.loading)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.processImages(t);window[At]=e,this._data=e}images(){return this._data.map(t=>({...t,full_image:`https://photos-cdn.rgrannell.xyz${t.full_image}`,thumbnail_url:`https://photos-cdn.rgrannell.xyz${t.thumbnail_url}`,thumbnail_mosaic_url:`data:image/bmp;base64,${t.thumbnail_mosaic_url}`}))}},xt=class{_data;constructor(t=`/manifest/videos.${rt.publication_id}.json`){this.url=t}processVideos(t){let e=t[0],s=[];for(let r of t.slice(1)){let n={};for(let o=0;o<e.length;o++)n[e[o]]=r[o];s.push(n)}return s}async init(){if(window[vt]&&(this._data=window[vt]),this._data||this.loading)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.processVideos(t);window[vt]=e,this._data=e}videos(){return this._data.map(t=>({...t,poster_url:`https://photos-cdn.rgrannell.xyz${t.poster_url}`,video_url_1080p:`https://photos-cdn.rgrannell.xyz${t.video_url_1080p}`,video_url_480p:`https://photos-cdn.rgrannell.xyz${t.video_url_480p}`,video_url_720p:`https://photos-cdn.rgrannell.xyz${t.video_url_720p}`,video_url_unscaled:`https://photos-cdn.rgrannell.xyz${t.video_url_unscaled}`,tags:(t.tags??"").split(",").filter(e=>e!="Published").map(e=>e.trim())}))}},Ut=class{_data;constructor(t=`/manifest/albums.${rt.publication_id}.json`){this.url=t}process(t){let e=t[0],s=[];for(let r of t.slice(1)){let n={};for(let o=0;o<e.length;o++)n[e[o]]=r[o];s.push(n)}return s}async init(){if(window[yt]&&(this._data=window[yt]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.process(t);window[yt]=e,this._data=e}albums(){return this._data.map(t=>({...t,thumbnail_url:`https://photos-cdn.rgrannell.xyz${t.thumbnail_url}`,thumbnail_mosaic_url:`${t.thumbnail_mosaic_url}`}))}},Tt=class{_data;constructor(t=`/manifest/exif.${rt.publication_id}.json`){this.url=t}process(t){let e=t[0],s=[];for(let r of t.slice(1)){let n={};for(let o=0;o<e.length;o++)n[e[o]]=r[o];s.push(n)}return s}async init(){if(window[wt]&&(this._data=window[wt]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.process(t);window[wt]=e,this._data=e}exif(){return this._data}};function Ge(i,t,e){if(!i.hasOwnProperty(t))return!1;let s=i[t];if(s.includes(e))return!0;for(let r of s)if(Ge(i,r,e))return!0;return!1}var Mt=class{_data;constructor(t=`/manifest/semantic.${rt.publication_id}.json`){this.url=t}async init(){if(window[St]&&(this._data=window[St]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json();window[St]=t,this._data=t}semantic(){return this._data}},Lt=class{_data;constructor(t="/manifest/metadata.json"){this.url=t}async init(){if(window[_t]&&(this._data=window[_t]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json();window[_t]=t,this._data=t}metadata(){return this._data}isChild(t,e){return Ge(this._data,t,e)}childrenOf(t,e){let s=new Set([]);for(let r of e)this.isChild(t,r)&&s.add(r);return s}};var L=class i{static ROUTES={[m.PHOTOS]:this.showPhotosUrl,[m.ALBUMS]:this.showAlbumsUrl,[m.ALBUM]:this.showAlbumUrl,[m.METADATA]:this.showMetadataUrl,[m.ABOUT]:this.showAboutUrl,[m.VIDEOS]:this.showVideosUrl,[m.THING]:this.showThingUrl};static router(t){if(i.ROUTES.hasOwnProperty(t))return i.ROUTES[t];throw new Error(`Unknown page: ${t}`)}static pageUsesId(t){return t===m.ALBUM||t===m.PHOTO||t===m.METADATA||t===m.THING}static showAboutUrl(){window.location.hash="#/about",document.title="About - photos"}static showAlbumsUrl(){window.location.hash="#/albums",document.title="Albums - photos"}static showPhotosUrl(){window.location.hash="#/photos",document.title="Photos - photos"}static showAlbumUrl(t){window.location.hash=`#/album/${t}`,document.title="Album - photos"}static showPhotoUrl(t){window.location.hash=`#/photo/${t}`,document.title="Photo - photos"}static showMetadataUrl(t){window.location.hash=`#/metadata/${t}`,document.title="Metadata - photos"}static showVideosUrl(){window.location.hash="#/videos",document.title="Videos - photos"}static showThingUrl(t){window.location.hash=`#/thing/${t}`,document.title="Thing - photos"}static getUrl(){return window.location.hash.startsWith("#/albums")?{type:"albums"}:window.location.hash.startsWith("#/album")?{type:"album",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/metadata")?{type:"metadata",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/thing")?{type:"thing",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/photos")?{type:"photos"}:window.location.hash.startsWith("#/about")?{type:"about"}:window.location.hash.startsWith("#/videos")?{type:"videos"}:{type:"albums"}}};var Gt=class extends p{static get properties(){return{visible:{type:Boolean}}}render(){let t=["photo-sidebar"];return this.visible&&t.push("sidebar-visible"),l`
    ...
    `}};customElements.define("about-page",re);var Ot=class{static loadingMode(t){return t===0?"auto":"none"}};var ne=class extends p{static get properties(){return{videos:{type:Object}}}connectedCallback(){super.connectedCallback(),v.setIndex()}videos(){return this.videos.videos()}render(){let t=this.videos().map((e,s)=>l`<app-video
      id=${e.id}
    ...
    `}};customElements.define("thing-page",oe);var T=new Ut,S=new Et,M=new xt,R=new Lt,C=new Tt,x=new Mt,$s=[[T,h.EAGER],[S,h.EAGER],[M,h.EAGER],[R,h.EAGER],[C,h.EAGER],[x,h.EAGER]],bs={[m.ABOUT]:[[T,h.LAZY],[S,h.LAZY],[M,h.LAZY],[R,h.LAZY],[C,h.LAZY],[x,h.LAZY]],[m.ALBUMS]:[[T,h.EAGER],[S,h.LAZY],[M,h.LAZY],[R,h.LAZY],[C,h.LAZY],[x,h.LAZY]],[m.PHOTOS]:[[T,h.EAGER],[S,h.EAGER],[M,h.EAGER],[R,h.LAZY],[C,h.LAZY],[x,h.LAZY]],[m.VIDEOS]:[[T,h.LAZY],[S,h.LAZY],[M,h.EAGER],[R,h.LAZY],[C,h.LAZY],[x,h.LAZY]],[m.ALBUM]:[[T,h.EAGER],[S,h.EAGER],[M,h.EAGER],[x,h.EAGER],[R,h.LAZY],[C,h.LAZY]],[m.PHOTO]:[[T,h.EAGER],[S,h.EAGER],[M,h.EAGER],[R,h.LAZY],[C,h.EAGER],[x,h.EAGER]],[m.METADATA]:[[T,h.LAZY],[S,h.EAGER],[M,h.EAGER],[R,h.EAGER],[C,h.EAGER],[x,h.EAGER]],[m.THING]:[[T,h.LAZY],[S,h.EAGER],[M,h.LAZY],[R,h.EAGER],[C,h.LAZY],[x,h.EAGER]]},ae=class{static async init(){let t=L.getUrl();console.log(`loading ${t?.type}`);let e=bs[t?.type]??$s,s=[];for(let[r,n]of e)n===h.EAGER?s.push(r.init()):n===h.LAZY&&r.init();await Promise.all(s)}};await ae.init();var le=class i extends p{static DEFAULT_PAGE=m.ALBUMS;static LOCATION_TYPE_TO_PAGE={album:m.ALBUM,albums:m.ALBUMS,photos:m.PHOTOS,metadata:m.METADATA,about:m.ABOUT,videos:m.VIDEOS,thing:m.THING};static get properties(){return{title:{type:String},page:{type:String},sidebarVisible:{type:Boolean,state:!0},id:{type:String},tags:{type:Array},imageUrl:{type:String},thumbnailUrl:{type:String},route:{type:String},params:{type:Object},query:{type:Object},darkMode:{type:Boolean}}}connectedCallback(){super.connectedCallback(),this.setStateFromUrl(),this.requestUpdate(),window.addEventListener("popstate",this.handlePopState.bind(this)),this.sidebarVisible=!1}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this.handlePopState.bind(this))}handlePopState(){this.setStateFromUrl(),this.requestUpdate()}setStateFromUrl(){let t=L.getUrl();i.LOCATION_TYPE_TO_PAGE[t?.type]?this.page=i.LOCATION_TYPE_TO_PAGE[t.type]:(console.error("did not match pagetype",t?.type),this.page=i.DEFAULT_PAGE),L.pageUsesId(this.page)&&(this.id=t.id)}receiveClickAlbum(t){let{title:e,id:s}=t.detail;this.page=m.PHOTOS,this.id=s,this.title=e,L.showAlbumUrl(s)}async receiveClickBurgerMenu(){this.sidebarVisible=!this.sidebarVisible}async receiveClickPhotoMetadata(t){let{id:e,imageUrl:s,thumbnailUrl:r,tags:n}=t.detail;this.page=m.METADATA,this.id=e,this.imageUrl=s,this.thumbnailUrl=r,this.tags=n??[],L.showMetadataUrl(e)}receiveSwitchTheme(t){this.darkMode=!this.darkMode,localStorage.setItem("darkMode",this.darkMode),this.requestUpdate()}receiveNavigatePage(t){this.page=t.detail.page,this.sidebarVisible=!1;let e=L.router(this.page);L.pageUsesId(this.page)?e(this.id):e()}pageClasses(t){let e=["page"];return t&&e.push("sidebar-visible"),e.join(" ")}renderPage(t){let e=this.pageClasses(t);if(!this.page||this.page==="albums")return l`
      ...
      <album-page
        ...
        class="${e}"></album-page>
      `}if(this.page===m.METADATA){let s=S.images().find(c=>c.id===this.id),r=C.exif().find(c=>c.id===this.id),n=x.semantic().filter(c=>c[0]===this.id),o={};for(let[c,a,u]of n)o[a]?typeof o[a]=="string"&&(o[a]=[o[a],u]):o[a]=u;return s||console.error(`failed to find photo with id ${this.id}`),l`
