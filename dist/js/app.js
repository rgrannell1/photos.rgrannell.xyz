...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ae=/'/g,ye=/"/g,Oe=/^(?:script|style|textarea|title)$/i,De=s=>(t,...e)=>({_$litType$:s,strings:t,values:e}),c=De(1),ns=De(2),y=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),_e=new WeakMap,G=Y.createTreeWalker(Y,129);function Re(s,t){if(!Array.isArray(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return fe!==void 0?fe.createHTML(t):t}var Ne=(s,t)=>{let e=s.length-1,i=[],r,a=t===2?"<svg>":"",o=F;for(let h=0;h<e;h++){let n=s[h],m,f,p=-1,$=0;for(;$<n.length&&(o.lastIndex=$,f=o.exec(n),f!==null);)$=o.lastIndex,o===F?f[1]==="!--"?o=$e:f[1]!==void 0?o=be:f[2]!==void 0?(Oe.test(f[2])&&(r=RegExp("</"+f[2],"g")),o=B):f[3]!==void 0&&(o=B):o===B?f[0]===">"?(o=r??F,p=-1):f[1]===void 0?p=-2:(p=o.lastIndex-f[2].length,m=f[1],o=f[3]===void 0?B:f[3]==='"'?ye:Ae):o===ye||o===Ae?o=B:o===$e||o===be?o=F:(o=B,r=void 0);let g=o===B&&s[h+1].startsWith("/>")?" ":"";a+=o===F?n+os:p>=0?(i.push(m),n.slice(0,p)+Gt+n.slice(p)+C+g):n+C+(p===-2?h:g)}return[Re(s,a+(s[e]||"<?>")+(t===2?"</svg>":"")),i]},K=class s{constructor({strings:t,_$litType$:e},i){let r;this.parts=[];let a=0,o=0,h=t.length-1,n=this.parts,[m,f]=Ne(t,e);if(this.el=s.createElement(m,i),G.currentNode=this.el.content,e===2){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(r=G.nextNode())!==null&&n.length<h;){if(r.nodeType===1){if(r.hasAttributes())for(let p of r.getAttributeNames())if(p.endsWith(Gt)){let $=f[o++],g=r.getAttribute(p).split(C),_=/([.?@])?(.*)/.exec($);n.push({type:1,index:a,name:_[2],strings:g,ctor:_[1]==="."?ot:_[1]==="?"?nt:_[1]==="@"?lt:j}),r.removeAttribute(p)}else p.startsWith(C)&&(n.push({type:6,index:a}),r.removeAttribute(p));if(Oe.test(r.tagName)){let p=r.textContent.split(C),$=p.length-1;if($>0){r.textContent=rt?rt.emptyScript:"";for(let g=0;g<$;g++)r.append(p[g],J()),G.nextNode(),n.push({type:2,index:++a});r.append(p[$],J())}}}else if(r.nodeType===8)if(r.data===Yt)n.push({type:2,index:a});else{let p=-1;for(;(p=r.data.indexOf(C,p+1))!==-1;)n.push({type:7,index:a}),p+=C.length-1}a++}}static createElement(t,e){let i=Y.createElement("template");return i.innerHTML=t,i}};function H(s,t,e=s,i){if(t===y)return t;let r=i!==void 0?e.U?.[i]:e.N,a=Q(t)?void 0:t._$litDirective$;return r?.constructor!==a&&(r?._$AO?.(!1),a===void 0?r=void 0:(r=new a(s),r._$AT(s,e,i)),i!==void 0?(e.U??=[])[i]=r:e.N=r),r!==void 0&&(t=H(s,r._$AS(s,t.values),r,i)),t}var at=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}O(t){let{el:{content:e},parts:i}=this._$AD,r=(t?.creationScope??Y).importNode(e,!0);G.currentNode=r;let a=G.nextNode(),o=0,h=0,n=i[0];for(;n!==void 0;){if(o===n.index){let m;n.type===2?m=new gt(a,a.nextSibling,this,t):n.type===1?m=new n.ctor(a,n.name,n.strings,this,t):n.type===6&&(m=new ct(a,this,t)),this._$AV.push(m),n=i[++h]}o!==n?.index&&(a=G.nextNode(),o++)}return G.currentNode=Y,r}R(t){let e=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}},gt=class Pe{get _$AU(){return this._$AM?._$AU??this.V}constructor(t,e,i,r){this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=r,this.V=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=H(this,t,e),Q(t)?t===b||t==null||t===""?(this._$AH!==b&&this._$AR(),this._$AH=b):t!==this._$AH&&t!==y&&this.L(t):t._$litType$!==void 0?this.I(t):t.nodeType!==void 0?this.j(t):Ce(t)?this.D(t):this.L(t)}H(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}j(t){this._$AH!==t&&(this._$AR(),this._$AH=this.H(t))}L(t){this._$AH!==b&&Q(this._$AH)?this._$AA.nextSibling.data=t:this.j(Y.createTextNode(t)),this._$AH=t}I(t){let{values:e,_$litType$:i}=t,r=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=K.createElement(Re(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===r)this._$AH.R(e);else{let a=new at(r,this),o=a.O(this.options);a.R(e),this.j(o),this._$AH=a}}_$AC(t){let e=_e.get(t.strings);return e===void 0&&_e.set(t.strings,e=new K(t)),e}D(t){ke(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,i,r=0;for(let a of t)r===e.length?e.push(i=new Pe(this.H(J()),this.H(J()),this,this.options)):i=e[r],i._$AI(a),r++;r<e.length&&(this._$AR(i&&i._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){let i=t.nextSibling;t.remove(),t=i}}setConnected(t){this._$AM===void 0&&(this.V=t,this._$AP?.(t))}},j=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,r,a){this.type=1,this._$AH=b,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=a,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=b}_$AI(t,e=this,i,r){let a=this.strings,o=!1;if(a===void 0)t=H(this,t,e,0),o=!Q(t)||t!==this._$AH&&t!==y,o&&(this._$AH=t);else{let h=t,n,m;for(t=a[0],n=0;n<a.length-1;n++)m=H(this,h[i+n],e,n),m===y&&(m=this._$AH[n]),o||=!Q(m)||m!==this._$AH[n],m===b?t=b:t!==b&&(t+=(m??"")+a[n+1]),this._$AH[n]=m}o&&!r&&this.B(t)}B(t){t===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},ot=class extends j{constructor(){super(...arguments),this.type=3}B(t){this.element[this.name]=t===b?void 0:t}},nt=class extends j{constructor(){super(...arguments),this.type=4}B(t){this.element.toggleAttribute(this.name,!!t&&t!==b)}},lt=class extends j{constructor(t,e,i,r,a){super(t,e,i,r,a),this.type=5}_$AI(t,e=this){if((t=H(this,t,e,0)??b)===y)return;let i=this._$AH,r=t===b&&i!==b||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,a=t!==b&&(i===b||r);r&&this.element.removeEventListener(this.name,this,i),a&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},ct=class{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){H(this,t)}},ls={W:Gt,q:C,J:Yt,Z:1,F:Ne,G:at,K:Ce,X:H,Y:gt,tt:j,st:nt,it:lt,et:ot,ot:ct},cs=Bt.litHtmlPolyfillSupport;cs?.(K,gt),(Bt.litHtmlVersions??=[]).push("3.1.3");var Ie=(s,t,e)=>{let i=e?.renderBefore??t,r=i._$litPart$;if(r===void 0){let a=e?.renderBefore??null;i._$litPart$=r=new gt(t.insertBefore(J(),a),a,void 0,e??{})}return r._$AI(s),r};var P=class extends R{constructor(){super(...arguments),this.renderOptions={host:this},this.ht=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this.ht=Ie(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this.ht?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this.ht?.setConnected(!1)}render(){return y}};P._$litElement$=!0,P.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:P});var hs=globalThis.litElementPolyfillSupport;hs?.({LitElement:P});(globalThis.litElementVersions??=[]).push("4.0.5");var{Y:ds}=ls,ps=s=>s===null||typeof s!="object"&&typeof s!="function";var we=(s,t)=>t===void 0?s?._$litType$!==void 0:s?._$litType$===t,us=s=>s?._$litType$?.h!=null;var Be=s=>s.strings===void 0,ve=()=>document.createComment(""),N=(s,t,e)=>{let i=s._$AA.parentNode,r=t===void 0?s._$AB:t._$AA;if(e===void 0){let a=i.insertBefore(ve(),r),o=i.insertBefore(ve(),r);e=new ds(a,o,s,s.options)}else{let a=e._$AB.nextSibling,o=e._$AM,h=o!==s;if(h){let n;e._$AQ?.(s),e._$AM=s,e._$AP!==void 0&&(n=s._$AU)!==o._$AU&&e._$AP(n)}if(a!==r||h){let n=e._$AA;for(;n!==a;){let m=n.nextSibling;i.insertBefore(n,r),n=m}}}return e},D=(s,t,e=s)=>(s._$AI(t,e),s),ms={},X=(s,t=ms)=>s._$AH=t,Nt=s=>s._$AH,Ct=s=>{s._$AP?.(!1,!0);let t=s._$AA,e=s._$AB.nextSibling;for(;t!==e;){let i=t.nextSibling;t.remove(),t=i}},Ge=s=>{s._$AR()};var x=s=>(...t)=>({_$litDirective$:s,values:t}),M=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this.nt=t,this._$AM=e,this.rt=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var q=(s,t)=>{let e=s._$AN;if(e===void 0)return!1;for(let i of e)i._$AO?.(t,!1),q(i,t);return!0},ht=s=>{let t,e;do{if((t=s._$AM)===void 0)break;e=t._$AN,e.delete(s),s=t}while(e?.size===0)},Ye=s=>{for(let t;t=s._$AM;s=t){let e=t._$AN;if(e===void 0)t._$AN=e=new Set;else if(e.has(s))break;e.add(s),$s(t)}};function gs(s){this._$AN!==void 0?(ht(this),this._$AM=s,Ye(this)):this._$AM=s}function fs(s,t=!1,e=0){let i=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(t)if(Array.isArray(i))for(let a=e;a<i.length;a++)q(i[a],!1),ht(i[a]);else i!=null&&(q(i,!1),ht(i));else q(this,s)}var $s=s=>{s.type==2&&(s._$AP??=fs,s._$AQ??=gs)},tt=class extends M{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,i){super._$AT(t,e,i),Ye(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(q(this,t),ht(this))}setValue(t){if(Be(this.nt))this.nt._$AI(t,this);else{let e=[...this.nt._$AH];e[this.rt]=t,this.nt._$AI(e,this,0)}}disconnected(){}reconnected(){}};var dt=class{constructor(t){this.ct=t}disconnect(){this.ct=void 0}reconnect(t){this.ct=t}deref(){return this.ct}},pt=class{constructor(){this.lt=void 0,this.ut=void 0}get(){return this.lt}pause(){this.lt??=new Promise(t=>this.ut=t)}resume(){this.ut?.(),this.lt=this.ut=void 0}};var ut=class extends tt{constructor(){super(...arguments),this.dt=new dt(this),this.ft=new pt}render(t,e){return y}update(t,[e,i]){if(this.isConnected||this.disconnected(),e===this.vt)return y;this.vt=e;let r=0,{dt:a,ft:o}=this;return(async(h,n)=>{for await(let m of h)if(await n(m)===!1)return})(e,async h=>{for(;o.get();)await o.get();let n=a.deref();if(n!==void 0){if(n.vt!==e)return!1;i!==void 0&&(h=i(h,r)),n.commitValue(h,r),r++}return!0}),y}commitValue(t,e){this.setValue(t)}disconnected(){this.dt.disconnect(),this.ft.pause()}reconnected(){this.dt.reconnect(this),this.ft.resume()}},Ls=x(ut),Ms=x(class extends ut{constructor(s){if(super(s),s.type!==2)throw Error("asyncAppend can only be used in child expressions")}update(s,t){return this.ht=s,super.update(s,t)}commitValue(s,t){t===0&&Ge(this.ht);let e=N(this.ht);D(e,s)}}),Se=s=>us(s)?s._$litType$.h:s.strings,ks=x(class extends M{constructor(s){super(s),this.yt=new WeakMap}render(s){return[s]}update(s,[t]){let e=we(this.bt)?Se(this.bt):null,i=we(t)?Se(t):null;if(e!==null&&(i===null||e!==i)){let r=Nt(s).pop(),a=this.yt.get(e);if(a===void 0){let o=document.createDocumentFragment();a=Ie(b,o),a.setConnected(!1),this.yt.set(e,a)}X(a,[r]),N(a,void 0,r)}if(i!==null){if(e===null||e!==i){let r=this.yt.get(i);if(r!==void 0){let a=Nt(r).pop();Ge(s),N(s,void 0,a),X(s,[a])}}this.bt=t}else this.bt=void 0;return this.render(t)}});var Cs=x(class extends M{constructor(s){if(super(s),s.type!==1||s.name!=="class"||s.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(s){return" "+Object.keys(s).filter(t=>s[t]).join(" ")+" "}update(s,[t]){if(this.gt===void 0){this.gt=new Set,s.strings!==void 0&&(this.wt=new Set(s.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(let i in t)t[i]&&!this.wt?.has(i)&&this.gt.add(i);return this.render(t)}let e=s.element.classList;for(let i of this.gt)i in t||(e.remove(i),this.gt.delete(i));for(let i in t){let r=!!t[i];r===this.gt.has(i)||this.wt?.has(i)||(r?(e.add(i),this.gt.add(i)):(e.remove(i),this.gt.delete(i)))}return y}}),bs={},Os=x(class extends M{constructor(){super(...arguments),this._t=bs}render(s,t){return t()}update(s,[t,e]){if(Array.isArray(t)){if(Array.isArray(this._t)&&this._t.length===t.length&&t.every((i,r)=>i===this._t[r]))return y}else if(this._t===t)return y;return this._t=Array.isArray(t)?Array.from(t):t,this.render(t,e)}});var Ds=x(class extends M{constructor(){super(...arguments),this.key=b}render(s,t){return this.key=s,t}update(s,[t,e]){return t!==this.key&&(X(s),this.key=t),e}}),Rs=x(class extends M{constructor(s){if(super(s),s.type!==3&&s.type!==1&&s.type!==4)throw Error("The `live` directive is not allowed on child or event bindings");if(!Be(s))throw Error("`live` bindings can only contain a single expression")}render(s){return s}update(s,[t]){if(t===y||t===b)return t;let e=s.element,i=s.name;if(s.type===3){if(t===e[i])return y;if(s.type===4){if(!!t===e.hasAttribute(i))return y;if(s.type===1&&e.getAttribute(i)===t+"")return y}}return X(s),t}});var Ot=new WeakMap,Ns=x(class extends tt{render(s){return b}update(s,[t]){let e=t!==this.ct;return e&&this.ct!==void 0&&this.St(void 0),(e||this.$t!==this.Tt)&&(this.ct=t,this.xt=s.options?.host,this.St(this.Tt=s.element)),b}St(s){if(typeof this.ct=="function"){let t=this.xt??globalThis,e=Ot.get(t);e===void 0&&(e=new WeakMap,Ot.set(t,e)),e.get(this.ct)!==void 0&&this.ct.call(this.xt,void 0),e.set(this.ct,s),s!==void 0&&this.ct.call(this.xt,s)}else this.ct.value=s}get $t(){return typeof this.ct=="function"?Ot.get(this.xt??globalThis)?.get(this.ct):this.ct?.value}disconnected(){this.$t===this.Tt&&this.St(void 0)}reconnected(){this.St(this.Tt)}}),Ee=(s,t,e)=>{let i=new Map;for(let r=t;r<=e;r++)i.set(s[r],r);return i},Ps=x(class extends M{constructor(s){if(super(s),s.type!==2)throw Error("repeat() can only be used in text expressions")}Et(s,t,e){let i;e===void 0?e=t:t!==void 0&&(i=t);let r=[],a=[],o=0;for(let h of s)r[o]=i?i(h,o):o,a[o]=e(h,o),o++;return{values:a,keys:r}}render(s,t,e){return this.Et(s,t,e).values}update(s,[t,e,i]){let r=Nt(s),{values:a,keys:o}=this.Et(t,e,i);if(!Array.isArray(r))return this.Ct=o,a;let h=this.Ct??=[],n=[],m,f,p=0,$=r.length-1,g=0,_=a.length-1;for(;p<=$&&g<=_;)if(r[p]===null)p++;else if(r[$]===null)$--;else if(h[p]===o[g])n[g]=D(r[p],a[g]),p++,g++;else if(h[$]===o[_])n[_]=D(r[$],a[_]),$--,_--;else if(h[p]===o[_])n[_]=D(r[p],a[_]),N(s,n[_+1],r[p]),p++,_--;else if(h[$]===o[g])n[g]=D(r[$],a[g]),N(s,r[p],r[$]),$--,g++;else if(m===void 0&&(m=Ee(o,g,_),f=Ee(h,p,$)),m.has(h[p]))if(m.has(h[$])){let k=f.get(o[g]),Z=k!==void 0?r[k]:null;if(Z===null){let de=N(s,r[p]);D(de,a[g]),n[g]=de}else n[g]=D(Z,a[g]),N(s,r[p],Z),r[k]=null;g++}else Ct(r[$]),$--;else Ct(r[p]),p++;for(;g<=_;){let k=N(s,n[_+1]);D(k,a[g]),n[g++]=k}for(;p<=$;){let k=r[p++];k!==null&&Ct(k)}return this.Ct=o,X(s,n),y}}),He="important",As=" !"+He,Is=x(class extends M{constructor(s){if(super(s),s.type!==1||s.name!=="style"||s.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(s){return Object.keys(s).reduce((t,e)=>{let i=s[e];return i==null?t:t+`${e=e.includes("-")?e:e.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`},"")}update(s,[t]){let{style:e}=s.element;if(this.Pt===void 0)return this.Pt=new Set(Object.keys(t)),this.render(t);for(let i of this.Pt)t[i]==null&&(this.Pt.delete(i),i.includes("-")?e.removeProperty(i):e[i]=null);for(let i in t){let r=t[i];if(r!=null){this.Pt.add(i);let a=typeof r=="string"&&r.endsWith(As);i.includes("-")||a?e.setProperty(i,a?r.slice(0,-11):r,a?He:""):e[i]=r}}return y}}),Bs=x(class extends M{constructor(s){if(super(s),s.type!==2)throw Error("templateContent can only be used in child bindings")}render(s){return this.At===s?y:(this.At=s,document.importNode(s.content,!0))}}),V=class extends M{constructor(t){if(super(t),this.bt=b,t.type!==2)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===b||t==null)return this.kt=void 0,this.bt=t;if(t===y)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.bt)return this.kt;this.bt=t;let e=[t];return e.raw=e,this.kt={_$litType$:this.constructor.resultType,strings:e,values:[]}}};V.directiveName="unsafeHTML",V.resultType=1;var ft=x(V);var et=class extends V{};et.directiveName="unsafeSVG",et.resultType=2;var Gs=x(et),xe=s=>!ps(s)&&typeof s.then=="function",Te=1073741823;var Pt=class extends tt{constructor(){super(...arguments),this.Mt=Te,this.Ut=[],this.dt=new dt(this),this.ft=new pt}render(...t){return t.find(e=>!xe(e))??y}update(t,e){let i=this.Ut,r=i.length;this.Ut=e;let a=this.dt,o=this.ft;this.isConnected||this.disconnected();for(let h=0;h<e.length&&!(h>this.Mt);h++){let n=e[h];if(!xe(n))return this.Mt=h,n;h<r&&n===i[h]||(this.Mt=Te,r=0,Promise.resolve(n).then(async m=>{for(;o.get();)await o.get();let f=a.deref();if(f!==void 0){let p=f.Ut.indexOf(n);p>-1&&p<f.Mt&&(f.Mt=p,f.setValue(m))}}))}return y}disconnected(){this.dt.disconnect(),this.ft.pause()}reconnected(){this.dt.reconnect(this),this.ft.resume()}},Ys=x(Pt);var ys=Symbol.for(""),_s=s=>{if(s?.r===ys)return s?._$litStatic$};var Ue=new Map,je=s=>(t,...e)=>{let i=e.length,r,a,o=[],h=[],n,m=0,f=!1;for(;m<i;){for(n=t[m];m<i&&(a=e[m],(r=_s(a))!==void 0);)n+=r+t[++m],f=!0;m!==i&&h.push(a),o.push(n),m++}if(m===i&&o.push(t[i]),f){let p=o.join("$$lit$$");(t=Ue.get(p))===void 0&&(o.raw=o,Ue.set(p,t=o)),e=h}return s(t,...e)},Hs=je(c),js=je(ns);var ws=/^\s*([a-zA-Z]+)\:/,vs=/^\s*"([^\"]+?)"/,Ss=/^\s*([^\s]+)/,z=class{static START="START";static RELATION="RELATION";static SUBQUERY="SUBQUERY";static END="END"},Es=class{state;lastState;constructor(){this.state=z.RELATION,this.lastState=z.START}parseRelation(s){let t=s.match(ws);if(!t)throw new SyntaxError(`failed while parsing relationship: ${s}, expected relation`);return[t[1],s.slice(t[0].length)]}parseSubquery(s){let t=s.match(vs);if(t)return[t[1],s.slice(t[0].length)];let e=s.match(Ss);if(e)return[e[1],s.slice(e[0].length)];throw new SyntaxError(`subquery: failed to parse query: ${s}, expected subquery`)}advanceState(s){this.lastState=this.state,this.state=s}tokenise(s){let t=s.trim(),e=[],i={};for(;t.length>0;){if(this.state===z.RELATION){let r=this.parseRelation(t);i.relation=r[0],t=r[1],this.advanceState(z.SUBQUERY);continue}if(this.state===z.SUBQUERY){let r=this.parseSubquery(t);i.subquery=r[0],t=r[1],e.push({...i}),t=r[1],this.advanceState(z.RELATION);continue}if(this.state===this.lastState)throw new SyntaxError(`failed to parse query: ${s}, expected relation`)}for(let r of e){if(!r.relation)throw new SyntaxError(`failed to parse query: ${s}, expected relation`);if(!r.subquery)throw new SyntaxError(`failed to parse query: ${s}, expected subquery`)}return e}},Ve=class{content;comparators;constructor(s,t){this.content=s,this.comparators=t}*search(s){let e=new Es().tokenise(s);for(let i of this.content){let r=!0;for(let{relation:a,subquery:o}of e){if(!a||!o)continue;let h=this.comparators[a];if(!h)r=!1;else if(!r)continue;r=r&&h(i,o)}r&&(yield i)}}};var u=class extends P{createRenderRoot(){return this}broadcast(t,e){return()=>{let i=new CustomEvent(t,{detail:e,bubbles:!0,composed:!0});this.dispatchEvent(i)}}};var $t=Symbol("the albums manifest"),bt=Symbol("the images manifest"),ni=Symbol("the site manifest"),At=Symbol("metadata about the site manifest"),yt=Symbol("the videos manifest"),_t=Symbol("the exif data"),wt=Symbol("the semantic data"),ze=53.33306,Ze=-6.24889,Fe=6,We="photos",l=class{static EAGER="eager";static LAZY="lazy"},d=class{static PHOTOS="photos";static ALBUMS="albums";static DATE="date";static LOCATIONS="locations";static ALBUM="album";static STATS="stats";static TAG="tag";static TAG_ALBUM="tag-album";static TAGS="tags";static METADATA="metadata";static ABOUT="about";static VIDEOS="videos"};async function xs(s="/manifest/env.json"){return await(await fetch(s)).json()}var st=await xs(),vt=class{_data;constructor(t=`/manifest/images.${st.publication_id}.json`){this.url=t}processImages(t){let e=t[0],i=[];for(let r of t.slice(1)){let a={};for(let o=0;o<e.length;o++)a[e[o]]=r[o];i.push(a)}return i}async init(){if(window[bt]&&(this._data=window[bt]),this._data||this.loading)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.processImages(t);window[bt]=e,this._data=e}images(){return this._data.map(t=>({...t,full_image:`https://photos-cdn.rgrannell.xyz${t.full_image}`,thumbnail_url:`https://photos-cdn.rgrannell.xyz${t.thumbnail_url}`,thumbnail_mosaic_url:`data:image/bmp;base64,${t.thumbnail_mosaic_url}`}))}},St=class{_data;constructor(t=`/manifest/videos.${st.publication_id}.json`){this.url=t}processVideos(t){let e=t[0],i=[];for(let r of t.slice(1)){let a={};for(let o=0;o<e.length;o++)a[e[o]]=r[o];i.push(a)}return i}async init(){if(window[yt]&&(this._data=window[yt]),this._data||this.loading)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.processVideos(t);window[yt]=e,this._data=e}videos(){return this._data.map(t=>({...t,poster_url:`https://photos-cdn.rgrannell.xyz${t.poster_url}`,video_url_1080p:`https://photos-cdn.rgrannell.xyz${t.video_url_1080p}`,video_url_480p:`https://photos-cdn.rgrannell.xyz${t.video_url_480p}`,video_url_720p:`https://photos-cdn.rgrannell.xyz${t.video_url_720p}`,video_url_unscaled:`https://photos-cdn.rgrannell.xyz${t.video_url_unscaled}`,tags:(t.tags??"").split(",").filter(e=>e!="Published").map(e=>e.trim())}))}},Et=class{_data;constructor(t=`/manifest/albums.${st.publication_id}.json`){this.url=t}process(t){let e=t[0],i=[];for(let r of t.slice(1)){let a={};for(let o=0;o<e.length;o++)a[e[o]]=r[o];i.push(a)}return i}async init(){if(window[$t]&&(this._data=window[$t]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.process(t);window[$t]=e,this._data=e}albums(){return this._data.map(t=>({...t,thumbnail_url:`https://photos-cdn.rgrannell.xyz${t.thumbnail_url}`,thumbnail_mosaic_url:`${t.thumbnail_mosaic_url}`}))}},xt=class{_data;constructor(t=`/manifest/exif.${st.publication_id}.json`){this.url=t}process(t){let e=t[0],i=[];for(let r of t.slice(1)){let a={};for(let o=0;o<e.length;o++)a[e[o]]=r[o];i.push(a)}return i}async init(){if(window[_t]&&(this._data=window[_t]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.process(t);window[_t]=e,this._data=e}exif(){return this._data}};function qe(s,t,e){if(!s.hasOwnProperty(t))return!1;let i=s[t];if(i.includes(e))return!0;for(let r of i)if(qe(s,r,e))return!0;return!1}var Tt=class{_data;constructor(t=`/manifest/semantic.${st.publication_id}.json`){this.url=t}async init(){if(window[wt]&&(this._data=window[wt]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json();window[wt]=t,this._data=t}semantic(){return this._data}},Ut=class{_data;constructor(t="/manifest/metadata.json"){this.url=t}async init(){if(window[At]&&(this._data=window[At]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json();window[At]=t,this._data=t}metadata(){return this._data}isChild(t,e){return qe(this._data,t,e)}childrenOf(t,e){let i=new Set([]);for(let r of e)this.isChild(t,r)&&i.add(r);return i}};var w=class{static showAboutUrl(){window.location.hash="#/about",document.title="About - photos"}static showAlbumsUrl(){window.location.hash="#/albums",document.title="Albums - photos"}static showPhotosUrl(){window.location.hash="#/photos",document.title="Photos - photos"}static showAlbumUrl(t){window.location.hash=`#/album/${t}`,document.title="Album - photos"}static showPhotoUrl(t){window.location.hash=`#/photo/${t}`,document.title="Photo - photos"}static showDateUrl(t){window.location.hash=`#/date/${t}`,document.title="Date - photos"}static showLocationsUrl(){window.location.hash="#/locations",document.title="Locations - photos"}static showTagsUrl(){window.location.hash="#/tags",document.title="Tags - photos"}static showStatsUrl(){window.location.hash="#/stats",document.title="Stats - photos"}static showMetadataUrl(t){window.location.hash=`#/metadata/${t}`,document.title="Metadata - photos"}static showTagAlbumUrl(t){window.location.hash=`#/tag/${encodeURIComponent(t)}`,document.title="Tag - photos"}static showVideosUrl(){window.location.hash="#/videos",document.title="Videos - photos"}static getUrl(){return window.location.hash.startsWith("#/albums")?{type:"albums"}:window.location.hash.startsWith("#/album")?{type:"album",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/locations")?{type:"locations"}:window.location.hash.startsWith("#/tags")?{type:"tags"}:window.location.hash.startsWith("#/tag")?{type:"tag-album",tag:decodeURIComponent(window.location.hash.split("/")[2])}:window.location.hash.startsWith("#/stats")?{type:"stats"}:window.location.hash.startsWith("#/metadata")?{type:"metadata",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/date")?{type:"date",date:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/photos")?{type:"photos"}:window.location.hash.startsWith("#/about")?{type:"about"}:window.location.hash.startsWith("#/videos")?{type:"videos"}:{type:"albums"}}};var Ht=class extends u{static get properties(){return{visible:{type:Boolean}}}render(){let t=["photo-sidebar"];return this.visible&&t.push("sidebar-visible"),c`
    ...
    `}};customElements.define("photo-sidebar",Ht);var jt=class extends u{static get properties(){return{darkMode:{type:Boolean},tag:{type:String}}}feedUrl(){return this.tag?`/feeds/tags/${this.tag}.json`:"/manifest/atom/atom-index.xml"}render(){let t=this.darkMode?"\u2600\uFE0F":"\u{1F319}",e=We;return c`
    ...
    `}};customElements.define("photo-header",jt);var Vt=class extends u{static get properties(){return{id:{type:String},imageUrl:{type:String},thumbnailDataUrl:{type:String},thumbnailUrl:{type:String},tags:{type:Array},loading:{type:String}}}renderIcon(){return c`
    ...
    `}};customElements.define("locations-page",qt);var Jt=class extends u{static get properties(){return{id:{type:String},url:{type:String},preload:{type:String},url_poster:{type:String},url_unscaled:{type:String},url_1080p:{type:String},url_720p:{type:String},url_480p:{type:String}}}render(){return c`
    <div>
    ...
    `}};customElements.define("tag-page",te);var ee=class extends u{static get properties(){return{tagName:{type:String},count:{type:Number}}}render(){let{tagName:t,count:e}=this,i=encodeURIComponent(t);return typeof e>"u"?c`<a
        href="#/tag/${i}"
    ...
    <img class="thumbnail-image" src="${t.thumbnail_url}"/>
      ...
      ${t.description?c`<br/><p>${ft(t.description)}</p>`:c``}
    ...
    `}};customElements.define("date-page",oe);var ne=class extends u{static get properties(){return{}}connectedCallback(){super.connectedCallback(),A.setIndex()}render(){return c`
    <div>
    ...
    `}};customElements.define("videos-page",le);var S=new Et,v=new vt,E=new St,T=new Ut,U=new xt,L=new Tt,Ts=[[S,l.EAGER],[v,l.EAGER],[E,l.EAGER],[T,l.EAGER],[U,l.EAGER],[L,l.EAGER]],Us={[d.ABOUT]:[[S,l.LAZY],[v,l.LAZY],[E,l.LAZY],[T,l.LAZY],[U,l.LAZY],[L,l.LAZY]],[d.ALBUMS]:[[S,l.EAGER],[v,l.LAZY],[E,l.LAZY],[T,l.LAZY],[U,l.LAZY],[L,l.LAZY]],[d.PHOTOS]:[[S,l.EAGER],[v,l.EAGER],[E,l.EAGER],[T,l.LAZY],[U,l.LAZY],[L,l.LAZY]],[d.VIDEOS]:[[S,l.LAZY],[v,l.LAZY],[E,l.EAGER],[T,l.LAZY],[U,l.LAZY],[L,l.LAZY]],[d.ALBUM]:[[S,l.EAGER],[v,l.EAGER],[E,l.EAGER],[T,l.LAZY],[U,l.LAZY],[L,l.LAZY]],[d.PHOTO]:[[S,l.EAGER],[v,l.EAGER],[E,l.EAGER],[T,l.LAZY],[U,l.EAGER],[L,l.EAGER]],[d.DATE]:[[S,l.EAGER],[v,l.EAGER],[E,l.EAGER],[T,l.LAZY],[U,l.LAZY],[L,l.LAZY]],[d.TAG_ALBUM]:[[S,l.LAZY],[v,l.EAGER],[E,l.EAGER],[T,l.LAZY],[U,l.EAGER],[L,l.EAGER]],[d.TAG]:[[S,l.LAZY],[v,l.EAGER],[E,l.EAGER],[T,l.LAZY],[U,l.EAGER],[L,l.EAGER]],[d.LOCATIONS]:[[S,l.EAGER],[v,l.LAZY],[E,l.LAZY],[T,l.LAZY],[U,l.EAGER],[L,l.EAGER]],[d.METADATA]:[[S,l.LAZY],[v,l.EAGER],[E,l.EAGER],[T,l.EAGER],[U,l.EAGER],[L,l.EAGER]],[d.STATS]:[[S,l.LAZY],[v,l.LAZY],[E,l.LAZY],[T,l.LAZY],[U,l.EAGER],[L,l.EAGER]]},ce=class{static async init(){let t=w.getUrl();console.log(`loading ${t?.type}`);let e=Us[t?.type]??Ts,i=[];for(let[r,a]of e)a===l.EAGER?i.push(r.init()):a===l.LAZY&&r.init();await Promise.all(i)}};await ce.init();var he=class s extends u{static DEFAULT_PAGE=d.ALBUMS;static LOCATION_TYPE_TO_PAGE={album:d.ALBUM,albums:d.ALBUMS,photos:d.PHOTOS,date:d.DATE,"tag-album":d.TAG_ALBUM,tags:d.TAGS,locations:d.LOCATIONS,stats:d.STATS,metadata:d.METADATA,about:d.ABOUT,videos:d.VIDEOS};static get properties(){return{title:{type:String},page:{type:String},sidebarVisible:{type:Boolean,state:!0},id:{type:String},tags:{type:Array},imageUrl:{type:String},thumbnailUrl:{type:String},route:{type:String},params:{type:Object},query:{type:Object},darkMode:{type:Boolean}}}connectedCallback(){super.connectedCallback(),this.setStateFromUrl(),this.requestUpdate(),window.addEventListener("popstate",this.handlePopState.bind(this)),this.sidebarVisible=!1}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this.handlePopState.bind(this))}handlePopState(){this.setStateFromUrl(),this.requestUpdate()}setStateFromUrl(){let t=w.getUrl();s.LOCATION_TYPE_TO_PAGE[t?.type]?this.page=s.LOCATION_TYPE_TO_PAGE[t.type]:(console.error("did not match pagetype",t?.type),this.page=s.DEFAULT_PAGE),this.page===d.METADATA||this.page===d.ALBUM||this.page===d.METADATA?this.id=t.id:this.page===d.TAG_ALBUM?this.tag=t.tag:this.page===d.DATE&&(this.date=t.date)}receiveClickAlbum(t){let{title:e,id:i}=t.detail;this.page=d.PHOTOS,this.id=i,this.title=e,w.showAlbumUrl(i)}async receiveClickTag(t){let{tagName:e}=t.detail;this.page=d.TAG_ALBUM,this.tag=e,w.showTagAlbumUrl(e)}async receiveClickBurgerMenu(){this.sidebarVisible=!this.sidebarVisible}async receiveClickPhotoMetadata(t){let{id:e,imageUrl:i,thumbnailUrl:r,tags:a}=t.detail;this.page=d.METADATA,this.id=e,this.imageUrl=i,this.thumbnailUrl=r,this.tags=a??[],w.showMetadataUrl(e)}receiveSwitchTheme(t){this.darkMode=!this.darkMode,localStorage.setItem("darkMode",this.darkMode),this.requestUpdate()}receiveNavigatePage(t){this.page=t.detail.page,this.page===d.ABOUT?w.showAboutUrl():this.page===d.PHOTOS?w.showPhotosUrl():this.page===d.ALBUMS?w.showAlbumsUrl():this.page===d.TAGS?w.showTagsUrl():this.page===d.LOCATIONS?w.showLocationsUrl():this.page===d.STATS?w.showStatsUrl():this.page===d.PHOTOS?w.showAlbumUrl(this.id):this.page===d.METADATA?w.showMetadataUrl(this.id):this.page===d.DATE?w.showDateUrl(this.date):this.page===d.VIDEOS?w.showVideosUrl():w.showAlbumsUrl(),this.sidebarVisible=!1}renderPage(t){let e=["page"];if(t&&e.push("sidebar-visible"),!this.page||this.page==="albums")return c`
      ...
      `;if(this.page===d.METADATA){let i=v.images().find(h=>h.id===this.id),r=U.exif().find(h=>h.id===this.id),a=L.semantic().filter(h=>h[0]===this.id),o={};for(let[h,n,m]of a)o[n]?typeof o[n]=="string"&&(o[n]=[o[n],m]):o[n]=m;return i||console.error(`failed to find photo with id ${this.id}`),c`
      ...
      `}loadDarkMode(){return typeof this.darkMode<"u"?this.darkMode:localStorage.getItem("darkMode")==="true"}render(){let t=["app-container"];this.sidebarVisible&&t.push("sidebar-visible");let e=document.documentElement,i=["photos-app"];this.darkMode?(e.classList.add("dark-mode"),i.push("dark-mode")):e.classList=[];let r=new Ve;return c`
    <body>
      <div class="${i.join(" ")}"
