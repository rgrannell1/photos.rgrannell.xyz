...
\f\r"'\`<>=]|("|')|))|$)`,"g"),ve=/'/g,we=/"/g,Ne=/^(?:script|style|textarea|title)$/i,De=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),l=De(1),os=De(2),A=Symbol.for("lit-noChange"),b=Symbol.for("lit-nothing"),Se=new WeakMap,H=Y.createTreeWalker(Y,129);function Ie(i,t){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return ye!==void 0?ye.createHTML(t):t}var Be=(i,t)=>{let e=i.length-1,s=[],r,n=t===2?"<svg>":"",o=J;for(let h=0;h<e;h++){let a=i[h],d,g,p=-1,$=0;for(;$<a.length&&(o.lastIndex=$,g=o.exec(a),g!==null);)$=o.lastIndex,o===J?g[1]==="!--"?o=Ae:g[1]!==void 0?o=_e:g[2]!==void 0?(Ne.test(g[2])&&(r=RegExp("</"+g[2],"g")),o=B):g[3]!==void 0&&(o=B):o===B?g[0]===">"?(o=r??J,p=-1):g[1]===void 0?p=-2:(p=o.lastIndex-g[2].length,d=g[1],o=g[3]===void 0?B:g[3]==='"'?we:ve):o===we||o===ve?o=B:o===Ae||o===_e?o=J:(o=B,r=void 0);let f=o===B&&i[h+1].startsWith("/>")?" ":"";n+=o===J?a+ns:p>=0?(s.push(d),a.slice(0,p)+zt+a.slice(p)+k+f):a+k+(p===-2?h:f)}return[Ie(i,n+(i[e]||"<?>")+(t===2?"</svg>":"")),s]},st=class i{constructor({strings:t,_$litType$:e},s){let r;this.parts=[];let n=0,o=0,h=t.length-1,a=this.parts,[d,g]=Be(t,e);if(this.el=i.createElement(d,s),H.currentNode=this.el.content,e===2){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(r=H.nextNode())!==null&&a.length<h;){if(r.nodeType===1){if(r.hasAttributes())for(let p of r.getAttributeNames())if(p.endsWith(zt)){let $=g[o++],f=r.getAttribute(p).split(k),_=/([.?@])?(.*)/.exec($);a.push({type:1,index:n,name:_[2],strings:f,ctor:_[1]==="."?ht:_[1]==="?"?ct:_[1]==="@"?dt:G}),r.removeAttribute(p)}else p.startsWith(k)&&(a.push({type:6,index:n}),r.removeAttribute(p));if(Ne.test(r.tagName)){let p=r.textContent.split(k),$=p.length-1;if($>0){r.textContent=at?at.emptyScript:"";for(let f=0;f<$;f++)r.append(p[f],tt()),H.nextNode(),a.push({type:2,index:++n});r.append(p[$],tt())}}}else if(r.nodeType===8)if(r.data===Zt)a.push({type:2,index:n});else{let p=-1;for(;(p=r.data.indexOf(k,p+1))!==-1;)a.push({type:7,index:n}),p+=k.length-1}n++}}static createElement(t,e){let s=Y.createElement("template");return s.innerHTML=t,s}};function j(i,t,e=i,s){if(t===A)return t;let r=s!==void 0?e.U?.[s]:e.N,n=et(t)?void 0:t._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),n===void 0?r=void 0:(r=new n(i),r._$AT(i,e,s)),s!==void 0?(e.U??=[])[s]=r:e.N=r),r!==void 0&&(t=j(i,r._$AS(i,t.values),r,s)),t}var lt=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}O(t){let{el:{content:e},parts:s}=this._$AD,r=(t?.creationScope??Y).importNode(e,!0);H.currentNode=r;let n=H.nextNode(),o=0,h=0,a=s[0];for(;a!==void 0;){if(o===a.index){let d;a.type===2?d=new bt(n,n.nextSibling,this,t):a.type===1?d=new a.ctor(n,a.name,a.strings,this,t):a.type===6&&(d=new pt(n,this,t)),this._$AV.push(d),a=s[++h]}o!==a?.index&&(n=H.nextNode(),o++)}return H.currentNode=Y,r}R(t){let e=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},bt=class He{get _$AU(){return this._$AM?._$AU??this.V}constructor(t,e,s,r){this.type=2,this._$AH=b,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=r,this.V=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=j(this,t,e),et(t)?t===b||t==null||t===""?(this._$AH!==b&&this._$AR(),this._$AH=b):t!==this._$AH&&t!==A&&this.L(t):t._$litType$!==void 0?this.I(t):t.nodeType!==void 0?this.j(t):Pe(t)?this.D(t):this.L(t)}H(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}j(t){this._$AH!==t&&(this._$AR(),this._$AH=this.H(t))}L(t){this._$AH!==b&&et(this._$AH)?this._$AA.nextSibling.data=t:this.j(Y.createTextNode(t)),this._$AH=t}I(t){let{values:e,_$litType$:s}=t,r=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=st.createElement(Ie(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===r)this._$AH.R(e);else{let n=new lt(r,this),o=n.O(this.options);n.R(e),this.j(o),this._$AH=n}}_$AC(t){let e=Se.get(t.strings);return e===void 0&&Se.set(t.strings,e=new st(t)),e}D(t){Re(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,s,r=0;for(let n of t)r===e.length?e.push(s=new He(this.H(tt()),this.H(tt()),this,this.options)):s=e[r],s._$AI(n),r++;r<e.length&&(this._$AR(s&&s._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){let s=t.nextSibling;t.remove(),t=s}}setConnected(t){this._$AM===void 0&&(this.V=t,this._$AP?.(t))}},G=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,r,n){this.type=1,this._$AH=b,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=n,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=b}_$AI(t,e=this,s,r){let n=this.strings,o=!1;if(n===void 0)t=j(this,t,e,0),o=!et(t)||t!==this._$AH&&t!==A,o&&(this._$AH=t);else{let h=t,a,d;for(t=n[0],a=0;a<n.length-1;a++)d=j(this,h[s+a],e,a),d===A&&(d=this._$AH[a]),o||=!et(d)||d!==this._$AH[a],d===b?t=b:t!==b&&(t+=(d??"")+n[a+1]),this._$AH[a]=d}o&&!r&&this.B(t)}B(t){t===b?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},ht=class extends G{constructor(){super(...arguments),this.type=3}B(t){this.element[this.name]=t===b?void 0:t}},ct=class extends G{constructor(){super(...arguments),this.type=4}B(t){this.element.toggleAttribute(this.name,!!t&&t!==b)}},dt=class extends G{constructor(t,e,s,r,n){super(t,e,s,r,n),this.type=5}_$AI(t,e=this){if((t=j(this,t,e,0)??b)===A)return;let s=this._$AH,r=t===b&&s!==b||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,n=t!==b&&(s===b||r);r&&this.element.removeEventListener(this.name,this,s),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},pt=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){j(this,t)}},as={W:zt,q:k,J:Zt,Z:1,F:Be,G:lt,K:Pe,X:j,Y:bt,tt:G,st:ct,it:dt,et:ht,ot:pt},ls=Vt.litHtmlPolyfillSupport;ls?.(st,bt),(Vt.litHtmlVersions??=[]).push("3.1.3");var Ye=(i,t,e)=>{let s=e?.renderBefore??t,r=s._$litPart$;if(r===void 0){let n=e?.renderBefore??null;s._$litPart$=r=new bt(t.insertBefore(tt(),n),n,void 0,e??{})}return r._$AI(i),r};var I=class extends N{constructor(){super(...arguments),this.renderOptions={host:this},this.ht=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this.ht=Ye(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this.ht?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this.ht?.setConnected(!1)}render(){return A}};I._$litElement$=!0,I.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:I});var hs=globalThis.litElementPolyfillSupport;hs?.({LitElement:I});(globalThis.litElementVersions??=[]).push("4.0.5");var{Y:cs}=as,ds=i=>i===null||typeof i!="object"&&typeof i!="function";var Ee=(i,t)=>t===void 0?i?._$litType$!==void 0:i?._$litType$===t,ps=i=>i?._$litType$?.h!=null;var je=i=>i.strings===void 0,xe=()=>document.createComment(""),D=(i,t,e)=>{let s=i._$AA.parentNode,r=t===void 0?i._$AB:t._$AA;if(e===void 0){let n=s.insertBefore(xe(),r),o=s.insertBefore(xe(),r);e=new cs(n,o,i,i.options)}else{let n=e._$AB.nextSibling,o=e._$AM,h=o!==i;if(h){let a;e._$AQ?.(i),e._$AM=i,e._$AP!==void 0&&(a=i._$AU)!==o._$AU&&e._$AP(a)}if(n!==r||h){let a=e._$AA;for(;a!==n;){let d=a.nextSibling;s.insertBefore(a,r),a=d}}}return e},P=(i,t,e=i)=>(i._$AI(t,e),i),us={},it=(i,t=us)=>i._$AH=t,Yt=i=>i._$AH,Dt=i=>{i._$AP?.(!1,!0);let t=i._$AA,e=i._$AB.nextSibling;for(;t!==e;){let s=t.nextSibling;t.remove(),t=s}},Ge=i=>{i._$AR()};var w=i=>(...t)=>({_$litDirective$:i,values:t}),E=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this.nt=t,this._$AM=e,this.rt=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var X=(i,t)=>{let e=i._$AN;if(e===void 0)return!1;for(let s of e)s._$AO?.(t,!1),X(s,t);return!0},ut=i=>{let t,e;do{if((t=i._$AM)===void 0)break;e=t._$AN,e.delete(i),i=t}while(e?.size===0)},Ve=i=>{for(let t;t=i._$AM;i=t){let e=t._$AN;if(e===void 0)t._$AN=e=new Set;else if(e.has(i))break;e.add(i),gs(t)}};function ms(i){this._$AN!==void 0?(ut(this),this._$AM=i,Ve(this)):this._$AM=i}function fs(i,t=!1,e=0){let s=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(t)if(Array.isArray(s))for(let n=e;n<s.length;n++)X(s[n],!1),ut(s[n]);else s!=null&&(X(s,!1),ut(s));else X(this,i)}var gs=i=>{i.type==2&&(i._$AP??=fs,i._$AQ??=ms)},rt=class extends E{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,s){super._$AT(t,e,s),Ve(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(X(this,t),ut(this))}setValue(t){if(je(this.nt))this.nt._$AI(t,this);else{let e=[...this.nt._$AH];e[this.rt]=t,this.nt._$AI(e,this,0)}}disconnected(){}reconnected(){}};var mt=class{constructor(t){this.ct=t}disconnect(){this.ct=void 0}reconnect(t){this.ct=t}deref(){return this.ct}},ft=class{constructor(){this.lt=void 0,this.ut=void 0}get(){return this.lt}pause(){this.lt??=new Promise(t=>this.ut=t)}resume(){this.ut?.(),this.lt=this.ut=void 0}};var gt=class extends rt{constructor(){super(...arguments),this.dt=new mt(this),this.ft=new ft}render(t,e){return A}update(t,[e,s]){if(this.isConnected||this.disconnected(),e===this.vt)return A;this.vt=e;let r=0,{dt:n,ft:o}=this;return(async(h,a)=>{for await(let d of h)if(await a(d)===!1)return})(e,async h=>{for(;o.get();)await o.get();let a=n.deref();if(a!==void 0){if(a.vt!==e)return!1;s!==void 0&&(h=s(h,r)),a.commitValue(h,r),r++}return!0}),A}commitValue(t,e){this.setValue(t)}disconnected(){this.dt.disconnect(),this.ft.pause()}reconnected(){this.dt.reconnect(this),this.ft.resume()}},Ss=w(gt),Es=w(class extends gt{constructor(i){if(super(i),i.type!==2)throw Error("asyncAppend can only be used in child expressions")}update(i,t){return this.ht=i,super.update(i,t)}commitValue(i,t){t===0&&Ge(this.ht);let e=D(this.ht);P(e,i)}}),Ue=i=>ps(i)?i._$litType$.h:i.strings,xs=w(class extends E{constructor(i){super(i),this.yt=new WeakMap}render(i){return[i]}update(i,[t]){let e=Ee(this.bt)?Ue(this.bt):null,s=Ee(t)?Ue(t):null;if(e!==null&&(s===null||e!==s)){let r=Yt(i).pop(),n=this.yt.get(e);if(n===void 0){let o=document.createDocumentFragment();n=Ye(b,o),n.setConnected(!1),this.yt.set(e,n)}it(n,[r]),D(n,void 0,r)}if(s!==null){if(e===null||e!==s){let r=this.yt.get(s);if(r!==void 0){let n=Yt(r).pop();Ge(i),D(i,void 0,n),it(i,[n])}}this.bt=t}else this.bt=void 0;return this.render(t)}});var Us=w(class extends E{constructor(i){if(super(i),i.type!==1||i.name!=="class"||i.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter(t=>i[t]).join(" ")+" "}update(i,[t]){if(this.gt===void 0){this.gt=new Set,i.strings!==void 0&&(this.wt=new Set(i.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(let s in t)t[s]&&!this.wt?.has(s)&&this.gt.add(s);return this.render(t)}let e=i.element.classList;for(let s of this.gt)s in t||(e.remove(s),this.gt.delete(s));for(let s in t){let r=!!t[s];r===this.gt.has(s)||this.wt?.has(s)||(r?(e.add(s),this.gt.add(s)):(e.remove(s),this.gt.delete(s)))}return A}}),$s={},Ts=w(class extends E{constructor(){super(...arguments),this._t=$s}render(i,t){return t()}update(i,[t,e]){if(Array.isArray(t)){if(Array.isArray(this._t)&&this._t.length===t.length&&t.every((s,r)=>s===this._t[r]))return A}else if(this._t===t)return A;return this._t=Array.isArray(t)?Array.from(t):t,this.render(t,e)}});var Ms=w(class extends E{constructor(){super(...arguments),this.key=b}render(i,t){return this.key=i,t}update(i,[t,e]){return t!==this.key&&(it(i),this.key=t),e}}),Ls=w(class extends E{constructor(i){if(super(i),i.type!==3&&i.type!==1&&i.type!==4)throw Error("The `live` directive is not allowed on child or event bindings");if(!je(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[t]){if(t===A||t===b)return t;let e=i.element,s=i.name;if(i.type===3){if(t===e[s])return A;if(i.type===4){if(!!t===e.hasAttribute(s))return A;if(i.type===1&&e.getAttribute(s)===t+"")return A}}return it(i),t}});var It=new WeakMap,Os=w(class extends rt{render(i){return b}update(i,[t]){let e=t!==this.ct;return e&&this.ct!==void 0&&this.St(void 0),(e||this.$t!==this.Tt)&&(this.ct=t,this.xt=i.options?.host,this.St(this.Tt=i.element)),b}St(i){if(typeof this.ct=="function"){let t=this.xt??globalThis,e=It.get(t);e===void 0&&(e=new WeakMap,It.set(t,e)),e.get(this.ct)!==void 0&&this.ct.call(this.xt,void 0),e.set(this.ct,i),i!==void 0&&this.ct.call(this.xt,i)}else this.ct.value=i}get $t(){return typeof this.ct=="function"?It.get(this.xt??globalThis)?.get(this.ct):this.ct?.value}disconnected(){this.$t===this.Tt&&this.St(void 0)}reconnected(){this.St(this.Tt)}}),Te=(i,t,e)=>{let s=new Map;for(let r=t;r<=e;r++)s.set(i[r],r);return s},Cs=w(class extends E{constructor(i){if(super(i),i.type!==2)throw Error("repeat() can only be used in text expressions")}Et(i,t,e){let s;e===void 0?e=t:t!==void 0&&(s=t);let r=[],n=[],o=0;for(let h of i)r[o]=s?s(h,o):o,n[o]=e(h,o),o++;return{values:n,keys:r}}render(i,t,e){return this.Et(i,t,e).values}update(i,[t,e,s]){let r=Yt(i),{values:n,keys:o}=this.Et(t,e,s);if(!Array.isArray(r))return this.Ct=o,n;let h=this.Ct??=[],a=[],d,g,p=0,$=r.length-1,f=0,_=n.length-1;for(;p<=$&&f<=_;)if(r[p]===null)p++;else if(r[$]===null)$--;else if(h[p]===o[f])a[f]=P(r[p],n[f]),p++,f++;else if(h[$]===o[_])a[_]=P(r[$],n[_]),$--,_--;else if(h[p]===o[_])a[_]=P(r[p],n[_]),D(i,a[_+1],r[p]),p++,_--;else if(h[$]===o[f])a[f]=P(r[$],n[f]),D(i,r[p],r[$]),$--,f++;else if(d===void 0&&(d=Te(o,f,_),g=Te(h,p,$)),d.has(h[p]))if(d.has(h[$])){let x=g.get(o[f]),Q=x!==void 0?r[x]:null;if(Q===null){let me=D(i,r[p]);P(me,n[f]),a[f]=me}else a[f]=P(Q,n[f]),D(i,r[p],Q),r[x]=null;f++}else Dt(r[$]),$--;else Dt(r[p]),p++;for(;f<=_;){let x=D(i,a[_+1]);P(x,n[f]),a[f++]=x}for(;p<=$;){let x=r[p++];x!==null&&Dt(x)}return this.Ct=o,it(i,a),A}}),ze="important",bs=" !"+ze,ks=w(class extends E{constructor(i){if(super(i),i.type!==1||i.name!=="style"||i.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(i){return Object.keys(i).reduce((t,e)=>{let s=i[e];return s==null?t:t+`${e=e.includes("-")?e:e.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(i,[t]){let{style:e}=i.element;if(this.Pt===void 0)return this.Pt=new Set(Object.keys(t)),this.render(t);for(let s of this.Pt)t[s]==null&&(this.Pt.delete(s),s.includes("-")?e.removeProperty(s):e[s]=null);for(let s in t){let r=t[s];if(r!=null){this.Pt.add(s);let n=typeof r=="string"&&r.endsWith(bs);s.includes("-")||n?e.setProperty(s,n?r.slice(0,-11):r,n?ze:""):e[s]=r}}return A}}),Rs=w(class extends E{constructor(i){if(super(i),i.type!==2)throw Error("templateContent can only be used in child bindings")}render(i){return this.At===i?A:(this.At=i,document.importNode(i.content,!0))}}),Z=class extends E{constructor(t){if(super(t),this.bt=b,t.type!==2)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===b||t==null)return this.kt=void 0,this.bt=t;if(t===A)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.bt)return this.kt;this.bt=t;let e=[t];return e.raw=e,this.kt={_$litType$:this.constructor.resultType,strings:e,values:[]}}};Z.directiveName="unsafeHTML",Z.resultType=1;var yt=w(Z);var nt=class extends Z{};nt.directiveName="unsafeSVG",nt.resultType=2;var Ps=w(nt),Me=i=>!ds(i)&&typeof i.then=="function",Le=1073741823;var jt=class extends rt{constructor(){super(...arguments),this.Mt=Le,this.Ut=[],this.dt=new mt(this),this.ft=new ft}render(...t){return t.find(e=>!Me(e))??A}update(t,e){let s=this.Ut,r=s.length;this.Ut=e;let n=this.dt,o=this.ft;this.isConnected||this.disconnected();for(let h=0;h<e.length&&!(h>this.Mt);h++){let a=e[h];if(!Me(a))return this.Mt=h,a;h<r&&a===s[h]||(this.Mt=Le,r=0,Promise.resolve(a).then(async d=>{for(;o.get();)await o.get();let g=n.deref();if(g!==void 0){let p=g.Ut.indexOf(a);p>-1&&p<g.Mt&&(g.Mt=p,g.setValue(d))}}))}return A}disconnected(){this.dt.disconnect(),this.ft.pause()}reconnected(){this.dt.reconnect(this),this.ft.resume()}},Ns=w(jt);var ys=Symbol.for(""),As=i=>{if(i?.r===ys)return i?._$litStatic$};var Oe=new Map,Ze=i=>(t,...e)=>{let s=e.length,r,n,o=[],h=[],a,d=0,g=!1;for(;d<s;){for(a=t[d];d<s&&(n=e[d],(r=As(n))!==void 0);)a+=r+t[++d],g=!0;d!==s&&h.push(n),o.push(a),d++}if(d===s&&o.push(t[s]),g){let p=o.join("$$lit$$");(t=Oe.get(p))===void 0&&(o.raw=o,Oe.set(p,t=o)),e=h}return i(t,...e)},Ds=Ze(l),Is=Ze(os);var u=class extends I{createRenderRoot(){return this}broadcast(t,e){return()=>{let s=new CustomEvent(t,{detail:e,bubbles:!0,composed:!0});this.dispatchEvent(s)}}};var At=Symbol("the albums manifest"),_t=Symbol("the images manifest"),Xs=Symbol("the site manifest"),vt=Symbol("metadata about the site manifest"),wt=Symbol("the videos manifest"),St=Symbol("the exif data"),Et=Symbol("the semantic data"),xt=Symbol("the album stats");var Fe="photos",c=class{static EAGER="eager";static LAZY="lazy"},m=class{static PHOTOS="photos";static ALBUMS="albums";static ALBUM="album";static METADATA="metadata";static ABOUT="about";static VIDEOS="videos";static THING="thing"},V=class{static UNESCO="unesco";static BIRD="bird";static MAMMAL="mammal"},F=class{static SUBJECT="subject";static LOCATION="location";static RATING="rating"},Ut=new Set(["bird","mammal","reptile","amphibian","fish"]);async function _s(i="/manifest/env.json"){return await(await fetch(i)).json()}var W=await _s(),Tt=class{_data;constructor(t=`/manifest/images.${W.publication_id}.json`){this.url=t}processImages(t){let e=t[0],s=[];for(let r of t.slice(1)){let n={};for(let o=0;o<e.length;o++)n[e[o]]=r[o];s.push(n)}return s}async init(){if(window[_t]&&(this._data=window[_t]),this._data||this.loading)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.processImages(t);window[_t]=e,this._data=e}images(){return this._data.map(t=>({...t,full_image:`https://photos-cdn.rgrannell.xyz${t.full_image}`,thumbnail_url:`https://photos-cdn.rgrannell.xyz${t.thumbnail_url}`,thumbnail_mosaic_url:`data:image/bmp;base64,${t.thumbnail_mosaic_url}`}))}},Mt=class{_data;constructor(t=`/manifest/videos.${W.publication_id}.json`){this.url=t}processVideos(t){let e=t[0],s=[];for(let r of t.slice(1)){let n={};for(let o=0;o<e.length;o++)n[e[o]]=r[o];s.push(n)}return s}async init(){if(window[wt]&&(this._data=window[wt]),this._data||this.loading)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.processVideos(t);window[wt]=e,this._data=e}videos(){return this._data.map(t=>({...t,poster_url:`https://photos-cdn.rgrannell.xyz${t.poster_url}`,video_url_1080p:`https://photos-cdn.rgrannell.xyz${t.video_url_1080p}`,video_url_480p:`https://photos-cdn.rgrannell.xyz${t.video_url_480p}`,video_url_720p:`https://photos-cdn.rgrannell.xyz${t.video_url_720p}`,video_url_unscaled:`https://photos-cdn.rgrannell.xyz${t.video_url_unscaled}`,tags:(t.tags??"").split(",").filter(e=>e!="Published").map(e=>e.trim())}))}},Lt=class{_data;constructor(t=`/manifest/albums.${W.publication_id}.json`){this.url=t}process(t){let e=t[0],s=[];for(let r of t.slice(1)){let n={};for(let o=0;o<e.length;o++)n[e[o]]=r[o];s.push(n)}return s}async init(){if(window[At]&&(this._data=window[At]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.process(t);window[At]=e,this._data=e}albums(){return this._data.map(t=>({...t,thumbnail_url:`https://photos-cdn.rgrannell.xyz${t.thumbnail_url}`,thumbnail_mosaic_url:`${t.thumbnail_mosaic_url}`}))}},Ot=class{_data;constructor(t=`/manifest/exif.${W.publication_id}.json`){this.url=t}process(t){let e=t[0],s=[];for(let r of t.slice(1)){let n={};for(let o=0;o<e.length;o++)n[e[o]]=r[o];s.push(n)}return s}async init(){if(window[St]&&(this._data=window[St]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.process(t);window[St]=e,this._data=e}exif(){return this._data}};function We(i,t,e){if(!i.hasOwnProperty(t))return!1;let s=i[t];if(s.includes(e))return!0;for(let r of s)if(We(i,r,e))return!0;return!1}var Ct=class{_data;constructor(t=`/manifest/semantic.${W.publication_id}.json`){this.url=t}async init(){if(window[Et]&&(this._data=window[Et]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json();window[Et]=t,this._data=t}semantic(){return this._data}},kt=class{_data;constructor(t="/manifest/metadata.json"){this.url=t}async init(){if(window[vt]&&(this._data=window[vt]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json();window[vt]=t,this._data=t}metadata(){return this._data}isChild(t,e){return We(this._data,t,e)}childrenOf(t,e){let s=new Set([]);for(let r of e)this.isChild(t,r)&&s.add(r);return s}},Rt=class{_data;constructor(t=`/manifest/stats.${W.publication_id}.json`){this.url=t}async init(){if(window[xt]&&(this._data=window[xt]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json();window[xt]=t,this._data=t}stats(){return this._data}};var M=class i{static ROUTES={[m.PHOTOS]:this.showPhotosUrl,[m.ALBUMS]:this.showAlbumsUrl,[m.ALBUM]:this.showAlbumUrl,[m.METADATA]:this.showMetadataUrl,[m.ABOUT]:this.showAboutUrl,[m.VIDEOS]:this.showVideosUrl,[m.THING]:this.showThingUrl};static router(t){if(i.ROUTES.hasOwnProperty(t))return i.ROUTES[t];throw new Error(`Unknown page: ${t}`)}static pageUsesId(t){return t===m.ALBUM||t===m.PHOTO||t===m.METADATA||t===m.THING}static showAboutUrl(){window.location.hash="#/about",document.title="About - photos"}static showAlbumsUrl(){window.location.hash="#/albums",document.title="Albums - photos"}static showPhotosUrl(){window.location.hash="#/photos",document.title="Photos - photos"}static showAlbumUrl(t){window.location.hash=`#/album/${t}`,document.title="Album - photos"}static showPhotoUrl(t){window.location.hash=`#/photo/${t}`,document.title="Photo - photos"}static showMetadataUrl(t){window.location.hash=`#/metadata/${t}`,document.title="Metadata - photos"}static showVideosUrl(){window.location.hash="#/videos",document.title="Videos - photos"}static showThingUrl(t){window.location.hash=`#/thing/${t}`,document.title="Thing - photos"}static getUrl(){return window.location.hash.startsWith("#/albums")?{type:"albums"}:window.location.hash.startsWith("#/album")?{type:"album",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/metadata")?{type:"metadata",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/thing")?{type:"thing",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/photos")?{type:"photos"}:window.location.hash.startsWith("#/about")?{type:"about"}:window.location.hash.startsWith("#/videos")?{type:"videos"}:{type:"albums"}}};var Ft=class extends u{static get properties(){return{visible:{type:Boolean}}}render(){let t=["photo-sidebar"];return this.visible&&t.push("sidebar-visible"),l`
    ...
    `:l`<span>Invalid UNESCO URN</span>`}};customElements.define("unesco-link",ie);var re=class extends u{static get properties(){return{title:{type:String},id:{type:String},minDate:{type:String},maxDate:{type:String},imageCount:{type:Number},description:{type:String},images:{type:Object},videos:{type:Object},semantic:{type:Object}}}connectedCallback(){super.connectedCallback(),this.albumPhotos()[0]||console.error(`empty album! ${this.id}`),v.setIndex()}albumPhotos(){let t=this.semantic.semantic();return this.images.images().filter(e=>e.album_id===this.id).map(e=>{let s={},r=t.filter(n=>n[0]===e.id);for(let[n,o,h]of r)s[o]||(s[o]=[]),s[o].push(h);return{...e,relations:s}})}albumVideos(){return this.videos.videos().filter(t=>t.album_id===this.id)}renderPhotoCount(){return this.imageCount===1?`${this.imageCount} photo`:`${this.imageCount} photos`}render(){let t=window.matchMedia("(max-width: 500px)"),e=q.dateRange(this.minDate,this.maxDate,t.matches),s=this.albumPhotos(),r=s.map((a,d)=>l`
      <app-photo
        ...
        ></app-video>`),o=new Set(s.flatMap(a=>a.relations.location?.filter(d=>(console.log(y.parseUrn(d),V.UNESCO,d),y.is(d,V.UNESCO)))).filter(a=>a)),h=Array.from(o).map(a=>l`<unesco-link urn="${a}"></unesco-link>`);return l`
    <div>
      <section class="photos-metadata">
        <h1>${this.title}</h1>
        <p class="photo-album-date">
    ...
    `}};customElements.define("thing-page",de);var U=new Lt,S=new Tt,T=new Mt,R=new kt,O=new Ot,z=new Ct,C=new Rt,vs=[[U,c.EAGER],[S,c.EAGER],[T,c.EAGER],[R,c.EAGER],[O,c.EAGER],[z,c.EAGER],[C,c.EAGER]],ws={[m.ABOUT]:[[U,c.LAZY],[S,c.LAZY],[T,c.LAZY],[R,c.LAZY],[O,c.LAZY],[C,c.LAZY]],[m.ALBUMS]:[[U,c.EAGER],[S,c.LAZY],[T,c.LAZY],[R,c.LAZY],[O,c.LAZY],[C,c.EAGER]],[m.PHOTOS]:[[U,c.EAGER],[S,c.EAGER],[T,c.EAGER],[R,c.LAZY],[O,c.LAZY],[C,c.LAZY]],[m.VIDEOS]:[[U,c.LAZY],[S,c.LAZY],[T,c.EAGER],[R,c.LAZY],[O,c.LAZY],[C,c.LAZY]],[m.ALBUM]:[[U,c.EAGER],[S,c.EAGER],[T,c.EAGER],[C,c.LAZY],[R,c.LAZY],[O,c.LAZY]],[m.PHOTO]:[[U,c.EAGER],[S,c.EAGER],[T,c.EAGER],[R,c.LAZY],[O,c.EAGER],[z,c.EAGER],[C,c.LAZY]],[m.METADATA]:[[U,c.LAZY],[S,c.EAGER],[T,c.EAGER],[R,c.EAGER],[O,c.EAGER],[z,c.EAGER],[C,c.LAZY]],[m.THING]:[[U,c.LAZY],[S,c.EAGER],[T,c.LAZY],[R,c.EAGER],[O,c.LAZY],[z,c.EAGER],[C,c.LAZY]]},pe=class{static async init(){let t=M.getUrl();console.log(`loading ${t?.type}`);let e=ws[t?.type]??vs,s=[];for(let[r,n]of e)n===c.EAGER?s.push(r.init()):n===c.LAZY&&r.init();await Promise.all(s)}};await pe.init();var ue=class i extends u{static DEFAULT_PAGE=m.ALBUMS;static LOCATION_TYPE_TO_PAGE={album:m.ALBUM,albums:m.ALBUMS,photos:m.PHOTOS,metadata:m.METADATA,about:m.ABOUT,videos:m.VIDEOS,thing:m.THING};static get properties(){return{title:{type:String},page:{type:String},sidebarVisible:{type:Boolean,state:!0},id:{type:String},tags:{type:Array},imageUrl:{type:String},thumbnailUrl:{type:String},route:{type:String},params:{type:Object},query:{type:Object},darkMode:{type:Boolean}}}connectedCallback(){super.connectedCallback(),this.setStateFromUrl(),this.requestUpdate(),window.addEventListener("popstate",this.handlePopState.bind(this)),this.sidebarVisible=!1}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this.handlePopState.bind(this))}handlePopState(){this.setStateFromUrl(),this.requestUpdate()}setStateFromUrl(){let t=M.getUrl();i.LOCATION_TYPE_TO_PAGE[t?.type]?this.page=i.LOCATION_TYPE_TO_PAGE[t.type]:(console.error("did not match pagetype",t?.type),this.page=i.DEFAULT_PAGE),M.pageUsesId(this.page)&&(this.id=t.id)}receiveClickAlbum(t){let{title:e,id:s}=t.detail;this.page=m.PHOTOS,this.id=s,this.title=e,M.showAlbumUrl(s)}async receiveClickBurgerMenu(){this.sidebarVisible=!this.sidebarVisible}async receiveClickPhotoMetadata(t){let{id:e,imageUrl:s,thumbnailUrl:r,tags:n}=t.detail;this.page=m.METADATA,this.id=e,this.imageUrl=s,this.thumbnailUrl=r,this.tags=n??[],M.showMetadataUrl(e)}receiveSwitchTheme(t){this.darkMode=!this.darkMode,localStorage.setItem("darkMode",this.darkMode),this.requestUpdate()}receiveNavigatePage(t){this.page=t.detail.page,this.sidebarVisible=!1;let e=M.router(this.page);M.pageUsesId(this.page)?e(this.id):e()}pageClasses(t){let e=["page"];return t&&e.push("sidebar-visible"),e.join(" ")}renderPage(t){let e=this.pageClasses(t);if(!this.page||this.page==="albums")return l`
      <photo-album-page .stats=${C} .albums="${U}" class="${e}"></photo-album-page>
      `;if(this.page===m.ABOUT)return l`<about-page class="${e}"></about-page>`;if(this.page===m.PHOTOS)return l`<photos-page class="${e}" .images=${S}></photos-page>`;if(this.page===m.ALBUM){this.id||console.error("no album id provided");let s=U.albums().find(r=>r.id===this.id);return s||console.error(`failed to find album with id ${this.id}`),l`
      <album-page
        .images=${S}
        .videos=${T}
        .semantic=${z}
        ...
        class="${e}"></album-page>
      `}if(this.page===m.METADATA){let s=S.images().find(h=>h.id===this.id),r=O.exif().find(h=>h.id===this.id),n=z.semantic().filter(h=>h[0]===this.id),o={};for(let[h,a,d]of n)o[a]?typeof o[a]=="string"&&(o[a]=[o[a],d]):o[a]=d;return s||console.error(`failed to find photo with id ${this.id}`),l`
      <metadata-page .image=${s} .semantic=${o} .exif=${r} id=${this.id} class="${e}"></metadata-page>
      `}if(this.page===m.VIDEOS)return l`
      <videos-page .videos=${T} class="${e}"></videos-page>
