var ht = globalThis,
  ...
  Xe = (i) => new Vt(typeof i == "string" ? i : i + "", void 0, Ne);
var ts = (i, t) => {
    if (Wt) {
      i.adoptedStyleSheets = t.map((e) =>
        ...
        let s = document.createElement("style"), r = ht.litNonce;
  ...
  _t = globalThis,
  ve = _t.trustedTypes,
  as = ve ? ve.emptyScript : "",
  ls = _t.reactiveElementPolyfillSupport,
  st = (i, t) => i,
  zt = {
    toAttribute(i, t) {
      switch (t) {
...
Symbol.metadata ??= Symbol("metadata"),
  _t.litPropertyMetadata ??= new WeakMap();
var H = class extends HTMLElement {
  ...
  static createProperty(t, e = we) {
    if (
      ...
      r !== void 0 && ss(this.prototype, t, r);
    }
  }
  static getPropertyDescriptor(t, e, s) {
    let { get: r, set: n } = is(this.prototype, t) ?? {
      get() {
        return this[e];
      },
      set(o) {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this.o(), this.hasOwnProperty(st("properties"))) {
      let e = this.properties, s = [...rs(e), ...ns(e)];
  ...
  C(t, e) {
    ...
    if (r !== void 0 && s.reflect === !0) {
      let n = (s.converter?.toAttribute !== void 0 ? s.converter : zt)
...
H.elementStyles = [],
  ...
  H[st("elementProperties")] = new Map(),
  H[st("finalized")] = new Map(),
  ls?.({ ReactiveElement: H }),
  (_t.reactiveElementVersions ??= []).push("2.0.4");
var qt = globalThis,
  dt = qt.trustedTypes,
  Se = dt ? dt.createPolicy("lit-html", { createHTML: (i) => i }) : void 0,
  Kt = "$lit$",
  ...
  Be = Array.isArray,
  He = (i) => Be(i) || typeof i?.[Symbol.iterator] == "function",
  jt = `[ 	
\f\r]`,
...
\f\r"'\`<>=]|("|')|))|$)`,
  ...
  Ge = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }),
  l = Ge(1),
  hs = Ge(2),
...
var Ve = (i, t) => {
    let e = i.length - 1, s = [], r, n = t === 2 ? "<svg>" : "", o = et;
    for (let c = 0; c < e; c++) {
      let a = i[c], d, $, p = -1, b = 0;
      for (; b < a.length && (o.lastIndex = b, $ = o.exec(a), $ !== null);) {
        b = o.lastIndex,
          o === et
            ? $[1] === "!--"
              ? o = Ee
            ...
            ? $[0] === ">"
              ...
              : $[1] === void 0
              ? p = -2
              : (p = o.lastIndex - $[2].length,
                d = $[1],
                o = $[3] === void 0 ? Y : $[3] === '"' ? Te : Ue)
            : o === Te || o === Ue
            ? o = Y
            : o === Ee || o === xe
            ? o = et
      ...
      let f = o === Y && i[c + 1].startsWith("/>") ? " " : "";
      n += o === et
        ? a + cs
        : p >= 0
        ? (s.push(d), a.slice(0, p) + Kt + a.slice(p) + N + f)
        : a + N + (p === -2 ? c : f);
    }
    return [Ye(i, n + (i[e] || "<?>") + (t === 2 ? "</svg>" : "")), s];
  },
  ot = class i {
    constructor({ strings: t, _$litType$: e }, s) {
      let r;
      this.parts = [];
      let n = 0, o = 0, c = t.length - 1, a = this.parts, [d, $] = Ve(t, e);
      if (
        this.el = i.createElement(d, s),
      ...
      for (; (r = V.nextNode()) !== null && a.length < c;) {
        if (r.nodeType === 1) {
            ...
            for (let p of r.getAttributeNames()) {
              if (p.endsWith(Kt)) {
                ...
                a.push({
                  ...
                  (a.push({ type: 6, index: n }), r.removeAttribute(p));}
            }
          }
          if (je.test(r.tagName)) {
            let p = r.textContent.split(N), b = p.length - 1;
            if (b > 0) {
          ...
          if (r.data === Jt) a.push({ type: 2, index: n });
            ...
            let p = -1;
            for (; (p = r.data.indexOf(N, p + 1)) !== -1;) {
              a.push({ type: 7, index: n }), p += N.length - 1;
            }
          }
        }
        n++;
    ...
    static createElement(t, e) {
      let s = z.createElement("template");
      return s.innerHTML = t, s;
    }
  };
function Z(i, t, e = i, s) {
  if (t === _) return t;
  let r = s !== void 0 ? e.U?.[s] : e.N, n = nt(t) ? void 0 : t._$litDirective$;
  return r?.constructor !== n &&
    (r?._$AO?.(!1),
      n === void 0 ? r = void 0 : (r = new n(i), r._$AT(i, e, s)),
      s !== void 0 ? (e.U ??= [])[s] = r : e.N = r),
    r !== void 0 && (t = Z(i, r._$AS(i, t.values), r, s)),
    t;
}
var pt = class {
    constructor(t, e) {
    ...
    O(t) {
      let { el: { content: e }, parts: s } = this._$AD,
        r = (t?.creationScope ?? z).importNode(e, !0);
      V.currentNode = r;
      ...
      for (; a !== void 0;) {
        if (o === a.index) {
          let d;
          a.type === 2
            ? d = new vt(n, n.nextSibling, this, t)
            : a.type === 1
            ? d = new a.ctor(n, a.name, a.strings, this, t)
            : a.type === 6 && (d = new gt(n, this, t)),
            this._$AV.push(d),
            a = s[++c];
        }
        o !== a?.index && (n = V.nextNode(), o++);
      }
      return V.currentNode = z, r;
    }
    R(t) {
      let e = 0;
  ...
  vt = class ze {
    ...
    L(t) {
      this._$AH !== A && nt(this._$AH)
        ? this._$AA.nextSibling.data = t
        : this.j(z.createTextNode(t)), this._$AH = t;
    }
    I(t) {
      let { values: e, _$litType$: s } = t,
        r = typeof s == "number" ? this._$AC(t) : (s.el === void 0 &&
          (s.el = ot.createElement(Ye(s.h, s.h[0]), this.options)),
          s);
      if (this._$AH?._$AD === r) this._$AH.R(e);
      else {
        let n = new pt(r, this), o = n.O(this.options);
        n.R(e), this.j(o), this._$AH = n;
      }
    }
    _$AC(t) {
      let e = Ce.get(t.strings);
      return e === void 0 && Ce.set(t.strings, e = new ot(t)), e;
    }
    D(t) {
      ...
      for (let n of t) {
        r === e.length
          ? e.push(s = new ze(this.H(rt()), this.H(rt()), this, this.options))
          : s = e[r],
          s._$AI(n),
          r++;
      }
    ...
    _$AI(t, e = this, s, r) {
      ...
      if (n === void 0) {
        ...
        for (t = n[0], a = 0; a < n.length - 1; a++) {
          d = Z(this, c[s + a], e, a),
            d === _ && (d = this._$AH[a]),
            o ||= !nt(d) || d !== this._$AH[a],
            d === A ? t = A : t !== A && (t += (d ?? "") + n[a + 1]),
            this._$AH[a] = d;
        }
      }
      o && !r && this.B(t);
  ...
  ft = class extends F {
    ...
    _$AI(t, e = this) {
      if ((t = Z(this, t, e, 0) ?? A) === _) return;
      let s = this._$AH,
        r = t === A && s !== A || t.capture !== s.capture ||
  ...
  ps = qt.litHtmlPolyfillSupport;
ps?.(ot, vt), (qt.litHtmlVersions ??= []).push("3.1.3");
var Ze = (i, t, e) => {
  let s = e?.renderBefore ?? t, r = s._$litPart$;
  if (r === void 0) {
    let n = e?.renderBefore ?? null;
    s._$litPart$ = r = new vt(t.insertBefore(rt(), n), n, void 0, e ?? {});
  }
  return r._$AI(i), r;
};
var G = class extends H {
  ...
  update(t) {
    ...
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      super.update(t),
      this.ht = Ze(e, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
G._$litElement$ = !0,
  G.finalized = !0,
  globalThis.litElementHydrateSupport?.({ LitElement: G });
var us = globalThis.litElementPolyfillSupport;
us?.({ LitElement: G });
(globalThis.litElementVersions ??= []).push("4.0.5");
var { Y: ms } = ds,
  fs = (i) => i === null || typeof i != "object" && typeof i != "function";
var Le = (i, t) =>
    t === void 0 ? i?._$litType$ !== void 0 : i?._$litType$ === t,
  gs = (i) => i?._$litType$?.h != null;
var Fe = (i) => i.strings === void 0,
  Me = () => document.createComment(""),
  j = (i, t, e) => {
    let s = i._$AA.parentNode, r = t === void 0 ? i._$AB : t._$AA;
    if (e === void 0) {
      let n = s.insertBefore(Me(), r), o = s.insertBefore(Me(), r);
      ...
      if (n !== r || c) {
        ...
        for (; a !== n;) {
          let d = a.nextSibling;
          s.insertBefore(a, r), a = d;
        }
      }
    }
    return e;
  },
  B = (i, t, e = i) => (i._$AI(t, e), i),
  $s = {},
  at = (i, t = $s) => i._$AH = t,
  Zt = (i) => i._$AH,
  Gt = (i) => {
...
var S = (i) => (...t) => ({ _$litDirective$: i, values: t }),
  C = class {
    constructor(t) {}
    get _$AU() {
      return this._$AM._$AU;
...
var it = (i, t) => {
    ...
    for (let s of e) s._$AO?.(t, !1), it(s, t);
    return !0;
  },
  $t = (i) => {
    let t, e;
...
function bs(i) {
  this._$AN !== void 0 ? ($t(this), this._$AM = i, qe(this)) : this._$AM = i;
}
function ys(i, t = !1, e = 0) {
  let s = this._$AH, r = this._$AN;
  if (r !== void 0 && r.size !== 0) {
    if (t) {
      if (Array.isArray(s)) {
        for (let n = e; n < s.length; n++) it(s[n], !1), $t(s[n]);
      } else s != null && (it(s, !1), $t(s));
    } else it(this, i);
  }
}
var As = (i) => {
    i.type == 2 && (i._$AP ??= ys, i._$AQ ??= bs);
  },
  lt = class extends C {
    constructor() {
    ...
    _$AT(t, e, s) {
      super._$AT(t, e, s), qe(this), this.isConnected = t._$AU;
    }
    _$AO(t, e = !0) {
      t !== this.isConnected &&
    ...
    setValue(t) {
      if (Fe(this.nt)) this.nt._$AI(t, this);
      else {
        let e = [...this.nt._$AH];
...
var At = class extends lt {
    constructor() {
      super(...arguments), this.dt = new bt(this), this.ft = new yt();
    }
    render(t, e) {
      return _;
    }
    update(t, [e, s]) {
      ...
      return (async (c, a) => {
        for await (let d of c) if (await a(d) === !1) return;
      })(e, async (c) => {
  ...
  Re = (i) => gs(i) ? i._$litType$.h : i.strings,
  Ts = S(
    class extends C {
      constructor(i) {
      ...
      update(i, [t]) {
        let e = Le(this.bt) ? Re(this.bt) : null, s = Le(t) ? Re(t) : null;
        if (e !== null && (s === null || e !== s)) {
          let r = Zt(i).pop(), n = this.yt.get(e);
          if (n === void 0) {
            let o = document.createDocumentFragment();
            n = Ze(A, o), n.setConnected(!1), this.yt.set(e, n);
          }
          at(n, [r]), j(n, void 0, r);
        }
        if (s !== null) {
...
var Ms = S(
    class extends C {
      ...
      update(i, [t, e]) {
        return t !== this.key && (at(i), this.key = t), e;
      }
    },
  ),
  Rs = S(
    class extends C {
      ...
      update(i, [t]) {
        ...
        if (i.type === 3) {
          if (t === e[s]) return _;
          if (i.type === 4) {
            if (!!t === e.hasAttribute(s)) return _;
            if (i.type === 1 && e.getAttribute(s) === t + "") return _;
          }
        }
        return at(i), t;
      }
...
var Yt = new WeakMap(),
    ...
    class extends lt {
      ...
      St(i) {
        if (typeof this.ct == "function") {
          let t = this.xt ?? globalThis, e = Yt.get(t);
          e === void 0 && (e = new WeakMap(), Yt.set(t, e)),
      ...
      get $t() {
        return typeof this.ct == "function"
          ? Yt.get(this.xt ?? globalThis)?.get(this.ct)
          : this.ct?.value;
      }
      disconnected() {
  ...
  Ps = S(
    class extends C {
      ...
      Et(i, t, e) {
        ...
        let r = [], n = [], o = 0;
        for (let c of i) r[o] = s ? s(c, o) : o, n[o] = e(c, o), o++;
      ...
      update(i, [t, e, s]) {
        let r = Zt(i), { values: n, keys: o } = this.Et(t, e, s);
        ...
        for (; p <= b && f <= y;) {
          ...
          else if (c[p] === o[f]) a[f] = B(r[p], n[f]), p++, f++;
          else if (c[b] === o[y]) a[y] = B(r[b], n[y]), b--, y--;
          else if (c[p] === o[y]) {
            a[y] = B(r[p], n[y]), j(i, a[y + 1], r[p]), p++, y--;
          } else if (c[b] === o[f]) {
            a[f] = B(r[b], n[f]), j(i, r[p], r[b]), b--, f++;
          } else if (
            d === void 0 && (d = Oe(o, f, y), $ = Oe(c, p, b)), d.has(c[p])
          ) {
            if (d.has(c[b])) {
              let x = $.get(o[f]), tt = x !== void 0 ? r[x] : null;
              if (tt === null) {
                let ye = j(i, r[p]);
                B(ye, n[f]), a[f] = ye;
              } else a[f] = B(tt, n[f]), j(i, r[p], tt), r[x] = null;
              f++;
            } else Gt(r[b]), b--;
          } else Gt(r[p]), p++;
        }
    ...
    class extends C {
      ...
      update(i, [t]) {
        ...
        for (let s in t) {
          ...
          if (r != null) {
            this.Pt.add(s);
            let n = typeof r == "string" && r.endsWith(vs);
            s.includes("-") || n
              ? e.setProperty(s, n ? r.slice(0, -11) : r, n ? Ke : "")
              : e[s] = r;
          }
        }
        return _;
  ...
  J = class extends C {
    ...
    render(t) {
      if (t === A || t == null) return this.kt = void 0, this.bt = t;
      if (t === _) return t;
      if (typeof t != "string") {
        throw Error(
...
var Ns = S(ct),
  Pe = (i) => !fs(i) && typeof i.then == "function",
  ke = 1073741823;
var Ft = class extends lt {
    ...
    update(t, e) {
      ...
      for (let c = 0; c < e.length && !(c > this.Mt); c++) {
        let a = e[c];
        if (!Pe(a)) return this.Mt = c, a;
        c < r && a === s[c] ||
          (this.Mt = ke,
            r = 0,
            Promise.resolve(a).then(async (d) => {
              for (; o.get();) await o.get();
              let $ = n.deref();
              if ($ !== void 0) {
                let p = $.Ut.indexOf(a);
                p > -1 && p < $.Mt && ($.Mt = p, $.setValue(d));
              }
            }));
      }
      return _;
...
var ws = Symbol.for(""),
  Ss = (i) => {
    if (i?.r === ws) return i?._$litStatic$;
  };
var Ie = new Map(),
  Je = (i) => (t, ...e) => {
    let s = e.length, r, n, o = [], c = [], a, d = 0, $ = !1;
    for (; d < s;) {
      for (a = t[d]; d < s && (n = e[d], (r = Ss(n)) !== void 0);) {
        a += r + t[++d], $ = !0;
      }
      d !== s && c.push(n), o.push(a), d++;
    }
    if (d === s && o.push(t[s]), $) {
      let p = o.join("$$lit$$");
      (t = Ie.get(p)) === void 0 && (o.raw = o, Ie.set(p, t = o)), e = c;
    }
    return i(t, ...e);
  },
  Bs = Je(l),
...
var Et = Symbol("the albums manifest"),
  xt = Symbol("the images manifest"),
  ti = Symbol("the site manifest"),
  Ut = Symbol("the videos manifest"),
  Tt = Symbol("the exif data"),
  Ct = Symbol("the semantic data"),
  Lt = Symbol("the album stats"),
  Mt = Symbol("the triples data");
var Qe = "photos",
  h = class {
    static EAGER = "eager";
    static LAZY = "lazy";
  ...
  Q = new Set(["bird", "mammal", "reptile", "amphibian", "fish"]);
var q = window.envConfig,
  Rt = class {
    _data;
    constructor(t = `/manifest/images.${q.publication_id}.json`) {
      this.url = t;
    }
    processImages(t) {
      let e = t[0], s = [];
  ...
  Ot = class {
    _data;
    constructor(t = `/manifest/videos.${q.publication_id}.json`) {
      this.url = t;
    }
    processVideos(t) {
      let e = t[0], s = [];
    ...
    async init() {
      if (window[Ut] && (this._data = window[Ut]), this._data || this.loading) {
        return;
      }
      console.log(`\u{1F50E} fetching ${this.url}`);
      let t = await (await fetch(this.url)).json(), e = this.processVideos(t);
      window[Ut] = e, this._data = e;
    }
    videos() {
      return this._data.map((t) => ({
        ...t,
  ...
  Pt = class {
    _data;
    constructor(t = `/manifest/albums.${q.publication_id}.json`) {
      this.url = t;
    }
    process(t) {
      let e = t[0], s = [];
    ...
    async init() {
      if (window[Et] && (this._data = window[Et]), this._data) return;
      console.log(`\u{1F50E} fetching ${this.url}`);
      let t = await (await fetch(this.url)).json(), e = this.process(t);
      window[Et] = e, this._data = e;
    }
    albums() {
      return this._data.map((t) => ({
        ...t,
  ...
  kt = class {
    _data;
    constructor(t = `/manifest/exif.${q.publication_id}.json`) {
      this.url = t;
    }
    process(t) {
      let e = t[0], s = [];
    ...
    async init() {
      if (window[Tt] && (this._data = window[Tt]), this._data) return;
      console.log(`\u{1F50E} fetching ${this.url}`);
      let t = await (await fetch(this.url)).json(), e = this.process(t);
      window[Tt] = e, this._data = e;
    }
    exif() {
      return this._data;
    }
...
var It = class {
    _data;
    constructor(t = `/manifest/semantic.${q.publication_id}.json`) {
      this.url = t;
    }
    async init() {
      if (window[Ct] && (this._data = window[Ct]), this._data) return;
      console.log(`\u{1F50E} fetching ${this.url}`);
      let t = await (await fetch(this.url)).json();
      window[Ct] = t, this._data = t;
    }
    semantic() {
      return this._data;
    }
  ...
  Nt = class {
    _data;
    constructor(t = `/manifest/stats.${q.publication_id}.json`) {
      this.url = t;
    }
    async init() {
  ...
  Dt = class {
    _data;
    constructor(t = `/manifest/triples.${q.publication_id}.json`) {
      this.url = t;
    }
    async init() {
      if (window[Mt] && (this._data = window[Mt]), this._data) return;
      console.log(`\u{1F50E} fetching ${this.url}`);
      let t = await (await fetch(this.url)).json();
      window[Mt] = t, this._data = t;
    }
  };
var O = class i {
  static ROUTES = {
    [m.PHOTOS]: this.showPhotosUrl,
    [m.ALBUMS]: this.showAlbumsUrl,
    [m.ALBUM]: this.showAlbumUrl,
    [m.METADATA]: this.showMetadataUrl,
    [m.ABOUT]: this.showAboutUrl,
    [m.VIDEOS]: this.showVideosUrl,
    [m.THING]: this.showThingUrl,
  };
  static router(t) {
  ...
  static pageUsesId(t) {
    return t === m.ALBUM || t === m.PHOTO || t === m.METADATA || t === m.THING;
  }
  static showAboutUrl() {
...
customElements.define("photo-sidebar", Qt);
var Xt = class extends u {
  ...
  render() {
    let t = this.darkMode ? "\u2600\uFE0F" : "\u{1F319}", e = Qe;
    return l`
...
customElements.define("photo-header", Xt);
var Bt = new Map(),
  E = class {
    ...
    static encodeBitmapDataURL(t) {
      ...
      return r.fillStyle = e[1],
        ...
        r.fillStyle = e[4],
        r.fillRect(1, 1, 1, 1),
        Bt.set(t, s.toDataURL("image/png")),
        Bt.get(t);
    }
  };
var te = class extends u {
  ...
  render() {
    ...
    let s = e.textContent ?? e.innerText ?? "";
    return l`
    <div class="photo">
...
customElements.define("app-photo", te);
...
customElements.define("search-bar", ee);
var w = class {
  static getElement() {
...
var se = class extends u {
  ...
  connectedCallback() {
    super.connectedCallback(), w.setIndex();
  }
  allImages() {
...
customElements.define("photos-page", se);
...
customElements.define("photos-stats", ie);
var X = class i {
  static parse(t) {
    let [e, s] = t.split(" ");
  ...
  static dateRange(t, e, s) {
    ...
    if (s) {
      let o = { day: "numeric", month: "short" },
        ...
        d = r.toLocaleDateString("en-IE", { day: "numeric" }),
        $ = n.toLocaleDateString("en-IE", { day: "numeric" }),
        p = r.toLocaleDateString("en-IE", { month: "short" }),
        b = n.toLocaleDateString("en-IE", { month: "short" }),
        f = r.getFullYear(),
        y = n.getFullYear(),
        x = p === b,
        tt = f === y;
...
customElements.define("photo-album", re);
...
customElements.define("photo-album-page", ne);
...
customElements.define("app-video", oe);
...
customElements.define("album-share-button", ae);
var P = class i {
    static findSourceRelation(t, e, s) {
      if (!Array.isArray(e)) throw new TypeError("Triples must be an array");
      let r = e.find((n) => g.sameURN(n[0], s) && D.hasRelation(n, t));
      return r ? D.getTarget(r) : null;
    }
    static findSubject(t, e) {
      return i.findSourceRelation(v.SUBJECT, t, e);
    }
    static findLocation(t, e) {
      return i.findSourceRelation(v.LOCATION, t, e);
    }
    static findRating(t, e) {
      return i.findSourceRelation(v.RATING, t, e);
    }
    static findName(t, e) {
      return i.findSourceRelation(v.NAME, t, e);
    }
    static findBirdwatchUrl(t, e) {
      return i.findSourceRelation(v.BIRDWATCH_URL, t, e);
    }
    static findWikipedia(t, e) {
      return i.findSourceRelation(v.WIKIPEDIA, t, e);
    }
    static findLongitude(t, e) {
      return i.findSourceRelation(v.LONGITUDE, t, e);
    }
    static findLatitude(t, e) {
      return i.findSourceRelation(v.LATITUDE, t, e);
    }
  },
  D = class {
    ...
    static filterRelation(t, e) {
      return t.filter((s) => s[1] === e);
    }
    static filterSourceId(t, e) {
      if (!g.isUrn(e)) throw new Error(`Invalid URN: ${e}`);
      let s = g.parseUrn(e);
      return t.filter((r) => g.sameURN(r[0], e) || g.hasId(r[0], s.id));
    }
  },
  g = class i {
    static isUrn(t) {
  ...
  K = class {
    ...
    static toCommonName(t, e) {
      let r = D.filterRelation(t, v.NAME).find((n) => g.hasId(n[0], e));
      return r ? D.getTarget(r) : e;
    }
    static birdwatchUrl(t, e) {
      let s = D.filterSourceId(D.filterRelation(t, v.BIRDWATCH_URL), e);
      if (s.length === 0) return;
      let [r] = s;
      return D.getTarget(r);
    }
  };
var le = class extends u {
  static properties = { urn: { type: String } };
  id() {
    return g.parseUrn(this.urn)?.id ?? "unknown";
  }
  url() {
...
customElements.define("unesco-link", le);
var ce = class extends u {
  ...
  connectedCallback() {
    super.connectedCallback(),
      this.albumPhotos()[0] || console.error(`empty album! ${this.id}`),
      w.setIndex();
  }
  albumPhotos() {
    let t = this.semantic.semantic();
    return this.images.images().filter((e) => e.album_id === this.id).map(
      (e) => {
        let s = {}, r = t.filter((n) => n[0] === e.id);
        for (let [n, o, c] of r) s[o] || (s[o] = []), s[o].push(c);
        return { ...e, relations: s };
      },
    );
  }
  albumVideos() {
  ...
  render() {
    let t = window.matchMedia("(max-width: 500px)"),
      e = X.dateRange(this.minDate, this.maxDate, t.matches),
      s = this.albumPhotos(),
      r = s.map((a, d) =>
        l`
      <app-photo
      ...
      o = new Set(
        s.flatMap((a) =>
          a.relations.location?.filter(
            (d) => (console.log(g.parseUrn(d), W.UNESCO, d), g.is(d, W.UNESCO)),
          )
        ).filter((a) => a),
      ),
      c = Array.from(o).map((a) => l`<unesco-link urn="${a}"></unesco-link>`);
    return l`
    <div>
      <section class="photos-metadata">
        <h1>${this.title}</h1>
...
customElements.define("album-page", ce);
...
customElements.define("share-metadata-button", he);
var de = class extends u {
  static properties = { urn: { type: String }, triples: { type: Array } };
  name() {
    let { type: t, id: e } = g.parseUrn(this.urn);
    if (Q.has(t)) return l`<span>${K.toCommonName(this.triples, e)}</span>`;
    let s = P.findName(this.triples, this.urn);
    return s ? l`<span>${s}</span>` : decodeURIComponent(e);
  }
  render() {
    return g.isUrn(this.urn)
      ? l`
...
customElements.define("thing-link", de);
...
customElements.define("tag-link", pe);
var ue = class extends u {
  ...
  renderAperture() {
    return this.exif.f_stop === "Unknown"
      ...
      : l`<td>ƒ/${this.exif.f_stop}</td>`;
  }
  renderFocalLength() {
    return this.exif.focal_length === "Unknown"
      ? l`${this.exif.focal_length}`
      : this.exif.focal_length === "0"
      ? l`<td>Manual lens</td>`
      : l`<td>${this.exif.focal_length}mm equiv.</td>`;
  }
  renderSemanticKey(t) {
  ...
  isIgnoredKey(t) {
    return console.log(t),
      new Set(["bird_binomial", "wildlife", "living_conditions"]).has(t);
  }
  renderSemanticData(t) {
    return l`
      ...
      <table class="metadata-table">
        ${
      Object.keys(t).sort().filter((e) => !this.isIgnoredKey(e)).map((e) =>
        l`
            <tr>
  ...
  render() {
    let t = this.image, e = this.exif, s = this.semantic, r = t.album_id;
    return l`
    <section>
    <h1>Metadata</h1>
...
customElements.define("metadata-page", ue);
...
customElements.define("about-page", me);
var Ht = class {
  static loadingMode(t) {
...
customElements.define("videos-page", fe);
var ge = class extends u {
  ...
  isSemanticRelation(t) {
    return t === v.SUBJECT || t === v.LOCATION || t === v.RATING;
  }
  filterPhotos(t, e) {
    return e.filter((s) => {
      let [r, n, o] = s,
        c = g.isRating(o) ? `urn:r\xF3:rating:${encodeURIComponent(o)}` : o;
      if (!this.isSemanticRelation(n) && !g.isUrn(c)) return !1;
      try {
        let a = g.parseUrn(c), d = g.parseUrn(this.urn);
        return d.id === "*" ? d.type === a.type : g.sameURN(c, this.urn);
      } catch {
        return !1;
      }
    }).map((s) => t.find((r) => r.id === s[0])).filter((s) => s !== void 0);
  }
  subjectPhotos(t, e) {
    return this.filterPhotos(t, e).map((s, r) =>
      l`
      <app-photo
        id=${s.id}
        ...
        imageUrl="${s.full_image}"></app-photo>`
    );
  }
  subjectAlbums(t, e) {
    let s = this.filterPhotos(t, e), r = new Set(s.map((n) => n.album_id));
  ...
  getFacts() {
    let t = this.triples.filter((s) => s[0] === this.urn), e = {};
    for (let s of t) {
      let [r, n, o] = s;
      e.hasOwnProperty(n) || (e[n] = []), e[n].push(o);
    }
    return e;
  }
  binomialToCommonName(t) {
    let e = this.triples.find((s) => {
      let [r, n, o] = s;
      if (!g.isUrn(r)) return !1;
      let c = g.parseUrn(r), a = t.replace(" ", "-").toLowerCase();
      return c.id === a && n === v.NAME;
    });
    return e ? e[2] : t;
  }
  firstPhotographed(t, e) {
    let r =
      this.filterPhotos(t, e).sort((n, o) => n.created_at - o.created_at)[0];
    return r
  ...
  getTitle() {
    let t = P.findName(this.triples, this.urn);
    if (t) return t;
    try {
      let e = g.parseUrn(this.urn), s = decodeURIComponent(e.id);
      return e.id === "*"
        ? `${e.type.charAt(0).toUpperCase()}${e.type.slice(1)}`
        : Q.has(e.type)
        ? K.toCommonName(this.triples, s)
        : s;
    } catch {
      return this.urn;
    }
  ...
  renderFacts(t, e) {
    let s = {};
    return e.country && (s.Country = l`${e.country}`), s;
  }
  render() {
    let t = this.images.images(),
      e = this.semantic.semantic(),
      s = this.subjectPhotos(t, e),
      r = this.subjectAlbums(t, e),
      n = this.getFacts(),
      o = g.parseUrn(this.urn),
      c = o.type,
      a = Object.assign({
        Classification: l`<a href="#/thing/${c}:*">${
          c.charAt(0).toUpperCase()
        }${c.slice(1)}</a>`,
      }, this.renderFacts(o, n));
    Q.has(c) &&
      (a["First Photographed"] = l`<span>${
        this.firstPhotographed(t, e)
      }</span>`);
    let d = P.findWikipedia(this.triples, this.urn),
      $ = P.findBirdwatchUrl(this.triples, this.urn),
      p = P.findLongitude(this.triples, this.urn),
      b = P.findLatitude(this.triples, this.urn),
      f;
    if (p && b) {
      let y = `https://www.google.com/maps?q=${n.latitude},${n.longitude}`;
      f = l`
    ...
    return l`
      ...
      <section class="thing-page">
        ...
        <p>
          ${
      Q.has(c)
        ? l`<span class="thing-binomial">(${K.pretty(o.id)})</span>`
        : l``
    }
        </p>
        <br>
...
customElements.define("thing-page", ge);
var L = new Pt(),
  T = new Rt(),
  M = new Ot(),
  k = new kt(),
  ...
  I = new Nt(),
  R = new Dt(),
  Es = [[L, h.EAGER], [T, h.EAGER], [M, h.EAGER], [k, h.EAGER], [U, h.EAGER], [
    I,
    h.EAGER,
  ], [R, h.LAZY]],
  xs = {
  ...
  $e = class {
    static async init() {
      ...
      let e = xs[t?.type] ?? Es, s = [];
      for (let [r, n] of e) {
        n === h.EAGER ? s.push(r.init()) : n === h.LAZY && r.init();
      }
      await Promise.all(s);
    }
  };
await $e.init();
var be = class i extends u {
  static DEFAULT_PAGE = m.ALBUMS;
  ...
  receiveClickAlbum(t) {
    ...
    this.page = m.PHOTOS, this.id = s, this.title = e, O.showAlbumUrl(s);
  }
  ...
  renderPage(t) {
    ...
    if (this.page === m.ABOUT) return l`<about-page class="${e}"></about-page>`;
    if (this.page === m.PHOTOS) {
      return l`<photos-page class="${e}" .images=${T}></photos-page>`;
    }
    if (this.page === m.ALBUM) {
      this.id || console.error("no album id provided");
      let s = L.albums().find((r) => r.id === this.id);
    ...
    if (this.page === m.METADATA) {
      let s = T.images().find((c) => c.id === this.id),
        r = k.exif().find((c) => c.id === this.id),
        n = U.semantic().filter((c) => c[0] === this.id),
        o = {};
      for (let [c, a, d] of n) {
        o[a] ? typeof o[a] == "string" && (o[a] = [o[a], d]) : o[a] = d;
      }
    ...
    if (this.page === m.VIDEOS) {
      return l`
      <videos-page .videos=${M} class="${e}"></videos-page>
      `;
    }
    if (this.page === m.THING) {
      return l`
      <thing-page
...
customElements.define("photo-app", be);
export { be as PhotoApp, Es as DEFAULT_DEPENDENCIES, xs as PAGE_DEPENDECIES };
/**
 * @license
