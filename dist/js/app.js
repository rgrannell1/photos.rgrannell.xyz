...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ue=/'/g,Te=/"/g,je=/^(?:script|style|textarea|title)$/i,Ge=i=>(t,...e)=>({_$litType$:i,strings:t,values:e}),a=Ge(1),hs=Ge(2),_=Symbol.for("lit-noChange"),A=Symbol.for("lit-nothing"),Le=new WeakMap,z=F.createTreeWalker(F,129);function Ye(i,t){if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return Se!==void 0?Se.createHTML(t):t}var Ve=(i,t)=>{let e=i.length-1,s=[],r,n=t===2?"<svg>":"",o=st;for(let c=0;c<e;c++){let l=i[c],p,$,d=-1,b=0;for(;b<l.length&&(o.lastIndex=b,$=o.exec(l),$!==null);)b=o.lastIndex,o===st?$[1]==="!--"?o=Ee:$[1]!==void 0?o=xe:$[2]!==void 0?(je.test($[2])&&(r=RegExp("</"+$[2],"g")),o=V):$[3]!==void 0&&(o=V):o===V?$[0]===">"?(o=r??st,d=-1):$[1]===void 0?d=-2:(d=o.lastIndex-$[2].length,p=$[1],o=$[3]===void 0?V:$[3]==='"'?Te:Ue):o===Te||o===Ue?o=V:o===Ee||o===xe?o=st:(o=V,r=void 0);let f=o===V&&i[c+1].startsWith("/>")?" ":"";n+=o===st?l+cs:d>=0?(s.push(p),l.slice(0,d)+Kt+l.slice(d)+D+f):l+D+(d===-2?c:f)}return[Ye(i,n+(i[e]||"<?>")+(t===2?"</svg>":"")),s]},at=class i{constructor({strings:t,_$litType$:e},s){let r;this.parts=[];let n=0,o=0,c=t.length-1,l=this.parts,[p,$]=Ve(t,e);if(this.el=i.createElement(p,s),z.currentNode=this.el.content,e===2){let d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(r=z.nextNode())!==null&&l.length<c;){if(r.nodeType===1){if(r.hasAttributes())for(let d of r.getAttributeNames())if(d.endsWith(Kt)){let b=$[o++],f=r.getAttribute(d).split(D),y=/([.?@])?(.*)/.exec(b);l.push({type:1,index:n,name:y[2],strings:f,ctor:y[1]==="."?mt:y[1]==="?"?ft:y[1]==="@"?gt:W}),r.removeAttribute(d)}else d.startsWith(D)&&(l.push({type:6,index:n}),r.removeAttribute(d));if(je.test(r.tagName)){let d=r.textContent.split(D),b=d.length-1;if(b>0){r.textContent=pt?pt.emptyScript:"";for(let f=0;f<b;f++)r.append(d[f],nt()),z.nextNode(),l.push({type:2,index:++n});r.append(d[b],nt())}}}else if(r.nodeType===8)if(r.data===Jt)l.push({type:2,index:n});else{let d=-1;for(;(d=r.data.indexOf(D,d+1))!==-1;)l.push({type:7,index:n}),d+=D.length-1}n++}}static createElement(t,e){let s=F.createElement("template");return s.innerHTML=t,s}};function Z(i,t,e=i,s){if(t===_)return t;let r=s!==void 0?e.U?.[s]:e.N,n=ot(t)?void 0:t._$litDirective$;return r?.constructor!==n&&(r?._$AO?.(!1),n===void 0?r=void 0:(r=new n(i),r._$AT(i,e,s)),s!==void 0?(e.U??=[])[s]=r:e.N=r),r!==void 0&&(t=Z(i,r._$AS(i,t.values),r,s)),t}var ut=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}O(t){let{el:{content:e},parts:s}=this._$AD,r=(t?.creationScope??F).importNode(e,!0);z.currentNode=r;let n=z.nextNode(),o=0,c=0,l=s[0];for(;l!==void 0;){if(o===l.index){let p;l.type===2?p=new wt(n,n.nextSibling,this,t):l.type===1?p=new l.ctor(n,l.name,l.strings,this,t):l.type===6&&(p=new $t(n,this,t)),this._$AV.push(p),l=s[++c]}o!==l?.index&&(n=z.nextNode(),o++)}return z.currentNode=F,r}R(t){let e=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},wt=class ze{get _$AU(){return this._$AM?._$AU??this.V}constructor(t,e,s,r){this.type=2,this._$AH=A,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=r,this.V=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Z(this,t,e),ot(t)?t===A||t==null||t===""?(this._$AH!==A&&this._$AR(),this._$AH=A):t!==this._$AH&&t!==_&&this.L(t):t._$litType$!==void 0?this.I(t):t.nodeType!==void 0?this.j(t):He(t)?this.D(t):this.L(t)}H(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}j(t){this._$AH!==t&&(this._$AR(),this._$AH=this.H(t))}L(t){this._$AH!==A&&ot(this._$AH)?this._$AA.nextSibling.data=t:this.j(F.createTextNode(t)),this._$AH=t}I(t){let{values:e,_$litType$:s}=t,r=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=at.createElement(Ye(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===r)this._$AH.R(e);else{let n=new ut(r,this),o=n.O(this.options);n.R(e),this.j(o),this._$AH=n}}_$AC(t){let e=Le.get(t.strings);return e===void 0&&Le.set(t.strings,e=new at(t)),e}D(t){Be(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,s,r=0;for(let n of t)r===e.length?e.push(s=new ze(this.H(nt()),this.H(nt()),this,this.options)):s=e[r],s._$AI(n),r++;r<e.length&&(this._$AR(s&&s._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t&&t!==this._$AB;){let s=t.nextSibling;t.remove(),t=s}}setConnected(t){this._$AM===void 0&&(this.V=t,this._$AP?.(t))}},W=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,r,n){this.type=1,this._$AH=A,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=n,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=A}_$AI(t,e=this,s,r){let n=this.strings,o=!1;if(n===void 0)t=Z(this,t,e,0),o=!ot(t)||t!==this._$AH&&t!==_,o&&(this._$AH=t);else{let c=t,l,p;for(t=n[0],l=0;l<n.length-1;l++)p=Z(this,c[s+l],e,l),p===_&&(p=this._$AH[l]),o||=!ot(p)||p!==this._$AH[l],p===A?t=A:t!==A&&(t+=(p??"")+n[l+1]),this._$AH[l]=p}o&&!r&&this.B(t)}B(t){t===A?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},mt=class extends W{constructor(){super(...arguments),this.type=3}B(t){this.element[this.name]=t===A?void 0:t}},ft=class extends W{constructor(){super(...arguments),this.type=4}B(t){this.element.toggleAttribute(this.name,!!t&&t!==A)}},gt=class extends W{constructor(t,e,s,r,n){super(t,e,s,r,n),this.type=5}_$AI(t,e=this){if((t=Z(this,t,e,0)??A)===_)return;let s=this._$AH,r=t===A&&s!==A||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,n=t!==A&&(s===A||r);r&&this.element.removeEventListener(this.name,this,s),n&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},$t=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){Z(this,t)}},ds={W:Kt,q:D,J:Jt,Z:1,F:Ve,G:ut,K:He,X:Z,Y:wt,tt:W,st:ft,it:gt,et:mt,ot:$t},ps=qt.litHtmlPolyfillSupport;ps?.(at,wt),(qt.litHtmlVersions??=[]).push("3.1.3");var Fe=(i,t,e)=>{let s=e?.renderBefore??t,r=s._$litPart$;if(r===void 0){let n=e?.renderBefore??null;s._$litPart$=r=new wt(t.insertBefore(nt(),n),n,void 0,e??{})}return r._$AI(i),r};var Y=class extends j{constructor(){super(...arguments),this.renderOptions={host:this},this.ht=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this.ht=Fe(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this.ht?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this.ht?.setConnected(!1)}render(){return _}};Y._$litElement$=!0,Y.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:Y});var us=globalThis.litElementPolyfillSupport;us?.({LitElement:Y});(globalThis.litElementVersions??=[]).push("4.0.5");var{Y:ms}=ds,fs=i=>i===null||typeof i!="object"&&typeof i!="function";var Ce=(i,t)=>t===void 0?i?._$litType$!==void 0:i?._$litType$===t,gs=i=>i?._$litType$?.h!=null;var Ze=i=>i.strings===void 0,Me=()=>document.createComment(""),G=(i,t,e)=>{let s=i._$AA.parentNode,r=t===void 0?i._$AB:t._$AA;if(e===void 0){let n=s.insertBefore(Me(),r),o=s.insertBefore(Me(),r);e=new ms(n,o,i,i.options)}else{let n=e._$AB.nextSibling,o=e._$AM,c=o!==i;if(c){let l;e._$AQ?.(i),e._$AM=i,e._$AP!==void 0&&(l=i._$AU)!==o._$AU&&e._$AP(l)}if(n!==r||c){let l=e._$AA;for(;l!==n;){let p=l.nextSibling;s.insertBefore(l,r),l=p}}}return e},H=(i,t,e=i)=>(i._$AI(t,e),i),$s={},lt=(i,t=$s)=>i._$AH=t,Ft=i=>i._$AH,Gt=i=>{i._$AP?.(!1,!0);let t=i._$AA,e=i._$AB.nextSibling;for(;t!==e;){let s=t.nextSibling;t.remove(),t=s}},We=i=>{i._$AR()};var S=i=>(...t)=>({_$litDirective$:i,values:t}),C=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this.nt=t,this._$AM=e,this.rt=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}};var rt=(i,t)=>{let e=i._$AN;if(e===void 0)return!1;for(let s of e)s._$AO?.(t,!1),rt(s,t);return!0},bt=i=>{let t,e;do{if((t=i._$AM)===void 0)break;e=t._$AN,e.delete(i),i=t}while(e?.size===0)},qe=i=>{for(let t;t=i._$AM;i=t){let e=t._$AN;if(e===void 0)t._$AN=e=new Set;else if(e.has(i))break;e.add(i),As(t)}};function bs(i){this._$AN!==void 0?(bt(this),this._$AM=i,qe(this)):this._$AM=i}function ys(i,t=!1,e=0){let s=this._$AH,r=this._$AN;if(r!==void 0&&r.size!==0)if(t)if(Array.isArray(s))for(let n=e;n<s.length;n++)rt(s[n],!1),bt(s[n]);else s!=null&&(rt(s,!1),bt(s));else rt(this,i)}var As=i=>{i.type==2&&(i._$AP??=ys,i._$AQ??=bs)},ct=class extends C{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,s){super._$AT(t,e,s),qe(this),this.isConnected=t._$AU}_$AO(t,e=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),e&&(rt(this,t),bt(this))}setValue(t){if(Ze(this.nt))this.nt._$AI(t,this);else{let e=[...this.nt._$AH];e[this.rt]=t,this.nt._$AI(e,this,0)}}disconnected(){}reconnected(){}};var yt=class{constructor(t){this.ct=t}disconnect(){this.ct=void 0}reconnect(t){this.ct=t}deref(){return this.ct}},At=class{constructor(){this.lt=void 0,this.ut=void 0}get(){return this.lt}pause(){this.lt??=new Promise(t=>this.ut=t)}resume(){this.ut?.(),this.lt=this.ut=void 0}};var _t=class extends ct{constructor(){super(...arguments),this.dt=new yt(this),this.ft=new At}render(t,e){return _}update(t,[e,s]){if(this.isConnected||this.disconnected(),e===this.vt)return _;this.vt=e;let r=0,{dt:n,ft:o}=this;return(async(c,l)=>{for await(let p of c)if(await l(p)===!1)return})(e,async c=>{for(;o.get();)await o.get();let l=n.deref();if(l!==void 0){if(l.vt!==e)return!1;s!==void 0&&(c=s(c,r)),l.commitValue(c,r),r++}return!0}),_}commitValue(t,e){this.setValue(t)}disconnected(){this.dt.disconnect(),this.ft.pause()}reconnected(){this.dt.reconnect(this),this.ft.resume()}},Us=S(_t),St=S(class extends _t{constructor(i){if(super(i),i.type!==2)throw Error("asyncAppend can only be used in child expressions")}update(i,t){return this.ht=i,super.update(i,t)}commitValue(i,t){t===0&&We(this.ht);let e=G(this.ht);H(e,i)}}),Re=i=>gs(i)?i._$litType$.h:i.strings,Ts=S(class extends C{constructor(i){super(i),this.yt=new WeakMap}render(i){return[i]}update(i,[t]){let e=Ce(this.bt)?Re(this.bt):null,s=Ce(t)?Re(t):null;if(e!==null&&(s===null||e!==s)){let r=Ft(i).pop(),n=this.yt.get(e);if(n===void 0){let o=document.createDocumentFragment();n=Fe(A,o),n.setConnected(!1),this.yt.set(e,n)}lt(n,[r]),G(n,void 0,r)}if(s!==null){if(e===null||e!==s){let r=this.yt.get(s);if(r!==void 0){let n=Ft(r).pop();We(i),G(i,void 0,n),lt(i,[n])}}this.bt=t}else this.bt=void 0;return this.render(t)}});var Ls=S(class extends C{constructor(i){if(super(i),i.type!==1||i.name!=="class"||i.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(i){return" "+Object.keys(i).filter(t=>i[t]).join(" ")+" "}update(i,[t]){if(this.gt===void 0){this.gt=new Set,i.strings!==void 0&&(this.wt=new Set(i.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(let s in t)t[s]&&!this.wt?.has(s)&&this.gt.add(s);return this.render(t)}let e=i.element.classList;for(let s of this.gt)s in t||(e.remove(s),this.gt.delete(s));for(let s in t){let r=!!t[s];r===this.gt.has(s)||this.wt?.has(s)||(r?(e.add(s),this.gt.add(s)):(e.remove(s),this.gt.delete(s)))}return _}}),_s={},Cs=S(class extends C{constructor(){super(...arguments),this._t=_s}render(i,t){return t()}update(i,[t,e]){if(Array.isArray(t)){if(Array.isArray(this._t)&&this._t.length===t.length&&t.every((s,r)=>s===this._t[r]))return _}else if(this._t===t)return _;return this._t=Array.isArray(t)?Array.from(t):t,this.render(t,e)}});var Ms=S(class extends C{constructor(){super(...arguments),this.key=A}render(i,t){return this.key=i,t}update(i,[t,e]){return t!==this.key&&(lt(i),this.key=t),e}}),Rs=S(class extends C{constructor(i){if(super(i),i.type!==3&&i.type!==1&&i.type!==4)throw Error("The `live` directive is not allowed on child or event bindings");if(!Ze(i))throw Error("`live` bindings can only contain a single expression")}render(i){return i}update(i,[t]){if(t===_||t===A)return t;let e=i.element,s=i.name;if(i.type===3){if(t===e[s])return _;if(i.type===4){if(!!t===e.hasAttribute(s))return _;if(i.type===1&&e.getAttribute(s)===t+"")return _}}return lt(i),t}});var Yt=new WeakMap,Os=S(class extends ct{render(i){return A}update(i,[t]){let e=t!==this.ct;return e&&this.ct!==void 0&&this.St(void 0),(e||this.$t!==this.Tt)&&(this.ct=t,this.xt=i.options?.host,this.St(this.Tt=i.element)),A}St(i){if(typeof this.ct=="function"){let t=this.xt??globalThis,e=Yt.get(t);e===void 0&&(e=new WeakMap,Yt.set(t,e)),e.get(this.ct)!==void 0&&this.ct.call(this.xt,void 0),e.set(this.ct,i),i!==void 0&&this.ct.call(this.xt,i)}else this.ct.value=i}get $t(){return typeof this.ct=="function"?Yt.get(this.xt??globalThis)?.get(this.ct):this.ct?.value}disconnected(){this.$t===this.Tt&&this.St(void 0)}reconnected(){this.St(this.Tt)}}),Oe=(i,t,e)=>{let s=new Map;for(let r=t;r<=e;r++)s.set(i[r],r);return s},ks=S(class extends C{constructor(i){if(super(i),i.type!==2)throw Error("repeat() can only be used in text expressions")}Et(i,t,e){let s;e===void 0?e=t:t!==void 0&&(s=t);let r=[],n=[],o=0;for(let c of i)r[o]=s?s(c,o):o,n[o]=e(c,o),o++;return{values:n,keys:r}}render(i,t,e){return this.Et(i,t,e).values}update(i,[t,e,s]){let r=Ft(i),{values:n,keys:o}=this.Et(t,e,s);if(!Array.isArray(r))return this.Ct=o,n;let c=this.Ct??=[],l=[],p,$,d=0,b=r.length-1,f=0,y=n.length-1;for(;d<=b&&f<=y;)if(r[d]===null)d++;else if(r[b]===null)b--;else if(c[d]===o[f])l[f]=H(r[d],n[f]),d++,f++;else if(c[b]===o[y])l[y]=H(r[b],n[y]),b--,y--;else if(c[d]===o[y])l[y]=H(r[d],n[y]),G(i,l[y+1],r[d]),d++,y--;else if(c[b]===o[f])l[f]=H(r[b],n[f]),G(i,r[d],r[b]),b--,f++;else if(p===void 0&&(p=Oe(o,f,y),$=Oe(c,d,b)),p.has(c[d]))if(p.has(c[b])){let U=$.get(o[f]),et=U!==void 0?r[U]:null;if(et===null){let ye=G(i,r[d]);H(ye,n[f]),l[f]=ye}else l[f]=H(et,n[f]),G(i,r[d],et),r[U]=null;f++}else Gt(r[b]),b--;else Gt(r[d]),d++;for(;f<=y;){let U=G(i,l[y+1]);H(U,n[f]),l[f++]=U}for(;d<=b;){let U=r[d++];U!==null&&Gt(U)}return this.Ct=o,lt(i,l),_}}),Ke="important",vs=" !"+Ke,Is=S(class extends C{constructor(i){if(super(i),i.type!==1||i.name!=="style"||i.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(i){return Object.keys(i).reduce((t,e)=>{let s=i[e];return s==null?t:t+`${e=e.includes("-")?e:e.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(i,[t]){let{style:e}=i.element;if(this.Pt===void 0)return this.Pt=new Set(Object.keys(t)),this.render(t);for(let s of this.Pt)t[s]==null&&(this.Pt.delete(s),s.includes("-")?e.removeProperty(s):e[s]=null);for(let s in t){let r=t[s];if(r!=null){this.Pt.add(s);let n=typeof r=="string"&&r.endsWith(vs);s.includes("-")||n?e.setProperty(s,n?r.slice(0,-11):r,n?Ke:""):e[s]=r}}return _}}),Ps=S(class extends C{constructor(i){if(super(i),i.type!==2)throw Error("templateContent can only be used in child bindings")}render(i){return this.At===i?_:(this.At=i,document.importNode(i.content,!0))}}),J=class extends C{constructor(t){if(super(t),this.bt=A,t.type!==2)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===A||t==null)return this.kt=void 0,this.bt=t;if(t===_)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.bt)return this.kt;this.bt=t;let e=[t];return e.raw=e,this.kt={_$litType$:this.constructor.resultType,strings:e,values:[]}}};J.directiveName="unsafeHTML",J.resultType=1;var Et=S(J);var ht=class extends J{};ht.directiveName="unsafeSVG",ht.resultType=2;var Ns=S(ht),ke=i=>!fs(i)&&typeof i.then=="function",Ie=1073741823;var Zt=class extends ct{constructor(){super(...arguments),this.Mt=Ie,this.Ut=[],this.dt=new yt(this),this.ft=new At}render(...t){return t.find(e=>!ke(e))??_}update(t,e){let s=this.Ut,r=s.length;this.Ut=e;let n=this.dt,o=this.ft;this.isConnected||this.disconnected();for(let c=0;c<e.length&&!(c>this.Mt);c++){let l=e[c];if(!ke(l))return this.Mt=c,l;c<r&&l===s[c]||(this.Mt=Ie,r=0,Promise.resolve(l).then(async p=>{for(;o.get();)await o.get();let $=n.deref();if($!==void 0){let d=$.Ut.indexOf(l);d>-1&&d<$.Mt&&($.Mt=d,$.setValue(p))}}))}return _}disconnected(){this.dt.disconnect(),this.ft.pause()}reconnected(){this.dt.reconnect(this),this.ft.resume()}},Ds=S(Zt);var ws=Symbol.for(""),Ss=i=>{if(i?.r===ws)return i?._$litStatic$};var Pe=new Map,Je=i=>(t,...e)=>{let s=e.length,r,n,o=[],c=[],l,p=0,$=!1;for(;p<s;){for(l=t[p];p<s&&(n=e[p],(r=Ss(n))!==void 0);)l+=r+t[++p],$=!0;p!==s&&c.push(n),o.push(l),p++}if(p===s&&o.push(t[s]),$){let d=o.join("$$lit$$");(t=Pe.get(d))===void 0&&(o.raw=o,Pe.set(d,t=o)),e=c}return i(t,...e)},Bs=Je(a),Hs=Je(hs);var u=class extends Y{createRenderRoot(){return this}broadcast(t,e){return()=>{let s=new CustomEvent(t,{detail:e,bubbles:!0,composed:!0});this.dispatchEvent(s)}}};var xt=Symbol("the albums manifest"),Ut=Symbol("the images manifest"),ti=Symbol("the site manifest"),Tt=Symbol("the videos manifest"),Lt=Symbol("the exif data"),Ct=Symbol("the semantic data"),ei=Symbol("the album stats"),Mt=Symbol("the triples data");var Qe="photos",h=class{static EAGER="eager";static LAZY="lazy"},m=class{static PHOTOS="photos";static ALBUMS="albums";static ALBUM="album";static METADATA="metadata";static ABOUT="about";static VIDEOS="videos";static THING="thing"},E=class{static UNESCO="unesco";static BIRD="bird";static MAMMAL="mammal";static GEONAME="geoname"},v=class{static SUBJECT="subject";static LOCATION="location";static LONGITUDE="longitude";static LATITUDE="latitude";static RATING="rating";static NAME="name";static BIRDWATCH_URL="birdwatch_url";static WIKIPEDIA="wikipedia"},Q=new Set(["bird","mammal","reptile","amphibian","fish"]);var q=window.envConfig,Rt=class{_data;constructor(t=`/manifest/images.${q.publication_id}.json`){this.url=t}processImages(t){let e=t[0],s=[];for(let r of t.slice(1)){let n={};for(let o=0;o<e.length;o++)n[e[o]]=r[o];s.push(n)}return s}async init(){if(window[Ut]&&(this._data=window[Ut]),this._data||this.loading)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.processImages(t);window[Ut]=e,this._data=e}images(){return this._data.map(t=>({...t,full_image:`https://photos-cdn.rgrannell.xyz${t.full_image}`,thumbnail_url:`https://photos-cdn.rgrannell.xyz${t.thumbnail_url}`}))}},Ot=class{_data;constructor(t=`/manifest/videos.${q.publication_id}.json`){this.url=t}processVideos(t){let e=t[0],s=[];for(let r of t.slice(1)){let n={};for(let o=0;o<e.length;o++)n[e[o]]=r[o];s.push(n)}return s}async init(){if(window[Tt]&&(this._data=window[Tt]),this._data||this.loading)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.processVideos(t);window[Tt]=e,this._data=e}videos(){return this._data.map(t=>({...t,poster_url:`https://photos-cdn.rgrannell.xyz${t.poster_url}`,video_url_1080p:`https://photos-cdn.rgrannell.xyz${t.video_url_1080p}`,video_url_480p:`https://photos-cdn.rgrannell.xyz${t.video_url_480p}`,video_url_720p:`https://photos-cdn.rgrannell.xyz${t.video_url_720p}`,video_url_unscaled:`https://photos-cdn.rgrannell.xyz${t.video_url_unscaled}`,tags:(t.tags??"").split(",").filter(e=>e!="Published").map(e=>e.trim())}))}},kt=class{_data;constructor(t=`/manifest/albums.${q.publication_id}.json`){this.url=t}process(t){let e=t[0],s=[];for(let r of t.slice(1)){let n={};if(r.length!==e.length)throw new Error(`album row length mismatch: expected ${e.length}, got ${r.length}`);for(let o=0;o<e.length;o++)n[e[o]]=r[o];s.push(n)}return s}async init(){if(window[xt]&&(this._data=window[xt]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.process(t);window[xt]=e,this._data=e}albums(){return this._data.map(t=>({...t,thumbnail_url:`https://photos-cdn.rgrannell.xyz${t.thumbnail_url}`,thumbnail_mosaic_url:`${t.thumbnail_mosaic_url}`}))}},It=class{_data;constructor(t=`/manifest/exif.${q.publication_id}.json`){this.url=t}process(t){let e=t[0],s=[];for(let r of t.slice(1)){let n={};for(let o=0;o<e.length;o++)n[e[o]]=r[o];s.push(n)}return s}async init(){if(window[Lt]&&(this._data=window[Lt]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json(),e=this.process(t);window[Lt]=e,this._data=e}exif(){return this._data}};var Pt=class{_data;constructor(t=`/manifest/semantic.${q.publication_id}.json`){this.url=t}async init(){if(window[Ct]&&(this._data=window[Ct]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json();window[Ct]=t,this._data=t}semantic(){return this._data}},Nt=class{_data;constructor(t=`/manifest/stats.${q.publication_id}.json`){this.url=t}async init(){let t=document.getElementById("stats-data");this._data=JSON.parse(t.textContent),this._data||console.error("stats symbol not injected")}stats(){return this._data}},Dt=class{_data;constructor(t=`/manifest/triples.${q.publication_id}.json`){this.url=t}async init(){if(window[Mt]&&(this._data=window[Mt]),this._data)return;console.log(`\u{1F50E} fetching ${this.url}`);let t=await(await fetch(this.url)).json();window[Mt]=t,this._data=t}};var k=class i{static ROUTES={[m.PHOTOS]:this.showPhotosUrl,[m.ALBUMS]:this.showAlbumsUrl,[m.ALBUM]:this.showAlbumUrl,[m.METADATA]:this.showMetadataUrl,[m.ABOUT]:this.showAboutUrl,[m.VIDEOS]:this.showVideosUrl,[m.THING]:this.showThingUrl};static router(t){if(i.ROUTES.hasOwnProperty(t))return i.ROUTES[t];throw new Error(`Unknown page: ${t}`)}static pageUsesId(t){return t===m.ALBUM||t===m.PHOTO||t===m.METADATA||t===m.THING}static showAboutUrl(){window.location.hash="#/about",document.title="About - photos"}static showAlbumsUrl(){window.location.hash="#/albums",document.title="Albums - photos"}static showPhotosUrl(){window.location.hash="#/photos",document.title="Photos - photos"}static showAlbumUrl(t){window.location.hash=`#/album/${t}`,document.title="Album - photos"}static showPhotoUrl(t){window.location.hash=`#/photo/${t}`,document.title="Photo - photos"}static showMetadataUrl(t){window.location.hash=`#/metadata/${t}`,document.title="Metadata - photos"}static showVideosUrl(){window.location.hash="#/videos",document.title="Videos - photos"}static showThingUrl(t){window.location.hash=`#/thing/${t}`,document.title="Thing - photos"}static getUrl(){return window.location.hash.startsWith("#/albums")?{type:"albums"}:window.location.hash.startsWith("#/album")?{type:"album",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/metadata")?{type:"metadata",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/thing")?{type:"thing",id:window.location.hash.split("/")[2]}:window.location.hash.startsWith("#/photos")?{type:"photos"}:window.location.hash.startsWith("#/about")?{type:"about"}:window.location.hash.startsWith("#/videos")?{type:"videos"}:{type:"albums"}}};var Qt=class extends u{static get properties(){return{visible:{type:Boolean}}}render(){let t=["photo-sidebar"];return this.visible&&t.push("sidebar-visible"),a`
    ...
    `:a`<span>Invalid UNESCO URN</span>`}};customElements.define("unesco-link",le);var ce=class extends u{static properties={urn:{type:String},triples:{type:Array}};name(){let{type:t,id:e}=g.parseUrn(this.urn);if(Q.has(t))return a`<span>${K.toCommonName(this.triples,e)}</span>`;let s=I.findName(this.triples,this.urn);return s?a`<span>${s}</span>`:decodeURIComponent(e)}linkClass(){let{type:t}=g.parseUrn(this.urn);if(t===E.BIRD)return"bird-link";if(t===E.MAMMAL)return"mammal-link"}render(){return g.isUrn(this.urn)?a`
      <a class="thing-link ${this.linkClass()}" href="${g.toURL(this.urn)}">${this.name()}</a>
    `:a`<span>Invalid URN</span>`}};customElements.define("thing-link",ce);var he=class extends u{static get properties(){return{title:{type:String},id:{type:String},minDate:{type:String},maxDate:{type:String},imageCount:{type:Number},description:{type:String},images:{type:Object},videos:{type:Object},semantic:{type:Object},triples:{type:Array},countries:{type:String}}}connectedCallback(){super.connectedCallback(),this.albumPhotos()[0]||console.error(`empty album! ${this.id}`),w.setIndex()}albumPhotos(){let t=this.semantic.semantic();return this.images.images().filter(e=>e.album_id===this.id).map(e=>{let s={},r=t.filter(n=>n[0]===e.id);for(let[n,o,c]of r)s[o]||(s[o]=[]),s[o].push(c);return{...e,relations:s}})}albumVideos(){return this.videos.videos().filter(t=>t.album_id===this.id)}renderPhotoCount(){return this.imageCount===1?`${this.imageCount} photo`:`${this.imageCount} photos`}thingsLinks(){let t={},e=this.albumPhotos();for(let r of[E.UNESCO])t[r]=Array.from(new Set(e.flatMap(n=>n.relations.location?.filter(o=>g.is(o,r))).filter(n=>n)));for(let r of[E.BIRD,E.MAMMAL])t[r]=Array.from(new Set(e.flatMap(n=>n.relations.subject?.filter(o=>g.is(o,r))).filter(n=>n)));let s=[];return s=s.concat(t[E.UNESCO].map(r=>a`<unesco-link urn="${r}"></unesco-link>`)),s=s.concat(t[E.BIRD].map(r=>a`<thing-link .urn="${r}" .triples="${this.triples}"></thing-link>`)),s=s.concat(t[E.MAMMAL].map(r=>a`<thing-link .urn="${r}" .triples="${this.triples}"></thing-link>`)),s}render(){let t=window.matchMedia("(max-width: 500px)"),e=X.dateRange(this.minDate,this.maxDate,t.matches),r=this.albumPhotos().map((c,l)=>a`
      <app-photo
        id=${c.id}
    ...
    `}};customElements.define("album-page",he);var de=class extends u{static get properties(){return{url:{type:String},format:{type:String},sharing:{state:!0,type:Boolean}}}async shareImage(t){if(!navigator.share)console.error("navigator.share not available");else{this.sharing=!0;try{let e=await fetch(t),s=new URL(t).pathname;await navigator.share({title:s,files:[new File([await e.blob()],s,{type:this.format})]})}finally{this.sharing=!1}}}render(){return this.sharing?a`<button class="photo-share-button" disabled>[sharing...]</button>`:a`
      ...
      </ul>`;if(t.includes("binomial"))return a`<em>${e}</em>`;if(t.toLowerCase()==="summary")return a`${Et(e??"")}`;if(g.isRating(e)){let s=`urn:r\xF3:rating:${e}`;return a`<thing-link .triples=${this.triples} .urn="${s}"></thing-link>`}else{if(g.isUrn(e)&&g.is(e,E.UNESCO))return a`<unesco-link .urn="${e}"></unesco-link>`;if(g.isUrn(e))return a`<thing-link .triples=${this.triples} .urn="${e}"></thing-link>`}return e}isIgnoredKey(t){return console.log(t),new Set(["bird_binomial","wildlife","living_conditions"]).has(t)}renderSemanticData(t){return a`
    ...
    `}};customElements.define("videos-page",fe);var ge=class extends u{static get properties(){return{urn:{type:String},images:{type:Object},albums:{type:Object},semantic:{type:Object},triples:{type:Array}}}connectedCallback(){super.connectedCallback(),w.setIndex()}isSemanticRelation(t){return t===v.SUBJECT||t===v.LOCATION||t===v.RATING}filterPhotos(t,e){return e.filter(s=>{let[r,n,o]=s,c=g.isRating(o)?`urn:r\xF3:rating:${encodeURIComponent(o)}`:o;if(!this.isSemanticRelation(n)&&!g.isUrn(c))return!1;try{let l=g.parseUrn(c),p=g.parseUrn(this.urn);return p.id==="*"?p.type===l.type:g.sameURN(c,this.urn)}catch{return!1}}).map(s=>t.find(r=>r.id===s[0])).filter(s=>s!==void 0)}subjectPhotos(t,e){return this.filterPhotos(t,e).sort((s,r)=>r.created_at-s.created_at).map((s,r)=>a`
      ...
      `)}getFacts(){let t=this.triples.filter(s=>s[0]===this.urn),e={};for(let s of t){let[r,n,o]=s;e.hasOwnProperty(n)||(e[n]=[]),e[n].push(o)}return e}binomialToCommonName(t){let e=this.triples.find(s=>{let[r,n,o]=s;if(!g.isUrn(r))return!1;let c=g.parseUrn(r),l=t.replace(" ","-").toLowerCase();return c.id===l&&n===v.NAME});return e?e[2]:t}firstPhotographed(t,e){let r=this.filterPhotos(t,e).sort((n,o)=>n.created_at-o.created_at)[0];return r?new Date(r.created_at).toLocaleDateString("en-IE",{day:"numeric",month:"short",year:"numeric"}):"Unknown"}getTitle(){let t=I.findName(this.triples,this.urn);if(t)return t;try{let e=g.parseUrn(this.urn),s=decodeURIComponent(e.id);return e.id==="*"?`${e.type.charAt(0).toUpperCase()}${e.type.slice(1)}`:Q.has(e.type)?K.toCommonName(this.triples,s):s}catch{return this.urn}}renderFacts(t,e){let s={};return e.country&&(s.Country=a`${e.country}`),s}render(){let t=this.images.images(),e=this.semantic.semantic(),s=this.subjectPhotos(t,e),r=this.subjectAlbums(t,e),n=this.getFacts(),o=g.parseUrn(this.urn),c=o.type,l=Object.assign({Classification:a`<a href="#/thing/${c}:*">${c.charAt(0).toUpperCase()}${c.slice(1)}</a>`},this.renderFacts(o,n));Q.has(c)&&(l["First Photographed"]=a`<span>${this.firstPhotographed(t,e)}</span>`);let p=I.findWikipedia(this.triples,this.urn),$=I.findBirdwatchUrl(this.triples,this.urn),d=I.findLongitude(this.triples,this.urn),b=I.findLatitude(this.triples,this.urn),f;if(d&&b){let y=`https://www.google.com/maps?q=${n.latitude},${n.longitude}`;f=a`
    ...
    `}};customElements.define("thing-page",ge);var M=new kt,L=new Rt,O=new Ot,P=new It,T=new Pt,N=new Nt,R=new Dt,Es=[[M,h.EAGER],[L,h.EAGER],[O,h.EAGER],[P,h.EAGER],[T,h.EAGER],[N,h.EAGER],[R,h.LAZY]],xs={[m.ABOUT]:[[M,h.LAZY],[L,h.LAZY],[O,h.LAZY],[P,h.LAZY],[N,h.LAZY],[T,h.EAGER],[R,h.LAZY]],[m.ALBUMS]:[[M,h.EAGER],[L,h.LAZY],[O,h.LAZY],[P,h.LAZY],[N,h.EAGER],[T,h.EAGER],[R,h.LAZY]],[m.PHOTOS]:[[M,h.EAGER],[L,h.EAGER],[O,h.EAGER],[P,h.LAZY],[N,h.LAZY],[T,h.EAGER],[R,h.LAZY]],[m.VIDEOS]:[[M,h.LAZY],[L,h.LAZY],[O,h.EAGER],[P,h.LAZY],[N,h.LAZY],[T,h.EAGER],[R,h.LAZY]],[m.ALBUM]:[[M,h.EAGER],[L,h.EAGER],[O,h.EAGER],[N,h.LAZY],[P,h.LAZY],[T,h.EAGER],[R,h.EAGER]],[m.PHOTO]:[[M,h.EAGER],[L,h.EAGER],[O,h.EAGER],[P,h.EAGER],[T,h.EAGER],[N,h.LAZY],[R,h.LAZY]],[m.METADATA]:[[M,h.LAZY],[L,h.EAGER],[O,h.EAGER],[P,h.EAGER],[T,h.EAGER],[N,h.LAZY],[T,h.EAGER],[R,h.EAGER]],[m.THING]:[[M,h.EAGER],[L,h.EAGER],[O,h.LAZY],[P,h.LAZY],[T,h.EAGER],[N,h.LAZY],[R,h.EAGER]]},$e=class{static async init(){let t=k.getUrl();console.log(`loading ${t?.type}`);let e=xs[t?.type]??Es,s=[];for(let[r,n]of e)n===h.EAGER?s.push(r.init()):n===h.LAZY&&r.init();await Promise.all(s)}};await $e.init();var be=class i extends u{static DEFAULT_PAGE=m.ALBUMS;static LOCATION_TYPE_TO_PAGE={album:m.ALBUM,albums:m.ALBUMS,photos:m.PHOTOS,metadata:m.METADATA,about:m.ABOUT,videos:m.VIDEOS,thing:m.THING};static get properties(){return{title:{type:String},page:{type:String},sidebarVisible:{type:Boolean,state:!0},id:{type:String},imageUrl:{type:String},thumbnailUrl:{type:String},route:{type:String},params:{type:Object},query:{type:Object},darkMode:{type:Boolean}}}connectedCallback(){super.connectedCallback(),this.setStateFromUrl(),this.requestUpdate(),window.addEventListener("popstate",this.handlePopState.bind(this)),this.sidebarVisible=!1}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this.handlePopState.bind(this))}handlePopState(){this.setStateFromUrl(),this.requestUpdate()}setStateFromUrl(){let t=k.getUrl();i.LOCATION_TYPE_TO_PAGE[t?.type]?this.page=i.LOCATION_TYPE_TO_PAGE[t.type]:(console.error("did not match pagetype",t?.type),this.page=i.DEFAULT_PAGE),k.pageUsesId(this.page)&&(this.id=t.id)}receiveClickAlbum(t){let{title:e,id:s}=t.detail;this.page=m.PHOTOS,this.id=s,this.title=e,k.showAlbumUrl(s)}async receiveClickBurgerMenu(){this.sidebarVisible=!this.sidebarVisible}async receiveClickPhotoMetadata(t){let{id:e,imageUrl:s,thumbnailUrl:r}=t.detail;this.page=m.METADATA,this.id=e,this.imageUrl=s,this.thumbnailUrl=r,k.showMetadataUrl(e)}receiveSwitchTheme(t){this.darkMode=!this.darkMode,localStorage.setItem("darkMode",this.darkMode),this.requestUpdate()}receiveNavigatePage(t){this.page=t.detail.page,this.sidebarVisible=!1;let e=k.router(this.page);k.pageUsesId(this.page)?e(this.id):e()}pageClasses(t){let e=["page"];return t&&e.push("sidebar-visible"),e.join(" ")}renderPage(t){let e=this.pageClasses(t);if(!this.page||this.page==="albums")return a`
      <photo-album-page .stats=${N} .albums="${M}" class="${e}"></photo-album-page>
      `;if(this.page===m.ABOUT)return a`<about-page class="${e}"></about-page>`;if(this.page===m.PHOTOS)return a`<photos-page class="${e}" .images=${L}></photos-page>`;if(this.page===m.ALBUM){this.id||console.error("no album id provided");let s=M.albums().find(r=>r.id===this.id);return s||console.error(`failed to find album with id ${this.id}`),a`
      <album-page
        .images=${L}
        .videos=${O}
        .semantic=${T}
        ...
        countries=${s.flags}
        class="${e}"></album-page>
      `}if(this.page===m.METADATA){let s=L.images().find(c=>c.id===this.id),r=P.exif().find(c=>c.id===this.id),n=T.semantic().filter(c=>c[0]===this.id),o={};for(let[c,l,p]of n)o[l]?typeof o[l]=="string"&&(o[l]=[o[l],p]):o[l]=p;return s||console.error(`failed to find photo with id ${this.id}`),a`
      <metadata-page
        .triples=${R._data}
        .image=${s}
        .semantic=${o} .exif=${r} id=${this.id} class="${e}"></metadata-page>
      `}if(this.page===m.VIDEOS)return a`
      <videos-page .videos=${O} class="${e}"></videos-page>
