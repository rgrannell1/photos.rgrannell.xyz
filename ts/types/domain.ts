...
import type { FeatureSchema, PlaceSchema, UnescoSchema } from "../schemas/place.ts";
import type {
  AmphibianSchema,
  ArthropodSchema,
  BirdSchema,
...
export type Transfer = InferOutput<typeof TransferSchema> & { type: "transfer" };
...
export type Amphibian = InferOutput<typeof AmphibianSchema> & { type: "amphibian" };
export type Arthropod = InferOutput<typeof ArthropodSchema> & { type: "arthropod" };
