...
import {
  ...
  setTitle,
  sharePhotoUrl,
} from "../../../services/browser/window.ts";
...
import { drawGridPhoto } from "../../media/images/photo-grid.ts";
import { drawVideoItem } from "../../media/content/video.ts";
import { AlbumsButton } from "../../album/controls/albums-button.ts";
